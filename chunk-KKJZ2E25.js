...
(function(AppStatusEnum2) {
  ...
  AppStatusEnum2[AppStatusEnum2["UNDER_REVIEW"] = 2] = "UNDER_REVIEW";
  AppStatusEnum2[AppStatusEnum2["CHANGES_REQUESTED"] = 3] = "CHANGES_REQUESTED";
  AppStatusEnum2[AppStatusEnum2["APPROVED"] = 4] = "APPROVED";
  AppStatusEnum2[AppStatusEnum2["REJECTED"] = 5] = "REJECTED";
  AppStatusEnum2[AppStatusEnum2["SUSPENDED"] = 6] = "SUSPENDED";
  AppStatusEnum2[AppStatusEnum2["WITHDRAWN"] = 7] = "WITHDRAWN";
...
function mapStatusFromApi(status) {
  switch (status) {
    ...
    case AppStatusEnum.UNDER_REVIEW:
      return "underReview";
    case AppStatusEnum.CHANGES_REQUESTED:
...
function mapStatusToApi(status) {
  switch (status) {
    ...
    case "underReview":
      return AppStatusEnum.UNDER_REVIEW;
    case "changesRequested":
      return AppStatusEnum.CHANGES_REQUESTED;
    case "approved":
    ...
    case "withdrawn":
      return AppStatusEnum.WITHDRAWN;
    default:
      return AppStatusEnum.DRAFT;
  }
}
...
var AppStoreService = class _AppStoreService {
   ...
   */
  getAppById(id) {
    return this.http.get(`${this.baseUrl}/apps/${id}`).pipe(map(mapAppDefinitionFromApi));
  }
  /**
...
//# sourceMappingURL=chunk-KKJZ2E25.js.map
