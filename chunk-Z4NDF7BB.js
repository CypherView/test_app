...
} from "./chunk-DT5AXNL4.js";
import {
  DynamicTabPanelComponent
} from "./chunk-NK366X3D.js";
import "./chunk-DTEK3MCY.js";
import {
  Tag,
  TagModule
} from "./chunk-YRD2G732.js";
import "./chunk-YKG5LWOW.js";
import "./chunk-WHE333XX.js";
import "./chunk-IPDDT53K.js";
import {
  ChartModule,
  UIChart
...
import "./chunk-KPRG7L7L.js";
import "./chunk-GPJSQTNR.js";
import "./chunk-NS6YWNCI.js";
import {
  ProgressBarModule
} from "./chunk-DTC2ZSBN.js";
...
function AzureFunctionsComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(7, "i", 29);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "p-card")(9, "div", 26)(10, "div", 30);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 28);
    \u0275\u0275text(14, " Total Executions ");
    \u0275\u0275element(15, "i", 31);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "p-card")(17, "div", 26)(18, "div", 32);
    \u0275\u0275text(19);
    \u0275\u0275pipe(20, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 28);
    \u0275\u0275text(22, " Avg Success Rate ");
    \u0275\u0275element(23, "i", 33);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "p-card")(25, "div", 26)(26, "div", 34);
    \u0275\u0275text(27);
    \u0275\u0275pipe(28, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 28);
    \u0275\u0275text(30, " Cold Starts ");
    \u0275\u0275element(31, "i", 35);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(12, 4, ctx_r0.getTotalExecutions(), "1.0-0"), " ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(20, 7, ctx_r0.getAverageSuccessRate(), "1.1-1"), "% ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(28, 10, ctx_r0.resources.totalColdStarts, "1.0-0"), " ");
  }
}
...
function AzureFunctionsComponent_Conditional_25_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275element(1, "th", 40);
    \u0275\u0275elementStart(2, "th", 41);
    \u0275\u0275text(3, " Function Name ");
    \u0275\u0275element(4, "p-sortIcon", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th", 43);
    \u0275\u0275text(6, " Status ");
    \u0275\u0275element(7, "p-sortIcon", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th", 45);
    \u0275\u0275text(9, " Executions ");
    \u0275\u0275element(10, "p-sortIcon", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "th", 47);
    \u0275\u0275text(12, " Success Rate ");
    \u0275\u0275element(13, "p-sortIcon", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "th", 49);
    \u0275\u0275text(15, " Avg Duration ");
    \u0275\u0275element(16, "p-sortIcon", 50);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "th", 51);
    \u0275\u0275text(18, " P95 Duration ");
    \u0275\u0275element(19, "p-sortIcon", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "th", 53);
    \u0275\u0275text(21, " Last Execution ");
    \u0275\u0275element(22, "p-sortIcon", 54);
    \u0275\u0275elementEnd()();
  }
}
function AzureFunctionsComponent_Conditional_25_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "p-button", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td")(4, "span");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td");
    \u0275\u0275element(7, "p-tag", 56);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "td", 57);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 57)(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "number");
    \u0275\u0275elementEnd()();
...
function AzureFunctionsComponent_Conditional_25_ng_template_5_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, AzureFunctionsComponent_Conditional_25_ng_template_5_Conditional_49_For_2_Template, 6, 9, "div", 71, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AzureFunctionsComponent_Conditional_25_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 58)(2, "div", 59)(3, "h4", 60);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 61)(6, "p-card", 62)(7, "div", 63)(8, "div", 64)(9, "span", 65);
    \u0275\u0275text(10, "Total:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(13, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 64)(15, "span", 65);
    \u0275\u0275text(16, "Failed:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(19, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 64)(21, "span", 65);
    ...
    \u0275\u0275pipe(25, "number");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(26, "p-card", 68)(27, "div", 63)(28, "div", 64)(29, "span", 65);
    \u0275\u0275text(30, "Min:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "span", 66);
    \u0275\u0275text(32);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 64)(34, "span", 65);
    \u0275\u0275text(35, "P50:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "span", 66);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 64)(39, "span", 65);
    \u0275\u0275text(40, "P99:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "span", 66);
    \u0275\u0275text(42);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "div", 64)(44, "span", 65);
    \u0275\u0275text(45, "Max:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "span", 66);
    \u0275\u0275text(47);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(48, "p-card", 69);
    \u0275\u0275conditionalCreate(49, AzureFunctionsComponent_Conditional_25_ng_template_5_Conditional_49_Template, 3, 0, "div", 63)(50, AzureFunctionsComponent_Conditional_25_ng_template_5_Conditional_50_Template, 2, 0, "p", 70);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
function AzureFunctionsComponent_Conditional_36_Conditional_24_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 85);
    \u0275\u0275text(2, " Function ");
    \u0275\u0275element(3, "p-sortIcon", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "th", 86);
    \u0275\u0275text(5, " Cold Starts ");
    \u0275\u0275element(6, "p-sortIcon", 87);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th", 88);
    \u0275\u0275text(8, " Rate ");
    \u0275\u0275element(9, "p-sortIcon", 89);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "th", 90);
    \u0275\u0275text(11, " Avg Cold ");
    \u0275\u0275element(12, "p-sortIcon", 91);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th", 92);
    \u0275\u0275text(14, " Avg Warm ");
    \u0275\u0275element(15, "p-sortIcon", 93);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 94);
    \u0275\u0275text(17, " Impact ");
    \u0275\u0275element(18, "p-sortIcon", 95);
    \u0275\u0275elementEnd()();
  }
}
function AzureFunctionsComponent_Conditional_36_Conditional_24_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "td", 57)(15, "span");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function AzureFunctionsComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "p-card", 74)(2, "div", 75)(3, "div", 26)(4, "div", 76);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 26)(10, "div", 78);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 26)(16, "div", 79);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 77);
    \u0275\u0275text(19, "Functions Analyzed");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(20, "p-card", 80);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "p-card", 81);
    \u0275\u0275conditionalCreate(24, AzureFunctionsComponent_Conditional_36_Conditional_24_Template, 5, 3, "p-table", 82)(25, AzureFunctionsComponent_Conditional_36_Conditional_25_Template, 4, 0, "div", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AzureFunctionsComponent_Conditional_38_Conditional_20_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "p-sortIcon", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "th", 98);
    \u0275\u0275text(5, " Type ");
    \u0275\u0275element(6, "p-sortIcon", 99);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th", 100);
    \u0275\u0275text(8, " Dependency ");
    \u0275\u0275element(9, "p-sortIcon", 101);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "th", 102);
    \u0275\u0275text(11, " Calls ");
    \u0275\u0275element(12, "p-sortIcon", 103);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th", 104);
    \u0275\u0275text(14, " Failed ");
    \u0275\u0275element(15, "p-sortIcon", 105);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 106);
    \u0275\u0275text(17, " Error Rate ");
    \u0275\u0275element(18, "p-sortIcon", 107);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "th", 108);
    \u0275\u0275text(20, " Avg Duration ");
    \u0275\u0275element(21, "p-sortIcon", 50);
    \u0275\u0275elementEnd()();
  }
}
...
function AzureFunctionsComponent_Conditional_38_Conditional_20_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td")(7, "div", 109);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, AzureFunctionsComponent_Conditional_38_Conditional_20_ng_template_3_Conditional_9_Template, 2, 1, "div", 110);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "td", 57);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "td", 57)(14, "span");
    \u0275\u0275text(15);
    \u0275\u0275pipe(16, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "td", 57)(18, "span");
    \u0275\u0275text(19);
    \u0275\u0275pipe(20, "number");
    \u0275\u0275elementEnd()();
...
function AzureFunctionsComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-card")(1, "div", 96)(2, "div", 26)(3, "div", 79);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 26)(9, "div", 97);
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 26)(15, "div", 76);
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 77);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(20, AzureFunctionsComponent_Conditional_38_Conditional_20_Template, 5, 3, "p-table", 82)(21, AzureFunctionsComponent_Conditional_38_Conditional_21_Template, 4, 0, "div", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var AzureFunctionsComponent = class _AzureFunctionsComponent {
  ...
  getStatusDescription(status) {
    switch (status?.toLowerCase()) {
      case "healthy":
        return "Operating normally with no significant errors or latency.";
      case "warning":
        return "Experiencing some errors or elevated latency, but still functional.";
      case "critical":
      case "error":
        return "Experiencing severe issues, high failure rates, or downtime.";
      case "unknown":
        return "No activity recorded in the selected time range.";
      default:
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AzureFunctionsComponent, selectors: [["app-azure-functions"]], viewQuery: function AzureFunctionsComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(9, AzureFunctionsComponent_Conditional_9_Template, 32, 13, "div", 12);
  ...
  <div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 m-4">
    <p-card>
      <div class="text-center">
        ...
        <div
          class="text-sm text-gray-800 flex items-center justify-center gap-1"
        >
          Total Functions
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The number of unique Azure functions deployed and detected within the time range."
          ></i>
        </div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The total aggregated number of executions for all Azure functions combined."
          ></i>
        </div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The average percentage of non-failing executions across all functions."
          ></i>
        </div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The number of executions that suffered from a cold start delay (the function had to spin up in Azure before executing)."
          ></i>
        </div>
      </div>
    </p-card>
            ...
            <ng-template #header>
              <tr>
                ...
                <th
                  ...
                  pTooltip="Name of the running Azure Function"
                >
                ...
                <th
                  ...
                  pTooltip="Health state based on error rates"
                >
                ...
                <th
                  ...
                  class="text-right"
                  pTooltip="Percentage of executions that succeed"
                >
                ...
                <th
                  ...
                  class="text-right"
                  pTooltip="Average time the function takes to complete"
                >
                ...
                <th
                  ...
                  class="text-right"
                  pTooltip="95th percentile execution time (slower than average)"
                >
                ...
                <th
                  ...
                  pTooltip="Timestamp of the most recently recorded execution"
                >
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AzureFunctionsComponent, { className: "AzureFunctionsComponent", filePath: "src/app/features/administration/components/system-health/azure-functions/azure-functions.component.ts", lineNumber: 62 });
})();
...
function DataStorageComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(8, "i", 17);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(9, "p-card")(10, "div", 14)(11, "div", 18);
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "percent");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 16);
    \u0275\u0275text(15, " Total Success Rate ");
    \u0275\u0275element(16, "i", 19);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(13, 4, ctx_r0.storage.totalSuccessRate / 100, "1.1-1"), " ");
  }
}
...
function DataStorageComponent_Conditional_13_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275element(1, "th", 24);
    \u0275\u0275elementStart(2, "th", 25);
    \u0275\u0275text(3, " Storage Type ");
    \u0275\u0275element(4, "p-sortIcon", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th", 27);
    \u0275\u0275text(6, " Target ");
    \u0275\u0275element(7, "p-sortIcon", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th", 29);
    \u0275\u0275text(9, " Status ");
    \u0275\u0275element(10, "p-sortIcon", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "th", 31);
    \u0275\u0275text(12, " Operations ");
    \u0275\u0275element(13, "p-sortIcon", 32);
    \u0275\u0275elementEnd();
...
function DataStorageComponent_Conditional_13_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275element(2, "p-button", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td")(4, "span", 44);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td")(7, "span", 45);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td");
    \u0275\u0275element(10, "p-tag", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 47);
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "td", 47)(15, "span");
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "number");
    \u0275\u0275elementEnd()();
...
function DataStorageComponent_Conditional_13_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 48)(2, "div", 49)(3, "h4", 50);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 51)(6, "p-card", 52)(7, "div", 53)(8, "div", 54)(9, "span", 55);
    \u0275\u0275text(10, "Total:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(31, "number");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(32, "p-card", 58)(33, "div", 53)(34, "div", 54)(35, "span", 55);
    \u0275\u0275text(36, "Min:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(45, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 54)(47, "span", 55);
    \u0275\u0275text(48, "P95:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "span", 44);
    \u0275\u0275text(50);
    \u0275\u0275pipe(51, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "div", 54)(53, "span", 55);
    \u0275\u0275text(54, "P99:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "span", 44);
    \u0275\u0275text(56);
    \u0275\u0275pipe(57, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(58, "div", 54)(59, "span", 55);
    \u0275\u0275text(60, "Max:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(63, "number");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(64, "p-card", 59)(65, "div", 53)(66, "div", 54)(67, "span", 55);
    \u0275\u0275text(68, "Throughput:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "span", 44);
    \u0275\u0275text(70);
    \u0275\u0275pipe(71, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "div", 54)(73, "span", 55);
    ...
    \u0275\u0275pipe(83, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(84, "div", 54)(85, "span", 55);
...
var DataStorageComponent = class _DataStorageComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DataStorageComponent, selectors: [["app-data-storage"]], decls: 14, vars: 5, consts: [["header", ""], ["body", ""], ["expandedrow", ""], [1, "m-4", "flex", "items-center", "justify-between", "gap-4", "flex-wrap"], [1, "text-2xl", "font-bold", "text-gray-800"], [1, "flex", "items-center", "gap-4", "flex-wrap"], [1, "flex", "items-center", "gap-2"], ["for", "timeRange", 1, "text-sm", "font-semibold", "text-gray-700"], ["inputId", "timeRange", "placeholder", "Select time range", 1, "min-w-[100px]", 3, "ngModelChange", "onChange", "options", "ngModel"], ["icon", "pi pi-refresh", "label", "Refresh", "severity", "secondary", "size", "small", 3, "onClick", "loading"], [1, "grid", "grid-cols-1", "md:grid-cols-3", "gap-4", "m-4"], ["header", "Storage Overview", 1, "m-4"], [1, "text-center", "py-8", "text-gray-500"], ["dataKey", "target", 1, "p-datatable-sm", 3, "value", "paginator", "rows", "rowsPerPageOptions", "expandedRowKeys"], [1, "text-center"], [1, "text-[2rem]", "font-bold", "text-gray-800", "mb-1"], [1, "text-sm", "text-gray-800", "flex", "items-center", "justify-center", "gap-1"], ["pTooltip", "The total number of storage operations (read, write, delete) across all connected storage services.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-green-800", "mb-1"], ["pTooltip", "The percentage of storage operations that completed successfully without errors.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "pi", "pi-spin", "pi-spinner", "text-5xl", "mb-4", "block"], [1, "text-lg", "font-medium"], [1, "pi", "pi-inbox", "text-5xl", "text-gray-800", "mb-4", "block"], [1, "text-lg", "font-semibold"], ["scope", "col", 1, "w-12"], ["scope", "col", "pSortableColumn", "storageType", "pTooltip", "Type of storage resource (e.g., Azure Blob, Cosmos DB)"], ["field", "storageType"], ["scope", "col", "pSortableColumn", "target", "pTooltip", "The specific resource instance or table name"], ["field", "target"], ["scope", "col", "pSortableColumn", "status", "pTooltip", "Current health condition of the storage resource"], ["field", "status"], ["scope", "col", "pSortableColumn", "totalOperations", "pTooltip", "Total number of operations on this specific resource", 1, "text-right"], ["field", "totalOperations"], ["scope", "col", "pSortableColumn", "successRate", "pTooltip", "Percentage of successful operations for this resource", 1, "text-right"], ["field", "successRate"], ["scope", "col", "pSortableColumn", "avgLatencyMs", "pTooltip", "Average time taken to complete an operation", 1, "text-right"], ["field", "avgLatencyMs"], ["scope", "col", "pSortableColumn", "p95LatencyMs", "pTooltip", "95th percentile query/operation time", 1, "text-right"], ["field", "p95LatencyMs"], ["scope", "col", "pSortableColumn", "throughputOpsPerSec", "pTooltip", "Average number of operations completed per second", 1, "text-right"], ["field", "throughputOpsPerSec"], ["scope", "col", "pSortableColumn", "lastActivity", "pTooltip", "Timestamp of the most recent recorded operation"], ["field", "lastActivity"], ["pRipple", "", 1, "p-button-text", "p-button-rounded", "p-button-plain", 3, "pRowToggler", "icon"], [1, "font-semibold"], [1, "text-sm"], [3, "value", "severity", "icon", "pTooltip"], [1, "text-right"], ["colspan", "10"], [1, "p-4"], [1, "text-lg", "font-semibold", "mb-3"], [1, "grid", "grid-cols-1", "md:grid-cols-3", "gap-4"], ["header", "Operation Statistics"], [1, "space-y-2"], [1, "flex", "justify-between", "text-sm"], [1, "text-gray-800"], [1, "font-semibold", "text-green-800"], [1, "font-semibold", "text-red-800"], ["header", "Latency Percentiles"], ["header", "Performance Summary"]], template: function DataStorageComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(9, DataStorageComponent_Conditional_9_Template, 17, 7, "div", 10);
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The total number of storage operations (read, write, delete) across all connected storage services."
          ></i>
        </div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The percentage of storage operations that completed successfully without errors."
          ></i>
        </div>
      </div>
    </p-card>
      ...
      <ng-template #header>
        <tr>
          ...
          <th
            ...
            pTooltip="Type of storage resource (e.g., Azure Blob, Cosmos DB)"
          >
          ...
          <th
            ...
            pTooltip="The specific resource instance or table name"
          >
          ...
          <th
            scope="col"
            pSortableColumn="status"
            pTooltip="Current health condition of the storage resource"
          >
            Status <p-sortIcon field="status" />
          </th>
          <th
            ...
            class="text-right"
            pTooltip="Total number of operations on this specific resource"
          >
          ...
          <th
            ...
            pSortableColumn="successRate"
            class="text-right"
            pTooltip="Percentage of successful operations for this resource"
          >
            Success Rate <p-sortIcon field="successRate" />
          </th>
          <th
            ...
            class="text-right"
            pTooltip="Average time taken to complete an operation"
          >
          ...
          <th
            ...
            class="text-right"
            pTooltip="95th percentile query/operation time"
          >
          ...
          <th
            ...
            class="text-right"
            pTooltip="Average number of operations completed per second"
          >
          ...
          <th
            ...
            pTooltip="Timestamp of the most recent recorded operation"
          >
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DataStorageComponent, { className: "DataStorageComponent", filePath: "src/app/features/administration/components/system-health/data-storage/data-storage.component.ts", lineNumber: 47 });
})();
...
function ErrorsAndAlertsComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
...
function ErrorsAndAlertsComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
...
function ErrorsAndAlertsComponent_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25);
    \u0275\u0275element(1, "i", 33);
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "div", 48);
    \u0275\u0275text(2, " Details: ");
    \u0275\u0275elementEnd();
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_64_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_64_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "number");
  }
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_64_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "number");
  }
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 51);
    \u0275\u0275element(2, "i", 62);
    \u0275\u0275text(3, "Duration ");
    ...
    \u0275\u0275conditionalCreate(5, ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_64_Conditional_5_Template, 1, 1)(6, ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_64_Conditional_6_Template, 2, 4)(7, ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_64_Conditional_7_Template, 2, 4);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const alert_r2 = \u0275\u0275nextContext().$implicit;
...
function ErrorsAndAlertsComponent_ng_template_51_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "p-card")(2, "div", 37)(3, "div", 38);
    \u0275\u0275element(4, "i", 39);
    \u0275\u0275elementStart(5, "div")(6, "div", 40)(7, "span", 41);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_14_Template, 3, 1, "span", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 46);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(17, "div", 47)(18, "div", 48);
    \u0275\u0275text(19, " Message: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 49);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(22, ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_22_Template, 5, 1, "div", 47);
    \u0275\u0275conditionalCreate(23, ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_23_Template, 5, 1, "div", 47);
    \u0275\u0275elementStart(24, "div", 50)(25, "div")(26, "div", 51);
    \u0275\u0275element(27, "i", 52);
    \u0275\u0275text(28, "Source ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(31, ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_31_Template, 6, 1, "div");
    \u0275\u0275elementStart(32, "div")(33, "div", 51);
    \u0275\u0275element(34, "i", 53);
    \u0275\u0275text(35, "Unique Issues ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 49);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div")(39, "div", 51);
    \u0275\u0275element(40, "i", 54);
    ...
    \u0275\u0275text(43);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(44, "div")(45, "div", 51);
    \u0275\u0275element(46, "i", 55);
    \u0275\u0275text(47, "First Occurrence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "div", 49);
    \u0275\u0275text(49);
    \u0275\u0275pipe(50, "timeAgo");
    \u0275\u0275elementStart(51, "span", 56);
    \u0275\u0275text(52);
    \u0275\u0275pipe(53, "date");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(54, "div")(55, "div", 51);
    \u0275\u0275element(56, "i", 57);
    \u0275\u0275text(57, "Last Occurrence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "div", 49);
    \u0275\u0275text(59);
    \u0275\u0275pipe(60, "timeAgo");
    \u0275\u0275elementStart(61, "span", 56);
    \u0275\u0275text(62);
    \u0275\u0275pipe(63, "date");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(64, ErrorsAndAlertsComponent_ng_template_51_For_1_Conditional_64_Template, 8, 1, "div");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(34, _c13, ctx_r2.getSeverityIcon(alert_r2.severity), ctx_r2.getSeverityColorClass(alert_r2.severity)));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(50, 24, alert_r2.firstOccurrence), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(53, 26, alert_r2.firstOccurrence, "medium"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(60, 29, alert_r2.lastOccurrence), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(63, 31, alert_r2.lastOccurrence, "medium"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(alert_r2.durationMinutes > 0 ? 64 : -1);
  }
}
function ErrorsAndAlertsComponent_ng_template_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, ErrorsAndAlertsComponent_ng_template_51_For_1_Template, 65, 37, "div", 36, _forTrack02);
  }
  if (rf & 2) {
...
function ErrorsAndAlertsComponent_ng_template_53_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25);
    \u0275\u0275element(1, "i", 63);
    \u0275\u0275elementStart(2, "p", 34);
...
function ErrorsAndAlertsComponent_Conditional_54_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-card", 30)(1, "div", 25);
    \u0275\u0275element(2, "i", 31);
...
var ErrorsAndAlertsComponent = class _ErrorsAndAlertsComponent {
  ...
  getStatusDescription(status) {
    switch (status) {
      case "Active":
        return "The issue is currently ongoing and active.";
      case "Recent":
        return "The issue occurred recently but may not be active right now.";
      case "Resolved":
        return "The issue has been resolved and is no longer active.";
      default:
        return "Status could not be determined.";
    }
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ErrorsAndAlertsComponent, selectors: [["app-errors-and-alerts"]], viewQuery: function ErrorsAndAlertsComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275element(22, "i", 17);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(23, "p-card")(24, "div", 14)(25, "div", 18);
      \u0275\u0275text(26);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(29, "i", 19);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(30, "p-card")(31, "div", 14)(32, "div", 20);
      \u0275\u0275text(33);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(36, "i", 21);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(37, "p-card")(38, "div", 14)(39, "div", 22);
      \u0275\u0275text(40);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(43, "i", 23);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(44, "p-card", 24);
      \u0275\u0275conditionalCreate(45, ErrorsAndAlertsComponent_Conditional_45_Template, 4, 0, "div", 25)(46, ErrorsAndAlertsComponent_Conditional_46_Template, 3, 0, "div", 26)(47, ErrorsAndAlertsComponent_Conditional_47_Template, 6, 0, "div", 25);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(48, "p-card", 27)(49, "p-dataview", 28, 0);
      \u0275\u0275template(51, ErrorsAndAlertsComponent_ng_template_51_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(53, ErrorsAndAlertsComponent_ng_template_53_Template, 6, 0, "ng-template", 29);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(54, ErrorsAndAlertsComponent_Conditional_54_Template, 5, 0, "p-card", 30);
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.chartLoading ? 45 : ctx.errorTimeline && ctx.errorTimeline.dataPoints.length > 0 ? 46 : 47);
      \u0275\u0275advance(4);
      ...
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.loading && ctx.alerts.length === 0 ? 54 : -1);
    }
  }, dependencies: [CommonModule, NgClass, CardModule, Card, PrimeTemplate, SelectModule, Select, ButtonModule, Button, FormsModule, NgControlStatus, NgModel, DataViewModule, DataView, TooltipModule, Tooltip, DecimalPipe, DatePipe, TimeAgoPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n}\n.chart-container[_ngcontent-%COMP%] {\n  position: relative;\n  height: 400px;\n}\n  .p-dataview .p-dataview-content {\n  background: transparent;\n  border: none;\n}\n  .p-dataview .p-paginator {\n  background: transparent;\n  border: none;\n  padding: 1rem 0;\n}\n  p-message {\n  display: block;\n}\n  .p-card {\n  border-width: 1px;\n}\n/*# sourceMappingURL=errors-and-alerts.component.css.map */"] });
};
(() => {
...
<div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 m-4">
  <p-card>
    <div class="text-center">
      ...
      <div class="text-sm text-gray-800 flex items-center justify-center gap-1">
        Total Alerts
        <i
          class="pi pi-info-circle text-gray-400"
          pTooltip="The total number of alerts recorded in the system."
        ></i>
      </div>
    </div>
  </p-card>
  ...
  <p-card>
    <div class="text-center">
      ...
      <div class="text-sm text-gray-800 flex items-center justify-center gap-1">
        ...
        <i
          class="pi pi-info-circle text-gray-400"
          pTooltip="Critical alerts that represent severe system failures or data loss. Requires immediate attention."
        ></i>
      </div>
    </div>
  </p-card>
  ...
  <p-card>
    <div class="text-center">
      ...
      <div class="text-sm text-gray-800 flex items-center justify-center gap-1">
        ...
        <i
          class="pi pi-info-circle text-gray-400"
          pTooltip="Standard error alerts indicating operations that failed but may not cause complete system outages."
        ></i>
      </div>
    </div>
  </p-card>
  ...
  <p-card>
    <div class="text-center">
      ...
      <div class="text-sm text-gray-800 flex items-center justify-center gap-1">
        ...
        <i
          class="pi pi-info-circle text-gray-400"
          pTooltip="Warning alerts indicating potential issues like high latency or throttled queries before they become hard errors."
        ></i>
      </div>
    </div>
  </p-card>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ErrorsAndAlertsComponent, { className: "ErrorsAndAlertsComponent", filePath: "src/app/features/administration/components/system-health/errors-and-alerts/errors-and-alerts.component.ts", lineNumber: 50 });
})();
...
function EventFlowComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(11, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "p-card")(13, "div", 10)(14, "div", 11);
    \u0275\u0275text(15, " Avg Events/sec ");
    \u0275\u0275element(16, "i", 15);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(22, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "p-card")(24, "div", 10)(25, "div", 11);
    \u0275\u0275text(26, " Avg Dependencies/sec ");
    \u0275\u0275element(27, "i", 17);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(32, "Real-time throughput");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(33, "p-card")(34, "div", 10)(35, "div", 11);
    \u0275\u0275text(36, " Total Operations ");
    \u0275\u0275element(37, "i", 19);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(42);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(43, "div", 21)(44, "p-card", 22)(45, "div", 23)(46, "div")(47, "div", 24);
    \u0275\u0275text(48);
    \u0275\u0275pipe(49, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(53, "i", 26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "p-card", 27)(55, "div", 23)(56, "div")(57, "div", 28);
    \u0275\u0275text(58);
    \u0275\u0275pipe(59, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(63, "i", 29);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(64, "p-card", 30)(65, "div", 23)(66, "div")(67, "div", 31);
    \u0275\u0275text(68);
    \u0275\u0275pipe(69, "number");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(8, 13, ctx_r0.throughput.averageRequestsPerSecond, "1.2-2"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Peak: ", \u0275\u0275pipeBind2(11, 16, ctx_r0.throughput.peakRequestsPerSecond, "1.2-2"), " ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(19, 19, ctx_r0.throughput.averageEventsPerSecond, "1.2-2"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Peak: ", \u0275\u0275pipeBind2(22, 22, ctx_r0.throughput.peakEventsPerSecond, "1.2-2"), " ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(30, 25, ctx_r0.throughput.averageDependenciesPerSecond, "1.2-2"), " ");
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(40, 28, ctx_r0.throughput.totalRequests + ctx_r0.throughput.totalEvents + ctx_r0.throughput.totalDependencies, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("in ", ctx_r0.throughput.timeRange);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(49, 31, ctx_r0.throughput.totalRequests, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(52, 34, ctx_r0.throughput.averageRequestsPerSecond, "1.2-2"), " requests/sec ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(59, 37, ctx_r0.throughput.totalEvents, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(62, 40, ctx_r0.throughput.averageEventsPerSecond, "1.2-2"), " events/sec ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(69, 43, ctx_r0.throughput.totalDependencies, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(72, 46, ctx_r0.throughput.averageDependenciesPerSecond, "1.2-2"), " calls/sec ");
  }
}
...
function EventFlowComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 39)(2, "div", 3);
    \u0275\u0275element(3, "div", 40);
...
var EventFlowComponent = class _EventFlowComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventFlowComponent, selectors: [["app-event-flow"]], decls: 14, vars: 5, consts: [[1, "m-4", "flex", "items-center", "justify-between", "gap-4", "flex-wrap"], [1, "text-2xl", "font-bold", "text-gray-800"], [1, "flex", "items-center", "gap-4", "flex-wrap"], [1, "flex", "items-center", "gap-2"], ["for", "timeRange", 1, "text-sm", "font-semibold", "text-gray-700"], ["inputId", "timeRange", "placeholder", "Select time range", 1, "min-w-[100px]", 3, "ngModelChange", "onChange", "options", "ngModel"], ["icon", "pi pi-refresh", "label", "Refresh", "severity", "secondary", "size", "small", 3, "onClick", "loading"], ["header", "Throughput Over Time", 1, "m-4"], [1, "text-center", "py-8", "text-gray-500"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-4", "gap-4", "m-4"], [1, "text-center"], [1, "text-sm", "text-gray-800", "mb-1", "flex", "items-center", "justify-center", "gap-1"], ["pTooltip", "The average number of incoming HTTP requests processed by the system per second.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-blue-800", "mb-1"], [1, "text-xs", "text-gray-500"], ["pTooltip", "The average number of custom events or messages processed per second internally.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-green-800", "mb-1"], ["pTooltip", "The average number of calls made to external systems (databases, APIs, storage) per second.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-orange-800", "mb-1"], ["pTooltip", "The combined total of all requests, events, and dependencies over the selected time range.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-gray-800", "mb-1"], [1, "grid", "grid-cols-1", "lg:grid-cols-3", "gap-4", "m-4"], ["header", "Total Requests"], [1, "flex", "items-center", "justify-between"], [1, "text-3xl", "font-bold", "text-blue-800"], [1, "text-sm", "text-gray-800", "mt-1"], [1, "pi", "pi-globe", "text-5xl", "text-blue-300"], ["header", "Total Events"], [1, "text-3xl", "font-bold", "text-green-800"], [1, "pi", "pi-chart-line", "text-5xl", "text-green-300"], ["header", "Total Dependencies"], [1, "text-3xl", "font-bold", "text-orange-800"], [1, "pi", "pi-sitemap", "text-5xl", "text-orange-300"], [1, "pi", "pi-spin", "pi-spinner", "text-5xl", "mb-4", "block"], [1, "text-lg", "font-medium"], [1, "pi", "pi-chart-line", "text-5xl", "text-gray-800", "mb-4", "block"], [1, "text-lg", "font-semibold"], [1, "text-sm", "mt-2"], ["type", "line", 3, "data", "options"], [1, "mt-4", "flex", "gap-6", "justify-center", "text-sm"], [1, "w-4", "h-4", "rounded", "bg-blue-500"], [1, "w-4", "h-4", "rounded", "bg-green-500"], [1, "w-4", "h-4", "rounded", "bg-orange-500"]], template: function EventFlowComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(9, EventFlowComponent_Conditional_9_Template, 74, 49);
...
@if (throughput) {
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 m-4">
    <p-card>
      <div class="text-center">
        <div
          class="text-sm text-gray-800 mb-1 flex items-center justify-center gap-1"
        >
          Avg Requests/sec
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The average number of incoming HTTP requests processed by the system per second."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-blue-800 mb-1">
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The average number of custom events or messages processed per second internally."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-green-800 mb-1">
    ...
    <p-card>
      <div class="text-center">
        <div
          class="text-sm text-gray-800 mb-1 flex items-center justify-center gap-1"
        >
          Avg Dependencies/sec
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The average number of calls made to external systems (databases, APIs, storage) per second."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-orange-800 mb-1">
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The combined total of all requests, events, and dependencies over the selected time range."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-gray-800 mb-1">
          {{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventFlowComponent, { className: "EventFlowComponent", filePath: "src/app/features/administration/components/system-health/event-flow/event-flow.component.ts", lineNumber: 35 });
})();

// src/app/features/administration/components/system-health/ingestion/ingestion.component.ts
var _c04 = () => [];
var _c14 = () => [5, 10, 20];
function IngestionComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 14)(4, "p-card")(5, "div", 15)(6, "div", 16);
    \u0275\u0275text(7, " Connected Devices ");
    \u0275\u0275element(8, "i", 17);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(11, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "p-card")(13, "div", 15)(14, "div", 16);
    \u0275\u0275text(15, " EventHub Incoming ");
    \u0275\u0275element(16, "i", 19);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "p-card")(23, "div", 15)(24, "div", 16);
    \u0275\u0275text(25, " EventHub Outgoing ");
    \u0275\u0275element(26, "i", 22);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "p-card")(33, "div", 15)(34, "div", 16);
    \u0275\u0275text(35, " Pending Messages ");
    \u0275\u0275element(36, "i", 24);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(39, "number");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(40, "div", 26)(41, "p-card")(42, "div", 15)(43, "div", 16);
    \u0275\u0275text(44, " Average Queue Lag ");
    \u0275\u0275element(45, "i", 27);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(48, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(49, "p-card")(50, "div", 15)(51, "div", 16);
    \u0275\u0275text(52, " Max Queue Lag ");
    \u0275\u0275element(53, "i", 28);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(56, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(57, "p-card")(58, "div", 15)(59, "div", 16);
    \u0275\u0275text(60, " Devices Backlog > 1000 ");
    \u0275\u0275element(61, "i", 30);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Last updated: ", \u0275\u0275pipeBind2(2, 10, ctx_r0.ingestion.lastUpdated, "short"), " ");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 13, ctx_r0.ingestion.connectedDevices, "1.0-0"), " ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(19, 16, ctx_r0.ingestion.totalIncomingMessages, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("in ", ctx_r0.ingestion.timeRange);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(29, 19, ctx_r0.ingestion.totalOutgoingMessages, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("in ", ctx_r0.ingestion.timeRange);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(39, 22, ctx_r0.ingestion.totalPendingMessages, "1.0-0"), " ");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(48, 25, ctx_r0.ingestion.averageQueueLagMs, "1.0-2"), " ms ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(56, 28, ctx_r0.ingestion.maxQueueLagMs, "1.0-2"), " ms ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(64, 31, ctx_r0.ingestion.devicesBacklogOver1000, "1.0-0"), " ");
  }
}
function IngestionComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10);
    \u0275\u0275element(1, "i", 32);
    \u0275\u0275elementStart(2, "p", 33);
    \u0275\u0275text(3, "Loading ingestion metrics...");
    \u0275\u0275elementEnd()();
  }
}
function IngestionComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function IngestionComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "i", 36);
    \u0275\u0275elementStart(2, "p", 35);
    \u0275\u0275text(3, "No ingestion data available");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 37);
    \u0275\u0275text(5, " Metrics will appear here once telemetry is available. ");
    \u0275\u0275elementEnd()();
  }
}
function IngestionComponent_Conditional_14_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 38);
    \u0275\u0275text(2, "Timestamp");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "th", 39);
    \u0275\u0275text(4, " Connected Devices ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(12, " Avg Lag (ms) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th", 44);
    \u0275\u0275text(14, " Max Lag (ms) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "th", 45);
    \u0275\u0275text(16, " Backlog >1000 ");
    \u0275\u0275elementEnd()();
  }
}
function IngestionComponent_Conditional_14_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(3, 8, point_r2.timestamp, "short"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 11, point_r2.connectedDevices, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(9, 14, point_r2.eventHubIncomingMessages, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(12, 17, point_r2.eventHubOutgoingMessages, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(15, 20, point_r2.pendingMessages, "1.0-0"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(18, 23, point_r2.averageQueueLagMs, "1.0-2"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(21, 26, point_r2.maxQueueLagMs, "1.0-2"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(24, 29, point_r2.devicesBacklogOver1000, "1.0-0"), " ");
  }
}
function IngestionComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-table", 12);
    \u0275\u0275template(1, IngestionComponent_Conditional_14_ng_template_1_Template, 17, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(3, IngestionComponent_Conditional_14_ng_template_3_Template, 25, 32, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var IngestionComponent = class _IngestionComponent {
  ...
  fetchIngestionData() {
    ...
    this.healthService.fetchIngestion(`${this.selectedTimeRange}h`).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (data) => {
        this.ingestion = data;
        this.loading = false;
        this.errorMessage = data == null ? "Unable to load ingestion metrics." : null;
        this.cdr.detectChanges();
      },
      error: () => {
        this.loading = false;
        this.errorMessage = "Unable to load ingestion metrics.";
        this.cdr.detectChanges();
      }
    });
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IngestionComponent, selectors: [["app-ingestion"]], decls: 15, vars: 5, consts: [["header", ""], ["body", ""], [1, "m-4", "flex", "items-center", "justify-between", "gap-4", "flex-wrap"], [1, "text-2xl", "font-bold", "text-gray-800"], [1, "flex", "items-center", "gap-4", "flex-wrap"], [1, "flex", "items-center", "gap-2"], ["for", "timeRange", 1, "text-sm", "font-semibold", "text-gray-700"], ["inputId", "timeRange", "placeholder", "Select time range", 1, "min-w-[100px]", 3, "ngModelChange", "onChange", "options", "ngModel"], ["icon", "pi pi-refresh", "label", "Refresh", "severity", "secondary", "size", "small", 3, "onClick", "loading"], ["header", "Ingestion Timeline", 1, "m-4"], [1, "text-center", "py-8", "text-gray-500"], [1, "text-center", "py-8", "text-red-600"], [1, "p-datatable-sm", 3, "value", "paginator", "rows", "rowsPerPageOptions"], [1, "m-4", "text-sm", "text-gray-600"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-4", "gap-4", "m-4"], [1, "text-center"], [1, "text-sm", "text-gray-800", "mb-1", "flex", "items-center", "justify-center", "gap-1"], ["pTooltip", "The number of IoT devices currently connected and sending heartbeat signals.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-blue-800", "mb-1"], ["pTooltip", "The total number of messages received by the Event Hub from connected devices.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-green-800", "mb-1"], [1, "text-xs", "text-gray-500"], ["pTooltip", "The total number of messages successfully processed and routed out of the Event Hub.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-orange-800", "mb-1"], ["pTooltip", "The number of messages currently sitting in the queue waiting to be processed. High numbers indicate processing delays.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-gray-800", "mb-1"], [1, "grid", "grid-cols-1", "md:grid-cols-3", "gap-4", "m-4"], ["pTooltip", "The average time a message spends in the queue before being picked up for processing.", 1, "pi", "pi-info-circle", "text-gray-400"], ["pTooltip", "The maximum longest time any single message had to wait in the queue before processing.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-red-800", "mb-1"], ["pTooltip", "The number of devices having a severe backlog (more than 1000 pending messages).", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "text-purple-800", "mb-1"], [1, "pi", "pi-spin", "pi-spinner", "text-5xl", "mb-4", "block"], [1, "text-lg", "font-medium"], [1, "pi", "pi-exclamation-triangle", "text-5xl", "mb-4", "block"], [1, "text-lg", "font-semibold"], [1, "pi", "pi-inbox", "text-5xl", "text-gray-800", "mb-4", "block"], [1, "text-sm", "mt-2"], ["scope", "col"], ["scope", "col", "pTooltip", "Active devices sending heartbeats", 1, "text-right"], ["scope", "col", "pTooltip", "Messages entering Event Hub", 1, "text-right"], ["scope", "col", "pTooltip", "Messages processed via Event Hub", 1, "text-right"], ["scope", "col", "pTooltip", "Current backlog of unprocessed messages", 1, "text-right"], ["scope", "col", "pTooltip", "Average time messages spend in queue", 1, "text-right"], ["scope", "col", "pTooltip", "Maximum time any message spent in queue", 1, "text-right"], ["scope", "col", "pTooltip", "Devices with severe backlogs (>1000 msgs)", 1, "text-right"], [1, "text-right"]], template: function IngestionComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 2)(1, "h2", 3);
      \u0275\u0275text(2, "Ingestion Metrics");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 4)(4, "div", 5)(5, "label", 6);
      \u0275\u0275text(6, "Time Range:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p-select", 7);
      \u0275\u0275twoWayListener("ngModelChange", function IngestionComponent_Template_p_select_ngModelChange_7_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.selectedTimeRange, $event) || (ctx.selectedTimeRange = $event);
        return $event;
      });
      \u0275\u0275listener("onChange", function IngestionComponent_Template_p_select_onChange_7_listener($event) {
        return ctx.onTimeRangeChange($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(8, "p-button", 8);
      \u0275\u0275listener("onClick", function IngestionComponent_Template_p_button_onClick_8_listener() {
        return ctx.refreshData();
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(9, IngestionComponent_Conditional_9_Template, 65, 34);
      \u0275\u0275elementStart(10, "p-card", 9);
      \u0275\u0275conditionalCreate(11, IngestionComponent_Conditional_11_Template, 4, 0, "div", 10)(12, IngestionComponent_Conditional_12_Template, 4, 1, "div", 11)(13, IngestionComponent_Conditional_13_Template, 6, 0, "div", 10)(14, IngestionComponent_Conditional_14_Template, 5, 6, "p-table", 12);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      ...
      \u0275\u0275property("loading", ctx.loading);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.ingestion ? 9 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.loading && !ctx.ingestion ? 11 : ctx.errorMessage ? 12 : ((ctx.ingestion == null ? null : ctx.ingestion.dataPoints == null ? null : ctx.ingestion.dataPoints.length) ?? 0) === 0 ? 13 : 14);
    }
  }, dependencies: [
    CommonModule,
    FormsModule,
...
<div class="m-4 flex items-center justify-between gap-4 flex-wrap">
  <h2 class="text-2xl font-bold text-gray-800">Ingestion Metrics</h2>
...
@if (ingestion) {
  <div class="m-4 text-sm text-gray-600">
    Last updated: {{ ingestion.lastUpdated | date: 'short' }}
  </div>
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The number of IoT devices currently connected and sending heartbeat signals."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-blue-800 mb-1">
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The total number of messages received by the Event Hub from connected devices."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-green-800 mb-1">
          {{ ingestion.totalIncomingMessages | number: '1.0-0' }}
        </div>
        <div class="text-xs text-gray-500">in {{ ingestion.timeRange }}</div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The total number of messages successfully processed and routed out of the Event Hub."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-orange-800 mb-1">
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The number of messages currently sitting in the queue waiting to be processed. High numbers indicate processing delays."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-gray-800 mb-1">
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The average time a message spends in the queue before being picked up for processing."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-gray-800 mb-1">
          {{ ingestion.averageQueueLagMs | number: '1.0-2' }} ms
        </div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        ...
        >
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The maximum longest time any single message had to wait in the queue before processing."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-red-800 mb-1">
          {{ ingestion.maxQueueLagMs | number: '1.0-2' }} ms
        </div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        <div
          class="text-sm text-gray-800 mb-1 flex items-center justify-center gap-1"
        >
          Devices Backlog > 1000
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The number of devices having a severe backlog (more than 1000 pending messages)."
          ></i>
        </div>
        <div class="text-[2rem] font-bold text-purple-800 mb-1">
...
<p-card header="Ingestion Timeline" class="m-4">
  @if (loading && !ingestion) {
    <div class="text-center py-8 text-gray-500">
      <i class="pi pi-spin pi-spinner text-5xl mb-4 block"></i>
      <p class="text-lg font-medium">Loading ingestion metrics...</p>
    </div>
    ...
    <div class="text-center py-8 text-gray-500">
      <i class="pi pi-inbox text-5xl text-gray-800 mb-4 block"></i>
      <p class="text-lg font-semibold">No ingestion data available</p>
      <p class="text-sm mt-2">
        Metrics will appear here once telemetry is available.
      </p>
    </div>
  } @else {
    <p-table
      ...
      <ng-template #header>
        <tr>
          ...
          <th
            scope="col"
            class="text-right"
            pTooltip="Active devices sending heartbeats"
          >
            Connected Devices
          </th>
          <th
            scope="col"
            class="text-right"
            pTooltip="Messages entering Event Hub"
          >
            Incoming
          </th>
          <th
            scope="col"
            class="text-right"
            pTooltip="Messages processed via Event Hub"
          >
            Outgoing
          </th>
          <th
            scope="col"
            class="text-right"
            pTooltip="Current backlog of unprocessed messages"
          >
            Pending
          </th>
          <th
            scope="col"
            class="text-right"
            pTooltip="Average time messages spend in queue"
          >
            Avg Lag (ms)
          </th>
          <th
            scope="col"
            class="text-right"
            pTooltip="Maximum time any message spent in queue"
          >
            Max Lag (ms)
          </th>
          <th
            scope="col"
            class="text-right"
            pTooltip="Devices with severe backlogs (>1000 msgs)"
          >
            Backlog >1000
          </th>
        </tr>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IngestionComponent, { className: "IngestionComponent", filePath: "src/app/features/administration/components/system-health/ingestion/ingestion.component.ts", lineNumber: 35 });
})();
...
function SystemOverviewComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8)(1, "p-card")(2, "div", 26);
    \u0275\u0275element(3, "i", 27);
    \u0275\u0275elementStart(4, "p", 28);
    \u0275\u0275text(5, "Loading system health data...");
    \u0275\u0275elementEnd()()()();
  }
}
function SystemOverviewComponent_ng_template_57_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th", 33);
    \u0275\u0275text(8, " Status ");
    \u0275\u0275element(9, "p-sortIcon", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "th", 35);
    \u0275\u0275text(11, " Uptime ");
    \u0275\u0275element(12, "p-sortIcon", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th", 37);
    \u0275\u0275text(14, " Error Rate ");
    \u0275\u0275element(15, "p-sortIcon", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 39);
    \u0275\u0275text(17, " Operations ");
    \u0275\u0275element(18, "p-sortIcon", 40);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "th", 41);
    \u0275\u0275text(20, " Avg Response ");
    \u0275\u0275element(21, "p-sortIcon", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "th", 43);
    \u0275\u0275text(23, " P95 ");
    \u0275\u0275element(24, "p-sortIcon", 44);
    \u0275\u0275elementEnd()();
  }
}
function SystemOverviewComponent_ng_template_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("value", service_r1.status)("severity", ctx_r1.getStatusSeverity(service_r1.status))("rounded", true)("pTooltip", ctx_r1.getStatusDescription(service_r1.status));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(9, 13, service_r1.uptimePercent, "1.2-2"), "%");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("font-semibold", service_r1.errorRatePercent > 5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(13, 16, service_r1.errorRatePercent, "1.2-2"), "% ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 19, service_r1.operations));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(19, 21, service_r1.avgResponseMs, "1.0-0"), "ms");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(22, 24, service_r1.p95Ms, "1.0-0"), "ms");
  }
}
function SystemOverviewComponent_ng_template_59_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 47);
    \u0275\u0275elementStart(1, "span");
    \u0275\u0275text(2, "Fetching service details...");
    \u0275\u0275elementEnd();
  }
}
function SystemOverviewComponent_ng_template_59_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 48);
    \u0275\u0275elementStart(1, "span");
...
function SystemOverviewComponent_ng_template_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 46);
    \u0275\u0275conditionalCreate(2, SystemOverviewComponent_ng_template_59_Conditional_2_Template, 3, 0)(3, SystemOverviewComponent_ng_template_59_Conditional_3_Template, 3, 0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SystemOverviewComponent_Conditional_60_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 50);
    \u0275\u0275text(2, " Function Name ");
    \u0275\u0275element(3, "p-sortIcon", 51);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "th", 52);
    \u0275\u0275text(5, " Status ");
...
function SystemOverviewComponent_Conditional_60_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275element(4, "p-tag", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "number");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("value", func_r3.status)("severity", ctx_r1.getStatusSeverity(func_r3.status))("rounded", true)("pTooltip", ctx_r1.getStatusDescription(func_r3.status));
    \u0275\u0275advance(2);
...
function SystemOverviewComponent_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-card", 25)(1, "p-table", 49);
    \u0275\u0275template(2, SystemOverviewComponent_Conditional_60_ng_template_2_Template, 16, 0, "ng-template", 22)(3, SystemOverviewComponent_Conditional_60_ng_template_3_Template, 14, 16, "ng-template", 23);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var SystemOverviewComponent = class _SystemOverviewComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SystemOverviewComponent, selectors: [["app-system-overview"]], decls: 61, vars: 23, consts: [[1, "m-4", "flex", "items-center", "justify-between", "gap-4", "flex-wrap"], [1, "text-2xl", "font-bold"], [1, "flex", "items-center", "gap-4", "flex-wrap"], [1, "flex", "items-center", "gap-2"], ["for", "timeRange", 1, "text-sm", "font-semibold"], ["inputId", "timeRange", "placeholder", "Select time range", 1, "min-w-[100px]", 3, "ngModelChange", "onChange", "options", "ngModel"], ["icon", "pi pi-refresh", "label", "Refresh", "severity", "secondary", "size", "small", 3, "onClick", "loading"], [1, "system-overview"], [1, "m-4"], [1, "p-4", "rounded-md", "flex", "items-center", "gap-2", 3, "ngClass"], [1, "pi"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-4", "gap-4", "m-4"], [1, "text-center"], [1, "text-sm", "mb-1", "flex", "items-center", "justify-center", "gap-1"], ["pTooltip", "The total number of unique services currently monitored by the system.", 1, "pi", "pi-info-circle", "text-gray-400"], [1, "text-[2rem]", "font-bold", "mb-1"], [1, "text-xs"], ["pTooltip", "The number of services currently reporting a healthy status without errors or latency warnings.", 1, "pi", "pi-info-circle", "text-gray-400"], ["pTooltip", "The average percentage of failed operations across all integrated services.", 1, "pi", "pi-info-circle", "text-gray-400"], ["pTooltip", "The average latency across all tracked successful operations in the system.", 1, "pi", "pi-info-circle", "text-gray-400"], ["header", "Service Health Status", 1, "m-4"], [3, "value", "sortMode"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], ["header", "Azure Functions Quick Status", 1, "m-4"], [1, "text-center", "py-8"], [1, "pi", "pi-spin", "pi-spinner", "text-5xl", "mb-4", "block"], [1, "text-lg", "font-medium"], ["pSortableColumn", "service", "scope", "col", "pTooltip", "Name of the backend service"], ["field", "service"], ["pSortableColumn", "type", "scope", "col", "pTooltip", "Category of the service (e.g., Compute, Storage, Database)"], ["field", "type"], ["pSortableColumn", "status", "scope", "col", "pTooltip", "Current health condition determined by failure rates and latency"], ["field", "status"], ["pSortableColumn", "uptimePercent", "scope", "col", "pTooltip", "Percentage of operations that completed successfully"], ["field", "uptimePercent"], ["pSortableColumn", "errorRatePercent", "scope", "col", "pTooltip", "Percentage of operations that resulted in errors or faults"], ["field", "errorRatePercent"], ["pSortableColumn", "operations", "scope", "col", "pTooltip", "Total volume of operations recorded within the time range"], ["field", "operations"], ["pSortableColumn", "avgResponseMs", "scope", "col", "pTooltip", "Average time taken by the service to process operations"], ["field", "avgResponseMs"], ["pSortableColumn", "p95Ms", "scope", "col", "pTooltip", "The 95th percentile latency - 95% of requests completed faster than this time"], ["field", "p95Ms"], [3, "value", "severity", "rounded", "pTooltip"], ["colspan", "8", 1, "text-center", "p-8"], [1, "pi", "pi-spin", "pi-spinner", "text-2xl", "mb-2", "block"], [1, "pi", "pi-inbox", "text-2xl", "mb-2", "block"], [1, "p-datatable-sm", 3, "value", "sortMode", "paginator", "rows"], ["pSortableColumn", "functionName", "scope", "col"], ["field", "functionName"], ["pSortableColumn", "status", "scope", "col"], ["pSortableColumn", "totalExecutions", "scope", "col"], ["field", "totalExecutions"], ["pSortableColumn", "successRate", "scope", "col"], ["field", "successRate"], ["pSortableColumn", "avgDuration", "scope", "col"], ["field", "avgDuration"]], template: function SystemOverviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "h2", 1);
      \u0275\u0275text(2, "System Health Overview");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 2)(4, "div", 3)(5, "label", 4);
      \u0275\u0275text(6, "Time Range:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p-select", 5);
      \u0275\u0275twoWayListener("ngModelChange", function SystemOverviewComponent_Template_p_select_ngModelChange_7_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.selectedTimeRange, $event) || (ctx.selectedTimeRange = $event);
        return $event;
      });
      \u0275\u0275listener("onChange", function SystemOverviewComponent_Template_p_select_onChange_7_listener($event) {
        return ctx.onTimeRangeChange($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(8, "p-button", 6);
      \u0275\u0275listener("onClick", function SystemOverviewComponent_Template_p_button_onClick_8_listener() {
        return ctx.refreshData();
      });
      \u0275\u0275elementEnd()()();
      ...
      \u0275\u0275text(14);
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(15, SystemOverviewComponent_Conditional_15_Template, 6, 0, "div", 8);
      \u0275\u0275elementStart(16, "div", 11)(17, "p-card")(18, "div", 12)(19, "div", 13);
      \u0275\u0275text(20, " Total Services ");
      \u0275\u0275element(21, "i", 14);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(25, "Services monitored");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(26, "p-card")(27, "div", 12)(28, "div", 13);
      \u0275\u0275text(29, " Healthy Services ");
      \u0275\u0275element(30, "i", 17);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(34, "Running normally");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(35, "p-card")(36, "div", 12)(37, "div", 13);
      \u0275\u0275text(38, " Avg Error Rate ");
      \u0275\u0275element(39, "i", 18);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(44, "Across all services");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(45, "p-card")(46, "div", 12)(47, "div", 13);
      \u0275\u0275text(48, " Avg Response Time ");
      \u0275\u0275element(49, "i", 19);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(54, "System latency");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(55, "p-card", 20)(56, "p-table", 21);
      \u0275\u0275template(57, SystemOverviewComponent_ng_template_57_Template, 25, 0, "ng-template", 22)(58, SystemOverviewComponent_ng_template_58_Template, 23, 27, "ng-template", 23)(59, SystemOverviewComponent_ng_template_59_Template, 4, 1, "ng-template", 24);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(60, SystemOverviewComponent_Conditional_60_Template, 4, 4, "p-card", 25);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.loading() && ctx.services().length === 0 ? 15 : -1);
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate1(" ", ctx.totalServicesCount(), " ");
      \u0275\u0275advance(9);
      \u0275\u0275textInterpolate1(" ", ctx.healthyServicesCount(), " ");
      \u0275\u0275advance(9);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(42, 17, ctx.averageErrorRate(), "1.2-2"), "% ");
      \u0275\u0275advance(10);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(52, 20, ctx.averageResponseTime(), "1.0-0"), "ms ");
      \u0275\u0275advance(5);
      \u0275\u0275property("value", ctx.services())("sortMode", "multiple");
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.functions().length > 0 ? 60 : -1);
    }
  }, dependencies: [
    CommonModule,
    NgClass,
...
<div class="m-4 flex items-center justify-between gap-4 flex-wrap">
  <h2 class="text-2xl font-bold">System Health Overview</h2>

  <div class="flex items-center gap-4 flex-wrap">
    <!-- Time Range Selector -->
    <div class="flex items-center gap-2">
      <label for="timeRange" class="text-sm font-semibold">Time Range:</label>
      <p-select
        inputId="timeRange"
        [options]="timeRangeOptions"
        [(ngModel)]="selectedTimeRange"
...
<div class="system-overview">
    ...
    <div class="m-4">
      <p-card>
        <div class="text-center py-8">
          <i class="pi pi-spin pi-spinner text-5xl mb-4 block"></i>
          <p class="text-lg font-medium">Loading system health data...</p>
        </div>
      </p-card>
    </div>
  }
    ...
    <p-card>
      <div class="text-center">
        <div class="text-sm mb-1 flex items-center justify-center gap-1">
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The total number of unique services currently monitored by the system."
          ></i>
        </div>
        <div class="text-[2rem] font-bold mb-1">
          {{ totalServicesCount() }}
        </div>
        <div class="text-xs">Services monitored</div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        <div class="text-sm mb-1 flex items-center justify-center gap-1">
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The number of services currently reporting a healthy status without errors or latency warnings."
          ></i>
        </div>
        <div class="text-[2rem] font-bold mb-1">
          {{ healthyServicesCount() }}
        </div>
        <div class="text-xs">Running normally</div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        <div class="text-sm mb-1 flex items-center justify-center gap-1">
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The average percentage of failed operations across all integrated services."
          ></i>
        </div>
        <div class="text-[2rem] font-bold mb-1">
          {{ averageErrorRate() | number: '1.2-2' }}%
        </div>
        <div class="text-xs">Across all services</div>
      </div>
    </p-card>
    ...
    <p-card>
      <div class="text-center">
        <div class="text-sm mb-1 flex items-center justify-center gap-1">
          ...
          <i
            class="pi pi-info-circle text-gray-400"
            pTooltip="The average latency across all tracked successful operations in the system."
          ></i>
        </div>
        <div class="text-[2rem] font-bold mb-1">
          {{ averageResponseTime() | number: '1.0-0' }}ms
        </div>
        <div class="text-xs">System latency</div>
      </div>
    </p-card>
  </div>
      ...
      <ng-template pTemplate="header">
        <tr>
          <th
            ...
            scope="col"
            pTooltip="Name of the backend service"
          >
          ...
          <th
            ...
            scope="col"
            pTooltip="Category of the service (e.g., Compute, Storage, Database)"
          >
          ...
          <th
            pSortableColumn="status"
            scope="col"
            pTooltip="Current health condition determined by failure rates and latency"
          >
          ...
          <th
            ...
            scope="col"
            pTooltip="Percentage of operations that completed successfully"
          >
          ...
          <th
            ...
            scope="col"
            pTooltip="Percentage of operations that resulted in errors or faults"
          >
          ...
          <th
            ...
            scope="col"
            pTooltip="Total volume of operations recorded within the time range"
          >
          ...
          <th
            ...
            scope="col"
            pTooltip="Average time taken by the service to process operations"
          >
          ...
          <th
            ...
            scope="col"
            pTooltip="The 95th percentile latency - 95% of requests completed faster than this time"
          >
  ...
  @if (functions().length > 0) {
    <p-card header="Azure Functions Quick Status" class="m-4">
      <p-table
        [value]="functions()"
        [sortMode]="'multiple'"
        [paginator]="true"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemOverviewComponent, { className: "SystemOverviewComponent", filePath: "src/app/features/administration/components/system-health/system-overview/system-overview.component.ts", lineNumber: 52 });
})();
...
chartjs-adapter-date-fns/dist/chartjs-adapter-date-fns.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Z4NDF7BB.js.map
