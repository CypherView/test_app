...
var FeedSectionComponent = class _FeedSectionComponent extends EntitySectionBaseComponent {
   ...
   */
  formatTime(dateStr) {
    return this.measurementDateTimeService.formatTime(this.measurementDateTimeService.createDateAssumingUtc(dateStr), "HH:mm");
  }
  /**
   ...
   */
  formatDate(dateStr) {
    return this.measurementDateTimeService.formatDateTime(this.measurementDateTimeService.createDateAssumingUtc(dateStr), DATE_FORMATS.DATE_TIME_SECONDS);
  }
  /**
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FeedSectionComponent, { className: "FeedSectionComponent", filePath: "src/app/features/administration/components/shared/feed-section/feed-section.component.ts", lineNumber: 44 });
})();
...
//# sourceMappingURL=chunk-OO24IG5B.js.map
