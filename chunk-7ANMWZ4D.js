...
import {
  ...
  AccordionModule,
  AccordionPanel
} from "./chunk-I3GLYQ4V.js";
import "./chunk-J225XH3P.js";
...
function DistributorDetailsContainerComponent_Conditional_3_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DistributorDetailsContainerComponent_Conditional_3_For_8_ng_container_0_Template, 1, 0, "ng-container", 11);
...
function DistributorDetailsContainerComponent_Conditional_3_Conditional_9_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DistributorDetailsContainerComponent_Conditional_3_Conditional_9_For_6_ng_container_0_Template, 1, 0, "ng-container", 11);
...
function DistributorDetailsContainerComponent_Conditional_3_Conditional_10_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DistributorDetailsContainerComponent_Conditional_3_Conditional_10_For_6_ng_container_0_Template, 1, 0, "ng-container", 11);
...
function DistributorDetailsContainerComponent_Conditional_3_Conditional_11_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DistributorDetailsContainerComponent_Conditional_3_Conditional_11_For_6_ng_container_0_Template, 1, 0, "ng-container", 11);
...
function DistributorDetailsContainerComponent_Conditional_3_Conditional_12_For_6_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function DistributorDetailsContainerComponent_Conditional_3_Conditional_12_For_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-divider");
  }
}
function DistributorDetailsContainerComponent_Conditional_3_Conditional_12_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DistributorDetailsContainerComponent_Conditional_3_Conditional_12_For_6_ng_container_0_Template, 1, 0, "ng-container", 11);
    \u0275\u0275conditionalCreate(1, DistributorDetailsContainerComponent_Conditional_3_Conditional_12_For_6_Conditional_1_Template, 1, 0, "p-divider");
  }
  if (rf & 2) {
...
function DistributorDetailsContainerComponent_Conditional_3_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "p-accordion-content");
    \u0275\u0275repeaterCreate(5, DistributorDetailsContainerComponent_Conditional_3_Conditional_12_For_6_Template, 2, 3, null, null, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function DistributorDetailsContainerComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(12, DistributorDetailsContainerComponent_Conditional_3_Conditional_12_Template, 7, 0, "p-accordion-panel", 10);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.hasChangesSections() ? 12 : -1);
  }
}
var DistributorDetailsContainerComponent = class _DistributorDetailsContainerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DistributorDetailsContainerComponent, selectors: [["app-distributor-details-container"]], decls: 4, vars: 3, consts: [[1, "admin-details-container", "h-full", "flex", "flex-col"], [1, "loading-container"], [1, "error-container"], [1, "details-container", "h-full", "flex", "flex-col", "overflow-hidden"], [1, "error-message"], ["value", "information"], [1, "uppercase"], ["value", "settings"], ["value", "limits"], ["value", "statistics"], ["value", "changes"], [4, "ngComponentOutlet", "ngComponentOutletInputs"]], template: function DistributorDetailsContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(3, DistributorDetailsContainerComponent_Conditional_3_Template, 13, 4, "div", 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
//# sourceMappingURL=chunk-7ANMWZ4D.js.map
