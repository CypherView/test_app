...
} from "./chunk-Z4BBJJMJ.js";
import {
  AdminTreetableContainerComponent,
  TreeTableConfigurationFactory
} from "./chunk-BC52OFOC.js";
import {
  EntityDetailsService,
  GridConfigurationFactory
} from "./chunk-HWO2Q5NX.js";
import "./chunk-QCRE3W3K.js";
import {
  ...
  faAngleLeft,
  faAngleRight
} from "./chunk-XH7MSRRK.js";
import {
  ConfirmDialog,
  ConfirmDialogModule,
  SEARCH_DEBOUNCE_TIME
} from "./chunk-LCEXQ7BI.js";
import {
  CardModule,
  ClientDetailsComponent
} from "./chunk-ZTXDF7WX.js";
...
import "./chunk-FTRAUB4Y.js";
import {
  FaIconComponent,
  FontAwesomeModule,
  getThemeDictionary
} from "./chunk-7JHFSANG.js";
import "./chunk-WGK2G26T.js";
import {
  ADMIN_TREE,
  ClientDataService,
  DATE_FORMATS,
...
var AdminSearchService = class _AdminSearchService {
  ...
  performSearch(query) {
    ...
    return this.cacheService.getOrFetch(`admin-search-${query}`, () => this.searchService.searchEntities(query).pipe(switchMap((response) => {
  ...
  /**
   * @deprecated Use searchAndLoadClient instead - progressively loading is no longer needed with global search
   */
  async progressivelyLoadClientInVendor(clientId, searchContext) {
    return this.searchAndLoadClient(clientId, searchContext);
  }
  /**
   * Finds a client in the currently loaded data
   */
  findClientInLoadedData(clientId, vendorId, groupId) {
    if (isDefined(groupId)) {
  ...
  async preloadSearchData() {
    try {
      ...
      const preloadPromises = vendors.map(async (vendor) => {
        try {
          if (!this.adminState.loadedVendors().has(vendor.id)) {
            await this.loadVendorData(vendor.id);
          }
        } catch (error) {
...
var AdminDataService = class _AdminDataService {
  ...
  expandSuperAdmin(_superAdminNode) {
    this.adminState.toggleNodeExpansion("super-admin-root", true);
  }
  collapseSuperAdmin(_superAdminNode) {
    this.adminState.toggleNodeExpansion("super-admin-root", false);
  }
...
function TreeSearchComponent_Conditional_6_Conditional_2_For_2_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("pTooltip", \u0275\u0275interpolate(ctx_r4.formatPath(result_r4.path)))("tooltipStyleClass", "max-w-xs break-words");
    \u0275\u0275advance();
...
function TreeSearchComponent_Conditional_6_Conditional_2_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, TreeSearchComponent_Conditional_6_Conditional_2_For_2_Conditional_6_Template, 2, 4, "div", 16);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("pTooltip", \u0275\u0275interpolate(result_r4.name))("tooltipStyleClass", "max-w-xs break-words");
    \u0275\u0275advance();
...
function TreeSearchComponent_Conditional_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275repeaterCreate(1, TreeSearchComponent_Conditional_6_Conditional_2_For_2_Template, 9, 10, "div", 10, _forTrack02);
...
var _c04 = (a0, a1) => ({ content: a0, scrollable: false, minSize: a1 });
...
function AdminContainerComponent_ng_template_3_Conditional_1_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-tree-search", 24);
...
function AdminContainerComponent_ng_template_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 12)(1, "p-toolbar", 21);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 22)(9, "app-tree-panel", 23);
    ...
    })("nodeNotFoundInData", function AdminContainerComponent_ng_template_3_Conditional_1_Template_app_tree_panel_nodeNotFoundInData_9_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onNodeNotFoundInData($event));
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(9);
    \u0275\u0275property("nodes", ctx_r3.hierarchyTree())("loading", ctx_r3.isLoading())("searchingForNode", ctx_r3.searchingForNode())("searchingNodeKey", ctx_r3.searchingNodeKey())("selection", ctx_r3.findSelectedNode())("scrollToNodeKey", ctx_r3.scrollToNodeKey())("contextExtractor", ctx_r3.contextExtractor);
  }
}
function AdminContainerComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275conditionalCreate(1, AdminContainerComponent_ng_template_3_Conditional_1_Template, 10, 7, "div", 12);
    ...
    \u0275\u0275listener("click", function AdminContainerComponent_ng_template_3_Template_button_click_3_listener() {
      ...
      return \u0275\u0275resetView(ctx_r3.navigateToSelectedClient());
    });
    \u0275\u0275element(4, "span", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 16)(6, "button", 17);
    \u0275\u0275listener("click", function AdminContainerComponent_ng_template_3_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(6, _c6, !ctx_r3.treeCollapsed()));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ((tmp_7_0 = ctx_r3.adminState.selectedClient()) == null ? null : tmp_7_0.name) || ((tmp_7_0 = ctx_r3.adminState.clientVendor()) == null ? null : tmp_7_0.name) || ((tmp_7_0 = ctx_r3.adminState.vendorDistributor()) == null ? null : tmp_7_0.name) || "COMPANY STRUCTURE", " ");
    \u0275\u0275advance(2);
...
function AdminContainerComponent_ng_template_5_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 26)(1, "router-outlet", 27);
...
function AdminContainerComponent_ng_template_5_ng_template_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-details-panel", 29);
...
function AdminContainerComponent_ng_template_5_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, AdminContainerComponent_ng_template_5_ng_template_3_Conditional_0_Template, 1, 0, "app-details-panel", 28);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function AdminContainerComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "app-adaptive-layout", 25);
...
var AdminContainerComponent = class _AdminContainerComponent {
  ...
  // Flag to suppress automatic scrolling to selected client (e.g., during user interactions)
  ...
  constructor() {
    ...
    effect(() => {
      ...
      const selectedClient = this.adminState.selectedClient();
      const currentTreeNode = this.selectedTreeNode();
      if (treeNodes.length > 0 && selectedClient && currentTreeNode?.key === selectedClient.id && !this.treeCollapsed()) {
        setTimeout(() => {
  ...
  ngOnInit() {
    ...
    this.adminDataService.loadInitialData(routeClientId).then(() => {
      this.ensureSuperAdminNodeExpansion();
  ...
  async navigateToSearchResult(result) {
    ...
    if (nodeToSelect) {
      this.selectedTreeNode.set(nodeToSelect);
      this.adminDataService.selectNode(nodeToSelect);
      this.scrollToClient(result.id);
    } else {
      console.warn(`Could not find tree node for ${result.type} ${result.id} after navigation`);
    }
  }
  /**
  ...
  async updateAdminStateForSearchResult(result) {
    try {
      if (result.type === ADMIN_TREE.NODE_TYPES.CLIENT) {
        ...
        if (hierarchy) {
          const client = this.findClientInState(result.id, hierarchy.vendorId, hierarchy.groupId);
          if (client) {
            ...
            this.clientDataService.setSelectedClient(clientResponse);
          }
        }
      } else if (result.type === ADMIN_TREE.NODE_TYPES.VENDOR) {
        const vendor = this.adminState.getVendorById(result.id);
        if (vendor) {
          this.adminState.setSelectedClient(null);
        }
      }
  ...
  /**
   * Finds a client in the admin state
   */
  findClientInState(clientId, vendorId, groupId) {
    if (isDefined(groupId)) {
      const groupClients = this.adminState.groupClients()[vendorId]?.[groupId];
      return groupClients?.find((client) => client.id === clientId);
    } else {
  ...
  scrollToClient(clientId) {
    ...
    setTimeout(() => {
      if (!this.suppressScrollToClient()) {
        ...
        setTimeout(() => this.scrollToNodeKey.set(null), 200);
      }
    }, 100);
  }
  /**
   ...
   * Uses global search to find and load the missing client
   * @param event The event containing node key and search context
   */
  onNodeNotFoundInData(event) {
    const clientId = event.nodeKey;
    const searchContext = event.context;
    this.searchingForNode.set(true);
    this.searchingNodeKey.set(clientId);
    this.adminSearchService.searchAndLoadClient(clientId, searchContext).then(() => {
      this.handleClientLoadSuccess(clientId);
    }).catch((error) => {
      if (this.isClientNotFoundError(error)) {
  ...
  /**
   * Determines if an error represents a "client not found" case vs a genuine error
   */
  isClientNotFoundError(error) {
    return error instanceof Error && error.message.includes("not found");
  }
  /**
   * Handles successful client loading - retries scrolling to the now-loaded client
   */
  handleClientLoadSuccess(clientId) {
    setTimeout(() => {
      this.scrollToClient(clientId);
    }, 300);
  }
  /**
   * Handles case where client could not be found even after global search
   */
  ...
  /**
   * Handles errors during client search and loading
   */
  ...
  ensureSuperAdminNodeExpansion() {
    ...
    if (isSuperAdmin && usesModernSchema && distributor) {
      ...
      if (!expandedNodes.has("super-admin-root")) {
        expandedNodes.add("super-admin-root");
      }
    }
  }
  buildSuperAdminHierarchy(distributor, selectedClient) {
    const expandedNodes = this.adminState.expandedNodes();
    const usesModernSchema = this.apiSchemaService.usesModernSchema();
    const isSuperAdminExpanded = usesModernSchema || expandedNodes.has("super-admin-root");
  ...
  async navigateToSelectedClient() {
    ...
    try {
      if (selectedClient.id !== this.adminState.selectedClient()?.id) {
        const searchResult = await this.adminSearchService.prepareClientForTreeSelection(selectedClient.id);
        if (searchResult) {
          const treeNodes = this.hierarchyTree();
  ...
  async onNodeExpand(node) {
    try {
      this.temporarilySuppressScrollToClient();
      switch (node.type) {
        case ADMIN_TREE.NODE_TYPES.VENDOR:
  ...
  updateSelectedNode(keyToSelect, typeToSelect, treeNodes) {
    ...
    if (nodeToSelect) {
      ...
      if (!this.treeCollapsed()) {
        setTimeout(() => {
          this.scrollToClient(keyToSelect);
        }, 200);
      }
    }
  }
      ...
      if (isDefined(currentClient?.id) && (!storedClient || currentClient.id !== storedClient.id)) {
        ...
        if (searchResult) {
          ...
          if (nodeToSelect) {
            ...
            setTimeout(() => {
              this.scrollToClient(currentClient.id);
            }, 300);
          } else {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminContainerComponent, selectors: [["app-admin-container"]], decls: 7, vars: 20, consts: [["combinedTreeToggleTemplate", ""], ["mainContentTemplate", ""], ["start", ""], ["center", ""], ["end", ""], ["nestedContent", ""], ["detailsContent", ""], [1, "flex", "h-full", "overflow-hidden", 3, "ngClass"], ["stateKey", "main-layout", 1, "h-full", "w-full", 3, "ngClass", "panels", "panelSizes", "minSizes", "defaultLayout", "responsive"], [1, "fixed", "inset-0", "bg-black", "bg-opacity-30", "z-40"], ["styleClass", "w-8 h-8", "strokeWidth", "2", 1, "fixed", "z-50", "top-1/2", "left-1/2", "-translate-x-1/2", "-translate-y-1/2"], [1, "h-full", "flex", "relative"], [1, "h-full", "flex-grow", "flex", "flex-col", "pr-8"], [1, "vertical-toggle-panel", "flex", "h-full", "z-10", "flex-col", 3, "ngClass"], ["title", "Go to selected client", 1, "group", "flex", "items-center", "justify-center", "p-2", "bg-gray-50", "hover:bg-gray-100", "rounded", "transition", "cursor-pointer", "border", "border-gray-300", "shadow-sm", "my-4", 3, "click"], [1, "pi", "pi-home", "text-gray-700", "group-hover:text-primary", "transition", "text-sm"], [1, "flex-grow", "flex", "items-center", "justify-center"], [1, "group", "flex", "flex-col", "items-center", "justify-center", "px-1", "py-2", "bg-gray-100", "hover:bg-gray-200", "rounded", "transition", "cursor-pointer", "border", "border-gray-300", "shadow-sm", 3, "click"], [1, "text-sm", "font-semibold", "text-gray-700", "tracking-tight", "select-none", "vertical-toggle-button"], [1, "mt-2"], [1, "text-gray-500", "group-hover:text-primary", "transition", 3, "icon"], ["styleClass", "!rounded-none !border-x-0 h-header"], [1, "flex-grow", "flex", "overflow-hidden"], [1, "w-full", "overflow-auto", 3, "nodeExpand", "nodeCollapse", "nodeSelect", "nodeNotFoundInData", "nodes", "loading", "searchingForNode", "searchingNodeKey", "selection", "scrollToNodeKey", "contextExtractor"], [1, "w-full", "max-w-sm", 3, "queryChange", "resultSelect", "searchClear", "results", "isSearching"], ["stateKey", "details-layout", 1, "h-full", "w-full", "overflow-hidden", 3, "ngClass", "panels", "panelSizes", "minSizes", "defaultLayout", "responsive"], [1, "h-full", "w-full", "flex", "flex-col"], [3, "activate"], [1, "h-full", "flex", "flex-col"], [1, "h-full", "flex", "flex-col", 3, "close"]], template: function AdminContainerComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", ctx.mainSplitterClass())("panels", \u0275\u0275pureFunction2(13, _c22, \u0275\u0275pureFunction2(8, _c04, combinedTreeToggleTemplate_r9, ctx.treeCollapsed() ? 2 : 15), \u0275\u0275pureFunction1(11, _c13, mainContentTemplate_r10)))("panelSizes", ctx.treeCollapsed() ? \u0275\u0275pureFunction0(16, _c32) : \u0275\u0275pureFunction0(17, _c4))("minSizes", \u0275\u0275pureFunction1(18, _c5, ctx.treeCollapsed() ? 2 : 15))("defaultLayout", "horizontal")("responsive", true);
    }
  }, dependencies: [
    AdaptiveLayoutComponent,
    RouterModule,
      ...
      <div class="h-full flex relative">
        ...
        >
          ...
          <button
            ...
            (click)="navigateToSelectedClient()"
          ...
          <div class="flex-grow flex items-center justify-center">
            ...
            >
              ...
              >
                {{
                  adminState.selectedClient()?.name ||
                    adminState.clientVendor()?.name ||
                    adminState.vendorDistributor()?.name ||
                    'COMPANY STRUCTURE'
                }}
              </span>
              <span class="mt-2">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminContainerComponent, { className: "AdminContainerComponent", filePath: "src/app/features/administration/components/admin-container/admin-container.component.ts", lineNumber: 96 });
})();
    ...
    children: [
      {
        ...
        loadChildren: () => import("./chunk-RS5EETUC.js").then((m) => m.SuperAdminModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-CHSDGYHJ.js").then((m) => m.VendorsModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-A27Y4GTO.js").then((m) => m.DistributorsModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-VWYXPEYB.js").then((m) => m.ClientsModule)
      }
    ]
  }
];
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    template: function StepPanel_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("@content", ctx.isVertical() ? ctx.active() ? \u0275\u0275pureFunction1(7, _c42, \u0275\u0275pureFunction1(5, _c33, ctx.transitionOptions())) : \u0275\u0275pureFunction1(11, _c52, \u0275\u0275pureFunction1(9, _c33, ctx.transitionOptions())) : void 0);
        \u0275\u0275advance();
...
function StepperComponent_For_5_ng_template_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngTemplateOutlet", step_r5.content)("ngTemplateOutletContext", \u0275\u0275pureFunction1(3, _c06, step_r5));
    \u0275\u0275advance();
...
var _c07 = ["deviceProviderDetailsStep"];
...
var _c08 = ["emailProviderDetailsStep"];
...
function AssetCreateWizardComponent_ng_template_5_Conditional_47_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AssetCreateWizardComponent_ng_template_5_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 19);
    \u0275\u0275repeaterCreate(1, AssetCreateWizardComponent_ng_template_5_Conditional_47_For_2_Template, 2, 1, "li", null, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function AssetCreateWizardComponent_ng_template_5_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
...
function AssetCreateWizardComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(47, AssetCreateWizardComponent_ng_template_5_Conditional_47_Template, 3, 0, "ul", 19)(48, AssetCreateWizardComponent_ng_template_5_Conditional_48_Template, 1, 0);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(49, "div", 20)(50, "p", 21);
    \u0275\u0275text(51, "Click finish to create this Asset.");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    \u0275\u0275advance(5);
    \u0275\u0275conditional(((tmp_12_0 = ctx_r2.newAsset().categories) == null ? null : tmp_12_0.length) ? 47 : 48);
  }
}
var AssetCreateWizardComponent = class _AssetCreateWizardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetCreateWizardComponent, selectors: [["app-asset-create-wizard"]], viewQuery: function AssetCreateWizardComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(1, AssetCreateWizardComponent_ng_template_1_Template, 3, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(3, AssetCreateWizardComponent_ng_template_3_Template, 3, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(5, AssetCreateWizardComponent_ng_template_5_Template, 52, 8, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      \u0275\u0275property("contentOnly", true)("steps", ctx.steps)("showSteps", false)("useWizardButtonsOnly", true);
    }
...
var GeofenceCoordinatesSectionComponent = class _GeofenceCoordinatesSectionComponent extends EntitySectionBaseComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GeofenceCoordinatesSectionComponent, selectors: [["app-geofence-coordinates-section"]], inputs: { ownerId: [1, "ownerId"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 6, consts: [[1, "card", "pt-2"], [1, "mb-4", "p-2", "flex", "justify-start", "items-center"], [1, "pi", "pi-map-marker", "!text-[2.5rem]", 3, "ngClass"], [1, "pl-6", "flex-1"], [1, "flex", "justify-between", "items-center"], [1, "icon-light"], [3, "fields", "actions", "hideActions"], [1, "pi", "pi-pen-to-square", "action", "hover", "!text-2xl", 3, "click", "keydown.enter"], [3, "formSubmit", "formValidityChange", "formValueChange", "fields", "actions", "hideActions"]], template: function GeofenceCoordinatesSectionComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(4, _c013, ctx.isFormEditable()));
...
var _c016 = ["assetRatingProfileDetailsStep"];
...
var _c018 = ["overspeedProfileDetailsStep"];
...
var _c019 = ["smsGatewayProviderDetailsStep"];
var _c117 = ["smsGatewayProviderParametersStep"];
...
var _c020 = ["deviceConfigProfileDetailsStep"];
...
var _c021 = ["customFieldDetailsStep"];
...
var _c023 = ["userDetailsStep"];
var _c121 = ["userRolesStep"];
...
var _c025 = ["distributorDetailsStep"];
var _c123 = ["confirmationTemplate"];
var _c221 = ["distributorDetailsForm"];
...
var SuperAdminDistributorsCreateWizardComponent = class _SuperAdminDistributorsCreateWizardComponent {
  ...
  onWizardComplete() {
    ...
    this.accountsService.createDistributor(distributorData).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (response) => {
        this.broadcastService.broadcast("entity-updated", {
          entityType: "distributor",
          operation: "create",
  ...
  }, decls: 5, vars: 4, consts: [["distributorDetailsStep", ""], ["confirmationTemplate", ""], ["distributorDetailsForm", ""], [3, "complete", "onCancel", "contentOnly", "steps", "showSteps", "useWizardButtonsOnly"], [1, "p-fluid"], [3, "formValidityChange", "formValueChange", "createMode", "entity", "ownerId"], [1, "flex", "gap-6"], [1, "pi", "pi-check", "!text-5xl"], [1, "flex-1"], [1, "grid"], [1, "col-12", "md:col-6"], [1, "mb-4"], [1, "space-y-2"], [1, "flex"], [1, "w-1/3", "font-medium"], [1, "w-2/3"], [1, "mt-4", "pt-4", "border-top-1", "border-surface-200", "dark:border-surface-700"], [1, "mb-0"]], template: function SuperAdminDistributorsCreateWizardComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "app-wizard", 3);
...
var _c026 = ["assetCategoryDetailsStep"];
var _c124 = ["confirmationTemplate"];
var _c222 = ["assetCategoryDetailsForm"];
...
var _c027 = ["assetGroupDetailsStep"];
var _c125 = ["confirmationTemplate"];
var _c223 = ["assetGroupDetailsForm"];
...
var _c028 = ["costCentreDetailsStep"];
var _c126 = ["confirmationTemplate"];
var _c224 = ["costCentreDetailsForm"];
...
var _c029 = ["geofenceGroupDetailsStep"];
var _c127 = ["confirmationTemplate"];
var _c225 = ["geofenceGroupDetailsForm"];
...
//# sourceMappingURL=chunk-SPFXH4SK.js.map
