...
var ClientSelectorComponent = class _ClientSelectorComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClientSelectorComponent, selectors: [["app-client-selector"]], inputs: { clientAccounts: [1, "clientAccounts"], maxHeightClass: [1, "maxHeightClass"] }, outputs: { accountSelected: "accountSelected" }, decls: 10, vars: 4, consts: [["searchInput", ""], [1, "w-full"], [1, "p-inputgroup"], ["type", "text", "pInputText", "", "placeholder", "Search accounts...", 1, "w-full", 3, "formControl"], [1, "pi", "pi-search"], [1, "flex", "items-center", "justify-between", "p-4", "gap-3", "hover:shadow-sm", "cursor-pointer", "transition"], [1, "text-center", "py-8"], [1, "flex", "items-center", "justify-between", "p-4", "gap-3", "hover:shadow-sm", "cursor-pointer", "transition", 3, "click", "keydown.enter"], [1, "flex", "gap-3", "justify-center"], [1, "w-10", "h-10", "rounded-full", "account-avatar", "flex", "items-center", "justify-center", "font-semibold", "text-lg", "flex-shrink-0"], [1, "flex", "flex-col", "gap-1"], [1, "font-semibold", "text-xl"], [1, "text-sm"], [1, "account-select-icon"], [1, "pi", "pi-arrow-right"]], template: function ClientSelectorComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "p-iconfield");
      \u0275\u0275element(3, "input", 3, 0)(5, "p-inputicon", 4);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(6, "div");
      \u0275\u0275repeaterCreate(7, ClientSelectorComponent_For_8_Template, 12, 6, "div", 5, _forTrack0);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275classMap("flex flex-col gap-3 w-full overflow-y-auto rounded mt-3 " + ctx.maxHeightClass());
      \u0275\u0275advance();
...
<div
  [class]="
    'flex flex-col gap-3 w-full overflow-y-auto rounded mt-3 ' +
    maxHeightClass()
  "
>
  @for (account of filteredAccounts(); track account.id) {
    <div
      class="flex items-center justify-between p-4 gap-3 hover:shadow-sm cursor-pointer transition"
      (click)="selectAccount(account.id)"
      (keydown.enter)="selectAccount(account.id)"
    >
      <div class="flex gap-3 justify-center">
        <div
          class="w-10 h-10 rounded-full account-avatar flex items-center justify-center font-semibold text-lg flex-shrink-0"
        >
  ...
  @if (filteredAccounts().length === 0) {
    <div class="text-center py-8">No accounts found.</div>
  }
</div>
...
css-vars-ponyfill/dist/css-vars-ponyfill.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-V3RFX5FU.js.map
