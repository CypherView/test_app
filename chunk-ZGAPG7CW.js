...
var _c6 = () => ({ label: "Medium (400x300)", value: "MEDIUM" });
var _c7 = () => ({ label: "Full Width", value: "FULL_WIDTH" });
var _c8 = () => ({ label: "Card", value: "CARD" });
var _c9 = (a0, a1, a2) => [a0, a1, a2];
var _c10 = () => ({ label: "Right Sidebar", value: "RIGHT_SIDEBAR" });
var _c11 = () => ({ label: "Main Content", value: "MAIN" });
...
function AppCreateWizardComponent_ng_template_4_For_8_ng_template_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "div", 37)(2, "div")(3, "label", 38);
    \u0275\u0275text(4, "Widget Size");
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "p-select", 39);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div")(7, "label", 38);
    \u0275\u0275text(8, "Position");
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "p-select", 40);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const screen_r5 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("formGroup", ctx_r2.getIntegrationPointControl(screen_r5.id));
    \u0275\u0275advance(3);
    \u0275\u0275property("for", \u0275\u0275interpolate1("widget-size-", screen_r5.id));
    \u0275\u0275advance(2);
    \u0275\u0275property("inputId", \u0275\u0275interpolate1("widget-size-", screen_r5.id))("options", \u0275\u0275pureFunction3(14, _c9, \u0275\u0275pureFunction0(11, _c6), \u0275\u0275pureFunction0(12, _c7), \u0275\u0275pureFunction0(13, _c8)));
    \u0275\u0275advance(2);
    \u0275\u0275property("for", \u0275\u0275interpolate1("widget-position-", screen_r5.id));
    \u0275\u0275advance(2);
    \u0275\u0275property("inputId", \u0275\u0275interpolate1("widget-position-", screen_r5.id))("options", \u0275\u0275pureFunction2(20, _c12, \u0275\u0275pureFunction0(18, _c10), \u0275\u0275pureFunction0(19, _c11)));
  }
}
function AppCreateWizardComponent_ng_template_4_For_8_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(4, AppCreateWizardComponent_ng_template_4_For_8_ng_template_1_Conditional_4_Template, 10, 23, "div", 36);
  }
  if (rf & 2) {
    const screen_r5 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("inputId", screen_r5.id)("binary", true)("ngModel", ctx_r2.isScreenSelected(screen_r5.id))("ngModelOptions", \u0275\u0275pureFunction0(7, _c5));
    \u0275\u0275advance();
    \u0275\u0275property("for", screen_r5.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(screen_r5.name);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.isScreenSelected(screen_r5.id) ? 4 : -1);
  }
}
function AppCreateWizardComponent_ng_template_4_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-card", 32);
    \u0275\u0275template(1, AppCreateWizardComponent_ng_template_4_For_8_ng_template_1_Template, 5, 8, "ng-template", 8);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const screen_r5 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("styleClass", ctx_r2.isScreenSelected(screen_r5.id) ? "border-primary" : "");
  }
}
...
function AppCreateWizardComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(7, AppCreateWizardComponent_ng_template_4_For_8_Template, 2, 1, "p-card", 32, _forTrack0);
...
function AppCreateWizardComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "form", 18)(4, "div", 41)(5, "div")(6, "label", 42);
    \u0275\u0275text(7, "Base URL *");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div")(13, "label", 45);
    \u0275\u0275text(14, "Health Check URL");
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "input", 46);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_8_0;
...
function AppCreateWizardComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Pricing");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "form", 18)(4, "div", 47)(5, "div")(6, "label", 48);
    \u0275\u0275text(7, "Model");
    \u0275\u0275elementEnd();
...
function AppCreateWizardComponent_ng_template_10_ng_template_5_For_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", point_r7.screenId, " (", point_r7.widgetSize, ") ");
  }
}
...
function AppCreateWizardComponent_ng_template_10_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 65)(1, "div", 66)(2, "div")(3, "span", 67);
    \u0275\u0275text(4, "App Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span", 68);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div")(8, "span", 67);
    ...
    \u0275\u0275text(14, "Base URL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "code", 70);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "div", 66)(18, "div")(19, "span", 67);
    \u0275\u0275text(20, "Pricing Model");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "span", 71);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(23, AppCreateWizardComponent_ng_template_10_ng_template_5_Conditional_23_Template, 2, 2, "span", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div")(25, "span", 67);
    \u0275\u0275text(26, "Integrations");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 73);
    \u0275\u0275repeaterCreate(28, AppCreateWizardComponent_ng_template_10_ng_template_5_For_29_Template, 2, 2, "span", 74, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275conditionalCreate(30, AppCreateWizardComponent_ng_template_10_ng_template_5_Conditional_30_Template, 2, 0, "span", 75);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_8_0;
...
function AppCreateWizardComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div")(4, "p-card", 56);
    \u0275\u0275template(5, AppCreateWizardComponent_ng_template_10_ng_template_5_Template, 31, 6, "ng-template", 8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-card", 57);
    \u0275\u0275template(7, AppCreateWizardComponent_ng_template_10_ng_template_7_Template, 8, 1, "ng-template", 8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, AppCreateWizardComponent_ng_template_10_Conditional_8_Template, 4, 1, "div", 58);
    \u0275\u0275elementStart(9, "div", 59)(10, "p-button", 60);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppCreateWizardComponent, [{
    type: Component,
    args: [{ selector: "app-app-create-wizard", standalone: true, imports: [
      CommonModule,
      RouterModule,
      FormsModule,
      ReactiveFormsModule,
    ...
    <form [formGroup]="appForm">
      <div class="space-y-4" formGroupName="integration">
        @for (screen of availableScreens; track screen.id) {
          <p-card
            [styleClass]="isScreenSelected(screen.id) ? 'border-primary' : ''"
          >
            <ng-template pTemplate="content">
              ...
              <!-- Configuration for selected screen -->
              @if (isScreenSelected(screen.id)) {
                <div
                  class="ml-6 pl-4 border-l-2 space-y-3"
                  [formGroup]="$any(getIntegrationPointControl(screen.id))"
                >
                  <div class="grid grid-cols-2 gap-4">
                    <div>
                      <label
                        for="widget-size-{{ screen.id }}"
                        class="block text-xs font-medium uppercase mb-1"
                        >Widget Size</label
                      >
                      <p-select
                        inputId="widget-size-{{ screen.id }}"
                        formControlName="widgetSize"
                        [options]="[
                          { label: 'Medium (400x300)', value: 'MEDIUM' },
                    ...
                    <div>
                      <label
                        for="widget-position-{{ screen.id }}"
                        class="block text-xs font-medium uppercase mb-1"
                        >Position</label
                      >
                      <p-select
                        inputId="widget-position-{{ screen.id }}"
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-2">
                  @for (
                    ...
                    >
                      {{ point.screenId }} ({{ point.widgetSize }})
                    </span>
                  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppCreateWizardComponent, { className: "AppCreateWizardComponent", filePath: "src/app/features/app-store/pages/app-create-wizard/app-create-wizard.component.ts", lineNumber: 84 });
})();
export {
  AppCreateWizardComponent
};
//# sourceMappingURL=chunk-ZGAPG7CW.js.map
