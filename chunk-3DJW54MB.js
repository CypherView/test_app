...
var SUPER_ADMIN_ROUTES = [
  {
    ...
    children: [
      ...
      {
        path: "system-health",
        loadChildren: () => import("./chunk-KT22GQ76.js").then((m) => m.ADMIN_SYSTEM_HEALTH_ROUTES)
      },
      {
        path: "analytics",
      ...
      ...createGuardedGridRoute("map-sets", mapSetsGuard, AdminGridContainerComponent),
...
//# sourceMappingURL=chunk-3DJW54MB.js.map
