import{D as S,G as oe,L as pe,a as m,b as F,d as k,k as f,oa as he,pa as E,ta as ue,wa as R,x as ae}from"./chunk-IWKSTHO7.js";import{$b as v,Ad as V,Bb as P,Cc as Z,Cd as D,Db as y,Ec as ee,Fa as C,Nb as d,Ob as h,Qb as j,Rb as K,Sb as T,Yc as I,_b as g,_c as te,dc as U,ea as A,ec as H,fa as B,ga as O,hc as M,ic as l,jc as q,kb as c,kc as X,la as Q,md as ie,nc as L,oc as Y,od as ne,pc as x,pd as se,qc as w,rc as J,sb as G,sc as W,sd as re,td as le,va as o,wa as p,xb as b,yb as N,za as _}from"./chunk-3S2TYEVV.js";var de=["*"],ge=["panel"],me=["container"],fe=n=>({display:"flex","flex-wrap":"nowrap","flex-direction":n});function Se(n,z){n&1&&U(0)}function ze(n,z){if(n&1){let e=H();g(0,"div",6),M("mousedown",function(i){o(e);let s=l().index,r=l();return p(r.onGutterMouseDown(i,s))})("touchstart",function(i){o(e);let s=l().index,r=l();return p(r.onGutterTouchStart(i,s))})("touchmove",function(i){o(e);let s=l(2);return p(s.onGutterTouchMove(i))})("touchend",function(i){o(e);let s=l(2);return p(s.onGutterTouchEnd(i))}),g(1,"div",7),M("keyup",function(i){o(e);let s=l(2);return p(s.onGutterKeyUp(i))})("keydown",function(i){o(e);let s=l().index,r=l();return p(r.onGutterKeyDown(i,s))}),v()()}if(n&2){let e=l(2);d("data-p-gutter-resizing",!1)("data-pc-section","gutter"),c(),h("ngStyle",e.gutterStyle()),d("aria-orientation",e.layout)("aria-valuenow",e.prevSize)("data-pc-section","gutterhandle")}}function _e(n,z){if(n&1&&(g(0,"div",3),y(1,Se,1,0,"ng-container",4),v(),y(2,ze,2,6,"div",5)),n&2){let e=z.$implicit,t=z.index,i=l();T(i.panelStyleClass),h("ngClass",i.panelContainerClass())("ngStyle",i.panelStyle),d("data-pc-name","splitter")("data-pc-section","root"),c(),h("ngTemplateOutlet",e),c(),h("ngIf",t!==i.panels.length-1)}}var ye=({dt:n})=>`
.p-splitter {
    display: flex;
    flex-wrap: nowrap;
