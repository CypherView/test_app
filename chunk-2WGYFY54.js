...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppStatusBadgeComponent, [{
    type: Component,
    args: [{ selector: "app-status-badge", imports: [CommonModule], template: '<span\n  class="px-2 py-0.5 rounded-full text-[10px] font-medium uppercase tracking-wider"\n  [ngClass]="badgeClass()"\n>\n  {{ label() }}\n</span>\n', styles: ["/* src/app/features/app-store/components/app-status-badge/app-status-badge.component.scss */\n.status-draft {\n  border-width: 1px;\n  --tw-border-opacity: 1;\n  border-color: color-mix(in srgb, var(--p-surface-200) calc(100% * var(--tw-border-opacity, 1)), transparent);\n  --tw-text-opacity: 1;\n  color: color-mix(in srgb, var(--p-surface-600) calc(100% * var(--tw-text-opacity, 1)), transparent);\n}\n.status-pending {\n  border-width: 1px;\n  --tw-border-opacity: 1;\n  border-color: rgb(219 234 254 / var(--tw-border-opacity, 1));\n  --tw-text-opacity: 1;\n  color: rgb(37 99 235 / var(--tw-text-opacity, 1));\n}\n.status-approved {\n  border-width: 1px;\n  --tw-border-opacity: 1;\n  border-color: rgb(220 252 231 / var(--tw-border-opacity, 1));\n  --tw-text-opacity: 1;\n  color: rgb(22 163 74 / var(--tw-text-opacity, 1));\n}\n.status-rejected {\n  border-width: 1px;\n  --tw-border-opacity: 1;\n  border-color: rgb(254 226 226 / var(--tw-border-opacity, 1));\n  --tw-text-opacity: 1;\n  color: rgb(220 38 38 / var(--tw-text-opacity, 1));\n}\n.status-suspended {\n  border-width: 1px;\n  --tw-border-opacity: 1;\n  border-color: rgb(255 237 213 / var(--tw-border-opacity, 1));\n  --tw-text-opacity: 1;\n  color: rgb(234 88 12 / var(--tw-text-opacity, 1));\n}\n/*# sourceMappingURL=app-status-badge.component.css.map */\n"] }]
  }], null, { status: [{ type: Input, args: [{ isSignal: true, alias: "status", required: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppStatusBadgeComponent, { className: "AppStatusBadgeComponent", filePath: "src/app/features/app-store/components/app-status-badge/app-status-badge.component.ts", lineNumber: 12 });
})();

export {
  AppStatusBadgeComponent
};
//# sourceMappingURL=chunk-2WGYFY54.js.map
