...
} from "./chunk-IAU2BK5M.js";
import {
  EntityDetailsService
} from "./chunk-A5X3UN4J.js";
import {
...
import {
  ...
  GridComponent
} from "./chunk-33ZEXWJN.js";
import {
  ContextMenuModule
} from "./chunk-VLMQNANX.js";
import {
  Popover,
  PopoverModule
...
var AdminGridContainerComponent = class _AdminGridContainerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminGridContainerComponent, selectors: [["app-admin-grid-container"]], viewQuery: function AdminGridContainerComponent_Query(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(6, 48, "ADMIN.SHARED.ARIA.GRID_ACTIONS"));
      \u0275\u0275advance(2);
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(8, 50, "SHARED.COMMON.BUTTONS.ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(9, 52, "ADMIN.SHARED.ARIA.ADD_NEW_ITEM"))("aria-disabled", !((tmp_4_0 = ctx.gridConfiguration()) == null ? null : tmp_4_0.onAdd));
      \u0275\u0275advance(3);
      \u0275\u0275conditional(((tmp_5_0 = ctx.gridConfiguration()) == null ? null : tmp_5_0.onBulkImport) ? 10 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(12, 54, "SHARED.COMMON.BUTTONS.REFRESH"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 56, "ADMIN.SHARED.ARIA.REFRESH_GRID_DATA"))("aria-busy", ctx.loading());
      \u0275\u0275advance(3);
      \u0275\u0275classProp("text-primary", ctx.showFilters());
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(15, 58, "ADMIN.SHARED.TOOLTIPS.FILTER"))("disabled", !ctx.canFilter());
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(16, 60, "ADMIN.SHARED.ARIA.TOGGLE_FILTERS"))("aria-disabled", !ctx.canFilter());
      \u0275\u0275advance(3);
      ...
      \u0275\u0275property("pTooltip", ctx.exporting() ? \u0275\u0275pipeBind1(19, 62, "SHARED.COMMON.BUTTONS.EXPORTING") + "..." : \u0275\u0275pipeBind1(20, 64, "ADMIN.SHARED.TOOLTIPS.EXPORT_CSV"))("disabled", ctx.exporting());
      \u0275\u0275attribute("aria-label", ctx.exporting() ? \u0275\u0275pipeBind1(21, 66, "ADMIN.SHARED.ARIA.EXPORTING") : \u0275\u0275pipeBind1(22, 68, "ADMIN.SHARED.ARIA.EXPORT_TO_CSV"))("aria-busy", ctx.exporting());
      \u0275\u0275advance(6);
      \u0275\u0275property("columns", ctx.columns())("data", ctx.data())("pagination", true)("totalRecords", ctx.totalRecords())("lazy", true)("filterable", ctx.showFilters())("visibleColumns", ctx.visibleColumns())("selectionMode", ctx.gridSelectionMode())("showCheckboxColumn", ctx.showCheckboxColumn())("metaKeySelection", true)("dataKey", "id")("loading", ctx.loading())("scrollable", true)("scrollHeight", "flex")("initialFilters", ctx.currentFilters())("sortable", true);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminGridContainerComponent, { className: "AdminGridContainerComponent", filePath: "src/app/features/administration/components/admin-grid-container/admin-grid-container.component.ts", lineNumber: 90 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TreeTableComponent, { className: "TreeTableComponent", filePath: "src/app/shared/components/tree-table/tree-table.component.ts", lineNumber: 49 });
})();
...
var AdminTreetableContainerComponent = class _AdminTreetableContainerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminTreetableContainerComponent, selectors: [["app-admin-treetable-container"]], viewQuery: function AdminTreetableContainerComponent_Query(rf, ctx) {
  ...
  }, decls: 20, vars: 43, consts: [[1, "flex", "flex-col", "h-full", "w-full", "overflow-hidden"], [1, "p-4", "content-header", "flex-none", "w-full"], [1, "flex", "justify-between", "items-center"], ["id", "treetableTitle", 1, "text-xl", "font-semibold", "truncate"], [1, "flex-none", "flex", "space-x-4", "align-center"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-plus", "action", "hover", 3, "click", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-refresh", "action", "hover", 3, "click", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-filter-fill", "action", "hover", 3, "pTooltip", "text-primary"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "action", "hover", 3, "pi-download", "pi-spinner", "pi-spin", "pTooltip", "disabled"], [3, "columnChange", "columns", "selectedColumns", "disabled"], [1, "flex-1", "min-h-0", "w-full", "overflow-auto"], ["role", "treegrid", 1, "h-full", "max-w-full", 3, "lazyLoad", "nodeSelect", "selectionChange", "nodeExpand", "nodeCollapse", "onFilterChange", "columnResize", "columns", "visibleColumns", "filterable", "initialFilters", "nodes", "totalRecords", "lazy", "paginator", "rows", "selectionMode", "metaKeySelection", "loading", "scrollable", "resizableColumns", "storedWidths", "scrollHeight"], ["aria-live", "polite", "aria-atomic", "true", 1, "sr-only"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-filter-fill", "action", "hover", 3, "click", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "action", "hover", 3, "click", "pTooltip", "disabled"]], template: function AdminTreetableContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h2", 3);
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(6, 33, "ADMIN.SHARED.ARIA.TREE_TABLE_ACTIONS"));
      \u0275\u0275advance(2);
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(8, 35, "SHARED.COMMON.BUTTONS.ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(9, 37, "ADMIN.SHARED.ARIA.ADD_NEW_ITEM"))("aria-disabled", !((tmp_4_0 = ctx.treeTableConfiguration()) == null ? null : tmp_4_0.onAdd));
      \u0275\u0275advance(3);
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(11, 39, "SHARED.COMMON.BUTTONS.REFRESH"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(12, 41, "ADMIN.SHARED.ARIA.REFRESH_TREE_TABLE_DATA"))("aria-busy", ctx.loading());
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("columns", ctx.columns())("visibleColumns", ctx.visibleColumns())("filterable", ctx.showFilters())("initialFilters", ctx.currentFilters())("nodes", ctx.nodes())("totalRecords", ctx.totalRecords())("lazy", true)("paginator", ctx.totalRecords() > ctx.limit())("rows", ctx.limit())("selectionMode", ctx.selectionMode())("metaKeySelection", true)("loading", ctx.loading())("scrollable", true)("resizableColumns", true)("storedWidths", ctx.columnWidths())("scrollHeight", "flex");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminTreetableContainerComponent, { className: "AdminTreetableContainerComponent", filePath: "src/app/features/administration/components/admin-treetable-container/admin-treetable-container.component.ts", lineNumber: 89 });
})();
...
//# sourceMappingURL=chunk-Q3OOU27C.js.map
