...
function wrap2(start, maybeString, end2 = "") {
...
var require_color_string = __commonJS({
  "node_modules/color-string/index.js"(exports, module2) {
    ...
    for (name in colorNames) {
      if (hasOwnProperty8.call(colorNames, name)) {
    ...
    cs.get.rgb = function(string) {
      ...
      if (match = string.match(hex)) {
        ...
        if (!hasOwnProperty8.call(colorNames, match[1])) {
          return null;
        }
  ...
  "node_modules/color/index.js"(exports, module2) {
    ...
    function Color3(object, model) {
      ...
      if (object == null) {
        ...
        const result2 = colorString.get(object);
        if (result2 === null) {
    ...
    Color3.prototype = {
      ...
      mix(mixinColor, weight) {
        ...
        const w22 = 1 - w1;
        return Color3.rgb(w1 * color1.red() + w22 * color2.red(), w1 * color1.green() + w22 * color2.green(), w1 * color1.blue() + w22 * color2.blue(), color1.alpha() * p2 + color2.alpha() * (1 - p2));
      }
    };
    for (const model of Object.keys(convert)) {
...
function getFragmentQueryDocument(document2, fragmentName) {
  ...
  var query2 = __assign(__assign({}, document2), {
...
function recurseTransformInfo(transform) {
  return transform ? __spreadArray(__spreadArray([getWrapperInformation(transform === null || transform === void 0 ? void 0 : transform["performWork"])], recurseTransformInfo(transform === null || transform === void 0 ? void 0 : transform["left"]), true), recurseTransformInfo(transform === null || transform === void 0 ? void 0 : transform["right"]), true).filter(isDefined2) : [];
}
function linkInfo(link) {
  var _a2;
  return link ? __spreadArray(__spreadArray([(_a2 = link === null || link === void 0 ? void 0 : link.getMemoryInternals) === null || _a2 === void 0 ? void 0 : _a2.call(link)], linkInfo(link === null || link === void 0 ? void 0 : link.left), true), linkInfo(link === null || link === void 0 ? void 0 : link.right), true).filter(isDefined2) : [];
}
...
var arrayFromSet = Array.from || function(set2) {
  const array = [];
...
function isEmpty3(op, fragmentMap) {
  return !op || op.selectionSet.selections.every(function(selection) {
    return selection.kind === Kind.FRAGMENT_SPREAD && isEmpty3(fragmentMap[selection.name.value], fragmentMap);
  });
}
function nullIfDocIsEmpty(doc) {
  return isEmpty3(getOperationDefinition(doc) || getFragmentDefinition(doc), createFragmentMap(getFragmentDefinitions(doc))) ? null : doc;
}
...
var Observable2 = /* @__PURE__ */ function() {
  ...
  Observable3.from = function from2(x2) {
    ...
    StoreReader2.prototype.diffQueryAgainstStore = function(_a2) {
      ...
      var execResult = this.executeSelectionSet({
        ...
        context: __assign({
          ...
          canonizeResults
        }, extractFragmentContext(query2, this.config.fragments))
      });
      var missing;
  ...
  function() {
    ...
    StoreWriter2.prototype.writeToStore = function(store, _a2) {
      ...
      var context = __assign(__assign({
        ...
        variables,
        varString: canonicalStringify(variables)
      }, extractFragmentContext(query2, this.fragments)), {
        overwrite: !!overwrite,
...
function selectHttpOptionsAndBodyInternal(operation, printer) {
  ...
  configs.forEach(function(config2) {
    options = __assign(__assign(__assign({}, options), config2.options), {
      headers: __assign(__assign({}, options.headers), config2.headers)
    });
  ...
  if (http.includeQuery) body.query = printer(query2, print2);
  return {
    options,
    body
  };
...
var createHttpLink = function(linkOptions) {
  ...
  return new ApolloLink(function(operation) {
    ...
    if (options.method === "GET") {
      var _c7 = rewriteURIForGET(chosenURI, body), newURI = _c7.newURI, parseError = _c7.parseError;
      if (parseError) {
...
var ObservableQuery = (
  ...
  function(_super) {
    ...
    ObservableQuery2.prototype.isDifferentFromLastResult = function(newResult, variables) {
      ...
      var query2 = dataMasking ? documentInfo.nonReactiveQuery : this.query;
      var resultIsDifferent = dataMasking || documentInfo.hasNonreactiveDirective ? !equalByQuery(query2, this.last.result, newResult, this.variables) : !equal(this.last.result, newResult);
...
var QueryManager = (
  ...
  function() {
    ...
    QueryManager2.prototype.watchQuery = function(options) {
      ...
      options = __assign(__assign({}, options), {
        variables: this.getVariables(query2, options.variables)
      });
      ...
      this.queries.forEach(function(_a2, queryId) {
        ...
        if (oq) {
          ...
          if (include === "active" || queryName && queryNamesAndQueryStrings.has(queryName) || document2 && queryNamesAndQueryStrings.has(print2(document2))) {
            ...
            if (document2) queryNamesAndQueryStrings.set(print2(document2), true);
          }
        }
      });
    ...
    QueryManager2.prototype.startGraphQLSubscription = function(options) {
      var _this = this;
      var query2 = options.query, variables = options.variables;
      ...
      var makeObservable = function(variables2) {
        return _this.getObservableFromLink(query2, context, variables2, extensions).map(function(result2) {
          if (fetchPolicy !== "no-cache") {
    ...
    QueryManager2.prototype.getObservableFromLink = function(query2, context, variables, extensions, deduplication) {
      var _this = this;
      var _a2;
    ...
    QueryManager2.prototype.maskOperation = function(options) {
      ...
      if (globalThis.__DEV__ !== false) {
        ...
        if (this.dataMasking && fetchPolicy === "no-cache" && !isFullyUnmaskedOperation(document2) && !this.noCacheWarningsByQueryId.has(operationId)) {
          ...
          globalThis.__DEV__ !== false && invariant2.warn(37, (_c = getOperationName(document2)) !== null && _c !== void 0 ? _c : "Unnamed ".concat(operationType !== null && operationType !== void 0 ? operationType : "operation"));
        }
      }
...
var ZoneScheduler = class {
  ...
  schedule(work, delay = 0, state2) {
    return this.zone.run(() => queueScheduler.schedule(work, delay, state2));
  }
};
...
var faClassList = (props) => {
  ...
  return Object.keys(classes2).map((key) => classes2[key] ? key : null).filter((key) => key);
};
...
function isLegacyTheme(theme2) {
  ...
  const base = isDefined(theme2.theme) ? themeDictionary[theme2.theme] : void 0;
  if (isDefined(base)) {
    const legacyKeys = base.variableSettings.map((x2) => x2.key);
    return theme2.theme === "nightrider" || (0, import_lodash.intersection)(legacyKeys, Object.keys(theme2.settings || {})).length > 0;
  }
  return false;
}
function convertLegacyTheme(theme2) {
  const result2 = {};
  if (theme2["theme"] === "nightrider") {
    (0, import_lodash.set)(result2, "main.background.color", "#161616");
    (0, import_lodash.set)(result2, "content.background.color", "#252526");
    (0, import_lodash.set)(result2, "header.background.color", "#333333");
    (0, import_lodash.set)(result2, "footer.background.color", "#4a4a4a");
    (0, import_lodash.set)(result2, "table.header.background.color", "#2e2e2e");
  }
  (0, import_lodash.set)(result2, "navigation.active.style", isDefined(theme2.settings?.["navigationActiveState"]) || (theme2.theme === "nightrider" ? "background" : "left-border"));
  const defaultSettings = isDefined(theme2.theme) && theme2.theme in THEME_DEFAULT_SETTINGS ? THEME_DEFAULT_SETTINGS[theme2.theme] : void 0;
  theme2.variableSettings?.forEach((item) => {
    const value = getComputedColor(item, isDefined(theme2["settings"]) ? theme2["settings"] : {}, defaultSettings);
    switch (item.key) {
      case "navigationColor_background":
        (0, import_lodash.set)(result2, "navigation.background.color", value);
        break;
      case "navigationColor_foreground":
        (0, import_lodash.set)(result2, "navigation.font.color", value);
        break;
      case "navigationColor_border":
        (0, import_lodash.set)(result2, "navigation.border.color", value);
        break;
      ...
      case "headerColor_background":
        (0, import_lodash.set)(result2, "header.background.color", value);
        if (theme2["theme"] === "nightrider") {
          (0, import_lodash.set)(result2, "footer.background.color", value);
        }
        break;
      case "headerColor_foreground":
        (0, import_lodash.set)(result2, "header.font.color", value);
        if (theme2["theme"] === "nightrider") {
          (0, import_lodash.set)(result2, "footer.font.color", value);
        }
        break;
      case "headerColor_border":
        (0, import_lodash.set)(result2, "header.border.color", value);
        break;
      ...
      case "headerColorActive_background":
        (0, import_lodash.set)(result2, "tab.active.background.color", value);
        break;
      case "headerColorActive_foreground":
        (0, import_lodash.set)(result2, "tab.active.font.color", value);
        break;
      case "headerColorActive_border":
        (0, import_lodash.set)(result2, "tab.active.border.color", value);
        break;
      case "primaryColor_main":
        (0, import_lodash.set)(result2, "color.primary.color", value);
        break;
      case "primaryColor_invert":
        (0, import_lodash.set)(result2, "color.primary.contrast", value);
        break;
      default:
        break;
    }
...
var ThemeEngine = class _ThemeEngine {
  ...
  resolveFormula(formula) {
    ...
    const result2 = hasProperty(this.formulaCache, formula) ? this.formulaCache[formula] : FALLBACK_COLOR;
    return result2;
  }
...
var ThemeDataService = class _ThemeDataService {
  ...
  fetchTheme(themeId) {
    return this.themesService.getTheme(themeId).pipe(tap((theme2) => {
      this.themeSubject.next(theme2);
    }));
  }
  setTheme(theme2) {
    const convertedTheme = this.convertToThemeResponse(theme2);
  ...
  getDomainTheme(domain) {
    return this.themesService.getThemeForDomain(domain).pipe(map((result2) => result2.theme));
  }
  convertToThemeResponse(input) {
    const theme2 = (0, import_lodash3.cloneDeep)(input);
    if (isLegacyTheme(theme2)) {
      const themeDictionary = getThemeDictionary();
      if (isNullOrUndefined(theme2.theme) || !(theme2.theme in themeDictionary)) {
        throw new Error("Invalid theme key");
      }
      const baseTheme = themeDictionary[theme2.theme];
      const mergedTheme = (0, import_lodash3.merge)((0, import_lodash3.cloneDeep)(baseTheme), theme2);
      theme2.settings = convertLegacyTheme(mergedTheme);
    }
    if (theme2.settings) {
      theme2.variables = __spreadValues(__spreadValues({}, theme2.variables), Object.fromEntries(Object.entries(this.themeEngine.settingsToVariables(theme2.settings)).map(([key, value]) => [
        key,
...
@fortawesome/fontawesome-svg-core/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-SESMNWMW.js.map
