...
function D(t2, e, o = true) {
  ...
  if (t2) {
    ...
    f2.top + u2 + s4 > lt.height ? (L = f2.top + g2 - s4, ot = "bottom", L < 0 && (L = g2)) : L = u2 + f2.top + g2, f2.left + a2 > lt.width ? N2 = Math.max(0, f2.left + it + p3 - a2) : N2 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n2 = x(/-anchor-gutter$/)) == null ? void 0 : n2.value) != null ? r : "2px"} * -1)` : (l3 = (i3 = x(/-anchor-gutter$/)) == null ? void 0 : i3.value) != null ? l3 : "");
  }
}
function S(t2, e) {
...
function zt(t2, e) {
  var o, n2;
  if (t2) {
    let r = t2.parentElement, i3 = K(r), l3 = h(), d2 = t2.offsetParent ? t2.offsetWidth : J(t2), s4 = t2.offsetParent ? t2.offsetHeight : G(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u2 = C((n2 = r == null ? void 0 : r.children) == null ? void 0 : n2[0]), p3 = "", f2 = "";
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u2 in m3) {
      let g2 = m3[u2], f2 = ve(g2), p3 = G2(u2, a2) ? Q2(d2) : Q2(d2, re(u2));
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R2, T2, j2, O3, M2, z3, V2;
  let { preset: a2, options: n2 } = t2, l3, o, c4, m3, d2, u2, g2;
  if (s2(a2) && n2.transform !== "strict") {
    let { primitive: L, semantic: te2, extend: re2 } = a2, f2 = te2 || {}, { colorScheme: K2 } = f2, A2 = v2(f2, ["colorScheme"]), x3 = re2 || {}, { colorScheme: X2 } = x3, G3 = v2(x3, ["colorScheme"]), p3 = K2 || {}, { dark: U2 } = p3, B2 = v2(p3, ["dark"]), y3 = X2 || {}, { dark: I2 } = y3, H2 = v2(y3, ["dark"]), W2 = s2(L) ? this._toVariables({ primitive: L }, n2) : {}, q2 = s2(A2) ? this._toVariables({ semantic: A2 }, n2) : {}, Z2 = s2(B2) ? this._toVariables({ light: B2 }, n2) : {}, pe = s2(U2) ? this._toVariables({ dark: U2 }, n2) : {}, fe = s2(G3) ? this._toVariables({ semantic: G3 }, n2) : {}, ye = s2(H2) ? this._toVariables({ light: H2 }, n2) : {}, Se = s2(I2) ? this._toVariables({ dark: I2 }, n2) : {}, [Me, ze] = [(R2 = W2.declarations) != null ? R2 : "", W2.tokens], [Ke, Xe] = [(T2 = q2.declarations) != null ? T2 : "", q2.tokens || []], [Ge, Ue] = [(j2 = Z2.declarations) != null ? j2 : "", Z2.tokens || []], [Be, Ie] = [(O3 = pe.declarations) != null ? O3 : "", pe.tokens || []], [He, We] = [(M2 = fe.declarations) != null ? M2 : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V2 = Se.declarations) != null ? V2 : "", Se.tokens || []];
    ...
    let et2 = this.transformCSS(e, `${He}${qe}color-scheme:light`, "light", "variable", n2, s4, i3), tt2 = this.transformCSS(e, `${Fe}color-scheme:dark`, "dark", "variable", n2, s4, i3);
    d2 = `${et2}${tt2}`, u2 = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g2 = m2(a2.css, { dt: E2 });
  }
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m3 = t2, { colorScheme: R2, extend: T2, css: j2 } = m3, O3 = v2(m3, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M2 } = d2, z3 = v2(d2, ["colorScheme"]), u2 = R2 || {}, { dark: V2 } = u2, L = v2(u2, ["dark"]), g2 = M2 || {}, { dark: te2 } = g2, re2 = v2(g2, ["dark"]), K2 = s2(O3) ? this._toVariables({ [y3]: h3(h3({}, O3), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y3]: h3(h3({}, L), re2) }, r) : {}, X2 = s2(V2) ? this._toVariables({ [y3]: h3(h3({}, V2), te2) }, r) : {}, [G3, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H2, W2] = [(p3 = X2.declarations) != null ? p3 : "", X2.tokens || []], q2 = this.transformCSS(y3, `${G3}${B2}`, "light", "variable", r, i3, a2, n2), Z2 = this.transformCSS(y3, H2, "dark", "variable", r, i3, a2, n2);
    l3 = `${q2}${Z2}`, o = [.../* @__PURE__ */ new Set([...U2, ...I2, ...W2])], c4 = m2(j2, { dt: E2 });
  }
  ...
  let a2 = function(l3, o = {}, c4 = []) {
    ...
    Object.entries(l3).forEach(([m3, d2]) => {
      ...
      i2(d2) ? n2(d2, u2, g2) : (i3[u2] || (i3[u2] = { paths: [], computed: (f2, x3 = {}, p3 = []) => {
...
var BaseStyle = class _BaseStyle {
  ...
  load = (style4, options = {}, transform = (cs) => cs) => {
    const computedStyle = transform(ar`${m2(style4, {
      dt: E2
    })}`);
...
//# sourceMappingURL=chunk-J2ANZLF2.js.map
