...
function VendorDetailsContainerComponent_Conditional_3_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, VendorDetailsContainerComponent_Conditional_3_For_8_ng_container_0_Template, 1, 0, "ng-container", 11);
...
function VendorDetailsContainerComponent_Conditional_3_Conditional_9_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, VendorDetailsContainerComponent_Conditional_3_Conditional_9_For_6_ng_container_0_Template, 1, 0, "ng-container", 11);
...
function VendorDetailsContainerComponent_Conditional_3_Conditional_10_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, VendorDetailsContainerComponent_Conditional_3_Conditional_10_For_6_ng_container_0_Template, 1, 0, "ng-container", 11);
...
function VendorDetailsContainerComponent_Conditional_3_Conditional_11_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, VendorDetailsContainerComponent_Conditional_3_Conditional_11_For_6_ng_container_0_Template, 1, 0, "ng-container", 11);
...
function VendorDetailsContainerComponent_Conditional_3_Conditional_12_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, VendorDetailsContainerComponent_Conditional_3_Conditional_12_For_6_ng_container_0_Template, 1, 0, "ng-container", 11);
...
var VendorDetailsContainerComponent = class _VendorDetailsContainerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VendorDetailsContainerComponent, selectors: [["app-vendor-details-container"]], decls: 4, vars: 3, consts: [[1, "admin-details-container", "h-full", "flex", "flex-col"], [1, "loading-container"], [1, "error-container"], [1, "details-container", "h-full", "flex", "flex-col", "overflow-hidden"], [1, "error-message"], ["value", "information"], [1, "uppercase"], ["value", "settings"], ["value", "limits"], ["value", "statistics"], ["value", "changes"], [4, "ngComponentOutlet", "ngComponentOutletInputs"]], template: function VendorDetailsContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(3, VendorDetailsContainerComponent_Conditional_3_Template, 13, 4, "div", 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VendorDetailsContainerComponent, { className: "VendorDetailsContainerComponent", filePath: "src/app/features/administration/components/vendors/vendor-details/vendor-details-container/vendor-details-container.component.ts", lineNumber: 68 });
})();
...
//# sourceMappingURL=chunk-QDFM5LPA.js.map
