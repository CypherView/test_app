...
function TreeTableComponent_ng_template_4_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, TreeTableComponent_ng_template_4_For_2_Conditional_3_Conditional_1_Template, 1, 1)(2, TreeTableComponent_ng_template_4_For_2_Conditional_3_Conditional_2_Template, 1, 1);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const col_r5 = \u0275\u0275nextContext().$implicit;
...
function TreeTableComponent_ng_template_4_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275template(1, TreeTableComponent_ng_template_4_For_2_Conditional_1_Template, 1, 1, "p-treeTableToggler", 8)(2, TreeTableComponent_ng_template_4_For_2_Conditional_2_Template, 1, 6, "ng-container", 9)(3, TreeTableComponent_ng_template_4_For_2_Conditional_3_Template, 3, 1, "ng-container");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
  ...
  loadEntityDetails(entityType, entityId) {
    ...
    try {
      ...
      entityService.getById(entityId).pipe(takeUntilDestroyed(this.destroyRef), finalize(() => this.stateService.isLoading.set(false))).subscribe({
        next: (item) => this.handleLoadSuccess(item, entityType, component),
        error: () => this.handleLoadError(entityType)
      });
    } catch (error) {
      ...
      this.messageService.add({
        severity: "error",
        summary: "Error",
        detail: `Failed to load ${entityType} details: ${error}`
      });
    }
  }
  /**
...
//# sourceMappingURL=chunk-3V5E6W6R.js.map
