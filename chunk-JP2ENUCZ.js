...
} from "./chunk-DCN557H4.js";
import "./chunk-SPOQ75GW.js";
import "./chunk-AYV72OLH.js";
import "./chunk-NDLTOK4H.js";
import "./chunk-2TNJGDYW.js";
import "./chunk-MLSXVC7L.js";
import "./chunk-6YA2H5H4.js";
import "./chunk-A656OLHR.js";
...
var DualApiService = class _DualApiService {
  ...
  httpNoInterceptors = new HttpClient(inject(HttpBackend));
  ...
  keyApiTokenObs = null;
  getKeyApiToken() {
    if (isDefined(this.keyApiToken)) {
      return of(this.keyApiToken);
    }
    this.keyApiTokenObs ??= this.authenticateKeyApi().pipe(tap(() => {
      this.keyApiTokenObs = null;
    }), shareReplay(1));
    return this.keyApiTokenObs;
  }
  /**
  ...
  authenticateKeyApi() {
    ...
    return this.httpNoInterceptors.post(authUrl, {
      ...
      const message = error.status === 401 ? "Invalid Key Telematics credentials. Please check your username and password." : error.status === 404 ? "Key Telematics authentication endpoint not found." : "Failed to connect to Key Telematics API. Please try again.";
      this.toastService.showError("Key Telematics Auth Failed", message);
      throw error;
    }));
  }
  /**
  ...
  searchKeyApiVehicleByDeviceName(deviceName) {
    return this.getKeyApiToken().pipe(switchMap((token) => {
      ...
      return this.httpNoInterceptors.get(url, {
        headers,
        params
      });
    }), map((response) => {
...
//# sourceMappingURL=chunk-JP2ENUCZ.js.map
