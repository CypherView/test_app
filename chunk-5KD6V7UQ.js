...
function ClientSelectionFormComponent_Conditional_9_For_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 18);
    \u0275\u0275listener("click", function ClientSelectionFormComponent_Conditional_9_For_7_Template_button_click_0_listener() {
      const client_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.selectRecentClient(client_r2));
    })("focus", function ClientSelectionFormComponent_Conditional_9_For_7_Template_button_focus_0_listener() {
      const \u0275$index_30_r4 = \u0275\u0275restoreView(_r1).$index;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onItemFocus(ctx_r2.getRecentClientIndex(\u0275$index_30_r4)));
    });
    \u0275\u0275elementStart(1, "span", 19)(2, "img", 20);
    \u0275\u0275listener("error", function ClientSelectionFormComponent_Conditional_9_For_7_Template_img_error_2_listener($event) {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("focused", ctx_r2.isItemFocused(ctx_r2.getRecentClientIndex(\u0275$index_30_r4)));
    \u0275\u0275property("tabindex", ctx_r2.getItemTabIndex(ctx_r2.getRecentClientIndex(\u0275$index_30_r4)));
    \u0275\u0275attribute("aria-label", "Select recently used client: " + client_r2.name)("aria-selected", false);
    \u0275\u0275advance();
    \u0275\u0275attribute("data-color", ctx_r2.getClientColor(client_r2.name));
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r2.getClientLogoUrl(client_r2.id), \u0275\u0275sanitizeUrl)("alt", client_r2.name + " logo");
    \u0275\u0275advance(2);
...
function ClientSelectionFormComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(6, ClientSelectionFormComponent_Conditional_9_For_7_Template, 7, 10, "button", 15, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "div", 16);
...
function ClientSelectionFormComponent_Conditional_13_For_2_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(client_r6.owner.name);
  }
}
function ClientSelectionFormComponent_Conditional_13_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 26);
    \u0275\u0275listener("click", function ClientSelectionFormComponent_Conditional_13_For_2_Template_div_click_0_listener() {
      const client_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.selectClient(client_r6));
    })("focus", function ClientSelectionFormComponent_Conditional_13_For_2_Template_div_focus_0_listener() {
      const \u0275$index_66_r7 = \u0275\u0275restoreView(_r5).$index;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onItemFocus(ctx_r2.getClientCardIndex(\u0275$index_66_r7)));
    });
    \u0275\u0275elementStart(1, "div", 27)(2, "img", 20);
    \u0275\u0275listener("error", function ClientSelectionFormComponent_Conditional_13_For_2_Template_img_error_2_listener($event) {
      \u0275\u0275restoreView(_r5);
      return \u0275\u0275resetView($event.target.style.display = "none");
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ClientSelectionFormComponent_Conditional_13_For_2_Conditional_8_Template, 2, 1, "div", 30);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const \u0275$index_66_r7 = ctx.$index;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("focused", ctx_r2.isItemFocused(ctx_r2.getClientCardIndex(\u0275$index_66_r7)));
    \u0275\u0275property("id", "client-card-" + ctx_r2.getClientCardIndex(\u0275$index_66_r7))("tabindex", ctx_r2.getItemTabIndex(ctx_r2.getClientCardIndex(\u0275$index_66_r7)));
    \u0275\u0275attribute("aria-label", "Select " + client_r6.name + ((client_r6.owner == null ? null : client_r6.owner.name) ? ", owned by " + client_r6.owner.name : ""))("aria-selected", false)("aria-posinset", \u0275$index_66_r7 + 1)("aria-setsize", ctx_r2.filteredClients().length);
    \u0275\u0275advance();
    \u0275\u0275attribute("data-color", ctx_r2.getClientColor(client_r6.name));
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r2.getClientLogoUrl(client_r6.id), \u0275\u0275sanitizeUrl)("alt", client_r6.name + " logo");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(client_r6.name.charAt(0).toUpperCase());
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(client_r6.name);
    \u0275\u0275advance();
    \u0275\u0275conditional((client_r6.owner == null ? null : client_r6.owner.name) ? 8 : -1);
  }
}
function ClientSelectionFormComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275repeaterCreate(1, ClientSelectionFormComponent_Conditional_13_For_2_Template, 11, 14, "div", 25, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275attribute("aria-activedescendant", ctx_r2.focusedIndex() >= 0 ? "client-card-" + ctx_r2.focusedIndex() : null);
    \u0275\u0275advance();
...
var ClientSelectionFormComponent = class _ClientSelectionFormComponent {
  ...
  /** Total number of navigable items (recent clients chips + client cards) */
  totalNavigableItems = computed(() => {
    const recentCount = this.showRecentSection() ? this.recentClients().length : 0;
    const clientCount = this.filteredClients().length;
  ...
  onKeyDown(event) {
    ...
    switch (event.key) {
      case "ArrowDown":
        if (currentIndex < 0) {
          newIndex = 0;
        } else if (currentIndex < recentCount) {
          newIndex = recentCount;
        } else {
          newIndex = Math.min(currentIndex + columnsCount, totalItems - 1);
        }
        handled = true;
        break;
      case "ArrowUp":
        if (currentIndex >= recentCount && currentIndex < recentCount + columnsCount) {
          newIndex = recentCount > 0 ? recentCount - 1 : currentIndex;
        } else if (currentIndex >= recentCount) {
          newIndex = Math.max(currentIndex - columnsCount, recentCount);
  ...
  /**
   * Calculate the global index for a client card
   */
  getClientCardIndex(localIndex) {
    const recentCount = this.showRecentSection() ? this.recentClients().length : 0;
    return recentCount + localIndex;
  }
  /** Setup keyboard event listener on the component */
  setupKeyboardNavigation() {
    this.keyboardListener = (event) => this.onKeyDown(event);
  ...
  selectItemAtIndex(index) {
    ...
    if (index < recentCount) {
      ...
      if (client !== void 0) {
        this.selectRecentClient(client);
      }
    } else {
  ...
  announceToScreenReader(message) {
    const liveRegion = document.getElementById("client-selection-live-region");
    if (liveRegion) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClientSelectionFormComponent, selectors: [["app-client-selection-form"]], inputs: { clients: [1, "clients"], loading: [1, "loading"], useServerSearch: [1, "useServerSearch"], totalRecords: [1, "totalRecords"], enablePagination: [1, "enablePagination"], enableLazyLoad: [1, "enableLazyLoad"], recentClients: [1, "recentClients"] }, outputs: { clientSelected: "clientSelected", searchQuery: "searchQuery", lazyLoad: "lazyLoad" }, decls: 14, vars: 4, consts: [[1, "client-selection-form", 2, "display", "flex", "flex-direction", "column", "max-height", "50vh"], ["id", "client-selection-live-region", "aria-live", "polite", "aria-atomic", "true", 1, "sr-only"], [2, "flex-shrink", "0", "margin-bottom", "0.75rem"], ["pInputText", "", "placeholder", "Search clients...", "aria-label", "Search clients", "aria-describedby", "client-count-description", 1, "w-full", 3, "ngModelChange", "ngModel"], [1, "pi", "pi-search"], ["id", "client-count-description", 1, "sr-only"], [2, "flex", "1", "min-height", "0", "display", "flex", "flex-direction", "column"], [1, "recent-clients-section", "mb-4", "flex-shrink-0"], [1, "flex-1", "min-h-0", "w-full", "overflow-y-auto"], [1, "client-cards-loading", "flex", "items-center", "justify-center", "h-full"], [1, "client-cards-empty", "flex", "flex-col", "items-center", "justify-center", "h-full", "text-[var(--text-color-secondary)]"], ["role", "listbox", "aria-label", "Available clients", 1, "client-cards-grid"], [1, "recent-clients-header", "text-sm", "font-medium", "text-gray-400", "mb-2", "flex", "items-center", "gap-2"], [1, "pi", "pi-history"], ["role", "listbox", "aria-label", "Recently used clients", 1, "recent-clients-chips"], ["type", "button", "role", "option", 1, "recent-client-chip", 3, "focused", "tabindex"], [1, "border-b", "border-[var(--surface-border)]", "mt-4", "mb-3"], [1, "text-sm", "font-medium", "text-gray-400", "mb-2"], ["type", "button", "role", "option", 1, "recent-client-chip", 3, "click", "focus", "tabindex"], ["aria-hidden", "true", 1, "recent-client-chip-avatar"], [1, "client-logo-img", 3, "error", "src", "alt"], [1, "client-logo-fallback"], [1, "recent-client-chip-name"], [1, "pi", "pi-spin", "pi-spinner", "text-2xl", "text-[var(--primary-color)]"], [1, "pi", "pi-inbox", "text-4xl", "mb-2"], ["role", "option", 1, "client-card", 3, "focused", "id", "tabindex"], ["role", "option", 1, "client-card", 3, "click", "focus", "id", "tabindex"], ["aria-hidden", "true", 1, "client-card-avatar"], [1, "client-card-content"], [1, "client-card-name"], [1, "client-card-owner"], ["aria-hidden", "true", 1, "client-card-action"], [1, "pi", "pi-chevron-right"]], template: function ClientSelectionFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "div", 1);
      \u0275\u0275elementStart(2, "div", 2)(3, "p-iconfield")(4, "input", 3);
      \u0275\u0275listener("ngModelChange", function ClientSelectionFormComponent_Template_input_ngModelChange_4_listener($event) {
      ...
      \u0275\u0275conditionalCreate(9, ClientSelectionFormComponent_Conditional_9_Template, 11, 0, "div", 7);
      \u0275\u0275elementStart(10, "div", 8);
      \u0275\u0275conditionalCreate(11, ClientSelectionFormComponent_Conditional_11_Template, 2, 0, "div", 9)(12, ClientSelectionFormComponent_Conditional_12_Template, 4, 0, "div", 10)(13, ClientSelectionFormComponent_Conditional_13_Template, 3, 1, "div", 11);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
...
(() => {
  ...
  <div style="flex-shrink: 0; margin-bottom: 0.75rem;">
    <p-iconfield>
      <input
        pInputText
        [ngModel]="search()"
        (ngModelChange)="search.set($event); onSearchInput($event)"
    ...
    <div id="client-count-description" class="sr-only">
  ...
  <div style="flex: 1; min-height: 0; display: flex; flex-direction: column;">
      <!-- Recently Used Section - Horizontal Pills/Chips Layout -->
      @if (showRecentSection()) {
        <div class="recent-clients-section mb-4 flex-shrink-0">
          <div class="recent-clients-header text-sm font-medium text-gray-400 mb-2 flex items-center gap-2">
            <i class="pi pi-history"></i>
            <span>Recently Used</span>
          </div>
          <div class="recent-clients-chips" role="listbox" aria-label="Recently used clients">
            @for (client of recentClients(); track client.id; let i = $index) {
              ...
              >
                <span class="recent-client-chip-avatar" [attr.data-color]="getClientColor(client.name)" aria-hidden="true">
                  <img
                    [src]="getClientLogoUrl(client.id)"
                    [alt]="client.name + ' logo'"
                    class="client-logo-img"
                    (error)="$any($event.target).style.display='none'"
                  />
                  <span class="client-logo-fallback">{{ client.name.charAt(0).toUpperCase() }}</span>
                </span>
      ...
      <div class="flex-1 min-h-0 w-full overflow-y-auto">
        @if (loading()) {
          <div class="client-cards-loading flex items-center justify-center h-full">
            <i class="pi pi-spin pi-spinner text-2xl text-[var(--primary-color)]"></i>
          </div>
        } @else if (filteredClients().length === 0) {
          <div class="client-cards-empty flex flex-col items-center justify-center h-full text-[var(--text-color-secondary)]">
            <i class="pi pi-inbox text-4xl mb-2"></i>
            <span>No clients found</span>
          </div>
        } @else {
          <div
            class="client-cards-grid"
            role="listbox"
            aria-label="Available clients"
            [attr.aria-activedescendant]="focusedIndex() >= 0 ? 'client-card-' + focusedIndex() : null"
          >
            @for (client of filteredClients(); track client.id; let i = $index) {
              <div
                ...
                role="option"
                [attr.aria-label]="'Select ' + client.name + (client.owner?.name ? ', owned by ' + client.owner.name : '')"
                [attr.aria-selected]="false"
                [attr.aria-posinset]="i + 1"
                [attr.aria-setsize]="filteredClients().length"
              >
                <div class="client-card-avatar" [attr.data-color]="getClientColor(client.name)" aria-hidden="true">
                  <img
                    [src]="getClientLogoUrl(client.id)"
                    [alt]="client.name + ' logo'"
                    class="client-logo-img"
                ...
                <div class="client-card-content">
                  ...
                  @if (client.owner?.name) {
                    <div class="client-card-owner">{{ client.owner.name }}</div>
                  }
                </div>
                <div class="client-card-action" aria-hidden="true">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientSelectionFormComponent, { className: "ClientSelectionFormComponent", filePath: "src/app/shared/components/client-selection-form/client-selection-form.component.ts", lineNumber: 33 });
})();
...
function ClientSelectorComponent_Conditional_12_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-label", "Select " + account_r2.name + ((account_r2.owner == null ? null : account_r2.owner.name) ? ", " + \u0275\u0275pipeBind1(1, 8, account_r2.owner.type) + ": " + account_r2.owner.name : ""))("aria-selected", false)("aria-posinset", \u0275$index_31_r4 + 1)("aria-setsize", ctx_r2.filteredAccounts().length);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", account_r2.name.charAt(0).toUpperCase(), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(account_r2.name);
    \u0275\u0275advance();
    \u0275\u0275conditional((account_r2.owner == null ? null : account_r2.owner.name) ? 7 : -1);
  }
}
function ClientSelectorComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9);
    \u0275\u0275repeaterCreate(1, ClientSelectorComponent_Conditional_12_For_2_Template, 10, 10, "div", 11, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
(() => {
  ...
  <div
    [class]="
      'flex flex-col w-full overflow-y-auto rounded ' +
      maxHeightClass()
    "
  >
    @if (filteredAccounts().length === 0) {
      <div class="account-cards-empty flex flex-col items-center justify-center py-8 text-[var(--text-color-secondary)]">
        <i class="pi pi-inbox text-4xl mb-2"></i>
      ...
      >
        @for (account of filteredAccounts(); track account.id; let i = $index) {
          <div
            ...
            tabindex="0"
            role="option"
            [attr.aria-label]="'Select ' + account.name + (account.owner?.name ? ', ' + (account.owner.type | titlecase) + ': ' + account.owner.name : '')"
            [attr.aria-selected]="false"
            [attr.aria-posinset]="i + 1"
...
var ThemeComponent = class _ThemeComponent {
  ...
  constructor() {
    effect(() => {
      ...
      if (isDefined(clientToUse) && clientToUse.id !== this.previousClientId) {
        this.updateTheme(this.getThemeId(clientToUse));
...
css-vars-ponyfill/dist/css-vars-ponyfill.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5KD6V7UQ.js.map
