import {
  WizardComponent
} from "./chunk-M732BHA6.js";
import {
  ClientSelectorComponent,
  ThemeComponent,
  userProfileResolver
} from "./chunk-V3RFX5FU.js";
import {
  ToastService
} from "./chunk-ZP5P7TRC.js";
import {
  GridComponent
} from "./chunk-PJZ36SSD.js";
import {
  ApiSchemaService,
  DynamicFormComponent,
  Password,
  PasswordModule
} from "./chunk-KJZZSJAL.js";
import {
  UtilityService
} from "./chunk-JAYLIL6Q.js";
import {
  BaseComponent,
  BaseStyle,
  Bind,
...
var ClientSelectionFormComponent = class _ClientSelectionFormComponent {
  ...
  ngOnInit() {
    this.columns.set([{ field: "name", header: "Name" }]);
  }
  constructor() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClientSelectionFormComponent, selectors: [["app-client-selection-form"]], inputs: { clients: [1, "clients"], loading: [1, "loading"], useServerSearch: [1, "useServerSearch"], totalRecords: [1, "totalRecords"], enablePagination: [1, "enablePagination"], enableLazyLoad: [1, "enableLazyLoad"] }, outputs: { clientSelected: "clientSelected", searchQuery: "searchQuery", lazyLoad: "lazyLoad" }, decls: 8, vars: 11, consts: [[1, "space-y-4"], [1, "space-y-3"], ["pInputText", "", "placeholder", "Search clients...", 1, "w-full", 3, "ngModelChange", "ngModel"], [1, "pi", "pi-search"], [1, "h-[50vh]", "flex", "flex-col"], [1, "flex-1", "min-h-0", "w-full", "overflow-hidden"], ["styleClass", "table-height", 1, "h-full", "max-w-full", 3, "onLazyLoad", "rowSelect", "columns", "data", "pagination", "totalRecords", "lazy", "selectionMode", "hideHeader", "loading", "scrollable", "scrollHeight"]], template: function ClientSelectionFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "p-iconfield")(3, "input", 2);
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "div", 4)(6, "div", 5)(7, "app-grid", 6);
      \u0275\u0275listener("onLazyLoad", function ClientSelectionFormComponent_Template_app_grid_onLazyLoad_7_listener($event) {
        return ctx.onLazyLoad($event);
      })("rowSelect", function ClientSelectionFormComponent_Template_app_grid_rowSelect_7_listener($event) {
        return ctx.selectClient($event.data);
      });
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("columns", ctx.columns())("data", ctx.filteredClients())("pagination", ctx.enablePagination())("totalRecords", ctx.totalRecords())("lazy", ctx.enableLazyLoad())("selectionMode", "single")("hideHeader", true)("loading", ctx.loading())("scrollable", true)("scrollHeight", "flex");
    }
  }, dependencies: [FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, InputTextModule, InputText, InputIcon, IconField, GridComponent], styles: ["\n\n.client-selection-form[_ngcontent-%COMP%]   .accounts[_ngcontent-%COMP%]   .meta[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n  line-height: 1rem;\n  --tw-text-opacity: 1;\n  color: rgb(107 114 128 / var(--tw-text-opacity, 1));\n}\n/*# sourceMappingURL=client-selection-form.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ClientSelectionFormComponent, [{
    type: Component,
    args: [{ selector: "app-client-selection-form", standalone: true, imports: [FormsModule, InputTextModule, InputIcon, IconField, GridComponent], template: `<div class="space-y-4">
  <div class="space-y-3">
    <p-iconfield>
      <input
        pInputText
...
`, styles: ["/* src/app/shared/components/client-selection-form/client-selection-form.component.scss */\n.client-selection-form .accounts .meta {\n  font-size: 0.75rem;\n  line-height: 1rem;\n  --tw-text-opacity: 1;\n  color: rgb(107 114 128 / var(--tw-text-opacity, 1));\n}\n/*# sourceMappingURL=client-selection-form.component.css.map */\n"] }]
  }], () => [], { clients: [{ type: Input, args: [{ isSignal: true, alias: "clients", required: false }] }], loading: [{ type: Input, args: [{ isSignal: true, alias: "loading", required: false }] }], useServerSearch: [{ type: Input, args: [{ isSignal: true, alias: "useServerSearch", required: false }] }], totalRecords: [{ type: Input, args: [{ isSignal: true, alias: "totalRecords", required: false }] }], enablePagination: [{ type: Input, args: [{ isSignal: true, alias: "enablePagination", required: false }] }], enableLazyLoad: [{ type: Input, args: [{ isSignal: true, alias: "enableLazyLoad", required: false }] }], clientSelected: [{ type: Output, args: ["clientSelected"] }], searchQuery: [{ type: Output, args: ["searchQuery"] }], lazyLoad: [{ type: Output, args: ["lazyLoad"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientSelectionFormComponent, { className: "ClientSelectionFormComponent", filePath: "src/app/shared/components/client-selection-form/client-selection-form.component.ts", lineNumber: 30 });
})();
...
function ContextSelectionWizardComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 8)(1, "div", 12);
    \u0275\u0275conditionalCreate(2, ContextSelectionWizardComponent_ng_template_6_Conditional_2_Template, 2, 0, "p", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "app-client-selection-form", 15);
    \u0275\u0275listener("clientSelected", function ContextSelectionWizardComponent_ng_template_6_Template_app_client_selection_form_clientSelected_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onClientSelected($event));
    })("searchQuery", function ContextSelectionWizardComponent_ng_template_6_Template_app_client_selection_form_searchQuery_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onClientSearch($event));
    })("lazyLoad", function ContextSelectionWizardComponent_ng_template_6_Template_app_client_selection_form_lazyLoad_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.loadingClients() && ctx_r2.availableClients().length === 0 ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("clients", ctx_r2.availableClients())("loading", ctx_r2.loadingClients())("useServerSearch", ctx_r2.useServerSearch())("totalRecords", ctx_r2.totalClientCount())("enablePagination", ctx_r2.useServerSearch())("enableLazyLoad", ctx_r2.useServerSearch());
  }
}
var ROUTES = {
  LOGIN: ["/auth", "login"],
...
var ContextSelectionWizardComponent = class _ContextSelectionWizardComponent {
  ...
  // Determine if we should use server-side search based on total count
  useServerSearch = computed(() => this.totalClientCount() >= DEFAULT_PAGE_SIZE, ...ngDevMode ? [{ debugName: "useServerSearch" }] : []);
  ...
  async handleClientSelectionFlow(account) {
    ...
    const defaultClientId = account?.defaultClient?.id;
  ...
  attemptAutoSelectClient(clientId) {
    this.clientsService.getClient(clientId).pipe(takeUntilDestroyed(this.destroyRef), finalize(() => this.isSubmitting.set(false))).subscribe({
      next: (client) => {
  ...
  finalizeClientSelection(client) {
    ...
    this.router.navigate(ROUTES.POSITION).catch(() => {
    });
  }
  ...
  loadClientsForAccount(searchTerm = "") {
    ...
    if (searchTerm.trim() === "" && this.cachedEmptyClients.length > 0) {
      this.availableClients.set(this.cachedEmptyClients);
      this.totalClientCount.set(this.cachedEmptyTotal);
      this.clientsOffset = this.cachedEmptyOffset;
      this.loadingClients.set(false);
      this.cdr.detectChanges();
      return;
    }
    const selectedAccount = this.selectedAccount();
    if (!isDefined(selectedAccount?.owner?.id)) {
      console.warn("Owner ID not found in selected account");
      this.fallbackToDefaultClient();
      return;
    }
    const ownerId = selectedAccount.owner.id;
    const filters = {
      state: {
        value: CONSTANTS.ACTIVE_STATE,
        operator: "="
      }
    };
    if (searchTerm.trim() !== "") {
    ...
    this.clientsService.listClients(ownerId, 0, this.pageSize, CONSTANTS.SORT_ORDER, rqlFilter).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (data) => {
        if (isDefined(data) && hasProperty(data, "items") && hasProperty(data, "count")) {
          const items = data.items ?? [];
          this.availableClients.set(items);
          this.clientsOffset = 0;
          this.totalClientCount.set(data.count);
          if (searchTerm.trim() === "") {
            this.cachedEmptyClients = items;
            this.cachedEmptyTotal = data.count ?? items.length;
            this.cachedEmptyOffset = 0;
          }
        } else {
  ...
  onClientSearch(searchTerm) {
    this.currentSearchTerm = searchTerm;
    if (this.useServerSearch()) {
      this.onLazyLoadClients({ first: 0, rows: this.pageSize });
    }
  }
  onLazyLoadClients(event) {
    const offset = event.first ?? 0;
    const ownerId = this.selectedAccount()?.owner?.id;
    ...
    this.clientsService.listClients(ownerId, offset, pageSize, CONSTANTS.SORT_ORDER, rqlFilter).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (data) => {
        if (isDefined(data) && hasProperty(data, "items") && hasProperty(data, "count")) {
          this.availableClients.set(data.items ?? []);
          this.totalClientCount.set(data.count);
          this.clientsOffset = offset;
        } else {
          console.warn("Invalid response data structure");
        }
        this.loadingClients.set(false);
  ...
  fallbackToDefaultClient() {
    const selectedAccount = this.selectedAccount();
    const defaultClientId = selectedAccount?.defaultClient?.id;
    if (isDefined(defaultClientId)) {
      console.warn("Attempting to proceed with default client due to loading failure");
      this.isSubmitting.set(true);
      this.clientsService.getClient(defaultClientId).pipe(takeUntilDestroyed(this.destroyRef), finalize(() => this.isSubmitting.set(false))).subscribe({
        next: (client) => {
          this.uiMessageService.add({
            severity: "info",
            summary: "Notice",
  ...
  }, decls: 12, vars: 7, consts: [["accountSelectionStep", ""], ["clientSelectionStep", ""], [1, "panel", "login-box", "flex", "flex-col", "w-full", "max-w-[700px]", "mx-auto", "pb-8"], [1, "bg-[var(--main-background-color)]", "p-6", "rounded-border", "shadow-card", "justify-start", "rounded-none"], ["header", "Context Selection", 3, "onCancel", "visibleChange", "visible", "steps", "useWizardButtonsOnly", "showFooterButtons", "loading", "contentOnly"], [1, "!text-white", "pt-4", "underline", "cursor-pointer", "self-center", 3, "click"], [1, "!text-white", "self-center"], [1, "flex", "flex-col", "items-center", "w-full"], [1, "w-full"], [1, "flex", "flex-col", "items-center", "gap-3", "mt-6"], ["styleClass", "w-10 h-10 text-primary-500"], [1, "text-sm", "text-gray-500"], [1, "text-center", "mb-8"], [1, "text-sm", "text-gray-400", "text-center", "mt-2"], [3, "accountSelected", "clientAccounts", "maxHeightClass"], [3, "clientSelected", "searchQuery", "lazyLoad", "clients", "loading", "useServerSearch", "totalRecords", "enablePagination", "enableLazyLoad"]], template: function ContextSelectionWizardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(4, ContextSelectionWizardComponent_ng_template_4_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(6, ContextSelectionWizardComponent_ng_template_6_Template, 4, 7, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ContextSelectionWizardComponent, [{
    ...
    args: [{ selector: "app-context-selection-wizard", imports: [
      ...
      ThemeComponent,
      ProgressSpinnerModule
    ], template: `<div class="panel login-box flex flex-col w-full max-w-[700px] mx-auto pb-8">
  <div
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContextSelectionWizardComponent, { className: "ContextSelectionWizardComponent", filePath: "src/app/features/auth/components/context-selection-wizard/context-selection-wizard.component.ts", lineNumber: 78 });
})();
...
var LoginComponent = class _LoginComponent {
        ...
        void (async () => {
          try {
            ...
            if (result.users.length > 1) {
              await this.router.navigate(["/auth", "select-client"], {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 11, vars: 4, consts: [[1, "panel", "login-box", "flex", "flex-col", "items-stretch", "w-full", "max-w-[700px]", "mx-auto", "pb-8"], [1, "bg-white", "p-[15px_34px_35px]", "justify-start", "rounded-none"], [1, "flex", "flex-col"], [1, "mt-8", "text-[1.62rem]", "font-normal", "leading-[2.25]", "text-center", "!text-gray-500"], [1, "mx-12", "mt-10", "flex", "flex-col", "items-center", "gap-6"], [1, "!text-white", "pt-4", "underline", "cursor-pointer", "self-center", 3, "routerLink"], [1, "!text-white", "self-center"], [1, "text-center", "text-gray-600"], ["styleClass", "w-[120px] h-[50px] !text-white rounded border-none !bg-[#378bc0]", 3, "loading", "disabled"], [1, "mx-12", "mt-6"], [1, "mx-12", "mt-10", 3, "ngSubmit", "formGroup"], [1, "grid", "gap-6"], ["id", "username", "pInputText", "", "formControlName", "username", 1, "w-full", 3, "autocomplete"], ["for", "username"], ["formControlName", "password", 1, "w-full", 3, "feedback", "toggleMask", "autocomplete"], ["for", "password"], [1, "flex", "justify-center", "items-center", "my-6"], ["styleClass", "w-[120px] h-[50px] !text-white rounded border-none !bg-[#378bc0]", "type", "submit", 3, "disabled", "loading"], ["severity", "error"], ["for", "apiUrl"], ["id", "apiUrl", "formControlName", "apiUrl", "optionLabel", "label", "optionValue", "value", 1, "w-full", 3, "onChange", "options"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var ResetPasswordWelcomeComponent = class _ResetPasswordWelcomeComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResetPasswordWelcomeComponent, selectors: [["app-reset-password-welcome"]], decls: 14, vars: 5, consts: [[1, "wrapper", "bg-cover", "bg-center", "h-screen"], [1, "panel", "login-box", "flex", "flex-col", "items-stretch", "w-full", "max-w-[700px]", "mx-auto"], [1, "bg-white", "p-[15px_34px]", "mb-4"], [1, "p-2", "flex", "flex-col"], [1, "text-2xl", "font-semibold", "m-0", "pb-1"], [1, "py-2", "muted"], [3, "fields", "actions"], [1, "!text-white", "underline", "cursor-pointer", "self-center", 3, "routerLink"], [1, "!text-white", "self-center"]], template: function ResetPasswordWelcomeComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  ...
  <div
    class="panel login-box flex flex-col items-stretch w-full max-w-[700px] mx-auto"
  >
...
//# sourceMappingURL=chunk-HYB4QNS2.js.map
