import{C as S,F as oe,K as pe,Ka as R,a as m,b as F,d as k,k as f,ma as he,na as E,ra as ue,w as ae}from"./chunk-TOHZAKMW.js";import{Ab as P,Ac as Z,Cb as y,Cc as ee,Ea as C,Mb as d,Nb as h,Pb as j,Qb as K,Rb as T,Wc as I,Yc as te,Zb as g,_b as v,cc as U,da as A,dc as H,ea as B,fa as O,fc as M,gc as l,hc as q,ic as X,jb as c,ka as Q,kd as ie,lc as L,mc as Y,md as ne,nc as x,nd as se,oc as w,pc as J,qc as W,qd as re,rb as G,rd as le,ua as o,va as p,vd as V,wb as b,xb as N,xd as D,ya as _}from"./chunk-XL4EU3MI.js";var de=["*"],ge=["panel"],me=["container"],fe=n=>({display:"flex","flex-wrap":"nowrap","flex-direction":n});function Se(n,z){n&1&&U(0)}function ze(n,z){if(n&1){let e=H();g(0,"div",6),M("mousedown",function(i){o(e);let s=l().index,r=l();return p(r.onGutterMouseDown(i,s))})("touchstart",function(i){o(e);let s=l().index,r=l();return p(r.onGutterTouchStart(i,s))})("touchmove",function(i){o(e);let s=l(2);return p(s.onGutterTouchMove(i))})("touchend",function(i){o(e);let s=l(2);return p(s.onGutterTouchEnd(i))}),g(1,"div",7),M("keyup",function(i){o(e);let s=l(2);return p(s.onGutterKeyUp(i))})("keydown",function(i){o(e);let s=l().index,r=l();return p(r.onGutterKeyDown(i,s))}),v()()}if(n&2){let e=l(2);d("data-p-gutter-resizing",!1)("data-pc-section","gutter"),c(),h("ngStyle",e.gutterStyle()),d("aria-orientation",e.layout)("aria-valuenow",e.prevSize)("data-pc-section","gutterhandle")}}function _e(n,z){if(n&1&&(g(0,"div",3),y(1,Se,1,0,"ng-container",4),v(),y(2,ze,2,6,"div",5)),n&2){let e=z.$implicit,t=z.index,i=l();T(i.panelStyleClass),h("ngClass",i.panelContainerClass())("ngStyle",i.panelStyle),d("data-pc-name","splitter")("data-pc-section","root"),c(),h("ngTemplateOutlet",e),c(),h("ngIf",t!==i.panels.length-1)}}var ye=({dt:n})=>`
.p-splitter {
    display: flex;
    flex-wrap: nowrap;
