...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdaptiveLayoutComponent, { className: "AdaptiveLayoutComponent", filePath: "src/app/shared/components/splitter/adaptive-layout/adaptive-layout.component.ts", lineNumber: 45 });
})();

export {
  AdaptiveLayoutComponent
};
//# sourceMappingURL=chunk-ADCDTE4V.js.map
