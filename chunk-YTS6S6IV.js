import{K as Se,j as fe}from"./chunk-2UQKQVAT.js";import{b as me}from"./chunk-SF4MUCMI.js";import{C as v,F as ue,Ga as O,K as ce,a as S,b as A,d as $,k as z,ka as de,la as b,pa as ge,w as he}from"./chunk-2XTWTRVI.js";import{d as pe}from"./chunk-6QJFECGL.js";import{$b as ee,Bb as H,Cb as q,Db as D,Ec as k,Fc as C,Kb as m,Lb as w,Pb as J,Qb as W,Sb as V,T as y,Tb as l,Tc as se,U as N,Ub as X,Vb as Y,Vc as re,Wc as le,Xa as g,Xb as R,Yb as Z,Z as p,Zb as E,Zc as ae,_b as P,_c as oe,ac as te,bd as F,cb as Q,db as j,dd as U,ha as h,hb as L,ia as u,ib as G,jc as ie,la as _,lb as I,lc as ne,nb as K,ob as x,ra as T,yb as f,zb as c}from"./chunk-ERBFMJQP.js";import{a as M}from"./chunk-DAQOROHW.js";var ze=class i{userProfileSignal=Q(null);router=p(pe);authService=p(fe);authTokensService=p(me);adminState=p(Se);profile=C(()=>this.userProfileSignal());getUserProfileSignal(){return this.userProfileSignal}getUserProfile(){return this.userProfileSignal()}setUserProfile(a){let e=this.userProfileSignal();e?this.userProfileSignal.set(M(M({},e),a)):this.userProfileSignal.set(a)}clearUserProfile(){this.userProfileSignal.set(null)}logout(){this.authService.signOut({}).subscribe({next:()=>{this.authTokensService.clearTokens(),this.adminState.clearAllState(),this.router.navigate(["/auth"]).catch(()=>{})}})}static \u0275fac=function(e){return new(e||i)};static \u0275prov=y({token:i,factory:i.\u0275fac,providedIn:"root"})};var _e=({dt:i})=>`
.p-splitter {
    display: flex;
    flex-wrap: nowrap;
