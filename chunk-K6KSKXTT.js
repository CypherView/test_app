...
} from "./chunk-KSIG7ZID.js";
import {
  AdminGridContainerComponent,
  AdminTreetableContainerComponent,
  clientsGuard,
  vendorAlertsGuard
} from "./chunk-Q3OOU27C.js";
import "./chunk-IAU2BK5M.js";
import {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          id: "vendor-map-sets",
          label: "Map Sets",
          route: "profiles/grid/vendor-map-sets",
          level: 1
        },
        {
          id: "vendor-io-types",
...
var ADMIN_VENDORS_ROUTES = [
  {
    ...
    children: [
      ...
      {
        path: "details",
        loadChildren: () => import("./chunk-YCC7CQMR.js").then((m) => m.ADMIN_VENDOR_DETAILS_ROUTES),
        ...
        children: [
          {
            ...
            canActivate: [
              createContextSmartRedirectGuard("vendor", "profiles", [
                ...
                "vendor-company-groups": "tree",
                "vendor-io-types": "grid",
                "vendor-device-config-profiles": "grid",
                "vendor-overspeed-profiles": "grid",
                "vendor-road-profiles": "grid",
                "vendor-geo-lock-profiles": "grid",
                "vendor-custom-fields": "grid",
                "vendor-map-sets": "grid"
              })
            ],
            component: AdminGridContainerComponent
          },
      ...
      },
      {
        path: "export-tasks",
        component: AdminGridContainerComponent,
        data: { gridType: "vendor-export-tasks", type: "vendor-export-tasks" }
      },
...
//# sourceMappingURL=chunk-K6KSKXTT.js.map
