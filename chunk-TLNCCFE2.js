...
import {
  Paginator,
  PaginatorModule
} from "./chunk-EX7TBVLG.js";
import {
  ContextMenuModule
} from "./chunk-32XJEEKW.js";
import {
  Popover,
  PopoverModule
...
function ColumnSelectorComponent_ng_template_9_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ColumnSelectorComponent_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ColumnSelectorComponent_ng_template_9_Conditional_3_Template, 2, 0, "span", 11);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var ColumnSelectorComponent = class _ColumnSelectorComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ColumnSelectorComponent, selectors: [["app-column-selector"]], inputs: { columns: [1, "columns"], selectedColumns: [1, "selectedColumns"], disabled: [1, "disabled"], inputClass: [1, "inputClass"] }, outputs: { columnChange: "columnChange" }, decls: 12, vars: 14, consts: [["overlayPanel", ""], ["type", "button", "pTooltip", "Column Visibility", "tooltipPosition", "bottom", 1, "pi", "pi-objects-column", "action", "hover", 3, "click", "disabled"], [3, "dismissable"], [1, "min-w-[300px]", "max-w-[400px]"], [1, "flex", "justify-between", "items-center", "mb-3", "gap-2"], [1, "m-0", "font-semibold"], [1, "column-options"], ["optionLabel", "label", "optionValue", "value", "display", "chip", "filterBy", "label", "placeholder", "Select columns to display", "styleClass", "w-full", "panelStyleClass", "column-selector-dropdown", 3, "ngModelChange", "onChange", "options", "ngModel", "showToggleAll", "showHeader", "filter", "disabled"], ["pTemplate", "item"], [1, "mt-2", "text-sm", "text-gray-600"], [1, "flex", "align-items-center", "gap-2"], [1, "text-xs", "text-blue-500"]], template: function ColumnSelectorComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "Show Columns");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "div", 6)(8, "p-multiSelect", 7);
      \u0275\u0275twoWayListener("ngModelChange", function ColumnSelectorComponent_Template_p_multiSelect_ngModelChange_8_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.selectedValues, $event) || (ctx.selectedValues = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("onChange", function ColumnSelectorComponent_Template_p_multiSelect_onChange_8_listener($event) {
        return ctx.onSelectionChange($event);
      });
      \u0275\u0275template(9, ColumnSelectorComponent_ng_template_9_Template, 4, 4, "ng-template", 8);
      \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ColumnSelectorComponent, { className: "ColumnSelectorComponent", filePath: "src/app/shared/components/grid/column-selector/column-selector.component.ts", lineNumber: 37 });
})();
...
var GridPreferenceService = class _GridPreferenceService {
  ...
  validateAndSyncPreferences(gridConfig, storedData) {
    ...
    if (isNullOrUndefined(storedData) || storedData.schemaVersion !== currentSchema) {
...
var AdminGridContainerComponent = class _AdminGridContainerComponent {
  ...
  }, decls: 16, vars: 30, consts: [[1, "flex", "flex-col", "h-full", "w-full", "overflow-hidden"], [1, "p-4", "content-header", "flex-none", "w-full"], [1, "flex", "justify-between", "items-center"], ["id", "gridTitle", 1, "text-xl", "font-semibold", "truncate"], ["aria-label", "Grid actions", 1, "flex-none", "flex", "space-x-4", "align-center"], ["type", "button", "pTooltip", "Add", "tooltipPosition", "bottom", "aria-label", "Add new item", 1, "pi", "pi-plus", "action", "hover", 3, "click"], ["type", "button", "tooltipPosition", "bottom", 3, "class", "pTooltip"], ["type", "button", "pTooltip", "Refresh", "tooltipPosition", "bottom", "aria-label", "Refresh grid data", 1, "pi", "pi-refresh", "action", "hover", 3, "click"], ["type", "button", "pTooltip", "Filter", "tooltipPosition", "bottom", "aria-label", "Toggle filters", 1, "pi", "pi-filter-fill", "action", "hover", 3, "click", "disabled"], [3, "columnChange", "columns", "selectedColumns", "disabled"], ["pTooltip", "Export CSV", "tooltipPosition", "bottom", "aria-label", "Export to CSV", 1, "pi", "pi-download", "action", "hover", 3, "click"], [1, "flex-1", "min-h-0", "w-full", "overflow-hidden"], ["role", "grid", "styleClass", "table-height", 1, "h-full", "max-w-full", 3, "onLazyLoad", "onFilterChange", "rowSelect", "rowUnselect", "columns", "data", "pagination", "totalRecords", "lazy", "filterable", "visibleColumns", "selectionMode", "showCheckboxColumn", "metaKeySelection", "loading", "scrollable", "scrollHeight", "initialFilters", "sortable"], ["aria-live", "polite", "aria-atomic", "true", 1, "sr-only"], ["type", "button", "tooltipPosition", "bottom", 3, "click", "pTooltip"]], template: function AdminGridContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      })("rowUnselect", function AdminGridContainerComponent_Template_app_grid_rowUnselect_13_listener($event) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminGridContainerComponent, { className: "AdminGridContainerComponent", filePath: "src/app/features/administration/components/admin-grid-container/admin-grid-container.component.ts", lineNumber: 83 });
})();
...
function TreeTableComponent_ng_template_2_For_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-treeTableSortIcon", 8);
  }
  if (rf & 2) {
...
function TreeTableComponent_ng_template_2_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, TreeTableComponent_ng_template_2_For_3_Conditional_2_Template, 1, 1, "p-treeTableSortIcon", 8);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r1 = ctx.$implicit;
    \u0275\u0275property("ttSortableColumn", col_r1.sortable ? col_r1.field : "");
    \u0275\u0275advance();
...
function TreeTableComponent_ng_template_2_Conditional_4_For_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-filter-wrapper", 11);
    \u0275\u0275listener("filterChange", function TreeTableComponent_ng_template_2_Conditional_4_For_2_Conditional_1_Template_app_filter_wrapper_filterChange_0_listener($event) {
      \u0275\u0275restoreView(_r2);
...
function TreeTableComponent_ng_template_2_Conditional_4_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 9);
    \u0275\u0275conditionalCreate(1, TreeTableComponent_ng_template_2_Conditional_4_For_2_Conditional_1_Template, 1, 5, "app-filter-wrapper", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TreeTableComponent_ng_template_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275repeaterCreate(1, TreeTableComponent_ng_template_2_Conditional_4_For_2_Template, 2, 1, "th", 9, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TreeTableComponent_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, TreeTableComponent_ng_template_2_For_3_Template, 3, 3, "th", 7, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, TreeTableComponent_ng_template_2_Conditional_4_Template, 3, 0, "tr");
  }
  if (rf & 2) {
...
function TreeTableComponent_ng_template_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "p-treeTableCheckbox", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TreeTableComponent_ng_template_4_For_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-treeTableToggler", 15);
  }
  if (rf & 2) {
...
function TreeTableComponent_ng_template_4_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, TreeTableComponent_ng_template_4_For_3_Conditional_2_Template, 1, 1, "p-treeTableToggler", 15);
    \u0275\u0275elementStart(3, "div");
    \u0275\u0275conditionalCreate(4, TreeTableComponent_ng_template_4_For_3_Conditional_4_Template, 1, 6, "ng-container", 16)(5, TreeTableComponent_ng_template_4_For_3_Conditional_5_Template, 3, 1, "ng-container");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const col_r6 = ctx.$implicit;
    const \u0275$index_37_r8 = ctx.$index;
    \u0275\u0275classProp("tree-column-cell", \u0275$index_37_r8 === 0);
    \u0275\u0275advance();
    \u0275\u0275classProp("tree-column-container", \u0275$index_37_r8 === 0);
    \u0275\u0275advance();
    \u0275\u0275conditional(\u0275$index_37_r8 === 0 ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("tree-column-value", \u0275$index_37_r8 === 0)("w-full", \u0275$index_37_r8 !== 0);
    \u0275\u0275advance();
...
function TreeTableComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, TreeTableComponent_ng_template_4_Conditional_1_Template, 2, 1, "td", 6);
    \u0275\u0275repeaterCreate(2, TreeTableComponent_ng_template_4_For_3_Template, 6, 10, "td", 13, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var TreeTableComponent = class _TreeTableComponent {
  ...
  displayedColumns = computed(() => {
    ...
    return filteredColumns.map((col) => __spreadProps(__spreadValues({}, col), {
      field: col.field
    }));
  ...
  <ng-template #header let-columns>
    <tr>
      @if (selectionMode() === 'checkbox' || selectionMode() === 'multiple') {
        <th class="w-12"><p-treeTableHeaderCheckbox /></th>
      }
      @for (col of displayedColumns(); track col.field) {
        <th scope="col" [ttSortableColumn]="col.sortable ? col.field : ''">
          {{ col.header }}
          @if (col.sortable) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TreeTableComponent, { className: "TreeTableComponent", filePath: "src/app/shared/components/tree-table/tree-table.component.ts", lineNumber: 46 });
})();

// src/app/features/administration/components/admin-treetable-container/admin-treetable-container.component.ts
function AdminTreetableContainerComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 12);
    \u0275\u0275listener("click", function AdminTreetableContainerComponent_Conditional_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-disabled", !ctx_r1.canFilter());
  }
}
var AdminTreetableContainerComponent = class _AdminTreetableContainerComponent {
  ...
  handleSelectionChange(nodes) {
    ...
    const items = nodes.map((node) => {
      const entityType = node.data?.type ?? routeEntityType;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminTreetableContainerComponent, selectors: [["app-admin-treetable-container"]], viewQuery: function AdminTreetableContainerComponent_Query(rf, ctx) {
  ...
  }, decls: 14, vars: 23, consts: [[1, "flex", "flex-col", "h-full", "w-full", "overflow-hidden"], [1, "p-4", "content-header", "flex-none", "w-full"], [1, "flex", "justify-between", "items-center"], ["id", "treetableTitle", 1, "text-xl", "font-semibold", "truncate"], ["aria-label", "Tree Table actions", 1, "flex-none", "flex", "space-x-4", "align-center"], ["type", "button", "pTooltip", "Add", "tooltipPosition", "bottom", "aria-label", "Add new item", 1, "pi", "pi-plus", "action", "hover", 3, "click"], ["type", "button", "pTooltip", "Refresh", "tooltipPosition", "bottom", "aria-label", "Refresh tree table data", 1, "pi", "pi-refresh", "action", "hover", 3, "click"], ["type", "button", "pTooltip", "Filter", "tooltipPosition", "bottom", "aria-label", "Toggle filters", 1, "pi", "pi-filter-fill", "action", "hover", 3, "text-primary"], [3, "columnChange", "columns", "selectedColumns", "disabled"], [1, "flex-1", "min-h-0", "w-full", "overflow-auto"], ["role", "treegrid", 1, "h-full", "max-w-full", 3, "lazyLoad", "nodeSelect", "selectionChange", "nodeExpand", "nodeCollapse", "onFilterChange", "columns", "visibleColumns", "filterable", "initialFilters", "nodes", "totalRecords", "lazy", "selectionMode", "metaKeySelection", "loading", "scrollable", "scrollHeight"], ["aria-live", "polite", "aria-atomic", "true", 1, "sr-only"], ["type", "button", "pTooltip", "Filter", "tooltipPosition", "bottom", "aria-label", "Toggle filters", 1, "pi", "pi-filter-fill", "action", "hover", 3, "click"]], template: function AdminTreetableContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h2", 3);
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(8, AdminTreetableContainerComponent_Conditional_8_Template, 1, 3, "button", 7);
      \u0275\u0275elementStart(9, "app-column-selector", 8);
      \u0275\u0275listener("columnChange", function AdminTreetableContainerComponent_Template_app_column_selector_columnChange_9_listener($event) {
        return ctx.handleColumnChange($event);
      });
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(10, "div", 9)(11, "app-tree-table", 10);
      \u0275\u0275listener("lazyLoad", function AdminTreetableContainerComponent_Template_app_tree_table_lazyLoad_11_listener($event) {
        return ctx.handleLazyLoad($event);
      })("nodeSelect", function AdminTreetableContainerComponent_Template_app_tree_table_nodeSelect_11_listener($event) {
        return ctx.handleNodeSelect($event);
      })("selectionChange", function AdminTreetableContainerComponent_Template_app_tree_table_selectionChange_11_listener($event) {
        return ctx.handleSelectionChange($event);
      })("nodeExpand", function AdminTreetableContainerComponent_Template_app_tree_table_nodeExpand_11_listener($event) {
        return ctx.handleNodeExpand($event);
      })("nodeCollapse", function AdminTreetableContainerComponent_Template_app_tree_table_nodeCollapse_11_listener($event) {
        return ctx.handleNodeCollapse($event);
      })("onFilterChange", function AdminTreetableContainerComponent_Template_app_tree_table_onFilterChange_11_listener($event) {
        return ctx.handleFilterChange($event);
      });
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275attribute("aria-busy", ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.canFilter() ? 8 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("columns", ctx.selectableColumns())("selectedColumns", ctx.visibleColumns())("disabled", !ctx.treeTableConfiguration());
      \u0275\u0275advance(2);
      \u0275\u0275property("columns", ctx.columns())("visibleColumns", ctx.visibleColumns())("filterable", ctx.showFilters())("initialFilters", ctx.currentFilters())("nodes", ctx.nodes())("totalRecords", ctx.totalRecords())("lazy", true)("selectionMode", ctx.selectionMode())("metaKeySelection", true)("loading", ctx.loading())("scrollable", true)("scrollHeight", "flex");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminTreetableContainerComponent, { className: "AdminTreetableContainerComponent", filePath: "src/app/features/administration/components/admin-treetable-container/admin-treetable-container.component.ts", lineNumber: 85 });
})();
...
//# sourceMappingURL=chunk-TLNCCFE2.js.map
