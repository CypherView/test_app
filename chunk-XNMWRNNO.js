...
function ClientSelectionFormComponent_Conditional_12_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ClientSelectionFormComponent_Conditional_12_For_2_Template_div_click_0_listener() {
      ...
      const \u0275$index_68_r7 = \u0275\u0275restoreView(_r5).$index;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onItemFocus(ctx_r2.getClientCardIndex(\u0275$index_68_r7)));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("focused", ctx_r2.isItemFocused(ctx_r2.getClientCardIndex(\u0275$index_68_r7)));
    \u0275\u0275property("id", "client-card-" + ctx_r2.getClientCardIndex(\u0275$index_68_r7))("tabindex", ctx_r2.getItemTabIndex(ctx_r2.getClientCardIndex(\u0275$index_68_r7)));
    \u0275\u0275attribute("aria-label", "Select " + client_r6.name + (client_r6.owner.name ? ", owned by " + client_r6.owner.name : ""))("aria-selected", ctx_r2.isItemFocused(ctx_r2.getClientCardIndex(\u0275$index_68_r7)))("aria-posinset", ctx_r2.first() + \u0275$index_68_r7 + 1)("aria-setsize", ctx_r2.currentTotalRecords());
    \u0275\u0275advance();
    \u0275\u0275attribute("data-color", ctx_r2.getClientColor(client_r6.name));
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_20_0 = ctx_r2.getClientLogoUrl(client_r6.id)) ? 2 : -1, tmp_20_0);
    \u0275\u0275advance(2);
...
//# sourceMappingURL=chunk-XNMWRNNO.js.map
