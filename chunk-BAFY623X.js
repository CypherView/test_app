...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientDetailsComponent, { className: "ClientDetailsComponent", filePath: "src/app/features/administration/components/clients/client-details/client-details/client-details.component.ts", lineNumber: 41 });
})();
...
var ClientSettingsComponent = class _ClientSettingsComponent extends EntitySectionBaseComponent {
  ...
  onSubmit(formGroup) {
    ...
    if (isDefined(dirtyValues["availableDeviceTypes"])) {
      dirtyValues["availableDeviceTypes"] = dirtyValues["availableDeviceTypes"].map((id) => {
...
//# sourceMappingURL=chunk-BAFY623X.js.map
