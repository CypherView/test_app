...
var ThemeComponent = class _ThemeComponent {
  ...
  reResolving = this.clientDataService.isReResolvingActiveClient();
  // Overlay covers both the account refetch and the subsequent theme apply.
  showOverlay = computed(() => this.loading() || this.reResolving(), ...ngDevMode ? [{ debugName: "showOverlay" }] : (
    /* istanbul ignore next */
    []
  ));
  ...
  getThemeId(selectedClient) {
    const effectiveThemeId = selectedClient?.["effectiveThemeId"];
    if (isDefined(effectiveThemeId) && effectiveThemeId !== "inherited") {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ThemeComponent, selectors: [["app-theme"]], hostVars: 2, hostBindings: function ThemeComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275conditional(ctx.showOverlay() ? 0 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ThemeComponent, [{
    type: Component,
    args: [{ selector: "app-theme", imports: [ProgressSpinnerModule, TranslatePipe], template: `@if (showOverlay()) {
  <div
...
//# sourceMappingURL=chunk-7RRKM5S4.js.map
