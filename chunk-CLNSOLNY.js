...
function GridComponent_Conditional_4_ng_template_0_Conditional_3_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GridComponent_Conditional_4_ng_template_0_Conditional_3_For_1_Template_th_click_0_listener() {
      const col_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r3.cycleSort(col_r3.field));
    })("keydown.enter", function GridComponent_Conditional_4_ng_template_0_Conditional_3_For_1_Template_th_keydown_enter_0_listener() {
      const col_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r3.cycleSort(col_r3.field));
    })("keydown.space", function GridComponent_Conditional_4_ng_template_0_Conditional_3_For_1_Template_th_keydown_space_0_listener($event) {
      const col_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(4);
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("p-datatable-column-sorted", ctx_r3.sortField() === col_r3.field);
    \u0275\u0275property("appDirectiveSwitch", \u0275\u0275pureFunction1(13, _c2, \u0275\u0275pureFunction1(11, _c1, ctx_r3.reOrderableColumns())));
    \u0275\u0275attribute("aria-sort", ctx_r3.ariaSort(col_r3.field));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", col_r3.header, " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("pi-sort-alt", ctx_r3.sortField() !== col_r3.field)("pi-sort-amount-up-alt", ctx_r3.sortField() === col_r3.field && ctx_r3.sortOrder() === 1)("pi-sort-amount-down", ctx_r3.sortField() === col_r3.field && ctx_r3.sortOrder() === -1);
  }
}
function GridComponent_Conditional_4_ng_template_0_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, GridComponent_Conditional_4_ng_template_0_Conditional_3_For_1_Template, 3, 15, "th", 10, _forTrack0);
  }
  if (rf & 2) {
...
function GridComponent_Conditional_4_ng_template_0_Conditional_4_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(4);
    \u0275\u0275property("appDirectiveSwitch", \u0275\u0275pureFunction1(4, _c2, \u0275\u0275pureFunction1(2, _c1, ctx_r3.reOrderableColumns())));
    \u0275\u0275advance();
...
function GridComponent_Conditional_4_ng_template_0_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, GridComponent_Conditional_4_ng_template_0_Conditional_4_For_1_Template, 2, 6, "th", 13, _forTrack0);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275repeater(ctx_r3.displayedColumns());
...
function GridComponent_Conditional_4_ng_template_0_Conditional_5_For_2_Conditional_1_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("filterChange", function GridComponent_Conditional_4_ng_template_0_Conditional_5_For_2_Conditional_1_ng_template_1_Template_app_filter_wrapper_filterChange_0_listener($event) {
      ...
      const ctx_r3 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r3.handleFilterChange(col_r7.field, $event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r7 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r3 = \u0275\u0275nextContext(4);
    \u0275\u0275property("field", col_r7.field)("filterType", col_r7.filterType ?? "text")("options", (col_r7.filterConfig == null ? null : col_r7.filterConfig.options) ?? \u0275\u0275pureFunction0(5, _c3))("defaultSelected", (col_r7.filterConfig == null ? null : col_r7.filterConfig.defaultSelected) ?? \u0275\u0275pureFunction0(6, _c3))("initialValue", ctx_r3.initialFilters()[col_r7.field]);
  }
}
function GridComponent_Conditional_4_ng_template_0_Conditional_5_For_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-columnFilter", 15);
    \u0275\u0275template(1, GridComponent_Conditional_4_ng_template_0_Conditional_5_For_2_Conditional_1_ng_template_1_Template, 1, 7, "ng-template", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("type", col_r7.filterType ?? "text")("field", col_r7.field)("showMenu", false);
  }
}
function GridComponent_Conditional_4_ng_template_0_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 14);
    \u0275\u0275conditionalCreate(1, GridComponent_Conditional_4_ng_template_0_Conditional_5_For_2_Conditional_1_Template, 2, 3, "p-columnFilter", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r7 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275conditional(col_r7.filter ? 1 : -1);
  }
}
function GridComponent_Conditional_4_ng_template_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275repeaterCreate(1, GridComponent_Conditional_4_ng_template_0_Conditional_5_For_2_Template, 2, 1, "th", 14, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(3);
...
function GridComponent_Conditional_4_ng_template_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.rowExpandable() ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.showCheckboxColumn() ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.sortable() ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r3.sortable() ? 4 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.filterable() ? 5 : -1);
  }
}
...
function GridComponent_ng_template_5_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275element(1, "p-tableCheckbox", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GridComponent_ng_template_5_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(1, _c5, ctx_r3.isRowExpanded(rowData_r8), !ctx_r3.isRowExpanded(rowData_r8)));
  }
}
...
function GridComponent_ng_template_5_For_5_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, GridComponent_ng_template_5_For_5_Conditional_1_ng_container_0_Template, 1, 0, "ng-container", 24);
  }
  if (rf & 2) {
    const col_r10 = \u0275\u0275nextContext().$implicit;
    const rowData_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("ngTemplateOutlet", col_r10.cellTemplate)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c6, rowData_r8));
  }
}
function GridComponent_ng_template_5_For_5_Conditional_2_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const rowData_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275textInterpolate1(" ", col_r10.valueGetter(rowData_r8), " ");
  }
}
function GridComponent_ng_template_5_For_5_Conditional_2_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const col_r10 = \u0275\u0275nextContext(2).$implicit;
    const rowData_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275textInterpolate1(" ", rowData_r8[col_r10.field], " ");
  }
}
function GridComponent_ng_template_5_For_5_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const col_r10 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275classMap(col_r10.transform);
    \u0275\u0275advance();
    \u0275\u0275conditional(col_r10.valueGetter ? 1 : 2);
  }
}
function GridComponent_ng_template_5_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275conditionalCreate(1, GridComponent_ng_template_5_For_5_Conditional_1_Template, 1, 4, "ng-container")(2, GridComponent_ng_template_5_For_5_Conditional_2_Template, 3, 3, "span", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r10 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275conditional(col_r10.cellTemplate ? 1 : 2);
  }
}
function GridComponent_ng_template_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275property("pReorderableRow", index_r11)("pSelectableRow", rowData_r8)("pSelectableRowIndex", index_r11)("appDirectiveSwitch", \u0275\u0275pureFunction1(10, _c2, \u0275\u0275pureFunction2(7, _c4, !!ctx_r3.contextMenuItems(), rowData_r8)));
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.showCheckboxColumn() ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.rowExpandable() ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.reOrderableRows() ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r3.displayedColumns());
  }
}
...
function GridComponent_Conditional_8_ng_template_0_Defer_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, GridComponent_Conditional_8_ng_template_0_Defer_2_ng_container_0_Template, 1, 0, "ng-container", 24);
  }
  if (rf & 2) {
    const rowData_r12 = \u0275\u0275nextContext().$implicit;
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngTemplateOutlet", ctx_r3.expandedRowTemplate())("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c6, rowData_r12));
  }
}
function GridComponent_Conditional_8_ng_template_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275attribute("colspan", ctx_r3.displayedColumns().length + 1);
  }
}
...
var GridComponent = class _GridComponent {
  ...
  // (e.g. 'ADMIN.DEVICES.ENTITY_PLURAL' -> "…out of 825 Devices"). When unset,
  // the report falls back to a generic translated noun ("items").
  ...
  // Three-state sort is owned by this wrapper (PrimeNG 21 has no `removableSort`).
  // `sortField === null` means "no active sort" — the header stays clickable and
  // the lazy grid falls back to the server default (see grid-base.service). The
  // `sortOrder` value is inert while the field is null; we still reset it to 1 so
  // the next fresh cycle starts from a known ascending baseline.
  ...
  /**
   * The string handed to PrimeNG's [currentPageReportTemplate]. It must already
   * contain the localized wording AND the resolved entity noun, but keep
   * PrimeNG's own {first}/{last}/{totalRecords} tokens as literals for PrimeNG
   * to substitute afterwards.
   *
   ...
   *
   * Behaviour:
   *   - entityLabelKey set  -> "Showing {first} of {last} out of {totalRecords} Devices"
   *   - entityLabelKey unset -> generic noun via SHARED.GRID.ITEMS ("items")
   *
   * i18n keys available:
   *   SHARED.GRID.PAGE_REPORT  -> "Showing {first} of {last} out of {totalRecords} {entity}"
  ...
  /**
   * During a shift range-selection PrimeNG updates its internal selection and
   * emits onRowSelect/onRowUnselect *before* the two-way [(selection)] binding
   * catches up (selectionChange fires after the range loop). Read the table's
   * live selection so consumers of `selectedRows` don't lag one step behind —
   * otherwise the first shift-select looks like a single selection.
   */
  syncSelectionFromTable() {
    const liveSelection = this.dt?.selection;
    if (liveSelection !== void 0) {
      this._selectedRows = liveSelection;
    }
  }
  toggleRow(rowData) {
   ...
   * We drive PrimeNG via the controlled [sortField]/[sortOrder] inputs rather than
   * its native two-state toggle, so we can insert the "Off" state it lacks.
   */
  cycleSort(field) {
  ...
  /** aria-sort value for a header, derived from the controlled sort state. */
  ariaSort(field) {
    if (this.sortField() !== field) {
      return "none";
    }
  ...
  }, inputs: { columns: [1, "columns"], data: [1, "data"], sortable: [1, "sortable"], selectionMode: [1, "selectionMode"], showCheckboxColumn: [1, "showCheckboxColumn"], filterable: [1, "filterable"], pagination: [1, "pagination"], resizableColumns: [1, "resizableColumns"], columnResizeMode: [1, "columnResizeMode"], reOrderableColumns: [1, "reOrderableColumns"], reOrderableRows: [1, "reOrderableRows"], virtualScroll: [1, "virtualScroll"], contextMenuItems: [1, "contextMenuItems"], size: [1, "size"], showGridLines: [1, "showGridLines"], stripedRows: [1, "stripedRows"], rows: [1, "rows"], rowsPerPageOptions: [1, "rowsPerPageOptions"], rowExpandMode: [1, "rowExpandMode"], rowExpandable: [1, "rowExpandable"], emptyMessage: [1, "emptyMessage"], expandedRowTemplate: [1, "expandedRowTemplate"], scrollable: [1, "scrollable"], scrollHeight: [1, "scrollHeight"], totalRecords: [1, "totalRecords"], lazy: [1, "lazy"], hideHeader: [1, "hideHeader"], loading: [1, "loading"], tableStyleClass: [1, "tableStyleClass"], styleClass: [1, "styleClass"], initialFilters: [1, "initialFilters"], selection: [1, "selection"], visibleColumns: [1, "visibleColumns"], metaKeySelection: [1, "metaKeySelection"], dataKey: [1, "dataKey"], entityLabelKey: [1, "entityLabelKey"] }, outputs: { pageChange: "pageChange", rowSelect: "rowSelect", rowUnselect: "rowUnselect", onLazyLoad: "onLazyLoad", onFilterChange: "onFilterChange" }, decls: 9, vars: 32, consts: [["cm", ""], ["dt", ""], ["emptymessage", ""], [3, "model", "hidden"], ["role", "grid", 3, "selectionChange", "onPage", "onRowSelect", "onRowUnselect", "onLazyLoad", "value", "paginator", "showCurrentPageReport", "currentPageReportTemplate", "rows", "resizableColumns", "reorderableColumns", "selectionMode", "sortField", "sortOrder", "contextMenu", "size", "showGridlines", "stripedRows", "rowExpandMode", "columnResizeMode", "scrollable", "scrollHeight", "totalRecords", "lazy", "columns", "loading", "metaKeySelection", "selection", "dataKey", "tableStyleClass", "styleClass"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "rowexpansion"], ["scope", "col", 1, "w-20"], [1, "w-12"], ["scope", "col", "role", "columnheader", "tabindex", "0", 1, "p-datatable-sortable-column", "cursor-pointer", "select-none", 3, "p-datatable-column-sorted", "appDirectiveSwitch"], ["scope", "col", "role", "columnheader", "tabindex", "0", 1, "p-datatable-sortable-column", "cursor-pointer", "select-none", 3, "click", "keydown.enter", "keydown.space", "appDirectiveSwitch"], ["aria-hidden", "true", 1, "pi", "ml-1", "text-xs"], ["scope", "col", 3, "appDirectiveSwitch"], ["scope", "col"], [3, "type", "field", "showMenu"], ["pTemplate", "filter"], [3, "filterChange", "field", "filterType", "options", "defaultSelected", "initialValue"], [3, "pReorderableRow", "pSelectableRow", "pSelectableRowIndex", "appDirectiveSwitch"], [3, "value"], ["href", "#", 3, "click"], [1, "pi", 3, "ngClass"], ["pReorderableRowHandle", "", 1, "pi", "pi-bars"], [3, "class"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"]], template: function GridComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275template(5, GridComponent_ng_template_5_Template, 6, 12, "ng-template", 6)(6, GridComponent_ng_template_6_Template, 4, 4, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
      \u0275\u0275conditionalCreate(8, GridComponent_Conditional_8_Template, 1, 0, null, 7);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      const cm_r13 = \u0275\u0275reference(1);
      \u0275\u0275property("model", ctx.contextMenuItems())("hidden", !ctx.contextMenuItems());
      \u0275\u0275advance(2);
      \u0275\u0275property("value", ctx.data())("paginator", ctx.pagination())("showCurrentPageReport", ctx.pagination())("currentPageReportTemplate", ctx.pageReportTemplate())("rows", ctx.rows())("resizableColumns", ctx.resizableColumns())("reorderableColumns", ctx.reOrderableColumns())("selectionMode", ctx.selectionMode())("sortField", ctx.sortField())("sortOrder", ctx.sortOrder())("contextMenu", ctx.contextMenuItems() ? cm_r13 : null)("size", ctx.size())("showGridlines", ctx.showGridLines())("stripedRows", ctx.stripedRows())("rowExpandMode", ctx.rowExpandMode())("columnResizeMode", ctx.columnResizeMode())("scrollable", ctx.scrollable())("scrollHeight", ctx.scrollable() ? "flex" : ctx.scrollHeight())("totalRecords", ctx.totalRecords())("lazy", ctx.lazy())("columns", ctx.displayedColumns())("loading", ctx.loading())("metaKeySelection", ctx.metaKeySelection());
...
<p-table
  ...
  [showCurrentPageReport]="pagination()"
        ...
        @if (sortable()) {
          @for (col of displayedColumns(); track col.field) {
            <th
              ...
              role="columnheader"
              tabindex="0"
              class="p-datatable-sortable-column cursor-pointer select-none"
              [class.p-datatable-column-sorted]="sortField() === col.field"
              [attr.aria-sort]="ariaSort(col.field)"
              (click)="cycleSort(col.field)"
              (keydown.enter)="cycleSort(col.field)"
              (keydown.space)="$event.preventDefault(); cycleSort(col.field)"
              [appDirectiveSwitch]="[
                {
            ...
            >
              {{ col.header }}
              <!-- Icon driven by our controlled sort state (not p-sortIcon), so the
                   'Off' state clears correctly \u2014 PrimeNG never notifies on a null sort. -->
              <i
                aria-hidden="true"
...
//# sourceMappingURL=chunk-CLNSOLNY.js.map
