...
function ClientSelectionFormComponent_Conditional_8_For_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, ClientSelectionFormComponent_Conditional_8_For_7_Conditional_2_Template, 1, 2, "img", 19);
...
function ClientSelectionFormComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(6, ClientSelectionFormComponent_Conditional_8_For_7_Template, 7, 10, "button", 14, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "div", 15);
...
function ClientSelectionFormComponent_Conditional_12_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, ClientSelectionFormComponent_Conditional_12_For_2_Conditional_2_Template, 1, 2, "img", 19);
    \u0275\u0275elementStart(3, "span", 20);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ClientSelectionFormComponent_Conditional_12_For_2_Conditional_8_Template, 2, 1, "div", 31);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-label", "Select " + client_r7.name + (client_r7.owner.name ? ", owned by " + client_r7.owner.name : ""))("aria-selected", ctx_r2.isItemFocused(ctx_r2.getClientCardIndex(\u0275$index_68_r8)))("aria-posinset", \u0275$index_68_r8 + 1)("aria-setsize", ctx_r2.filteredClients().length);
    \u0275\u0275advance();
...
function ClientSelectionFormComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ClientSelectionFormComponent_Conditional_12_For_2_Template, 11, 13, "div", 26, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var ClientSelectionFormComponent = class _ClientSelectionFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClientSelectionFormComponent, selectors: [["app-client-selection-form"]], inputs: { clients: [1, "clients"], loading: [1, "loading"], useServerSearch: [1, "useServerSearch"], totalRecords: [1, "totalRecords"], enablePagination: [1, "enablePagination"], enableLazyLoad: [1, "enableLazyLoad"], recentClients: [1, "recentClients"] }, outputs: { clientSelected: "clientSelected", searchQuery: "searchQuery", lazyLoad: "lazyLoad" }, decls: 13, vars: 4, consts: [[1, "client-selection-form", "flex", "flex-col", "max-h-[50vh]", 3, "keydown"], [1, "flex-shrink-0", "my-3"], ["pInputText", "", "placeholder", "Search clients...", "aria-label", "Search clients", "aria-describedby", "client-count-description", 1, "w-full", 3, "ngModelChange", "keydown", "ngModel"], [1, "pi", "pi-search"], ["id", "client-count-description", "aria-live", "polite", 1, "sr-only"], [1, "flex-1", "min-h-0", "flex", "flex-col"], [1, "recent-clients-section", "mb-4", "flex-shrink-0"], [1, "flex-1", "min-h-0", "w-full", "overflow-y-auto"], [1, "client-cards-loading", "flex", "items-center", "justify-center", "h-full"], [1, "client-cards-empty", "flex", "flex-col", "items-center", "justify-center", "h-full", "text-[var(--text-color-secondary)]"], ["role", "listbox", "aria-label", "Available clients", 1, "grid", "grid-cols-1", "sm:grid-cols-2", "gap-3", "p-1"], [1, "recent-clients-header", "text-sm", "font-medium", "text-gray-400", "mb-2", "flex", "items-center", "gap-2"], ["aria-hidden", "true", 1, "pi", "pi-history"], ["role", "listbox", "aria-label", "Recently used clients", 1, "recent-clients-chips"], ["type", "button", "role", "option", "tooltipPosition", "top", 1, "recent-client-chip", 3, "focused", "tabindex", "pTooltip"], [1, "border-b", "border-[var(--surface-border)]", "mt-4", "mb-3"], [1, "text-sm", "font-medium", "text-gray-400", "mb-2"], ["type", "button", "role", "option", "tooltipPosition", "top", 1, "recent-client-chip", 3, "click", "keydown", "focus", "tabindex", "pTooltip"], ["aria-hidden", "true", 1, "recent-client-chip-avatar"], [1, "client-logo-img", 3, "src", "alt"], [1, "client-logo-fallback"], [1, "recent-client-chip-name"], [1, "client-logo-img", 3, "error", "src", "alt"], ["aria-hidden", "true", 1, "pi", "pi-spin", "pi-spinner", "text-2xl", "text-[var(--primary-color)]"], [1, "sr-only"], ["aria-hidden", "true", 1, "pi", "pi-inbox", "text-4xl", "mb-2"], ["role", "option", 1, "client-card", "flex", "items-center", "gap-3", "p-3.5", "px-4", 3, "focused", "id", "tabindex"], ["role", "option", 1, "client-card", "flex", "items-center", "gap-3", "p-3.5", "px-4", 3, "click", "keydown", "focus", "id", "tabindex"], ["aria-hidden", "true", 1, "client-card-avatar", "flex", "items-center", "justify-center", "w-12", "h-12", "min-w-[3rem]"], [1, "client-card-content", "flex-1", "min-w-0", "flex", "flex-col", "gap-0.5"], [1, "client-card-name", "truncate"], [1, "client-card-owner", "truncate"], ["aria-hidden", "true", 1, "client-card-action", "flex", "items-center", "justify-center"], [1, "pi", "pi-chevron-right"]], template: function ClientSelectionFormComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientSelectionFormComponent, { className: "ClientSelectionFormComponent", filePath: "src/app/shared/components/client-selection-form/client-selection-form.component.ts", lineNumber: 32 });
})();
...
css-vars-ponyfill/dist/css-vars-ponyfill.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FLDPDFAL.js.map
