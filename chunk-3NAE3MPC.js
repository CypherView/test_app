...
var BroadcastMessageService = class _BroadcastMessageService {
  ...
  constructor(authDataService, router, apiUrlService) {
    ...
    switch (action) {
      ...
      case ActionType.r2_token_generated: {
        ...
        if (tokenPayload?.r2Token !== void 0 && tokenPayload.r2Token !== "") {
          console.log("R2 token successfully generated:", tokenPayload.timestamp);
        }
        break;
      }
      ...
      case ActionType.r2_token_failed: {
        ...
        setTimeout(() => {
          console.log("Retrying R2 token generation after failure");
          this.sendAuthTokensToFlutter();
        }, 5e3);
        break;
      }
  ...
  sendAuthTokensToFlutter() {
    ...
    if (accessToken && refreshToken && userSession) {
      try {
        ...
        console.log("Auth tokens sent successfully to Flutter");
      } catch (error) {
  ...
  static \u0275fac = function BroadcastMessageService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BroadcastMessageService)(\u0275\u0275inject(AuthDataService), \u0275\u0275inject(Router), \u0275\u0275inject(ApiUrlService));
  };
...
//# sourceMappingURL=chunk-3NAE3MPC.js.map
