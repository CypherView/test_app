...
var AdaptiveLayoutComponent = class _AdaptiveLayoutComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (Array.isArray(inputSizes) && inputSizes.length > 0) {
        sizesToUse = [...inputSizes];
      } else if (Array.isArray(defaultSizes) && defaultSizes.length > 0) {
        sizesToUse = [...defaultSizes];
      } else {
        sizesToUse = [25, 75];
      }
      const validSizes = sizesToUse.filter((size) => typeof size === "number" && !isNaN(size));
      if (validSizes.length === 0) {
        validSizes.push(25, 75);
      }
  ...
  getMinSizes() {
    ...
    return Array.isArray(minSizes) ? minSizes : [];
  }
  /**
...
//# sourceMappingURL=chunk-BAD3ET2Z.js.map
