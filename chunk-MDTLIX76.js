...
} from "./chunk-4WW3LW3Q.js";
import {
  EntityDetailsService
} from "./chunk-5JMK2SR2.js";
import {
...
import {
  ...
  GridComponent
} from "./chunk-ALIF3AEH.js";
import {
  LanguageService
} from "./chunk-XOZKSEPK.js";
import {
  ContextMenuModule
} from "./chunk-2BO3MRS2.js";
import {
  Popover,
  PopoverModule
...
// src/app/features/administration/guards/client-contacts.guard.ts
var clientContactsGuard = (route, _state) => {
  const router = inject(Router);
  const allParams = getAllRouteParams(route);
  const clientId = allParams["clientId"];
  if (isDefined(clientId)) {
...
// src/app/features/administration/guards/map-sets.guard.ts
var mapSetsGuard = (route, _state) => {
  const router = inject(Router);
  const allParams = getAllRouteParams(route);
  const superAdminId = allParams["superAdminId"];
  if (isDefined(superAdminId)) {
...
function ColumnSelectorComponent_ng_template_11_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("(", \u0275\u0275pipeBind1(2, 1, "SHARED.COMMON.COLUMN_SELECTOR.REQUIRED"), ")");
  }
}
function ColumnSelectorComponent_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ColumnSelectorComponent_ng_template_11_Conditional_3_Template, 3, 3, "span", 11);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var ColumnSelectorComponent = class _ColumnSelectorComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (selected.length > 0) {
        ...
        const allColumns = this.columns().map((col) => String(col.field));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ColumnSelectorComponent, selectors: [["app-column-selector"]], inputs: { columns: [1, "columns"], selectedColumns: [1, "selectedColumns"], disabled: [1, "disabled"], inputClass: [1, "inputClass"] }, outputs: { columnChange: "columnChange" }, decls: 14, vars: 20, consts: [["overlayPanel", ""], ["type", "button", "pTooltip", "Column Visibility", "tooltipPosition", "bottom", 1, "pi", "pi-objects-column", "action", "hover", 3, "click", "disabled"], [3, "dismissable"], [1, "min-w-[300px]", "max-w-[400px]"], [1, "flex", "justify-between", "items-center", "mb-3", "gap-2"], [1, "m-0", "font-semibold"], [1, "column-options"], ["optionLabel", "label", "optionValue", "value", "display", "chip", "filterBy", "label", "styleClass", "w-full", "panelStyleClass", "column-selector-dropdown", "appendTo", "body", 3, "ngModelChange", "onChange", "options", "ngModel", "showToggleAll", "showHeader", "filter", "placeholder", "disabled"], ["pTemplate", "item"], [1, "mt-2", "text-sm", "text-gray-600"], [1, "flex", "align-items-center", "gap-2"], [1, "text-xs", "text-blue-500"]], template: function ColumnSelectorComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "button", 1);
      \u0275\u0275listener("click", function ColumnSelectorComponent_Template_button_click_0_listener($event) {
        \u0275\u0275restoreView(_r1);
        const overlayPanel_r2 = \u0275\u0275reference(2);
        return \u0275\u0275resetView(overlayPanel_r2.toggle($event));
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(1, "p-popover", 2, 0)(3, "div", 3)(4, "div", 4)(5, "h5", 5);
      \u0275\u0275text(6);
      \u0275\u0275pipe(7, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(8, "div", 6)(9, "p-multiSelect", 7);
      \u0275\u0275pipe(10, "translate");
      ...
      \u0275\u0275template(11, ColumnSelectorComponent_ng_template_11_Template, 4, 4, "ng-template", 8);
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 16, "SHARED.COMMON.COLUMN_SELECTOR.TITLE"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("options", ctx.columnOptions());
      \u0275\u0275twoWayProperty("ngModel", ctx.selectedValues);
      \u0275\u0275property("showToggleAll", true)("showHeader", true)("filter", true)("placeholder", \u0275\u0275pipeBind1(10, 18, "SHARED.COMMON.COLUMN_SELECTOR.PLACEHOLDER"))("disabled", ctx.disabled());
      \u0275\u0275advance(4);
  ...
  <div class="min-w-[300px] max-w-[400px]">
    <div class="flex justify-between items-center mb-3 gap-2">
      <h5 class="m-0 font-semibold">
        {{ 'SHARED.COMMON.COLUMN_SELECTOR.TITLE' | translate }}
      </h5>
    </div>
    ...
    <div class="column-options">
      <p-multiSelect
        ...
        [filter]="true"
        filterBy="label"
        [placeholder]="'SHARED.COMMON.COLUMN_SELECTOR.PLACEHOLDER' | translate"
        styleClass="w-full"
          ...
          <div class="flex align-items-center gap-2">
            ...
            @if (option.required) {
              <span class="text-xs text-blue-500"
                >({{
                  'SHARED.COMMON.COLUMN_SELECTOR.REQUIRED' | translate
                }})</span
              >
            }
          </div>
...
`, styles: ["/* src/app/shared/components/grid/column-selector/column-selector.component.scss */\n:host {\n  display: block;\n}\n:host ::ng-deep .p-multiselect {\n  min-height: 120px;\n}\n:host ::ng-deep .p-multiselect .p-multiselect-label {\n  min-height: 2.5rem;\n  display: flex;\n  align-items: center;\n  flex-wrap: wrap;\n  gap: 0.25rem;\n}\n:host ::ng-deep .p-multiselect .p-multiselect-token {\n  font-size: 0.875rem;\n  padding: 0.25rem 0.5rem;\n}\n/*# sourceMappingURL=column-selector.component.css.map */\n"] }]
  }], () => [], { columns: [{ type: Input, args: [{ isSignal: true, alias: "columns", required: true }] }], selectedColumns: [{ type: Input, args: [{ isSignal: true, alias: "selectedColumns", required: false }] }], disabled: [{ type: Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], inputClass: [{ type: Input, args: [{ isSignal: true, alias: "inputClass", required: false }] }], columnChange: [{ type: Output, args: ["columnChange"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ColumnSelectorComponent, { className: "ColumnSelectorComponent", filePath: "src/app/shared/components/grid/column-selector/column-selector.component.ts", lineNumber: 39 });
})();
...
var GridPreferenceService = class _GridPreferenceService {
  ...
  generateSchemaVersion(gridConfig) {
    const columnFields = gridConfig.columns.map((col) => String(col.field)).sort((a, b) => a.localeCompare(b)).join("|");
  ...
  validateAndSyncPreferences(gridConfig, storedData) {
    const availableFields = new Set(gridConfig.columns.map((col) => String(col.field)));
    ...
    return validStoredColumns.length > 0 ? validStoredColumns : this.getDefaultColumns(gridConfig);
  }
  /**
  ...
  getDefaultColumns(gridConfig) {
    ...
    return gridConfig.columns.map((col) => String(col.field));
  }
  /**
   * Retrieves the visible columns for a specific grid or tree table.
   * Automatically handles schema changes and maintains sync.
   * Works with both GridConfiguration and TreeTableConfiguration.
   *
   * @param gridConfig - The configuration object for the grid or tree table.
  ...
  getVisibleColumns(gridConfig) {
    ...
    const schemaMatches = storedData?.schemaVersion === currentSchema;
    if (isNullOrUndefined(storedData) || schemaMatches && JSON.stringify(storedData.visibleColumns) !== JSON.stringify(syncedColumns)) {
  ...
  saveVisibleColumns(gridId, visibleColumns, schemaVersion) {
    const allPreferences = this.localStorageService.getItem(GRID_PREFERENCES_KEY) ?? {};
    const existing = allPreferences[gridId];
    const version = schemaVersion ?? "unknown";
    const keepWidths = existing?.schemaVersion === version;
    allPreferences[gridId] = {
      visibleColumns,
      columnWidths: keepWidths ? existing?.columnWidths : void 0,
  ...
  /**
   * Retrieves user-resized column widths for a grid.
   *
   * Returns an empty map unless the stored schema version still matches the
   * current column set - widths captured against a different set of columns
   * would produce a mixed px/% layout, so they are discarded rather than
   * partially applied.
   */
  getColumnWidths(gridConfig) {
    const allPreferences = this.localStorageService.getItem(GRID_PREFERENCES_KEY) ?? {};
    const storedData = allPreferences[gridConfig.entityType];
    if (isNullOrUndefined(storedData?.columnWidths)) {
      return {};
    }
    return storedData.schemaVersion === this.generateSchemaVersion(gridConfig) ? storedData.columnWidths : {};
  }
  /**
   * Saves user-resized column widths, leaving the stored visible-column
   * selection untouched.
   */
  saveColumnWidths(gridConfig, columnWidths) {
    const allPreferences = this.localStorageService.getItem(GRID_PREFERENCES_KEY) ?? {};
    const gridId = gridConfig.entityType;
    const existing = allPreferences[gridId];
    allPreferences[gridId] = {
      visibleColumns: existing?.visibleColumns ?? this.getDefaultColumns(gridConfig),
      columnWidths,
      schemaVersion: this.generateSchemaVersion(gridConfig),
      lastUpdated: Date.now()
    };
    this.localStorageService.setItem(GRID_PREFERENCES_KEY, allPreferences);
  }
...
function AdminGridContainerComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 14);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function AdminGridContainerComponent_Conditional_10_Template_button_click_0_listener() {
      let tmp_2_0;
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("pTooltip", ((tmp_2_0 = ctx_r1.gridConfiguration()) == null ? null : tmp_2_0.bulkImportLabel) || \u0275\u0275pipeBind1(1, 5, "SHARED.COMMON.BUTTONS.BULK_IMPORT"));
    \u0275\u0275attribute("aria-label", ((tmp_3_0 = ctx_r1.gridConfiguration()) == null ? null : tmp_3_0.bulkImportLabel) || \u0275\u0275pipeBind1(2, 7, "ADMIN.SHARED.ARIA.BULK_IMPORT"));
  }
}
var AdminGridContainerComponent = class _AdminGridContainerComponent {
  ...
  lastSelectionWasMeta = false;
  // Computed property to check if filtering is enabled for the current config
  canFilter = computed(() => this.columns().some((col) => col.filter === true), ...ngDevMode ? [{ debugName: "canFilter" }] : (
    /* istanbul ignore next */
    []
  ));
  gridSelectionMode = computed(() => {
    const mode = this.gridConfiguration()?.selectionMode ?? "single";
    return mode === "checkbox" ? "multiple" : mode;
  }, ...ngDevMode ? [{ debugName: "gridSelectionMode" }] : (
    /* istanbul ignore next */
    []
  ));
  showCheckboxColumn = computed(() => this.gridConfiguration()?.selectionMode === "checkbox", ...ngDevMode ? [{ debugName: "showCheckboxColumn" }] : (
    /* istanbul ignore next */
    []
  ));
  /**
   * i18n key for the entity noun shown in the paginator count (e.g. "825 Devices").
   * The config's kebab `entityType` derives to `ADMIN.ENTITIES.<UPPER_SNAKE>` for
   * the common case; the alias map covers entity types whose noun lives under a
   * legacy key name (geofence↔zone, client-assets↔assets). Unknown types fall
   * through to `undefined`, letting the grid use its generic "items" fallback.
   */
  entityLabelKeyAliases = {
    geofences: "ADMIN.ENTITIES.ZONES",
    "geofence-groups": "ADMIN.ENTITIES.ZONE_GROUPS",
    "client-contacts": "ADMIN.ENTITIES.CONTACTS",
    "client-assets": "ADMIN.ENTITIES.ASSETS"
  };
  entityLabelKey = computed(() => {
    const entityType = this.gridConfiguration()?.entityType;
    if (!isString(entityType) || entityType.length === 0) {
      return void 0;
    }
    return this.entityLabelKeyAliases[entityType] ?? `ADMIN.ENTITIES.${entityType.toUpperCase().replace(/-/g, "_")}`;
  }, ...ngDevMode ? [{ debugName: "entityLabelKey" }] : (
    /* istanbul ignore next */
    []
  ));
  // Helper to make columns compatible with column selector
  selectableColumns = computed(() => this.columns().map((col) => ({
    field: col.field,
    header: col.header
  })), ...ngDevMode ? [{ debugName: "selectableColumns" }] : (
    /* istanbul ignore next */
    []
  ));
  constructor() {
  ...
  onExport() {
    ...
    const result = config.onExport();
    if (!isObservable(result))
      return;
    this.exporting.set(true);
    result.pipe(takeUntilDestroyed(this.destroyRef), catchError(() => EMPTY), finalize(() => this.exporting.set(false))).subscribe();
  }
  onRefresh() {
    const config = this.gridConfiguration();
    if (!this.isValidConfig(config)) {
  ...
  handleRowSelect(event) {
    ...
    this.lastSelectionWasMeta = (originalEvent?.ctrlKey ?? false) || (originalEvent?.metaKey ?? false);
    const routeEntityType = this.detailsFactory.getEntityTypeFromRoute(this.activatedRoute, "type");
    const selectedRows = Array.isArray(this.grid?.selectedRows) ? this.grid.selectedRows : this.grid?.selectedRows ? [this.grid.selectedRows] : [];
    const withEntityType = selectedRows.map((row) => __spreadProps(__spreadValues({}, row), {
      entityType: routeEntityType ?? row["type"]
    }));
    const componentType = this.detailsFactory.getDetailsComponent(String(withEntityType[0]?.entityType));
    const isMultiSelect = withEntityType.length > 1 || this.lastSelectionWasMeta;
    this.lastSelectionWasMeta = false;
    if (isMultiSelect) {
      this.bulkSelectionService.setAll(withEntityType);
      this.broadcastService.broadcast("grid-items-selected", {
        items: withEntityType,
        componentType
      });
    } else {
      this.bulkSelectionService.clear();
      this.broadcastService.broadcast("grid-item-selected", {
        item: withEntityType[0],
        componentType
      });
    }
  }
  handleRowUnselect(event) {
    ...
    if (withEntityType.length === 0) {
      this.bulkSelectionService.clear();
      if (this.detailsService.showPanel()) {
   ...
   */
  waitForColumnsReady() {
    return toObservable(this.columns, { injector: this.injector }).pipe(filter((cols) => cols.length > 0), first(), map(() => void 0), timeout(2e3), catchError(() => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminGridContainerComponent, selectors: [["app-admin-grid-container"]], viewQuery: function AdminGridContainerComponent_Query(rf, ctx) {
  ...
  }, decls: 27, vars: 71, consts: [[1, "flex", "flex-col", "h-full", "w-full", "overflow-hidden"], [1, "p-4", "content-header", "flex-none", "w-full"], [1, "flex", "justify-between", "items-center"], ["id", "gridTitle", 1, "text-xl", "font-semibold", "truncate"], [1, "flex-none", "flex", "space-x-4", "align-center"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-plus", "action", "hover", 3, "click", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 3, "class", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-refresh", "action", "hover", 3, "click", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-filter-fill", "action", "hover", 3, "click", "pTooltip", "disabled"], [3, "columnChange", "columns", "selectedColumns", "disabled"], ["tooltipPosition", "bottom", 1, "pi", "action", "hover", 3, "click", "pTooltip", "disabled"], [1, "flex-1", "min-h-0", "w-full", "overflow-hidden"], ["role", "grid", "styleClass", "table-height", 1, "h-full", "max-w-full", 3, "onLazyLoad", "onFilterChange", "rowSelect", "rowUnselect", "columns", "data", "pagination", "totalRecords", "entityLabelKey", "lazy", "filterable", "visibleColumns", "selectionMode", "showCheckboxColumn", "metaKeySelection", "dataKey", "loading", "scrollable", "scrollHeight", "initialFilters", "sortable"], ["aria-live", "polite", "aria-atomic", "true", 1, "sr-only"], ["type", "button", "tooltipPosition", "bottom", 3, "click", "pTooltip"]], template: function AdminGridContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(10, AdminGridContainerComponent_Conditional_10_Template, 3, 9, "button", 6);
      ...
      \u0275\u0275pipe(15, "translate");
      \u0275\u0275pipe(16, "translate");
      \u0275\u0275listener("click", function AdminGridContainerComponent_Template_button_click_14_listener() {
        return ctx.onFilterToggle();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "app-column-selector", 9);
      \u0275\u0275listener("columnChange", function AdminGridContainerComponent_Template_app_column_selector_columnChange_17_listener($event) {
      ...
      \u0275\u0275pipe(21, "translate");
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275listener("click", function AdminGridContainerComponent_Template_button_click_18_listener() {
        return ctx.onExport();
      });
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(23, "div", 11)(24, "app-grid", 12);
      \u0275\u0275listener("onLazyLoad", function AdminGridContainerComponent_Template_app_grid_onLazyLoad_24_listener($event) {
        return ctx.handleLazyLoad($event);
      })("onFilterChange", function AdminGridContainerComponent_Template_app_grid_onFilterChange_24_listener($event) {
        return ctx.handleFilterChange($event);
      })("rowSelect", function AdminGridContainerComponent_Template_app_grid_rowSelect_24_listener($event) {
        return ctx.handleRowSelect($event);
      })("rowUnselect", function AdminGridContainerComponent_Template_app_grid_rowUnselect_24_listener($event) {
        return ctx.handleRowUnselect($event);
      });
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(6, 49, "ADMIN.SHARED.ARIA.GRID_ACTIONS"));
      \u0275\u0275advance(2);
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(8, 51, "SHARED.COMMON.BUTTONS.ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(9, 53, "ADMIN.SHARED.ARIA.ADD_NEW_ITEM"))("aria-disabled", !((tmp_4_0 = ctx.gridConfiguration()) == null ? null : tmp_4_0.onAdd));
      \u0275\u0275advance(3);
      \u0275\u0275conditional(((tmp_5_0 = ctx.gridConfiguration()) == null ? null : tmp_5_0.onBulkImport) ? 10 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(12, 55, "SHARED.COMMON.BUTTONS.REFRESH"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 57, "ADMIN.SHARED.ARIA.REFRESH_GRID_DATA"))("aria-busy", ctx.loading());
      \u0275\u0275advance(3);
      \u0275\u0275classProp("text-primary", ctx.showFilters());
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(15, 59, "ADMIN.SHARED.TOOLTIPS.FILTER"))("disabled", !ctx.canFilter());
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(16, 61, "ADMIN.SHARED.ARIA.TOGGLE_FILTERS"))("aria-disabled", !ctx.canFilter());
      \u0275\u0275advance(3);
      \u0275\u0275property("columns", ctx.selectableColumns())("selectedColumns", ctx.visibleColumns())("disabled", !ctx.gridConfiguration());
      \u0275\u0275advance();
      \u0275\u0275classProp("pi-download", !ctx.exporting())("pi-spinner", ctx.exporting())("pi-spin", ctx.exporting());
      \u0275\u0275property("pTooltip", ctx.exporting() ? \u0275\u0275pipeBind1(19, 63, "SHARED.COMMON.BUTTONS.EXPORTING") + "..." : \u0275\u0275pipeBind1(20, 65, "ADMIN.SHARED.TOOLTIPS.EXPORT_CSV"))("disabled", ctx.exporting());
      \u0275\u0275attribute("aria-label", ctx.exporting() ? \u0275\u0275pipeBind1(21, 67, "ADMIN.SHARED.ARIA.EXPORTING") : \u0275\u0275pipeBind1(22, 69, "ADMIN.SHARED.ARIA.EXPORT_TO_CSV"))("aria-busy", ctx.exporting());
      \u0275\u0275advance(6);
      \u0275\u0275property("columns", ctx.columns())("data", ctx.data())("pagination", true)("totalRecords", ctx.totalRecords())("entityLabelKey", ctx.entityLabelKey())("lazy", true)("filterable", ctx.showFilters())("visibleColumns", ctx.visibleColumns())("selectionMode", ctx.gridSelectionMode())("showCheckboxColumn", ctx.showCheckboxColumn())("metaKeySelection", true)("dataKey", "id")("loading", ctx.loading())("scrollable", true)("scrollHeight", "flex")("initialFilters", ctx.currentFilters())("sortable", true);
...
(() => {
  ...
  <div class="p-4 content-header flex-none w-full">
    <div class="flex justify-between items-center">
      ...
      <div
        ...
        [attr.aria-label]="'ADMIN.SHARED.ARIA.GRID_ACTIONS' | translate"
      >
        <button
          type="button"
          class="pi pi-plus action hover"
          [pTooltip]="'SHARED.COMMON.BUTTONS.ADD' | translate"
          tooltipPosition="bottom"
          [attr.aria-label]="'ADMIN.SHARED.ARIA.ADD_NEW_ITEM' | translate"
        ...
        @if (gridConfiguration()?.onBulkImport) {
          <button
            ...
            [pTooltip]="
              gridConfiguration()?.bulkImportLabel ||
              ('SHARED.COMMON.BUTTONS.BULK_IMPORT' | translate)
            "
            tooltipPosition="bottom"
            [attr.aria-label]="
              gridConfiguration()?.bulkImportLabel ||
              ('ADMIN.SHARED.ARIA.BULK_IMPORT' | translate)
            "
        ...
        <button
          ...
          [pTooltip]="'SHARED.COMMON.BUTTONS.REFRESH' | translate"
          tooltipPosition="bottom"
          (click)="onRefresh()"
          [attr.aria-label]="'ADMIN.SHARED.ARIA.REFRESH_GRID_DATA' | translate"
          [attr.aria-busy]="loading()"
        ></button>
        <button
          type="button"
          class="pi pi-filter-fill action hover"
          [pTooltip]="'ADMIN.SHARED.TOOLTIPS.FILTER' | translate"
          tooltipPosition="bottom"
          [class.text-primary]="showFilters()"
          (click)="onFilterToggle()"
          [attr.aria-label]="'ADMIN.SHARED.ARIA.TOGGLE_FILTERS' | translate"
          [attr.aria-disabled]="!canFilter()"
          [disabled]="!canFilter()"
        ></button>
        <app-column-selector
        ...
        ></app-column-selector>
        <button
          class="pi action hover"
          [class.pi-download]="!exporting()"
          [class.pi-spinner]="exporting()"
          [class.pi-spin]="exporting()"
          [pTooltip]="
            exporting()
              ? ('SHARED.COMMON.BUTTONS.EXPORTING' | translate) + '...'
              : ('ADMIN.SHARED.TOOLTIPS.EXPORT_CSV' | translate)
          "
          tooltipPosition="bottom"
          [disabled]="exporting()"
          (click)="onExport()"
          [attr.aria-label]="
            exporting()
              ? ('ADMIN.SHARED.ARIA.EXPORTING' | translate)
              : ('ADMIN.SHARED.ARIA.EXPORT_TO_CSV' | translate)
          "
  ...
  <div class="flex-1 min-h-0 w-full overflow-hidden">
    <app-grid
      ...
      (rowUnselect)="handleRowUnselect($event)"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminGridContainerComponent, { className: "AdminGridContainerComponent", filePath: "src/app/features/administration/components/admin-grid-container/admin-grid-container.component.ts", lineNumber: 91 });
})();
...
var _c02 = ["tt"];
var _c110 = (a0) => ({ "min-width.px": a0 });
var _c210 = () => [];
var _c310 = (a0, a1, a2) => ({ $implicit: a0, rowData: a1, field: a2 });
var _forTrack0 = ($index, $item) => $item.field;
function TreeTableComponent_ng_template_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "col", 7);
  }
}
function TreeTableComponent_ng_template_2_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "col");
  }
  if (rf & 2) {
    const col_r1 = ctx.$implicit;
    \u0275\u0275styleProp("width", col_r1.width)("min-width", col_r1.minWidth, "px");
  }
}
function TreeTableComponent_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "colgroup");
    \u0275\u0275conditionalCreate(1, TreeTableComponent_ng_template_2_Conditional_1_Template, 1, 0, "col", 7);
    \u0275\u0275repeaterCreate(2, TreeTableComponent_ng_template_2_For_3_Template, 1, 4, "col", 8, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.selectionMode() === "checkbox" || ctx_r1.selectionMode() === "multiple" ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.displayedColumns());
  }
}
function TreeTableComponent_ng_template_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 9);
    \u0275\u0275element(1, "p-treeTableHeaderCheckbox");
    \u0275\u0275elementEnd();
  }
}
function TreeTableComponent_ng_template_4_For_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 13);
  }
  if (rf & 2) {
    ...
    \u0275\u0275classProp("pi-sort-alt", ctx_r1.sortField() !== col_r4.field)("pi-sort-amount-up-alt", ctx_r1.sortField() === col_r4.field && ctx_r1.sortOrder() === 1)("pi-sort-amount-down", ctx_r1.sortField() === col_r4.field && ctx_r1.sortOrder() === -1);
  }
}
function TreeTableComponent_ng_template_4_For_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "th", 11);
    \u0275\u0275listener("click", function TreeTableComponent_ng_template_4_For_3_Template_th_click_0_listener() {
      const col_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(col_r4.sortable && ctx_r1.cycleSort(col_r4.field));
    })("keydown.enter", function TreeTableComponent_ng_template_4_For_3_Template_th_keydown_enter_0_listener() {
      const col_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(col_r4.sortable && ctx_r1.cycleSort(col_r4.field));
    })("keydown.space", function TreeTableComponent_ng_template_4_For_3_Template_th_keydown_space_0_listener($event) {
      const col_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(col_r4.sortable && ctx_r1.onSortSpace($event, col_r4.field));
    });
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, TreeTableComponent_ng_template_4_For_3_Conditional_2_Template, 1, 6, "i", 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r4 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275styleProp("min-width", col_r4.minWidth, "px")("width", col_r4.width);
    \u0275\u0275classProp("p-sortable-column", col_r4.sortable)("p-treetable-column-sorted", col_r4.sortable && ctx_r1.sortField() === col_r4.field)("cursor-pointer", col_r4.sortable)("select-none", col_r4.sortable);
    \u0275\u0275property("ngClass", col_r4.styleClass);
    \u0275\u0275attribute("role", col_r4.sortable ? "columnheader" : null)("tabindex", col_r4.sortable ? 0 : null)("aria-sort", col_r4.sortable ? ctx_r1.ariaSort(col_r4.field) : null);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", col_r4.header, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(col_r4.sortable ? 2 : -1);
  }
}
function TreeTableComponent_ng_template_4_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "th", 9);
  }
}
function TreeTableComponent_ng_template_4_Conditional_4_For_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-filter-wrapper", 17);
    \u0275\u0275listener("filterChange", function TreeTableComponent_ng_template_4_Conditional_4_For_3_Conditional_1_Template_app_filter_wrapper_filterChange_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const col_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.handleFilterChange(col_r6.field, $event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r6 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("field", col_r6.field)("filterType", col_r6.filterType ?? "text")("options", col_r6.filterOptions ?? \u0275\u0275pureFunction0(4, _c210))("initialValue", ctx_r1.initialFilters()[col_r6.field]);
  }
}
function TreeTableComponent_ng_template_4_Conditional_4_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 15);
    \u0275\u0275conditionalCreate(1, TreeTableComponent_ng_template_4_Conditional_4_For_3_Conditional_1_Template, 1, 5, "app-filter-wrapper", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r6 = ctx.$implicit;
    \u0275\u0275styleProp("width", col_r6.width)("min-width", col_r6.minWidth, "px");
    \u0275\u0275property("ngClass", col_r6.styleClass);
    \u0275\u0275advance();
    \u0275\u0275conditional(col_r6.filterable ? 1 : -1);
  }
}
function TreeTableComponent_ng_template_4_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275conditionalCreate(1, TreeTableComponent_ng_template_4_Conditional_4_Conditional_1_Template, 1, 0, "th", 9);
    \u0275\u0275repeaterCreate(2, TreeTableComponent_ng_template_4_Conditional_4_For_3_Template, 2, 6, "th", 14, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function TreeTableComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275conditionalCreate(1, TreeTableComponent_ng_template_4_Conditional_1_Template, 2, 0, "th", 9);
    \u0275\u0275repeaterCreate(2, TreeTableComponent_ng_template_4_For_3_Template, 3, 18, "th", 10, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, TreeTableComponent_ng_template_4_Conditional_4_Template, 4, 1, "tr");
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275repeater(ctx_r1.displayedColumns());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.filterable() ? 4 : -1);
  }
}
function TreeTableComponent_ng_template_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 7);
    \u0275\u0275element(1, "p-treeTableCheckbox", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const rowNode_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("value", rowNode_r7);
  }
}
function TreeTableComponent_ng_template_6_For_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-treeTableToggler", 22);
  }
  if (rf & 2) {
    const rowNode_r7 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275property("rowNode", rowNode_r7);
  }
}
function TreeTableComponent_ng_template_6_For_3_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0, 23);
  }
  if (rf & 2) {
    const col_r8 = \u0275\u0275nextContext().$implicit;
    const rowData_r9 = \u0275\u0275nextContext().rowData;
    \u0275\u0275property("ngTemplateOutlet", col_r8.template)("ngTemplateOutletContext", \u0275\u0275pureFunction3(2, _c310, rowData_r9, rowData_r9, col_r8.field));
  }
}
function TreeTableComponent_ng_template_6_For_3_Conditional_5_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
    ...
    const rowData_r9 = \u0275\u0275nextContext().rowData;
    \u0275\u0275textInterpolate1(" ", col_r8.valueGetter(rowData_r9), " ");
  }
}
function TreeTableComponent_ng_template_6_For_3_Conditional_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function TreeTableComponent_ng_template_6_For_3_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275conditionalCreate(1, TreeTableComponent_ng_template_6_For_3_Conditional_5_Conditional_1_Template, 1, 1)(2, TreeTableComponent_ng_template_6_For_3_Conditional_5_Conditional_2_Template, 1, 1);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const col_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275conditional(col_r8.valueGetter ? 1 : 2);
  }
}
function TreeTableComponent_ng_template_6_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 21)(1, "div");
    \u0275\u0275conditionalCreate(2, TreeTableComponent_ng_template_6_For_3_Conditional_2_Template, 1, 1, "p-treeTableToggler", 22);
    \u0275\u0275elementStart(3, "div");
    \u0275\u0275conditionalCreate(4, TreeTableComponent_ng_template_6_For_3_Conditional_4_Template, 1, 6, "ng-container", 23)(5, TreeTableComponent_ng_template_6_For_3_Conditional_5_Template, 3, 1, "ng-container");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const col_r8 = ctx.$implicit;
    const \u0275$index_50_r10 = ctx.$index;
    \u0275\u0275styleProp("width", col_r8.width);
    \u0275\u0275classProp("tree-column-cell", \u0275$index_50_r10 === 0);
    \u0275\u0275property("ngClass", col_r8.styleClass);
    \u0275\u0275advance();
    \u0275\u0275classProp("tree-column-container", \u0275$index_50_r10 === 0);
    \u0275\u0275advance();
    \u0275\u0275conditional(\u0275$index_50_r10 === 0 ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("tree-column-value", \u0275$index_50_r10 === 0)("w-full", \u0275$index_50_r10 !== 0);
    \u0275\u0275advance();
    \u0275\u0275conditional(col_r8.type === "template" ? 4 : 5);
  }
}
function TreeTableComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 18);
    \u0275\u0275conditionalCreate(1, TreeTableComponent_ng_template_6_Conditional_1_Template, 2, 1, "td", 7);
    \u0275\u0275repeaterCreate(2, TreeTableComponent_ng_template_6_For_3_Template, 6, 13, "td", 19, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const rowNode_r7 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ttRow", rowNode_r7)("ttSelectableRow", rowNode_r7);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.selectionMode() === "checkbox" || ctx_r1.selectionMode() === "multiple" ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.displayedColumns());
...
function TreeTableComponent_ng_template_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.emptyMessage() || \u0275\u0275pipeBind1(3, 2, "SHARED.COMMON.STATUS.NO_DATA"), " ");
  }
}
function TreeTableComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275attribute("colspan", columns_r11.length);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 2, "SHARED.COMMON.STATUS.LOADING"), " ");
  }
}
var TreeTableComponent = class _TreeTableComponent {
  ...
  languageService = inject(LanguageService);
  /**
   * String handed to PrimeNG's [currentPageReportTemplate]. Resolves the entity
   * noun and returns e.g. "{totalRecords} Devices", keeping PrimeNG's own
   * {totalRecords} token as a literal for PrimeNG to substitute afterwards.
   *
   * Reading languageService.currentLanguage() makes this recompute on a
   * language switch (translate.instant() is not reactive on its own).
   *
   * i18n keys (shared with GridComponent):
   *   SHARED.GRID.PAGE_REPORT -> "{totalRecords} {{entity}}"
   *   SHARED.GRID.ITEMS       -> generic fallback noun, e.g. "items"
   */
  pageReportTemplate = computed(() => {
    this.languageService.currentLanguage();
    const key = this.entityLabelKey();
    const entity = this.translate.instant(key ?? "SHARED.GRID.ITEMS");
    return this.translate.instant("SHARED.GRID.PAGE_REPORT", { entity });
  }, ...ngDevMode ? [{ debugName: "pageReportTemplate" }] : (
    /* istanbul ignore next */
    []
  ));
  // Input properties
  ...
  // i18n key for the entity noun shown in the paginator count
  // (e.g. 'ADMIN.ENTITIES.DEVICES' -> "825 Devices"). When unset, the report
  // falls back to a generic translated noun ("items"). Mirrors GridComponent.
  entityLabelKey = input(void 0, ...ngDevMode ? [{ debugName: "entityLabelKey" }] : (
    /* istanbul ignore next */
    []
  ));
  ...
  /**
   * `expand` grows the table when a column is widened, letting the horizontal
   * scroll absorb it; `fit` would steal the width from the neighbour, which the
   * per-column min-width floors usually forbid.
   */
  columnResizeMode = input("expand", ...ngDevMode ? [{ debugName: "columnResizeMode" }] : (
    /* istanbul ignore next */
    []
  ));
  ...
  /**
   * User-resized widths in px, keyed by field. Applied only when the map covers
   * every visible column - see {@link allocatedWidths}.
   */
  storedWidths = input({}, ...ngDevMode ? [{ debugName: "storedWidths" }] : (
    /* istanbul ignore next */
    []
  ));
  // Output events
  ...
  /** Complete px snapshot of every visible column, emitted after a resize. */
  columnResize = output();
  // Three-state sort owned by this wrapper (PrimeNG 21 has no `removableSort`).
  // See GridComponent for the full rationale — same mechanism, TreeTable inputs.
  sortField = signal(null, ...ngDevMode ? [{ debugName: "sortField" }] : (
    /* istanbul ignore next */
    []
  ));
  sortOrder = signal(1, ...ngDevMode ? [{ debugName: "sortOrder" }] : (
    /* istanbul ignore next */
    []
  ));
  // Single assembly point for column widths. Any user/stored width overrides
  // layer in here, on top of the pure allocation - never inside the utility.
  allocatedWidths = computed(() => {
    const allColumns = this.columns();
    const visibleColumnFields = this.visibleColumns();
    const filteredColumns = visibleColumnFields.length === 0 ? allColumns : allColumns.filter((col) => visibleColumnFields.includes(col.field));
    const allocation = allocateTreeTableColumnWidths(filteredColumns.map((col) => __spreadProps(__spreadValues({}, col), {
      field: col.field
    })));
    const stored = this.storedWidths();
    const coversEveryColumn = allocation.columns.length > 0 && allocation.columns.every((col) => isDefined(stored[col.field]));
    if (!coversEveryColumn) {
      return allocation;
    }
    return __spreadProps(__spreadValues({}, allocation), {
      columns: allocation.columns.map((col) => __spreadProps(__spreadValues({}, col), {
        width: `${stored[col.field]}px`
      }))
    });
  }, ...ngDevMode ? [{ debugName: "allocatedWidths" }] : (
    /* istanbul ignore next */
    []
  ));
  /** The template renders a leading checkbox `th` in these selection modes. */
  hasSelectionColumn = computed(() => this.selectionMode() === "checkbox" || this.selectionMode() === "multiple", ...ngDevMode ? [{ debugName: "hasSelectionColumn" }] : (
    /* istanbul ignore next */
    []
  ));
  // Computed property to get visible columns
  displayedColumns = computed(() => this.allocatedWidths().columns, ...ngDevMode ? [{ debugName: "displayedColumns" }] : (
    /* istanbul ignore next */
    []
  ));
  /** px floor for the table; below this it scrolls horizontally. */
  tableMinWidth = computed(() => this.allocatedWidths().tableMinWidth, ...ngDevMode ? [{ debugName: "tableMinWidth" }] : (
    /* istanbul ignore next */
    []
  ));
  constructor() {
  ...
  /**
   * Three-state sort cycle for a single column (Ascending -> Descending -> Off),
   * driving PrimeNG via the controlled [sortField]/[sortOrder] inputs.
   */
  cycleSort(field) {
  ...
  /** Keyboard activation via Space; prevents the page from scrolling. */
  onSortSpace(event, field) {
    event.preventDefault();
    this.cycleSort(field);
  }
  emitClearedLazyLoad() {
    if (!this.lazy()) {
      return;
    }
    const first2 = this.treeTable?.first ?? 0;
    const rows = this.treeTable?.rows ?? this.rows();
    this.lazyLoad.emit({
      first: first2,
      rows,
      last: first2 + rows,
      sortField: null,
      sortOrder: void 0,
      filters: this.treeTable?.filters ?? {}
    });
  }
  /**
   * Snapshots the rendered width of every visible column after a drag.
   *
   * PrimeNG reports the resized `th` rather than the column, so widths are read
   * back off the header row by position - offset by the checkbox column when
   * one is rendered.
   */
  onColResize(event) {
    const headerRow = event.element.parentElement;
    if (!isDefined(headerRow)) {
      return;
    }
    const cells = Array.from(headerRow.children);
    const offset = this.hasSelectionColumn() ? 1 : 0;
    const widths = {};
    this.displayedColumns().forEach((col, index) => {
      const cell = cells[index + offset];
      if (isDefined(cell)) {
        widths[col.field] = Math.round(cell.getBoundingClientRect().width);
      }
    });
    this.columnResize.emit(widths);
  }
  onFilter(event) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TreeTableComponent, selectors: [["app-tree-table"]], viewQuery: function TreeTableComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c02, 5)(FilterWrapperComponent, 5);
    }
    if (rf & 2) {
      let _t;
  ...
  }, inputs: { nodes: [1, "nodes"], columns: [1, "columns"], selectionMode: [1, "selectionMode"], loading: [1, "loading"], emptyMessage: [1, "emptyMessage"], styleClass: [1, "styleClass"], selection: [1, "selection"], paginator: [1, "paginator"], rows: [1, "rows"], rowsPerPageOptions: [1, "rowsPerPageOptions"], totalRecords: [1, "totalRecords"], entityLabelKey: [1, "entityLabelKey"], lazy: [1, "lazy"], scrollable: [1, "scrollable"], scrollHeight: [1, "scrollHeight"], resizableColumns: [1, "resizableColumns"], columnResizeMode: [1, "columnResizeMode"], reorderableColumns: [1, "reorderableColumns"], rowHover: [1, "rowHover"], filterMode: [1, "filterMode"], filterable: [1, "filterable"], visibleColumns: [1, "visibleColumns"], initialFilters: [1, "initialFilters"], metaKeySelection: [1, "metaKeySelection"], storedWidths: [1, "storedWidths"] }, outputs: { nodeSelect: "nodeSelect", nodeUnselect: "nodeUnselect", selectionChange: "selectionChange", nodeExpand: "nodeExpand", nodeCollapse: "nodeCollapse", lazyLoad: "lazyLoad", pageChange: "pageChange", sort: "sort", filter: "filter", onFilterChange: "onFilterChange", columnResize: "columnResize" }, decls: 12, vars: 25, consts: [["tt", ""], ["colgroup", ""], ["header", ""], ["body", ""], ["emptymessage", ""], ["loadingbody", ""], [3, "onNodeSelect", "onNodeUnselect", "selectionChange", "onNodeExpand", "onNodeCollapse", "onLazyLoad", "onPage", "onSort", "onColResize", "onFilter", "value", "columns", "selectionMode", "selection", "loading", "paginator", "showCurrentPageReport", "currentPageReportTemplate", "rows", "rowsPerPageOptions", "totalRecords", "lazy", "scrollable", "scrollHeight", "tableStyle", "resizableColumns", "columnResizeMode", "reorderableColumns", "rowHover", "sortField", "sortOrder", "filterMode", "metaKeySelection"], [1, "w-12"], [3, "width", "min-width"], ["scope", "col", 1, "w-12"], ["scope", "col", "ttResizableColumn", "", 3, "min-width", "p-sortable-column", "p-treetable-column-sorted", "cursor-pointer", "select-none", "width", "ngClass"], ["scope", "col", "ttResizableColumn", "", 3, "click", "keydown.enter", "keydown.space", "ngClass"], ["aria-hidden", "true", 1, "pi", "ml-1", "text-xs", 3, "pi-sort-alt", "pi-sort-amount-up-alt", "pi-sort-amount-down"], ["aria-hidden", "true", 1, "pi", "ml-1", "text-xs"], ["scope", "col", 3, "width", "min-width", "ngClass"], ["scope", "col", 3, "ngClass"], [3, "field", "filterType", "options", "initialValue"], [3, "filterChange", "field", "filterType", "options", "initialValue"], [3, "ttRow", "ttSelectableRow"], [3, "tree-column-cell", "width", "ngClass"], [3, "value"], [3, "ngClass"], [3, "rowNode"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "flex", "justify-content-center", "align-items-center"]], template: function TreeTableComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "p-treeTable", 6, 0);
      ...
      })("selectionChange", function TreeTableComponent_Template_p_treeTable_selectionChange_0_listener($event) {
        return ctx.onSelectionChange($event);
      ...
      })("onColResize", function TreeTableComponent_Template_p_treeTable_onColResize_0_listener($event) {
        return ctx.onColResize($event);
      })("onFilter", function TreeTableComponent_Template_p_treeTable_onFilter_0_listener($event) {
        return ctx.onFilter($event);
      });
      \u0275\u0275template(2, TreeTableComponent_ng_template_2_Template, 4, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(4, TreeTableComponent_ng_template_4_Template, 5, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(6, TreeTableComponent_ng_template_6_Template, 4, 3, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(8, TreeTableComponent_ng_template_8_Template, 4, 4, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(10, TreeTableComponent_ng_template_10_Template, 5, 4, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275property("value", ctx.nodes())("columns", ctx.columns())("selectionMode", ctx.selectionMode())("selection", ctx.selection())("loading", ctx.loading())("paginator", ctx.paginator())("showCurrentPageReport", ctx.paginator())("currentPageReportTemplate", ctx.pageReportTemplate())("rows", ctx.rows())("rowsPerPageOptions", ctx.rowsPerPageOptions())("totalRecords", ctx.totalRecords())("lazy", ctx.lazy())("scrollable", ctx.scrollable())("scrollHeight", ctx.scrollHeight())("tableStyle", \u0275\u0275pureFunction1(23, _c110, ctx.tableMinWidth()))("resizableColumns", ctx.resizableColumns())("columnResizeMode", ctx.columnResizeMode())("reorderableColumns", ctx.reorderableColumns())("rowHover", ctx.rowHover())("sortField", ctx.sortField())("sortOrder", ctx.sortOrder())("filterMode", ctx.filterMode())("metaKeySelection", ctx.metaKeySelection());
    }
  }, dependencies: [
    CommonModule,
    NgClass,
    ...
    TooltipModule,
    TranslatePipe
  ], styles: ['@charset "UTF-8";\n\n\n[_nghost-%COMP%] {\n  display: block;\n  width: 100%;\n  height: 100%;\n}\n[_nghost-%COMP%]     .p-treetable-table {\n  table-layout: fixed;\n  width: 100%;\n}\n[_nghost-%COMP%]     {\n}\n[_nghost-%COMP%]     .p-treetable-flex-scrollable .p-treetable-scrollable-wrapper {\n  flex: 1 1 auto;\n  min-height: 0;\n}\n[_nghost-%COMP%]     .p-treetable-flex-scrollable .p-paginator {\n  flex-shrink: 0;\n}\n[_nghost-%COMP%]     .p-paginator {\n  position: relative;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n[_nghost-%COMP%]     .p-paginator .p-paginator-current {\n  position: absolute;\n  right: 0.5rem;\n}\n[_nghost-%COMP%]     {\n}\n[_nghost-%COMP%]     .p-column-resizer {\n  width: 9px;\n  border-right: 1px solid var(--surface-border);\n  transition: background-color 0.15s ease, border-right-color 0.15s ease;\n}\n[_nghost-%COMP%]     .p-column-resizer:hover {\n  background-color: var(--color-primary-color, var(--primary-color));\n  border-right-color: var(--color-primary-color, var(--primary-color));\n  opacity: 0.45;\n}\n[_nghost-%COMP%]     .col-name {\n  word-break: break-word;\n  overflow-wrap: anywhere;\n}\n[_nghost-%COMP%]     .col-compact {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr {\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr > td {\n  vertical-align: top;\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr {\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr.shared-asset-row {\n  opacity: 0.55;\n  cursor: not-allowed;\n  font-style: italic;\n  background-color: var(--surface-ground);\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr {\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr .p-treetable-indent {\n  width: 1.5rem;\n  height: 1.5rem;\n  position: relative;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr .p-treetable-indent::before {\n  content: "";\n  position: absolute;\n  left: 50%;\n  top: -1.25rem;\n  bottom: -1.25rem;\n  width: 1px;\n  opacity: 0.4;\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr .p-treetable-toggler {\n  margin-right: 0.5rem;\n  position: relative;\n  z-index: 2;\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr .p-treetable-toggler::before {\n  content: "";\n  position: absolute;\n  right: 100%;\n  top: 50%;\n  width: 0.75rem;\n  height: 1px;\n  opacity: 0.4;\n  pointer-events: none;\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr .p-treetable-toggler {\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr .p-treetable-toggler.p-disabled {\n  visibility: hidden;\n  pointer-events: none;\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr {\n}\n[_nghost-%COMP%]     .p-treetable-tbody > tr:hover .p-treetable-indent::before, \n[_nghost-%COMP%]     .p-treetable-tbody > tr:hover .p-treetable-toggler::before {\n  background-color: var(--color-primary-color, var(--primary-color));\n  opacity: 0.8;\n}\n.tree-column-container[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  width: 100%;\n}\n/*# sourceMappingURL=tree-table.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TreeTableComponent, [{
    type: Component,
    args: [{ selector: "app-tree-table", imports: [
      CommonModule,
      TreeTableModule,
      ContextMenuModule,
      FilterWrapperComponent,
  ...
  [scrollHeight]="scrollHeight()"
  [tableStyle]="{ 'min-width.px': tableMinWidth() }"
...
>
  <!-- PrimeNG resizes a scrollable table by writing widths into a colgroup and
       throws without one, before it emits onColResize. The col order must match
       the header cells exactly, checkbox column included - PrimeNG indexes into
       this by the resized th's position in its row. -->
  <ng-template #colgroup>
    <colgroup>
      @if (selectionMode() === 'checkbox' || selectionMode() === 'multiple') {
        <col class="w-12" />
      }
      @for (col of displayedColumns(); track col.field) {
        <!-- eslint-disable-next-line @angular-eslint/template/no-inline-styles -->
        <col [style.width]="col.width" [style.min-width.px]="col.minWidth" />
      }
    </colgroup>
  </ng-template>
  ...
  <ng-template #header let-columns>
    <tr>
      @if (selectionMode() === 'checkbox' || selectionMode() === 'multiple') {
        <th class="w-12" scope="col"><p-treeTableHeaderCheckbox /></th>
      }
      @for (col of displayedColumns(); track col.field) {
        <!-- eslint-disable-next-line @angular-eslint/template/no-inline-styles -->
        <th
          ...
          [attr.aria-sort]="col.sortable ? ariaSort(col.field) : null"
          [class.p-sortable-column]="col.sortable"
          [class.p-treetable-column-sorted]="
            col.sortable && sortField() === col.field
          "
          [class.cursor-pointer]="col.sortable"
          [class.select-none]="col.sortable"
          (click)="col.sortable && cycleSort(col.field)"
          (keydown.enter)="col.sortable && cycleSort(col.field)"
          (keydown.space)="col.sortable && onSortSpace($event, col.field)"
          [style.width]="col.width"
          [ngClass]="col.styleClass"
        >
          {{ col.header }}
          @if (col.sortable) {
            <!-- Icon driven by controlled sort state so the 'Off' state clears. -->
            <i
              aria-hidden="true"
              class="pi ml-1 text-xs"
              [class.pi-sort-alt]="sortField() !== col.field"
  ...
  <ng-template #body let-rowNode let-rowData="rowData" let-columns="columns">
    <tr [ttRow]="rowNode" [ttSelectableRow]="rowNode">
      @if (selectionMode() === 'checkbox' || selectionMode() === 'multiple') {
        <td class="w-12"><p-treeTableCheckbox [value]="rowNode" /></td>
      }
      @for (col of displayedColumns(); track col.field; let i = $index) {
        <!-- eslint-disable-next-line @angular-eslint/template/no-inline-styles -->
        <td
          [class.tree-column-cell]="i === 0"
          [style.width]="col.width"
          [ngClass]="col.styleClass"
        >
          <div [class.tree-column-container]="i === 0">
            @if (i === 0) {
              <p-treeTableToggler [rowNode]="rowNode"></p-treeTableToggler>
            }
            <div [class.tree-column-value]="i === 0" [class.w-full]="i !== 0">
...
`, styles: ['@charset "UTF-8";\n\n/* src/app/shared/components/tree-table/tree-table.component.scss */\n:host {\n  display: block;\n  width: 100%;\n  height: 100%;\n}\n:host ::ng-deep .p-treetable-table {\n  table-layout: fixed;\n  width: 100%;\n}\n:host ::ng-deep {\n}\n:host ::ng-deep .p-treetable-flex-scrollable .p-treetable-scrollable-wrapper {\n  flex: 1 1 auto;\n  min-height: 0;\n}\n:host ::ng-deep .p-treetable-flex-scrollable .p-paginator {\n  flex-shrink: 0;\n}\n:host ::ng-deep .p-paginator {\n  position: relative;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n:host ::ng-deep .p-paginator .p-paginator-current {\n  position: absolute;\n  right: 0.5rem;\n}\n:host ::ng-deep {\n}\n:host ::ng-deep .p-column-resizer {\n  width: 9px;\n  border-right: 1px solid var(--surface-border);\n  transition: background-color 0.15s ease, border-right-color 0.15s ease;\n}\n:host ::ng-deep .p-column-resizer:hover {\n  background-color: var(--color-primary-color, var(--primary-color));\n  border-right-color: var(--color-primary-color, var(--primary-color));\n  opacity: 0.45;\n}\n:host ::ng-deep .col-name {\n  word-break: break-word;\n  overflow-wrap: anywhere;\n}\n:host ::ng-deep .col-compact {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n:host ::ng-deep .p-treetable-tbody > tr {\n}\n:host ::ng-deep .p-treetable-tbody > tr > td {\n  vertical-align: top;\n}\n:host ::ng-deep .p-treetable-tbody > tr {\n}\n:host ::ng-deep .p-treetable-tbody > tr.shared-asset-row {\n  opacity: 0.55;\n  cursor: not-allowed;\n  font-style: italic;\n  background-color: var(--surface-ground);\n}\n:host ::ng-deep .p-treetable-tbody > tr {\n}\n:host ::ng-deep .p-treetable-tbody > tr .p-treetable-indent {\n  width: 1.5rem;\n  height: 1.5rem;\n  position: relative;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n}\n:host ::ng-deep .p-treetable-tbody > tr .p-treetable-indent::before {\n  content: "";\n  position: absolute;\n  left: 50%;\n  top: -1.25rem;\n  bottom: -1.25rem;\n  width: 1px;\n  opacity: 0.4;\n}\n:host ::ng-deep .p-treetable-tbody > tr .p-treetable-toggler {\n  margin-right: 0.5rem;\n  position: relative;\n  z-index: 2;\n}\n:host ::ng-deep .p-treetable-tbody > tr .p-treetable-toggler::before {\n  content: "";\n  position: absolute;\n  right: 100%;\n  top: 50%;\n  width: 0.75rem;\n  height: 1px;\n  opacity: 0.4;\n  pointer-events: none;\n}\n:host ::ng-deep .p-treetable-tbody > tr .p-treetable-toggler {\n}\n:host ::ng-deep .p-treetable-tbody > tr .p-treetable-toggler.p-disabled {\n  visibility: hidden;\n  pointer-events: none;\n}\n:host ::ng-deep .p-treetable-tbody > tr {\n}\n:host ::ng-deep .p-treetable-tbody > tr:hover .p-treetable-indent::before,\n:host ::ng-deep .p-treetable-tbody > tr:hover .p-treetable-toggler::before {\n  background-color: var(--color-primary-color, var(--primary-color));\n  opacity: 0.8;\n}\n.tree-column-container {\n  display: flex;\n  align-items: flex-start;\n  width: 100%;\n}\n/*# sourceMappingURL=tree-table.component.css.map */\n'] }]
  }], () => [], { treeTable: [{
    type: ViewChild,
    args: ["tt"]
  }], filterWrappers: [{
  ...
  }], nodes: [{ type: Input, args: [{ isSignal: true, alias: "nodes", required: false }] }], columns: [{ type: Input, args: [{ isSignal: true, alias: "columns", required: false }] }], selectionMode: [{ type: Input, args: [{ isSignal: true, alias: "selectionMode", required: false }] }], loading: [{ type: Input, args: [{ isSignal: true, alias: "loading", required: false }] }], emptyMessage: [{ type: Input, args: [{ isSignal: true, alias: "emptyMessage", required: false }] }], styleClass: [{ type: Input, args: [{ isSignal: true, alias: "styleClass", required: false }] }], selection: [{ type: Input, args: [{ isSignal: true, alias: "selection", required: false }] }], paginator: [{ type: Input, args: [{ isSignal: true, alias: "paginator", required: false }] }], rows: [{ type: Input, args: [{ isSignal: true, alias: "rows", required: false }] }], rowsPerPageOptions: [{ type: Input, args: [{ isSignal: true, alias: "rowsPerPageOptions", required: false }] }], totalRecords: [{ type: Input, args: [{ isSignal: true, alias: "totalRecords", required: false }] }], entityLabelKey: [{ type: Input, args: [{ isSignal: true, alias: "entityLabelKey", required: false }] }], lazy: [{ type: Input, args: [{ isSignal: true, alias: "lazy", required: false }] }], scrollable: [{ type: Input, args: [{ isSignal: true, alias: "scrollable", required: false }] }], scrollHeight: [{ type: Input, args: [{ isSignal: true, alias: "scrollHeight", required: false }] }], resizableColumns: [{ type: Input, args: [{ isSignal: true, alias: "resizableColumns", required: false }] }], columnResizeMode: [{ type: Input, args: [{ isSignal: true, alias: "columnResizeMode", required: false }] }], reorderableColumns: [{ type: Input, args: [{ isSignal: true, alias: "reorderableColumns", required: false }] }], rowHover: [{ type: Input, args: [{ isSignal: true, alias: "rowHover", required: false }] }], filterMode: [{ type: Input, args: [{ isSignal: true, alias: "filterMode", required: false }] }], filterable: [{ type: Input, args: [{ isSignal: true, alias: "filterable", required: false }] }], visibleColumns: [{ type: Input, args: [{ isSignal: true, alias: "visibleColumns", required: false }] }], initialFilters: [{ type: Input, args: [{ isSignal: true, alias: "initialFilters", required: false }] }], metaKeySelection: [{ type: Input, args: [{ isSignal: true, alias: "metaKeySelection", required: false }] }], storedWidths: [{ type: Input, args: [{ isSignal: true, alias: "storedWidths", required: false }] }], nodeSelect: [{ type: Output, args: ["nodeSelect"] }], nodeUnselect: [{ type: Output, args: ["nodeUnselect"] }], selectionChange: [{ type: Output, args: ["selectionChange"] }], nodeExpand: [{ type: Output, args: ["nodeExpand"] }], nodeCollapse: [{ type: Output, args: ["nodeCollapse"] }], lazyLoad: [{ type: Output, args: ["lazyLoad"] }], pageChange: [{ type: Output, args: ["pageChange"] }], sort: [{ type: Output, args: ["sort"] }], filter: [{ type: Output, args: ["filter"] }], onFilterChange: [{ type: Output, args: ["onFilterChange"] }], columnResize: [{ type: Output, args: ["columnResize"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TreeTableComponent, { className: "TreeTableComponent", filePath: "src/app/shared/components/tree-table/tree-table.component.ts", lineNumber: 51 });
})();

// src/app/features/administration/components/admin-treetable-container/admin-treetable-container.component.ts
function AdminTreetableContainerComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 13);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function AdminTreetableContainerComponent_Conditional_13_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFilterToggle());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("text-primary", ctx_r1.showFilters());
    \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(1, 5, "ADMIN.SHARED.TOOLTIPS.FILTER"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 7, "ADMIN.SHARED.ARIA.TOGGLE_FILTERS"))("aria-disabled", !ctx_r1.canFilter());
  }
}
function AdminTreetableContainerComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 14);
    \u0275\u0275pipe(1, "translate");
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275listener("click", function AdminTreetableContainerComponent_Conditional_14_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.handleExport());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("pi-download", !ctx_r1.exporting())("pi-spinner", ctx_r1.exporting())("pi-spin", ctx_r1.exporting());
    \u0275\u0275property("pTooltip", ctx_r1.exporting() ? \u0275\u0275pipeBind1(1, 10, "SHARED.COMMON.BUTTONS.EXPORTING") + "..." : \u0275\u0275pipeBind1(2, 12, "SHARED.COMMON.BUTTONS.EXPORT"))("disabled", ctx_r1.exporting());
    \u0275\u0275attribute("aria-label", ctx_r1.exporting() ? \u0275\u0275pipeBind1(3, 14, "ADMIN.SHARED.ARIA.EXPORTING") : \u0275\u0275pipeBind1(4, 16, "ADMIN.SHARED.ARIA.EXPORT_DATA_AS_CSV"))("aria-busy", ctx_r1.exporting());
  }
}
var AdminTreetableContainerComponent = class _AdminTreetableContainerComponent {
  ...
  selectionMode = computed(() => this.treeTableConfiguration()?.selectionMode === "multiple" ? "multiple" : "single", ...ngDevMode ? [{ debugName: "selectionMode" }] : (
    /* istanbul ignore next */
    []
  ));
  totalRecords = signal(0, ...ngDevMode ? [{ debugName: "totalRecords" }] : (
  ...
  /**
   * i18n key for the entity noun shown in the paginator count (e.g. "825
   * Devices"). The config's kebab `entityType` derives to
   * `ADMIN.ENTITIES.<UPPER_SNAKE>` for the common case; the alias map covers
   * entity types whose noun lives under a legacy key name. Unknown types fall
   * through to `undefined`, letting the tree-table use its "items" fallback.
   * Mirrors AdminGridContainerComponent.
   */
  entityLabelKeyAliases = {
    geofences: "ADMIN.ENTITIES.ZONES",
    "geofence-groups": "ADMIN.ENTITIES.ZONE_GROUPS",
  ...
  entityLabelKey = computed(() => {
    const entityType = this.treeTableConfiguration()?.entityType;
    if (!isString(entityType) || entityType.length === 0) {
      return void 0;
    }
    return this.entityLabelKeyAliases[entityType] ?? `ADMIN.ENTITIES.${entityType.toUpperCase().replace(/-/g, "_")}`;
  ...
  lastSelectionWasMeta = false;
  // Computed property to check if filtering is enabled for the current config
  canFilter = computed(() => this.columns().some((col) => col.filterable === true), ...ngDevMode ? [{ debugName: "canFilter" }] : (
    /* istanbul ignore next */
    []
  ));
  ...
  displayedColumns = computed(() => {
    ...
    return allColumns.filter((col) => visible.includes(String(col.field)));
  ...
  constructor() {
    effect(() => {
      ...
      if (isDefined(config?.columnsSignal)) {
        this.columns.set(config.columnsSignal());
        const syncedColumns = this.gridPreferenceService.getVisibleColumns(config);
        this.visibleColumns.set(syncedColumns);
        this.columnWidths.set(this.gridPreferenceService.getColumnWidths(config));
      }
    });
    effect(() => {
  ...
  initializeClientChangeHandler() {
    ...
    configChanges$.pipe(takeUntilDestroyed(this.destroyRef), debounceTime(100)).subscribe(() => {
      this.bulkSelectionService.clear();
      this.treeTable?.setSelection([]);
      this.lastProcessedRouteKey.set(null);
      this.forceTreeReconfig$.next();
    });
    this.broadcastService.on("details-panel-closed").pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => {
      this.bulkSelectionService.clear();
      this.treeTable?.setSelection([]);
    });
    dataChanges$.pipe(takeUntilDestroyed(this.destroyRef), debounceTime(100)).subscribe(() => {
  ...
  initializeTreeTableConfiguration() {
    ...
    merge(navigationEvents$, forceReconfigEvents$).pipe(takeUntilDestroyed(this.destroyRef), switchMap((isForcedReconfig) => {
      this.loading.set(true);
      const type = this.activatedRoute.snapshot.paramMap.get("type") ?? this.activatedRoute.snapshot.data["gridType"];
      const routeParams = this.getRouteParams();
      const ownerId = routeParams["clientId"] ?? routeParams["vendorId"] ?? routeParams["distributorId"] ?? "none";
      const currentRouteKey = `${type}-${ownerId}`;
      if (!isForcedReconfig && this.lastProcessedRouteKey() === currentRouteKey) {
        this.loading.set(false);
        return EMPTY;
      }
      this.lastProcessedRouteKey.set(currentRouteKey);
  ...
  initializeFilterDebounce() {
    this.filterSubject.pipe(takeUntilDestroyed(this.destroyRef), debounceTime(300), tap((event) => {
      ...
      if (!config)
        return;
      config.onFilterChange?.(event.field, event.value);
      this.currentFilters.update((prev) => __spreadProps(__spreadValues({}, prev), {
  ...
  handleColumnResize(columnWidths) {
    ...
    const config = this.treeTableConfiguration();
    if (config) {
      this.gridPreferenceService.saveColumnWidths(config, columnWidths);
    }
  }
  handleLazyLoad(event) {
    if (isDefined(event?.rows) && event.rows !== this.limit()) {
  ...
  handleSelectionChange(nodes) {
    const routeEntityType = this.detailsFactory.getEntityTypeFromRoute(this.activatedRoute, "type");
    const configEntityType = this.treeTableConfiguration()?.entityType;
    const items = nodes.map((node) => {
      const entityType = node.data?.type ?? routeEntityType ?? configEntityType;
      return __spreadProps(__spreadValues({}, node.data), { entityType });
    });
    if (items.length === 0) {
      this.bulkSelectionService.clear();
      if (this.detailsService.showPanel()) {
    ...
    const componentType = this.detailsFactory.getDetailsComponent(String(items[0].entityType));
    const isMultiSelect = items.length > 1 || this.lastSelectionWasMeta;
    this.lastSelectionWasMeta = false;
    if (isMultiSelect) {
      this.bulkSelectionService.setAll(items);
      this.broadcastService.broadcast("tree-items-selected", {
        items,
        componentType
      });
    } else {
  ...
  handleExport() {
    if (this.exporting())
      return;
    const result = this.treeTableConfiguration()?.onExport?.(this.nodes(), this.visibleColumns());
    if (!isObservable(result))
      return;
    this.exporting.set(true);
    result.pipe(takeUntilDestroyed(this.destroyRef), catchError(() => EMPTY), finalize(() => this.exporting.set(false))).subscribe();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminTreetableContainerComponent, selectors: [["app-admin-treetable-container"]], viewQuery: function AdminTreetableContainerComponent_Query(rf, ctx) {
  ...
  }, decls: 20, vars: 44, consts: [[1, "flex", "flex-col", "h-full", "w-full", "overflow-hidden"], [1, "p-4", "content-header", "flex-none", "w-full"], [1, "flex", "justify-between", "items-center"], ["id", "treetableTitle", 1, "text-xl", "font-semibold", "truncate"], [1, "flex-none", "flex", "space-x-4", "align-center"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-plus", "action", "hover", 3, "click", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-refresh", "action", "hover", 3, "click", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-filter-fill", "action", "hover", 3, "pTooltip", "text-primary"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "action", "hover", 3, "pi-download", "pi-spinner", "pi-spin", "pTooltip", "disabled"], [3, "columnChange", "columns", "selectedColumns", "disabled"], [1, "flex-1", "min-h-0", "w-full", "overflow-hidden"], ["role", "treegrid", 1, "h-full", "max-w-full", 3, "lazyLoad", "nodeSelect", "selectionChange", "nodeExpand", "nodeCollapse", "onFilterChange", "columnResize", "columns", "visibleColumns", "filterable", "initialFilters", "nodes", "totalRecords", "entityLabelKey", "lazy", "paginator", "rows", "selectionMode", "metaKeySelection", "loading", "scrollable", "resizableColumns", "storedWidths", "scrollHeight"], ["aria-live", "polite", "aria-atomic", "true", 1, "sr-only"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "pi-filter-fill", "action", "hover", 3, "click", "pTooltip"], ["type", "button", "tooltipPosition", "bottom", 1, "pi", "action", "hover", 3, "click", "pTooltip", "disabled"]], template: function AdminTreetableContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h2", 3);
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(11, "translate");
      \u0275\u0275pipe(12, "translate");
      \u0275\u0275listener("click", function AdminTreetableContainerComponent_Template_button_click_10_listener() {
        return ctx.onRefresh();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(13, AdminTreetableContainerComponent_Conditional_13_Template, 3, 9, "button", 7);
      \u0275\u0275conditionalCreate(14, AdminTreetableContainerComponent_Conditional_14_Template, 5, 18, "button", 8);
      \u0275\u0275elementStart(15, "app-column-selector", 9);
      \u0275\u0275listener("columnChange", function AdminTreetableContainerComponent_Template_app_column_selector_columnChange_15_listener($event) {
        return ctx.handleColumnChange($event);
      });
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(16, "div", 10)(17, "app-tree-table", 11);
      \u0275\u0275listener("lazyLoad", function AdminTreetableContainerComponent_Template_app_tree_table_lazyLoad_17_listener($event) {
        return ctx.handleLazyLoad($event);
      })("nodeSelect", function AdminTreetableContainerComponent_Template_app_tree_table_nodeSelect_17_listener($event) {
        return ctx.handleNodeSelect($event);
      })("selectionChange", function AdminTreetableContainerComponent_Template_app_tree_table_selectionChange_17_listener($event) {
        return ctx.handleSelectionChange($event);
      })("nodeExpand", function AdminTreetableContainerComponent_Template_app_tree_table_nodeExpand_17_listener($event) {
        return ctx.handleNodeExpand($event);
      })("nodeCollapse", function AdminTreetableContainerComponent_Template_app_tree_table_nodeCollapse_17_listener($event) {
        return ctx.handleNodeCollapse($event);
      })("onFilterChange", function AdminTreetableContainerComponent_Template_app_tree_table_onFilterChange_17_listener($event) {
        return ctx.handleFilterChange($event);
      })("columnResize", function AdminTreetableContainerComponent_Template_app_tree_table_columnResize_17_listener($event) {
        return ctx.handleColumnResize($event);
      });
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(6, 34, "ADMIN.SHARED.ARIA.TREE_TABLE_ACTIONS"));
      \u0275\u0275advance(2);
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(8, 36, "SHARED.COMMON.BUTTONS.ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(9, 38, "ADMIN.SHARED.ARIA.ADD_NEW_ITEM"))("aria-disabled", !((tmp_4_0 = ctx.treeTableConfiguration()) == null ? null : tmp_4_0.onAdd));
      \u0275\u0275advance(3);
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(11, 40, "SHARED.COMMON.BUTTONS.REFRESH"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(12, 42, "ADMIN.SHARED.ARIA.REFRESH_TREE_TABLE_DATA"))("aria-busy", ctx.loading());
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.canFilter() ? 13 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(((tmp_9_0 = ctx.treeTableConfiguration()) == null ? null : tmp_9_0.onExport) ? 14 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("columns", ctx.selectableColumns())("selectedColumns", ctx.visibleColumns())("disabled", !ctx.treeTableConfiguration());
      \u0275\u0275advance(2);
      \u0275\u0275property("columns", ctx.columns())("visibleColumns", ctx.visibleColumns())("filterable", ctx.showFilters())("initialFilters", ctx.currentFilters())("nodes", ctx.nodes())("totalRecords", ctx.totalRecords())("entityLabelKey", ctx.entityLabelKey())("lazy", true)("paginator", true)("rows", ctx.limit())("selectionMode", ctx.selectionMode())("metaKeySelection", true)("loading", ctx.loading())("scrollable", true)("resizableColumns", true)("storedWidths", ctx.columnWidths())("scrollHeight", "flex");
...
(() => {
  ...
  <div class="p-4 content-header flex-none w-full">
    <div class="flex justify-between items-center">
      ...
      <div
        class="flex-none flex space-x-4 align-center"
        [attr.aria-label]="'ADMIN.SHARED.ARIA.TREE_TABLE_ACTIONS' | translate"
      >
        <button
          type="button"
          class="pi pi-plus action hover"
        ...
        <button
          ...
          (click)="onRefresh()"
          [attr.aria-label]="
            'ADMIN.SHARED.ARIA.REFRESH_TREE_TABLE_DATA' | translate
          "
          [attr.aria-busy]="loading()"
        ></button>
        @if (canFilter()) {
        ...
        @if (treeTableConfiguration()?.onExport) {
          <button
            type="button"
            class="pi action hover"
            [class.pi-download]="!exporting()"
            ...
            [pTooltip]="
              exporting()
                ? ('SHARED.COMMON.BUTTONS.EXPORTING' | translate) + '...'
                : ('SHARED.COMMON.BUTTONS.EXPORT' | translate)
            "
            tooltipPosition="bottom"
            [disabled]="exporting()"
            (click)="handleExport()"
            [attr.aria-label]="
              exporting()
                ? ('ADMIN.SHARED.ARIA.EXPORTING' | translate)
                : ('ADMIN.SHARED.ARIA.EXPORT_DATA_AS_CSV' | translate)
            "
            [attr.aria-busy]="exporting()"
          ></button>
        }
        <app-column-selector
          [columns]="selectableColumns()"
          [selectedColumns]="visibleColumns()"
          [disabled]="!treeTableConfiguration()"
          (columnChange)="handleColumnChange($event)"
        ></app-column-selector>
      </div>
    </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminTreetableContainerComponent, { className: "AdminTreetableContainerComponent", filePath: "src/app/features/administration/components/admin-treetable-container/admin-treetable-container.component.ts", lineNumber: 90 });
})();
...
//# sourceMappingURL=chunk-MDTLIX76.js.map
