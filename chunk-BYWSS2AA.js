...
var require_conversions = __commonJS({
  "node_modules/color-convert/conversions.js"(exports, module) {
    ...
    for (const model2 of Object.keys(convert)) {
      if (!("channels" in convert[model2])) {
        throw new Error("missing channels property: " + model2);
      }
      if (!("labels" in convert[model2])) {
        throw new Error("missing channel labels property: " + model2);
      }
      if (convert[model2].labels.length !== convert[model2].channels) {
        throw new Error("channel and label counts mismatch: " + model2);
      }
      const { channels, labels } = convert[model2];
      delete convert[model2].channels;
      delete convert[model2].labels;
      Object.defineProperty(convert[model2], "channels", { value: channels });
      Object.defineProperty(convert[model2], "labels", { value: labels });
    }
...
var require_color = __commonJS({
  "node_modules/color/index.js"(exports, module) {
    ...
    var hashedModelKeys = {};
    for (const model2 of Object.keys(convert)) {
      hashedModelKeys[[...convert[model2].labels].sort().join("")] = model2;
    }
    var limiters = {};
    function Color3(object, model2) {
      if (!(this instanceof Color3)) {
        return new Color3(object, model2);
      }
    ...
    for (const model2 of Object.keys(convert)) {
      if (skippedModels.includes(model2)) {
        continue;
      }
      const { channels } = convert[model2];
      Color3.prototype[model2] = function(...args) {
        if (this.model === model2) {
          return new Color3(this);
        }
        if (args.length > 0) {
          return new Color3(args, model2);
        }
        return new Color3([...assertArray(convert[this.model][model2].raw(this.color)), this.valpha], model2);
      };
      Color3[model2] = function(...args) {
        let color = args[0];
        if (typeof color === "number") {
          color = zeroArray(args, channels);
        }
        return new Color3(color, model2);
      };
    }
...
_PREFIX_TO_STYLE[s2] = _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, {
  "fa-duotone": "duotone"
}), S[s2]), St["kit"]), St["kit-duotone"]);
var PREFIX_TO_STYLE = familyProxy(_PREFIX_TO_STYLE);
var _STYLE_TO_PREFIX = _objectSpread2({}, xt);
_STYLE_TO_PREFIX[s2] = _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, {
  duotone: "fad"
}), _STYLE_TO_PREFIX[s2]), Et["kit"]), Et["kit-duotone"]);
var STYLE_TO_PREFIX = familyProxy(_STYLE_TO_PREFIX);
var _PREFIX_TO_LONG_STYLE = _objectSpread2({}, ga);
_PREFIX_TO_LONG_STYLE[s2] = _objectSpread2(_objectSpread2({}, _PREFIX_TO_LONG_STYLE[s2]), Wt["kit"]);
var PREFIX_TO_LONG_STYLE = familyProxy(_PREFIX_TO_LONG_STYLE);
var _LONG_STYLE_TO_PREFIX = _objectSpread2({}, ua);
_LONG_STYLE_TO_PREFIX[s2] = _objectSpread2(_objectSpread2({}, _LONG_STYLE_TO_PREFIX[s2]), Ct["kit"]);
...
function insertCss(css2) {
  ...
  const style3 = DOCUMENT2.createElement("style");
  ...
  DOCUMENT2.head.insertBefore(style3, beforeChild);
  return css2;
}
...
var bindInternal4 = function bindInternal42(func, thisContext) {
  return function(a2, b, c, d) {
    return func.call(thisContext, a2, b, c, d);
  };
};
...
var build = () => {
  const lookup = (reducer) => {
    return reduce(styles, (o$$1, style3, prefix) => {
      o$$1[prefix] = reduce(style3, reducer, {});
      return o$$1;
    }, {});
  };
...
function getCanonicalPrefix(styleOrPrefix) {
  ...
  const style3 = PREFIX_TO_STYLE[family][styleOrPrefix];
  if (family === t && !styleOrPrefix) {
    return "fad";
  }
  const prefix = STYLE_TO_PREFIX[family][styleOrPrefix] || STYLE_TO_PREFIX[family][style3];
...
function styleParser(node) {
  const style3 = node.getAttribute("style");
  let val = [];
  if (style3) {
    val = style3.split(";").reduce((acc, style4) => {
      const styles2 = style4.split(":");
...
var faClassList = (props) => {
  ...
  return Object.keys(classes2).map((key) => classes2[key] ? key : null).filter((key) => key != null);
};
...
function ensureCss2(document2, config2) {
  ...
  const style3 = document2.createElement("style");
  style3.setAttribute("type", "text/css");
  style3.setAttribute("id", autoCssId);
  style3.innerHTML = dom$1.css();
  const headChildren = document2.head.childNodes;
  let beforeChild = null;
  for (let i = headChildren.length - 1; i > -1; i--) {
    const child = headChildren[i];
...
@fortawesome/fontawesome-svg-core/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-BYWSS2AA.js.map
