...
import {
  ...
  faSquareBinary,
  faUserSecret
} from "./chunk-6IJRKA5O.js";
import {
  CardModule
} from "./chunk-YIMY3N3Q.js";
import {
    ...
    switch (type) {
      ...
      case "user":
        if (isDefined(owner)) {
          ...
          await this.navigationService.navigateToEntityDetails(type, id, owner);
        } else {
          console.warn(`Cannot navigate to ${type} without owner information.`);
        }
        break;
      default:
    ...
    children: [
      {
        ...
        loadChildren: () => import("./chunk-44I3ZYAR.js").then((m) => m.SuperAdminModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-ZINYMAR2.js").then((m) => m.VendorsModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-ES2TWAYN.js").then((m) => m.DistributorsModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-YQF7A2DI.js").then((m) => m.ClientsModule)
      }
    ]
  }
];
...
var UserRolesGridConfig = class _UserRolesGridConfig {
  ...
  initialize(params) {
    console.log("Initializing UserRolesGridConfig with params:", params);
    this.params = params;
    if (isDefined(this.params["clientId"])) {
      this.ownerId = String(this.params["clientId"]);
    } else if (isDefined(this.params["vendorId"])) {
...
//# sourceMappingURL=chunk-33GHOPH3.js.map
