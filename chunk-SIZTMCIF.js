...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d2.height, a2 = d2.width, u = e.offsetHeight, p2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $(), it = k(), lt2 = h(), L, N, ot = "top";
    f2.top + u + s4 > lt2.height ? (L = f2.top + g3 - s4, ot = "bottom", L < 0 && (L = g3)) : L = u + f2.top + g3, f2.left + a2 > lt2.width ? N = Math.max(0, f2.left + it + p2 - a2) : N = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N + "px" : t2.style.insetInlineStart = N + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t2, e) {
...
function zt(t2, e) {
  var o, n;
  if (t2) {
    let r = t2.parentElement, i2 = K(r), l2 = h(), d2 = t2.offsetParent ? t2.offsetWidth : J(t2), s4 = t2.offsetParent ? t2.offsetHeight : G(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u = C((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), p2 = "", f2 = "";
    i2.left + a2 + d2 > l2.width - P() ? i2.left < d2 ? e % 2 === 1 ? p2 = i2.left ? "-" + i2.left + "px" : "100%" : e % 2 === 0 && (p2 = l2.width - d2 - P() + "px") : p2 = "-100%" : p2 = "100%", t2.getBoundingClientRect().top + u + s4 > l2.height ? f2 = `-${s4 - u}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = p2;
  }
}
function Qt(t2) {
  var e;
  ...
  if (p(e)) {
    ...
    if (z2(a2, v2)) {
      let n = a2.replaceAll(v2, (l2) => {
        let c3 = l2.replace(/{|}/g, "").split(".").filter((m3) => !s4.some((u) => z2(m3, u)));
        return `var(${ne(r, ee(c3.join("-")))}${s2(o) ? `, ${o}` : ""})`;
      });
      return z2(n.replace(ct2, "0"), lt) ? `calc(${n})` : n;
    }
    return a2;
...
function oe(e, t2) {
  ...
  function r(n, l2) {
    let i2 = [], c3 = 0, m3 = "", u = null, p2 = 0;
    for (; c3 <= n.length; ) {
      let h2 = n[c3];
      if ((h2 === '"' || h2 === "'" || h2 === "`") && n[c3 - 1] !== "\\" && (u = u === h2 ? null : h2), !u && (h2 === "(" && p2++, h2 === ")" && p2--, (h2 === "," || c3 === n.length) && p2 === 0)) {
        let y3 = m3.trim();
        y3.startsWith("dt(") ? i2.push(oe(y3, l2)) : i2.push(s4(y3)), m3 = "", c3++;
        continue;
      }
      h2 !== void 0 && (m3 += h2), c3++;
    }
  ...
  for (let n = o.length - 1; n >= 0; n--) {
    let [l2, i2] = o[n], c3 = e.slice(l2 + 3, i2), m3 = r(c3, t2), u = t2(...m3);
...
var tr = (e) => {
  var a2;
  let t2 = g2.getTheme(), r = le(t2, e, void 0, "variable"), s4 = (a2 = r == null ? void 0 : r.match(/--[\w-]+/g)) == null ? void 0 : a2[0], o = le(t2, e, void 0, "value");
  return { name: s4, variable: r, value: o };
};
var P2 = (...e) => le(g2.getTheme(), ...e);
var le = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: o, options: a2 } = g2.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, i2 = z2(t2, v2) ? t2 : `{${t2}}`;
    return s4 === "value" || a(s4) && l2 === "strict" ? g2.getTokenValue(t2) : Y3(i2, void 0, n, [o.excludedKeyRegex], r);
  }
  return "";
};
function ar(e, ...t2) {
  if (e instanceof Array) {
    let r = e.reduce((s4, o, a2) => {
      var n;
      return s4 + o + ((n = m2(t2[a2], { dt: P2 })) != null ? n : "");
    }, "");
    return oe(r, P2);
  }
  return m2(e, { dt: P2 });
...
function ce(e, t2 = {}) {
  let r = g2.defaults.variable, { prefix: s4 = r.prefix, selector: o = r.selector, excludedKeyRegex: a2 = r.excludedKeyRegex } = t2, n = [], l2 = [], i2 = [{ node: e, path: s4 }];
  for (; i2.length; ) {
    let { node: m3, path: u } = i2.pop();
    for (let p2 in m3) {
      let h2 = m3[p2], y3 = ke(h2), x2 = z2(p2, a2) ? Q3(u) : Q3(u, ee(p2));
      if (i(y3)) i2.push({ node: y3, path: x2 });
      else {
        let k3 = ne(x2), w2 = Y3(y3, x2, s4, [a2]);
        _e(l2, k3, w2);
        let $2 = x2;
  ...
  let c3 = l2.join("");
  return { value: l2, tokens: n, declarations: c3, css: T3(o, c3) };
}
var S2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var w2, $2, j3, V2, D2, z3, E2;
  let { preset: a2, options: n } = t2, l2, i2, c3, m3, u, p2, h2;
  if (s2(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re } = a2, y3 = te || {}, { colorScheme: K2 } = y3, M2 = b3(y3, ["colorScheme"]), N = re || {}, { colorScheme: X } = N, B3 = b3(N, ["colorScheme"]), x2 = K2 || {}, { dark: G3 } = x2, I2 = b3(x2, ["dark"]), k3 = X || {}, { dark: U2 } = k3, H2 = b3(k3, ["dark"]), W2 = s2(L) ? this._toVariables({ primitive: L }, n) : {}, q = s2(M2) ? this._toVariables({ semantic: M2 }, n) : {}, Z2 = s2(I2) ? this._toVariables({ light: I2 }, n) : {}, de = s2(G3) ? this._toVariables({ dark: G3 }, n) : {}, ue = s2(B3) ? this._toVariables({ semantic: B3 }, n) : {}, pe = s2(H2) ? this._toVariables({ light: H2 }, n) : {}, ge = s2(U2) ? this._toVariables({ dark: U2 }, n) : {}, [Le, Me] = [(w2 = W2.declarations) != null ? w2 : "", W2.tokens], [Ae, je] = [($2 = q.declarations) != null ? $2 : "", q.tokens || []], [De, ze] = [(j3 = Z2.declarations) != null ? j3 : "", Z2.tokens || []], [Ke, Xe] = [(V2 = de.declarations) != null ? V2 : "", de.tokens || []], [Be, Ge] = [(D2 = ue.declarations) != null ? D2 : "", ue.tokens || []], [Ie, Ue] = [(z3 = pe.declarations) != null ? z3 : "", pe.tokens || []], [He, We] = [(E2 = ge.declarations) != null ? E2 : "", ge.tokens || []];
    ...
    c3 = `${qe}${Ze}`, m3 = [.../* @__PURE__ */ new Set([...je, ...ze, ...Xe])];
    ...
    u = `${Fe}${Je}`, p2 = [.../* @__PURE__ */ new Set([...Ge, ...Ue, ...We])], h2 = m2(a2.css, { dt: P2 });
  }
  return { primitive: { css: l2, tokens: i2 }, semantic: { css: c3, tokens: m3 }, global: { css: u, tokens: p2 }, style: h2 };
}, getPreset({ name: e = "", preset: t2 = {}, options: r, params: s4, set: o, defaults: a2, selector: n }) {
  var y3, N, x2;
  let l2, i2, c3;
  if (s2(t2) && r.transform !== "strict") {
    let k3 = e.replace("-directive", ""), m3 = t2, { colorScheme: w2, extend: $2, css: j3 } = m3, V2 = b3(m3, ["colorScheme", "extend", "css"]), u = $2 || {}, { colorScheme: D2 } = u, z3 = b3(u, ["colorScheme"]), p2 = w2 || {}, { dark: E2 } = p2, L = b3(p2, ["dark"]), h2 = D2 || {}, { dark: te } = h2, re = b3(h2, ["dark"]), K2 = s2(V2) ? this._toVariables({ [k3]: d(d({}, V2), z3) }, r) : {}, M2 = s2(L) ? this._toVariables({ [k3]: d(d({}, L), re) }, r) : {}, X = s2(E2) ? this._toVariables({ [k3]: d(d({}, E2), te) }, r) : {}, [B3, G3] = [(y3 = K2.declarations) != null ? y3 : "", K2.tokens || []], [I2, U2] = [(N = M2.declarations) != null ? N : "", M2.tokens || []], [H2, W2] = [(x2 = X.declarations) != null ? x2 : "", X.tokens || []], q = this.transformCSS(k3, `${B3}${I2}`, "light", "variable", r, o, a2, n), Z2 = this.transformCSS(k3, H2, "dark", "variable", r, o, a2, n);
    l2 = `${q}${Z2}`, i2 = [.../* @__PURE__ */ new Set([...G3, ...U2, ...W2])], c3 = m2(j3, { dt: P2 });
  }
  ...
  var c3, m3;
  let a2 = e.replace("-directive", ""), { preset: n, options: l2 } = t2, i2 = ((c3 = n == null ? void 0 : n.components) == null ? void 0 : c3[a2]) || ((m3 = n == null ? void 0 : n.directives) == null ? void 0 : m3[a2]);
  ...
  let { cssLayer: o } = t2;
  return o ? `@layer ${m2(o.order || o.name || "primeui", r)}` : "";
}, getCommonStyleSheet({ name: e = "", theme: t2 = {}, params: r, props: s4 = {}, set: o, defaults: a2 }) {
  let n = this.getCommon({ name: e, theme: t2, params: r, set: o, defaults: a2 }), l2 = Object.entries(s4).reduce((i2, [c3, m3]) => i2.push(`${c3}="${m3}"`) && i2, []).join(" ");
  return Object.entries(n || {}).reduce((i2, [c3, m3]) => {
    if (i(m3) && Object.hasOwn(m3, "css")) {
      let u = G2(m3.css), p2 = `${c3}-variables`;
  ...
  var c3;
  let n = { name: e, theme: t2, params: r, set: o, defaults: a2 }, l2 = (c3 = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c3.css, i2 = Object.entries(s4).reduce((m3, [u, p2]) => m3.push(`${u}="${p2}"`) && m3, []).join(" ");
  ...
  var l2;
  let o = ((i2) => i2.split(".").filter((m3) => !z2(m3.toLowerCase(), r.variable.excludedKeyRegex)).join("."))(t2), a2 = t2.includes("colorScheme.light") ? "light" : t2.includes("colorScheme.dark") ? "dark" : void 0, n = [(l2 = e[o]) == null ? void 0 : l2.computed(a2)].flat().filter((i2) => i2);
  return n.length === 1 ? n[0].value : n.reduce((i2 = {}, c3) => {
    let p2 = c3, { colorScheme: m3 } = p2, u = b3(p2, ["colorScheme"]);
    return i2[m3] = u, i2;
  }, void 0);
}, getSelectorRule(e, t2, r, s4) {
  return r === "class" || r === "attr" ? T3(s2(t2) ? `${e}${t2},${e} ${t2}` : e, s4) : T3(e, T3(t2 != null ? t2 : ":root", s4));
}, transformCSS(e, t2, r, s4, o = {}, a2, n, l2) {
  if (s2(t2)) {
    let { cssLayer: i2 } = o;
    if (s4 !== "style") {
      let c3 = this.getColorSchemeOption(o, n);
      t2 = r === "dark" ? c3.reduce((m3, { type: u, selector: p2 }) => (s2(p2) && (m3 += p2.includes("[CSS]") ? p2.replace("[CSS]", t2) : this.getSelectorRule(p2, l2, u, t2)), m3), "") : T3(l2 != null ? l2 : ":root", t2);
    }
    if (i2) {
      let c3 = { name: "primeui", order: "primeui" };
      i(i2) && (c3.name = m2(i2.name, { name: e, type: s4 })), s2(c3.name) && (t2 = T3(`@layer ${c3.name}`, t2), a2 == null || a2.layerNames(c3.name));
    }
    return t2;
  }
  return "";
...
var g2 = { defaults: { variable: { prefix: "p", selector: ":root", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t2 } = e;
  t2 && (this._theme = _2(d({}, t2), { options: d(d({}, this.defaults.options), t2.options) }), this._tokens = S2.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
  ...
  this._theme = _2(d({}, this.theme), { preset: e }), this._tokens = S2.createTokens(e, this.defaults), this.clearLoadedStyleNames(), R3.emit("preset:change", e), R3.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
  this._theme = _2(d({}, this.theme), { options: e }), this.clearLoadedStyleNames(), R3.emit("options:change", e), R3.emit("theme:change", this.theme);
}, getLayerNames() {
...
var BaseStyle = class _BaseStyle {
  ...
  loadTheme = (options = {}, style11 = "") => {
    return this.load(this.theme, options, (computedStyle = "") => g2.transformCSS(options.name || this.name, `${computedStyle}${ar`${style11}`}`));
  };
  loadGlobalCSS = (options = {}) => {
    return this.load(css, options);
  };
  loadGlobalTheme = (options = {}, style$1 = "") => {
    return this.load(style2, options, (computedStyle = "") => g2.transformCSS(options.name || this.name, `${computedStyle}${ar`${style$1}`}`));
  };
  ...
  getThemeStyleSheet = (params, props = {}) => {
    let css3 = [g2.getStyleSheet(this.name, params, props)];
    if (this.theme) {
      const name = this.name === "base" ? "global-style" : `${this.name}-style`;
      const _css = ar`${m2(this.theme, {
        dt: P2
      })}`;
      const _style = G2(g2.transformCSS(name, _css));
      const _props = Object.entries(props).reduce((acc, [k3, v3]) => acc.push(`${k3}="${v3}"`) && acc, []).join(" ");
...
var BaseComponent = class _BaseComponent {
  ...
  ngOnDestroy() {
    ...
    this.themeChangeListeners.forEach((callback) => R3.off("theme:change", callback));
  }
  _loadStyles() {
    const _load = () => {
  ...
  _loadThemeStyles() {
    ...
    if (!g2.isStyleNameLoaded(this.componentStyle?.name) && this.componentStyle?.name) {
      const {
        css: css3,
        style: style11
      ...
      g2.setLoadedStyleName(this.componentStyle?.name);
    }
...
var DomHandler = class _DomHandler {
  ...
  static getViewport() {
    let win = window, d2 = document, e = d2.documentElement, g3 = d2.getElementsByTagName("body")[0], w2 = win.innerWidth || e.clientWidth || g3.clientWidth, h2 = win.innerHeight || e.clientHeight || g3.clientHeight;
...
var Select = class _Select extends BaseInput {
  ...
  getOptionLabel(option) {
    return this.optionLabel !== void 0 && this.optionLabel !== null ? c2(option, this.optionLabel) : option && option.label !== void 0 ? option.label : option;
  }
  getOptionValue(option) {
    return this.optionValue && this.optionValue !== null ? c2(option, this.optionValue) : !this.optionLabel && option && option.value !== void 0 ? option.value : option;
  }
  ...
  isOptionDisabled(option) {
    if (this.getOptionValue(this.modelValue()) === this.getOptionValue(option) || this.getOptionLabel(this.modelValue() === this.getOptionLabel(option)) && option.disabled === false) {
      ...
      return this.optionDisabled ? c2(option, this.optionDisabled) : option && option.disabled !== void 0 ? option.disabled : false;
    }
  }
  getOptionGroupLabel(optionGroup) {
    return this.optionGroupLabel !== void 0 && this.optionGroupLabel !== null ? c2(optionGroup, this.optionGroupLabel) : optionGroup && optionGroup.label !== void 0 ? optionGroup.label : optionGroup;
  }
  getOptionGroupChildren(optionGroup) {
    return this.optionGroupChildren !== void 0 && this.optionGroupChildren !== null ? c2(optionGroup, this.optionGroupChildren) : optionGroup.items;
  }
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-SIZTMCIF.js.map
