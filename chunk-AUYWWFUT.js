...
var AdminContainerComponent = class _AdminContainerComponent {
  ...
  /**
   * Handles the 'view-entity-in-tree' event for a client by preparing the tree and navigating.
  ...
  async handleVendorInTree(vendor) {
    this.detailsService.closeDetailsPanel();
    const result = this.adminSearchService.createSearchResultForVendor(vendor);
    if (this.treeCollapsed()) {
      this.toggleTreePanel();
    }
    await this.adminSearchService.ensureParentNodesLoaded(result);
    ...
    children: [
      {
        ...
        loadChildren: () => import("./chunk-GQEDP2TG.js").then((m) => m.VendorsModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-AWMS4HCH.js").then((m) => m.DistributorsModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-UZCEPIFS.js").then((m) => m.ClientsModule)
      }
    ]
  }
];
...
//# sourceMappingURL=chunk-AUYWWFUT.js.map
