...
function ClientSelectionFormComponent_Conditional_9_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-label", "Select recently used client: " + client_r2.name)("aria-selected", ctx_r2.isItemFocused(ctx_r2.getRecentClientIndex(\u0275$index_30_r4)));
    \u0275\u0275advance();
...
function ClientSelectionFormComponent_Conditional_13_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-label", "Select " + client_r6.name + (client_r6.owner.name ? ", owned by " + client_r6.owner.name : ""))("aria-selected", ctx_r2.isItemFocused(ctx_r2.getClientCardIndex(\u0275$index_66_r7)))("aria-posinset", \u0275$index_66_r7 + 1)("aria-setsize", ctx_r2.filteredClients().length);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(client_r6.owner.name ? 8 : -1);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ClientSelectionFormComponent, [{
    type: Component,
    args: [{ selector: "app-client-selection-form", standalone: true, imports: [FormsModule, InputTextModule, InputIcon, IconField], template: `<div class="client-selection-form flex flex-col max-h-[50vh]">
...
css-vars-ponyfill/dist/css-vars-ponyfill.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HUVOLRF6.js.map
