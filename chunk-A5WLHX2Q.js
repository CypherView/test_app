...
function D(t2, e, o = true) {
  var n2, r, i3, l3;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d2.height, a2 = d2.width, u2 = e.offsetHeight, p4 = e.offsetWidth, f2 = e.getBoundingClientRect(), g2 = $(), it = k(), lt = h(), L2, N3, ot = "top";
    f2.top + u2 + s4 > lt.height ? (L2 = f2.top + g2 - s4, ot = "bottom", L2 < 0 && (L2 = g2)) : L2 = u2 + f2.top + g2, f2.left + a2 > lt.width ? N3 = Math.max(0, f2.left + it + p4 - a2) : N3 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N3 + "px" : t2.style.insetInlineStart = N3 + "px", t2.style.top = L2 + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n2 = x(/-anchor-gutter$/)) == null ? void 0 : n2.value) != null ? r : "2px"} * -1)` : (l3 = (i3 = x(/-anchor-gutter$/)) == null ? void 0 : i3.value) != null ? l3 : "");
  }
}
function S(t2, e) {
...
function I(t2, e, o = true, n2 = void 0) {
  var r;
  if (t2) {
    let i3 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), l3 = e.offsetHeight, d2 = e.getBoundingClientRect(), s4 = h(), a2, u2, p4 = n2 != null ? n2 : "top";
    if (!n2 && d2.top + l3 + i3.height > s4.height ? (a2 = -1 * i3.height, p4 = "bottom", d2.top + a2 < 0 && (a2 = -1 * d2.top)) : a2 = l3, i3.width > s4.width ? u2 = d2.left * -1 : d2.left + i3.width > s4.width ? u2 = (d2.left + i3.width - s4.width) * -1 : u2 = 0, t2.style.top = a2 + "px", t2.style.insetInlineStart = u2 + "px", t2.style.transformOrigin = p4, o) {
      let f2 = (r = x(/-anchor-gutter$/)) == null ? void 0 : r.value;
      t2.style.marginTop = p4 === "bottom" ? `calc(${f2 != null ? f2 : "2px"} * -1)` : f2 != null ? f2 : "";
    }
  }
}
function y(t2) {
      ...
      return [r].flat().reduce((s4, a2) => {
        if (a2 != null) {
          ...
          if (u2 === "string" || u2 === "number") s4.push(a2);
            ...
            let p4 = Array.isArray(a2) ? o(n2, a2) : Object.entries(a2).map(([f2, g2]) => n2 === "style" && (g2 || g2 === 0) ? `${f2.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}:${g2}` : g2 ? f2 : void 0);
...
function zt(t2, e) {
  var o, n2;
  if (t2) {
    let r = t2.parentElement, i3 = K(r), l3 = h(), d2 = t2.offsetParent ? t2.offsetWidth : J(t2), s4 = t2.offsetParent ? t2.offsetHeight : G(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u2 = C((n2 = r == null ? void 0 : r.children) == null ? void 0 : n2[0]), p4 = "", f2 = "";
    i3.left + a2 + d2 > l3.width - O() ? i3.left < d2 ? e % 2 === 1 ? p4 = i3.left ? "-" + i3.left + "px" : "100%" : e % 2 === 0 && (p4 = l3.width - d2 - O() + "px") : p4 = "-100%" : p4 = "100%", t2.getBoundingClientRect().top + u2 + s4 > l3.height ? f2 = `-${s4 - u2}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = p4;
  }
}
function Qt() {
  ...
  if (t2) {
    ...
    for (let a2 = 0; a2 < t2.length; a2++) {
      ...
      if (r === "string" || r === "number") e.push(o);
        ...
        let s4 = Array.isArray(o) ? [u(...o)] : Object.entries(o).map(([f2, m3]) => m3 ? f2 : void 0);
...
function b2(e, t2, n2 = /* @__PURE__ */ new WeakSet()) {
  ...
  for (u2 = f2; u2-- !== 0; ) if (T3 = R2[u2], !b2(e[T3], t2[T3], n2)) return false;
  return true;
}
function y2(e, t2) {
  return b2(e, t2);
...
function F2(e, t2 = "", n2 = {}) {
  ...
  if (r) {
    if (i2(e)) {
      ...
      return F2(m2(e[u2], n2), o.join("."), n2);
    }
    return;
  }
  return m2(e, n2);
  ...
  if (a(e)) {
    ...
    if (G2(a2, k3)) {
      let n2 = a2.replaceAll(k3, (l3) => {
        let c4 = l3.replace(/{|}/g, "").split(".").filter((m3) => !s4.some((d2) => G2(m3, d2)));
        return `var(${ae(r, re(c4.join("-")))}${s2(i3) ? `, ${i3}` : ""})`;
      });
      return G2(n2.replace(ie, "0"), ne) ? `calc(${n2})` : n2;
    }
    return a2;
...
function le(e, t2) {
  ...
  for (let n2 = i3.length - 1; n2 >= 0; n2--) {
    let [l3, o] = i3[n2], c4 = e.slice(l3 + 3, o), m3 = r(c4, t2), d2 = t2(...m3);
...
function ar(e, ...t2) {
  if (e instanceof Array) {
    let r = e.reduce((s4, i3, a2) => {
      var n2;
      return s4 + i3 + ((n2 = m2(t2[a2], { dt: E2 })) != null ? n2 : "");
    }, "");
    return le(r, E2);
  }
  return m2(e, { dt: E2 });
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u2 in m3) {
      let g2 = m3[u2], f2 = ve(g2), p4 = G2(u2, a2) ? Q2(d2) : Q2(d2, re(u2));
      if (i2(f2)) o.push({ node: f2, path: p4 });
      else {
        let y3 = ae(p4), R2 = Y3(f2, p4, s4, [a2]);
        Re(l3, y3, R2);
        let T3 = p4;
        s4 && T3.startsWith(s4 + "-") && (T3 = T3.slice(s4.length + 1)), n2.push(T3.replace(/-/g, "."));
      }
    }
  }
  let c4 = l3.join("");
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R2, T3, j3, O3, M2, z4, V3;
  let { preset: a2, options: n2 } = t2, l3, o, c4, m3, d2, u2, g2;
  if (s2(a2) && n2.transform !== "strict") {
    let { primitive: L2, semantic: te2, extend: re2 } = a2, f2 = te2 || {}, { colorScheme: K2 } = f2, A3 = v2(f2, ["colorScheme"]), x3 = re2 || {}, { colorScheme: X2 } = x3, G4 = v2(x3, ["colorScheme"]), p4 = K2 || {}, { dark: U3 } = p4, B2 = v2(p4, ["dark"]), y3 = X2 || {}, { dark: I2 } = y3, H3 = v2(y3, ["dark"]), W3 = s2(L2) ? this._toVariables({ primitive: L2 }, n2) : {}, q3 = s2(A3) ? this._toVariables({ semantic: A3 }, n2) : {}, Z2 = s2(B2) ? this._toVariables({ light: B2 }, n2) : {}, pe = s2(U3) ? this._toVariables({ dark: U3 }, n2) : {}, fe = s2(G4) ? this._toVariables({ semantic: G4 }, n2) : {}, ye = s2(H3) ? this._toVariables({ light: H3 }, n2) : {}, Se = s2(I2) ? this._toVariables({ dark: I2 }, n2) : {}, [Me, ze] = [(R2 = W3.declarations) != null ? R2 : "", W3.tokens], [Ke, Xe] = [(T3 = q3.declarations) != null ? T3 : "", q3.tokens || []], [Ge, Ue] = [(j3 = Z2.declarations) != null ? j3 : "", Z2.tokens || []], [Be, Ie] = [(O3 = pe.declarations) != null ? O3 : "", pe.tokens || []], [He, We] = [(M2 = fe.declarations) != null ? M2 : "", fe.tokens || []], [qe, Ze] = [(z4 = ye.declarations) != null ? z4 : "", ye.tokens || []], [Fe, Je] = [(V3 = Se.declarations) != null ? V3 : "", Se.tokens || []];
    ...
    let et2 = this.transformCSS(e, `${He}${qe}color-scheme:light`, "light", "variable", n2, s4, i3), tt3 = this.transformCSS(e, `${Fe}color-scheme:dark`, "dark", "variable", n2, s4, i3);
    d2 = `${et2}${tt3}`, u2 = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g2 = m2(a2.css, { dt: E2 });
  }
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m3 = t2, { colorScheme: R2, extend: T3, css: j3 } = m3, O3 = v2(m3, ["colorScheme", "extend", "css"]), d2 = T3 || {}, { colorScheme: M2 } = d2, z4 = v2(d2, ["colorScheme"]), u2 = R2 || {}, { dark: V3 } = u2, L2 = v2(u2, ["dark"]), g2 = M2 || {}, { dark: te2 } = g2, re2 = v2(g2, ["dark"]), K2 = s2(O3) ? this._toVariables({ [y3]: h3(h3({}, O3), z4) }, r) : {}, A3 = s2(L2) ? this._toVariables({ [y3]: h3(h3({}, L2), re2) }, r) : {}, X2 = s2(V3) ? this._toVariables({ [y3]: h3(h3({}, V3), te2) }, r) : {}, [G4, U3] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x3 = A3.declarations) != null ? x3 : "", A3.tokens || []], [H3, W3] = [(p4 = X2.declarations) != null ? p4 : "", X2.tokens || []], q3 = this.transformCSS(y3, `${G4}${B2}`, "light", "variable", r, i3, a2, n2), Z2 = this.transformCSS(y3, H3, "dark", "variable", r, i3, a2, n2);
    l3 = `${q3}${Z2}`, o = [.../* @__PURE__ */ new Set([...U3, ...I2, ...W3])], c4 = m2(j3, { dt: E2 });
  }
  ...
  var c4, m3;
  let a2 = e.replace("-directive", ""), { preset: n2, options: l3 } = t2, o = ((c4 = n2 == null ? void 0 : n2.components) == null ? void 0 : c4[a2]) || ((m3 = n2 == null ? void 0 : n2.directives) == null ? void 0 : m3[a2]);
  ...
  let n2 = this.getCommon({ name: e, theme: t2, params: r, set: i3, defaults: a2 }), l3 = Object.entries(s4).reduce((o, [c4, m3]) => o.push(`${c4}="${m3}"`) && o, []).join(" ");
  return Object.entries(n2 || {}).reduce((o, [c4, m3]) => {
  ...
  var c4;
  let n2 = { name: e, theme: t2, params: r, set: i3, defaults: a2 }, l3 = (c4 = e.includes("-directive") ? this.getPresetD(n2) : this.getPresetC(n2)) == null ? void 0 : c4.css, o = Object.entries(s4).reduce((m3, [d2, u2]) => m3.push(`${d2}="${u2}"`) && m3, []).join(" ");
  ...
  let a2 = function(l3, o = {}, c4 = []) {
    ...
    Object.entries(l3).forEach(([m3, d2]) => {
      let u2 = G2(m3, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe2(m3)}` : oe2(m3), g2 = c4 ? `${c4}.${m3}` : m3;
      i2(d2) ? n2(d2, u2, g2) : (i3[u2] || (i3[u2] = { paths: [], computed: (f2, x3 = {}, p4 = []) => {
  ...
  var l3;
  let i3 = ((o) => o.split(".").filter((m3) => !G2(m3.toLowerCase(), r.variable.excludedKeyRegex)).join("."))(t2), a2 = t2.includes("colorScheme.light") ? "light" : t2.includes("colorScheme.dark") ? "dark" : void 0, n2 = [(l3 = e[i3]) == null ? void 0 : l3.computed(a2)].flat().filter((o) => o);
...
var S2 = { defaults: { variable: { prefix: "p", selector: ":root,:host", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t2 } = e;
  t2 && (this._theme = $2(h3({}, t2), { options: h3(h3({}, this.defaults.options), t2.options) }), this._tokens = b3.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
...
var BaseStyle = class _BaseStyle {
  ...
  loadStyle = (options = {}, style11 = "") => {
    return this.load(this.style, options, (computedStyle = "") => S2.transformCSS(options.name || this.name, `${computedStyle}${ar`${style11}`}`));
  };
  loadBaseCSS = (options = {}) => {
...
var DomHandler = class _DomHandler {
  ...
  static getViewport() {
    let win = window, d2 = document, e = d2.documentElement, g2 = d2.getElementsByTagName("body")[0], w3 = win.innerWidth || e.clientWidth || g2.clientWidth, h4 = win.innerHeight || e.clientHeight || g2.clientHeight;
    return { width: w3, height: h4 };
  }
  static getOffset(el) {
...
var BadgeDirective = class _BadgeDirective extends BaseComponent {
  ...
  constructor() {
    super();
    effect(() => {
      const pt2 = this.ptBadgeDirective() || this.pBadgePT();
      pt2 && this.directivePT.set(pt2);
    });
    effect(() => {
...
var ButtonLabel = class _ButtonLabel extends BaseComponent {
  ...
  constructor() {
    super();
    effect(() => {
      const pt2 = this.ptButtonLabel() || this.pButtonLabelPT();
      pt2 && this.directivePT.set(pt2);
    });
    effect(() => {
...
var ButtonIcon = class _ButtonIcon extends BaseComponent {
  ...
  constructor() {
    super();
    effect(() => {
      const pt2 = this.ptButtonIcon() || this.pButtonIconPT();
      pt2 && this.directivePT.set(pt2);
    });
    effect(() => {
...
var ButtonDirective = class _ButtonDirective extends BaseComponent {
  ...
  constructor() {
    super();
    effect(() => {
      const pt2 = this.ptButtonDirective() || this.pButtonPT();
      pt2 && this.directivePT.set(pt2);
    });
    effect(() => {
      this.pButtonUnstyled() && this.directiveUnstyled.set(this.pButtonUnstyled());
  ...
  set buttonProps(val) {
    ...
    if (val && typeof val === "object") {
      Object.entries(val).forEach(([k5, v4]) => this[`_${k5}`] !== v4 && (this[`_${k5}`] = v4));
    }
  }
  /**
...
var InputText = class _InputText extends BaseModelHolder {
  ...
  constructor() {
    super();
    effect(() => {
      const pt2 = this.ptInputText() || this.pInputTextPT();
      pt2 && this.directivePT.set(pt2);
    });
    effect(() => {
...
var Tooltip = class _Tooltip extends BaseComponent {
  ...
  constructor(zone, viewContainer) {
    ...
    effect(() => {
      const pt2 = this.ptTooltip() || this.pTooltipPT();
      pt2 && this.directivePT.set(pt2);
    });
    effect(() => {
...
var D2 = (t2, n2, e) => n2 in t2 ? j2(t2, n2, { enumerable: true, configurable: true, writable: true, value: e }) : t2[n2] = e;
var p3 = (t2, n2) => {
  for (var e in n2 || (n2 = {})) q2.call(n2, e) && D2(t2, e, n2[e]);
  if (T2) for (var e of T2(n2)) V2.call(n2, e) && D2(t2, e, n2[e]);
  return t2;
};
var N2 = (t2, n2, e) => new Promise((o, m3) => {
  var i3 = (r) => {
    try {
      f2(e.next(r));
    } catch (u2) {
  ...
  }, f2 = (r) => r.done ? o(r.value) : Promise.resolve(r.value).then(i3, M2);
  f2((e = e.apply(t2, n2)).next());
});
var E3 = "animation";
var v3 = "transition";
function H2(t2) {
...
function k4(t2, n2) {
  return t2 ? p3(p3({}, t2), Object.entries(n2).reduce((e, [o, m3]) => {
    var i3;
    return e[o] = (i3 = t2[o]) != null ? i3 : m3, e;
  }, {})) : n2;
}
function L(t2) {
  let { name: n2, enterClass: e, leaveClass: o } = t2 || {};
  return { enter: { from: (e == null ? void 0 : e.from) || `${n2}-enter-from`, to: (e == null ? void 0 : e.to) || `${n2}-enter-to`, active: (e == null ? void 0 : e.active) || `${n2}-enter-active` }, leave: { from: (o == null ? void 0 : o.from) || `${n2}-leave-from`, to: (o == null ? void 0 : o.to) || `${n2}-leave-to`, active: (o == null ? void 0 : o.active) || `${n2}-leave-active` } };
}
function W2(t2) {
...
function A2(t2, n2) {
  let e = window.getComputedStyle(t2), o = (l3) => {
    let c4 = e[`${l3}Delay`], h4 = e[`${l3}Duration`];
    return [c4.split(", ").map(oe), h4.split(", ").map(oe)];
  }, [m3, i3] = o(v3), [M2, f2] = o(E3), r = Math.max(...i3.map((l3, c4) => l3 + m3[c4])), u2 = Math.max(...f2.map((l3, c4) => l3 + M2[c4])), a2, s4 = 0, d2 = 0;
  return n2 === v3 ? r > 0 && (a2 = v3, s4 = r, d2 = i3.length) : n2 === E3 ? u2 > 0 && (a2 = E3, s4 = u2, d2 = f2.length) : (s4 = Math.max(r, u2), a2 = s4 > 0 ? r > u2 ? v3 : E3 : void 0, d2 = a2 ? a2 === v3 ? i3.length : f2.length : 0), { type: a2, timeout: s4, count: d2 };
}
function $3(t2, n2) {
  return typeof t2 == "number" ? t2 : typeof t2 == "object" && t2[n2] != null ? t2[n2] : null;
}
function S3(t2, n2 = true, e = false) {
  if (!n2 && !e) return;
  let o = w(t2);
  n2 && te(t2, "--pui-motion-height", o.height + "px"), e && te(t2, "--pui-motion-width", o.width + "px");
}
...
function tt2(t2, n2) {
  ...
  let e = {}, o = false, m3 = {}, i3 = null, M2 = {}, f2 = (a2) => {
    if (Object.assign(e, k4(a2, U2)), !e.enter && !e.leave) throw new Error("Enter or leave must be true.");
    M2 = W2(e), o = H2(e), m3 = L(e), i3 = null;
  }, r = (a2) => N2(null, null, function* () {
    i3 == null || i3();
    let { onBefore: s4, onStart: d2, onAfter: l3, onCancelled: c4 } = M2[a2] || {}, h4 = { element: t2 };
    if (o) {
      s4 == null || s4(h4), d2 == null || d2(h4), l3 == null || l3(h4);
      return;
    }
    let { from: g2, active: y3, to: P2 } = m3[a2] || {};
    return S3(t2, e.autoHeight, e.autoWidth), s4 == null || s4(h4), W(t2, g2), W(t2, y3), t2.offsetHeight, P(t2, g2), W(t2, P2), d2 == null || d2(h4), new Promise((b4) => {
...
var z3 = 0;
function G3(t2, n2, e, o) {
  let m3 = t2._motionEndId = ++z3, i3 = () => {
    m3 === t2._motionEndId && o();
  };
  if (e != null) return setTimeout(i3, e);
  let { type: M2, timeout: f2, count: r } = A2(t2, n2);
  if (!M2) {
    o();
    return;
  }
  let u2 = M2 + "end", a2 = 0, s4 = () => {
...
var Motion = class _Motion extends BaseComponent {
  ...
  constructor() {
    ...
    effect(() => {
      if (!this.motion) {
        this.motion = tt2(this.$el, this.motionOptions());
      } else {
      }
    });
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-A5WLHX2Q.js.map
