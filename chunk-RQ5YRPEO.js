...
`, styles: ["/* src/app/shared/components/tabs/dynamic-tab-panel/dynamic-tab-panel.component.scss */\n:host {\n  display: block;\n  height: 100%;\n  overflow: hidden;\n}\n/*# sourceMappingURL=dynamic-tab-panel.component.css.map */\n"] }]
  }], null, { tabs: [{ type: Input, args: [{ isSignal: true, alias: "tabs", required: false }] }], baseRoute: [{ type: Input, args: [{ isSignal: true, alias: "baseRoute", required: false }] }], tabChange: [{ type: Output, args: ["tabChange"] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-RQ5YRPEO.js.map
