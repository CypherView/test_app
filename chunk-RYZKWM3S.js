...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ClientSelectionFormComponent, [{
    type: Component,
    args: [{ selector: "app-client-selection-form", standalone: true, imports: [
      FormsModule,
      InputTextModule,
      InputIcon,
      IconField,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientSelectionFormComponent, { className: "ClientSelectionFormComponent", filePath: "src/app/shared/components/client-selection-form/client-selection-form.component.ts", lineNumber: 40 });
})();
...
//# sourceMappingURL=chunk-RYZKWM3S.js.map
