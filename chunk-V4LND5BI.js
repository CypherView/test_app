import {
  AppCardComponent
} from "./chunk-ZOHOQZ7C.js";
import {
  AppInstallFacadeService
} from "./chunk-U6B6EWVE.js";
import "./chunk-O34F6462.js";
import "./chunk-N23YVXYH.js";
import {
  AppStoreService
...
var AppMarketplaceComponent = class _AppMarketplaceComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppMarketplaceComponent, selectors: [["app-marketplace"]], features: [\u0275\u0275ProvidersFeature([ConfirmationService])], decls: 8, vars: 6, consts: [[1, "flex", "flex-col", "h-full", "w-full", "overflow-hidden"], [3, "searchQueryChange", "categoryChange", "sortChange", "categories", "sortOptions", "selectedCategory", "selectedSort", "searchQuery"], [1, "flex-1", "min-h-0", "w-full", "overflow-auto", "p-6"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-3", "xl:grid-cols-4", "gap-6"], [1, "flex", "flex-col", "items-center", "justify-center", "py-20", "text-center"], [1, "text-center", "py-12"], [1, "h-64", "rounded-2xl", "animate-pulse", "border", "border-subtle"], [1, "w-16", "h-16", "rounded-full", "flex", "items-center", "justify-center", "mb-4"], [1, "pi", "pi-exclamation-triangle", "text-3xl"], [1, "text-xl", "font-bold", "mb-2"], [1, "text-muted"], [3, "app", "isLoading"], [3, "installClick", "uninstallClick", "app", "isLoading"], [1, "pi", "pi-inbox", "!text-6xl", "muted", "mb-4"], [1, "text-lg", "font-medium", "mb-2"], [1, "muted"]], template: function AppMarketplaceComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-V4LND5BI.js.map
