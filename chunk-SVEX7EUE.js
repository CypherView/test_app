import{C as S,F as oe,Ia as R,K as pe,a as m,b as F,d as k,k as f,ma as he,na as E,ra as ue,w as ae}from"./chunk-BENBQ5BH.js";import{Bb as y,Bc as ee,Da as C,Lb as d,Mb as h,Ob as j,Pb as K,Qb as T,Vc as I,Xc as te,Yb as g,Zb as v,bc as U,ca as A,cc as H,da as B,ea as O,ec as M,fc as l,gc as q,hc as X,ib as c,ja as Q,jd as ie,kc as L,lc as Y,ld as ne,mc as x,md as se,nc as w,oc as J,pc as W,pd as re,qb as G,qd as le,ta as o,ua as p,ud as V,vb as b,wb as N,wd as D,xa as _,zb as P,zc as Z}from"./chunk-YH3INYG5.js";var de=["*"],ge=["panel"],me=["container"],fe=n=>({display:"flex","flex-wrap":"nowrap","flex-direction":n});function Se(n,z){n&1&&U(0)}function ze(n,z){if(n&1){let e=H();g(0,"div",6),M("mousedown",function(i){o(e);let s=l().index,r=l();return p(r.onGutterMouseDown(i,s))})("touchstart",function(i){o(e);let s=l().index,r=l();return p(r.onGutterTouchStart(i,s))})("touchmove",function(i){o(e);let s=l(2);return p(s.onGutterTouchMove(i))})("touchend",function(i){o(e);let s=l(2);return p(s.onGutterTouchEnd(i))}),g(1,"div",7),M("keyup",function(i){o(e);let s=l(2);return p(s.onGutterKeyUp(i))})("keydown",function(i){o(e);let s=l().index,r=l();return p(r.onGutterKeyDown(i,s))}),v()()}if(n&2){let e=l(2);d("data-p-gutter-resizing",!1)("data-pc-section","gutter"),c(),h("ngStyle",e.gutterStyle()),d("aria-orientation",e.layout)("aria-valuenow",e.prevSize)("data-pc-section","gutterhandle")}}function _e(n,z){if(n&1&&(g(0,"div",3),y(1,Se,1,0,"ng-container",4),v(),y(2,ze,2,6,"div",5)),n&2){let e=z.$implicit,t=z.index,i=l();T(i.panelStyleClass),h("ngClass",i.panelContainerClass())("ngStyle",i.panelStyle),d("data-pc-name","splitter")("data-pc-section","root"),c(),h("ngTemplateOutlet",e),c(),h("ngIf",t!==i.panels.length-1)}}var ye=({dt:n})=>`
.p-splitter {
    display: flex;
    flex-wrap: nowrap;
