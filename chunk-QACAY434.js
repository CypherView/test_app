...
} from "./chunk-WOSTIYSR.js";
import {
  EntityDetailsService,
  GridConfigurationFactory
} from "./chunk-SJJMMFUN.js";
import "./chunk-7IID4E3D.js";
import {
...
import {
  getThemeDictionary
} from "./chunk-R6WDU73R.js";
import {
  FaIconComponent,
  FontAwesomeModule
} from "./chunk-WI5JYU2U.js";
import {
  ADMIN_TREE,
  ClientDataService,
  DATE_FORMATS,
...
var AdminTreeEventHandlerService = class _AdminTreeEventHandlerService {
  ...
  onNodeNotFoundInData(event) {
    ...
    this.adminSearchService.searchAndLoadClient(clientId, searchContext).then(async () => {
...
var AdminContainerComponent = class _AdminContainerComponent {
  ...
  ngOnInit() {
    ...
    this.broadcastService.on("tree-refresh-required").pipe(takeUntilDestroyed(this.destroyRef)).subscribe((message) => {
  ...
  handleTreeRefreshRequired(message) {
    ...
    switch (m.entityType) {
      case "vendor": {
        const distributorId = m.distributorId ?? this.adminState.vendorDistributor()?.id;
        const expandedDistributors = this.adminState.expandedDistributors?.();
        if (isDefined(distributorId) && (isNullOrUndefined(expandedDistributors) || expandedDistributors.has(distributorId))) {
          this.adminTreeService.listDistributorVendors(distributorId).then((vendors) => {
            this.adminState.setVendors(vendors);
          }).catch((error) => {
            console.error("Error reloading vendors after creation:", error);
          });
        }
        break;
      }
      /*     case 'distributor': {
              // Refresh distributors under super-admin root if expanded
              const expandedNodes = this.adminState.expandedNodes?.();
              const superAdminExpanded = expandedNodes?.has?.('super-admin-root');
      
              if (superAdminExpanded) {
                this.adminTreeService
                  .listDistributors()
                  .then((distributors) => {
                  ...
                  .catch((error: unknown) => {
                    console.error(
                      'Error reloading distributors after creation:',
                      error,
                    );
                  });
              }
      ...
      case "client": {
        let vendorId = m.vendorId;
        if (isNullOrUndefined(vendorId)) {
          const selected = this.selectedTreeNode();
          if (selected?.type === ADMIN_TREE.NODE_TYPES.VENDOR && isDefined(selected.key)) {
            vendorId = selected.key;
          }
        }
        if (isNullOrUndefined(vendorId)) {
          console.warn("Client created but no vendorId available to refresh.");
          return;
        }
        const expandedVendors = this.adminState.expandedNodes?.();
        if (isNullOrUndefined(expandedVendors) || expandedVendors.has(vendorId)) {
          this.adminTreeService.listVendorClients(vendorId).then((result) => {
            this.adminState.addVendorClients(vendorId, result.clients, {
              offset: 0,
              limit: DEFAULT_LIST_SIZE,
              total: result.total,
            ...
            console.error("Error reloading clients after creation:", error);
          });
        }
        break;
      }
  ...
  /**
   * Synchronizes tree selection between route-based selection and local storage.
   * This handles all node types, not just clients.
   */
  async syncTreeSelectionWithRouteAndLocalStorage() {
    try {
      const clientServiceClient = this.clientDataService.getSelectedClient();
      if (clientServiceClient && isDefined(clientServiceClient.id)) {
        this.treeEventHandler.setEventSource(EventSource.SYSTEM);
        this.containerState.suppressScrollToClient.set(false);
        const currentUrl = this.router.url;
        const expectedClientPath = `/admin/client/${clientServiceClient.id}`;
        if (!currentUrl.startsWith(expectedClientPath)) {
          await this.handleSelectedClientChange(clientServiceClient);
          return;
        }
      }
      const { keyToSelect, typeToSelect } = this.getEntityInfoFromRoute();
      if (!isDefined(keyToSelect)) {
        ...
        if (isDefined(currentClient?.id)) {
          await this.handleClientBasedSelection(currentClient);
        }
        return;
      }
      this.treeEventHandler.setEventSource(EventSource.SYSTEM);
  ...
  /**
   * Prepares tree data for client nodes
   */
  ...
  /**
   * Updates tree selection based on route parameters
   */
  ...
  /**
   * Handles client-based selection (fallback when no route selection)
   */
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminContainerComponent, { className: "AdminContainerComponent", filePath: "src/app/features/administration/components/admin-container/admin-container.component.ts", lineNumber: 70 });
})();
    ...
    children: [
      {
        ...
        loadChildren: () => import("./chunk-D3FD7RI3.js").then((m) => m.SuperAdminModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-I3BP53PV.js").then((m) => m.VendorsModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-H36BDH4H.js").then((m) => m.DistributorsModule)
      },
      {
        ...
        loadChildren: () => import("./chunk-7YC3YRZF.js").then((m) => m.ClientsModule)
      }
    ]
  }
];
...
var WizardComponent = class _WizardComponent {
  ...
  }, inputs: { steps: [1, "steps"], visible: [1, "visible"], header: [1, "header"], linearProgression: [1, "linearProgression"], showFooterButtons: [1, "showFooterButtons"], closeOnEscape: [1, "closeOnEscape"], useWizardButtonsOnly: [1, "useWizardButtonsOnly"], showSteps: [1, "showSteps"], contentOnly: [1, "contentOnly"], loading: [1, "loading"] }, outputs: { visible: "visibleChange", loading: "loadingChange", visibleChange: "visibleChange", onCancel: "onCancel", complete: "complete", stepChange: "stepChange" }, decls: 2, vars: 1, consts: [["styleClass", "wizard-dialog", 3, "visible", "header", "modal", "draggable", "resizable", "closeOnEscape"], [1, "wizard-content"], [3, "stepChange", "complete", "steps", "currentStepValue", "linearProgression", "showNavButtons", "showSteps"], [1, "flex", "justify-end", "gap-2", "w-full", "mt-3"], ["label", "Cancel", "icon", "pi pi-times", "severity", "secondary", 3, "onClick"], ["label", "Back", "icon", "pi pi-arrow-left", "severity", "secondary"], ["label", "Next", "icon", "pi pi-arrow-right", "iconPos", "right", 3, "disabled"], ["label", "Finish", "icon", "pi pi-check", "severity", "primary", 3, "disabled", "loading"], ["label", "Back", "icon", "pi pi-arrow-left", "severity", "secondary", 3, "onClick"], ["label", "Next", "icon", "pi pi-arrow-right", "iconPos", "right", 3, "onClick", "disabled"], ["label", "Finish", "icon", "pi pi-check", "severity", "primary", 3, "onClick", "disabled", "loading"], ["styleClass", "wizard-dialog", 3, "onHide", "visibleChange", "visible", "header", "modal", "draggable", "resizable", "closeOnEscape"], ["pTemplate", "footer"], [1, "flex", "justify-end", "gap-2", "w-full"]], template: function WizardComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetTagCreateWizardComponent, { className: "AssetTagCreateWizardComponent", filePath: "src/app/features/administration/components/asset-tags/asset-tag-create-wizard/asset-tag-create-wizard.component.ts", lineNumber: 42 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SimCardCreateWizardComponent, { className: "SimCardCreateWizardComponent", filePath: "src/app/features/administration/components/sim-cards/sim-card-create-wizard/sim-card-create-wizard.component.ts", lineNumber: 42 });
})();
...
var _c022 = ["smsGatewayProviderDetailsStep"];
var _c120 = ["smsGatewayProviderParametersStep"];
var _c217 = ["confirmationTemplate"];
...
var _c023 = ["deviceConfigProfileDetailsStep"];
var _c121 = ["confirmationTemplate"];
var _c218 = ["deviceConfigProfileDetailsForm"];
...
var _c024 = ["customFieldDetailsStep"];
var _c122 = ["confirmationTemplate"];
var _c219 = ["customFieldDetailsForm"];
...
var _c025 = ["userRoleDetailsStep"];
var _c123 = ["confirmationTemplate"];
var _c220 = ["userRoleDetailsForm"];
...
var _c026 = ["userDetailsStep"];
var _c124 = ["userRolesStep"];
var _c221 = ["confirmationTemplate"];
...
var _c027 = ["vendorDetailsStep"];
var _c125 = ["confirmationTemplate"];
var _c222 = ["vendorDetailsForm"];
...
var _c028 = ["clientDetailsStep"];
var _c126 = ["confirmationTemplate"];
var _c223 = ["clientDetailsForm"];
...
var _c029 = ["distributorDetailsStep"];
var _c127 = ["confirmationTemplate"];
var _c224 = ["distributorDetailsForm"];
...
var _c030 = ["assetCategoryDetailsStep"];
var _c128 = ["confirmationTemplate"];
var _c225 = ["assetCategoryDetailsForm"];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetCategoryCreateWizardComponent, { className: "AssetCategoryCreateWizardComponent", filePath: "src/app/features/administration/components/asset-categories/asset-category-create-wizard/asset-category-create-wizard.component.ts", lineNumber: 43 });
})();
...
var _c031 = ["assetGroupDetailsStep"];
var _c129 = ["confirmationTemplate"];
var _c226 = ["assetGroupDetailsForm"];
...
var _c032 = ["costCentreDetailsStep"];
var _c130 = ["confirmationTemplate"];
var _c227 = ["costCentreDetailsForm"];
...
var _c033 = ["geofenceGroupDetailsStep"];
var _c131 = ["confirmationTemplate"];
var _c228 = ["geofenceGroupDetailsForm"];
...
//# sourceMappingURL=chunk-QACAY434.js.map
