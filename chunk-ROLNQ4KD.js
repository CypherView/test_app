...
var AppCreatorDashboardComponent = class _AppCreatorDashboardComponent {
  ...
  loadApps() {
    ...
    this.error.set(null);
    this.appStoreService.getApps({
      developerId: this.authDataService.getUserProfile()?.id
    }).pipe(catchError(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppCreatorDashboardComponent, { className: "AppCreatorDashboardComponent", filePath: "src/app/features/app-store/pages/app-creator-dashboard/app-creator-dashboard.component.ts", lineNumber: 30 });
})();
export {
  AppCreatorDashboardComponent
};
//# sourceMappingURL=chunk-ROLNQ4KD.js.map
