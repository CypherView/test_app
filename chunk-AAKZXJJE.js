...
function AppDetailComponent_Conditional_0_ng_template_3_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(app_r2.status === "draft" ? 3 : app_r2.status === "pendingReview" ? 4 : app_r2.status === "rejected" ? 5 : -1);
  }
}
...
var AppDetailComponent = class _AppDetailComponent {
  ...
  isInPendingReview(app) {
    return app?.status === "pendingReview";
  }
  approveApp(app) {
    if (!app)
      return;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppDetailComponent, [{
    type: Component,
    args: [{ selector: "app-app-detail", imports: [
      CommonModule,
      RouterModule,
      FormsModule,
      ButtonModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppDetailComponent, { className: "AppDetailComponent", filePath: "src/app/features/app-store/pages/app-detail/app-detail.component.ts", lineNumber: 49 });
})();
export {
  AppDetailComponent
};
//# sourceMappingURL=chunk-AAKZXJJE.js.map
