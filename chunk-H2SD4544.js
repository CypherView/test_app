...
var ContextSelectionWizardComponent = class _ContextSelectionWizardComponent {
  ...
  // This should NOT change when search results come back
  ...
  // Uses the initial/unfiltered count so it doesn't flip when search results are fewer
  ...
  loadClientsForAccount(searchTerm = "") {
    ...
    if (searchTerm.trim() === "" && this.cachedEmptyClients.length > 0) {
      ...
      this.totalClientCount.set(this.unfilteredTotalCount());
  ...
  }, decls: 12, vars: 7, consts: [["accountSelectionStep", ""], ["clientSelectionStep", ""], [1, "panel", "login-box", "flex", "flex-col", "w-full", "mx-auto", "pb-8"], [1, "bg-[var(--main-background-color)]", "p-6", "rounded-border", "shadow-card", "justify-start", "rounded-none"], ["header", "Context Selection", 3, "onCancel", "visibleChange", "visible", "steps", "useWizardButtonsOnly", "showFooterButtons", "loading", "contentOnly"], [1, "!text-white", "pt-4", "underline", "cursor-pointer", "self-center", 3, "click"], [1, "!text-white", "self-center"], [1, "flex", "flex-col", "items-center", "w-full"], [1, "w-full"], [1, "flex", "flex-col", "items-center", "gap-3", "mt-6"], ["styleClass", "w-10 h-10 text-primary-500"], [1, "text-sm", "text-gray-500"], [1, "text-center", "mb-8"], [1, "text-sm", "text-gray-400", "text-center", "mt-2"], [3, "accountSelected", "clientAccounts", "maxHeightClass"], [3, "clientSelected", "searchQuery", "lazyLoad", "clients", "loading", "useServerSearch", "totalRecords", "enablePagination", "enableLazyLoad", "recentClients"]], template: function ContextSelectionWizardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(4, ContextSelectionWizardComponent_ng_template_4_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(6, ContextSelectionWizardComponent_ng_template_6_Template, 4, 8, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContextSelectionWizardComponent, { className: "ContextSelectionWizardComponent", filePath: "src/app/features/auth/components/context-selection-wizard/context-selection-wizard.component.ts", lineNumber: 79 });
})();
...
//# sourceMappingURL=chunk-H2SD4544.js.map
