...
var AdminGridContainerComponent = class _AdminGridContainerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminGridContainerComponent, selectors: [["app-admin-grid-container"]], viewQuery: function AdminGridContainerComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(21, "div", 11)(22, "app-grid", 12);
      \u0275\u0275listener("onLazyLoad", function AdminGridContainerComponent_Template_app_grid_onLazyLoad_22_listener($event) {
        return ctx.handleLazyLoad($event);
      })("onFilterChange", function AdminGridContainerComponent_Template_app_grid_onFilterChange_22_listener($event) {
        return ctx.handleFilterChange($event);
      })("rowSelect", function AdminGridContainerComponent_Template_app_grid_rowSelect_22_listener($event) {
        return ctx.handleRowSelect($event);
      })("rowUnselect", function AdminGridContainerComponent_Template_app_grid_rowUnselect_22_listener($event) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(6, 40, "ADMIN.SHARED.ARIA.GRID_ACTIONS"));
      \u0275\u0275advance(2);
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(8, 42, "SHARED.COMMON.BUTTONS.ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(9, 44, "ADMIN.SHARED.ARIA.ADD_NEW_ITEM"))("aria-disabled", !((tmp_4_0 = ctx.gridConfiguration()) == null ? null : tmp_4_0.onAdd));
      \u0275\u0275advance(3);
      \u0275\u0275conditional(((tmp_5_0 = ctx.gridConfiguration()) == null ? null : tmp_5_0.onBulkImport) ? 10 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(12, 46, "SHARED.COMMON.BUTTONS.REFRESH"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 48, "ADMIN.SHARED.ARIA.REFRESH_GRID_DATA"))("aria-busy", ctx.loading());
      \u0275\u0275advance(3);
      \u0275\u0275classProp("text-primary", ctx.showFilters());
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(15, 50, "ADMIN.SHARED.TOOLTIPS.FILTER"))("disabled", !ctx.canFilter());
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(16, 52, "ADMIN.SHARED.ARIA.TOGGLE_FILTERS"))("aria-disabled", !ctx.canFilter());
      \u0275\u0275advance(3);
      \u0275\u0275property("columns", ctx.selectableColumns())("selectedColumns", ctx.visibleColumns())("disabled", !ctx.gridConfiguration());
      \u0275\u0275advance();
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(19, 54, "ADMIN.SHARED.TOOLTIPS.EXPORT_CSV"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(20, 56, "ADMIN.SHARED.ARIA.EXPORT_TO_CSV"));
      \u0275\u0275advance(4);
    ...
    <div class="flex justify-between items-center">
      ...
      >
        ...
        <button
          ...
          [pTooltip]="'ADMIN.SHARED.TOOLTIPS.EXPORT_CSV' | translate"
          tooltipPosition="bottom"
          (click)="onExport()"
          [attr.aria-label]="'ADMIN.SHARED.ARIA.EXPORT_TO_CSV' | translate"
        ></button>
      </div>
    </div>
  </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminGridContainerComponent, { className: "AdminGridContainerComponent", filePath: "src/app/features/administration/components/admin-grid-container/admin-grid-container.component.ts", lineNumber: 89 });
})();
...
function TreeTableComponent_ng_template_2_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ttSortableColumn", col_r1.sortable ? col_r1.field : "")("ngClass", col_r1.styleClass);
    \u0275\u0275advance();
...
function TreeTableComponent_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, TreeTableComponent_ng_template_2_For_3_Template, 3, 6, "th", 7, _forTrack0);
    \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-KE5TEEAF.js.map
