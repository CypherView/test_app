import {
  ...
  userProfileResolver
} from "./chunk-HXV6KUCM.js";
import {
  ThemeComponent
} from "./chunk-FHG5IVOL.js";
import {
  NO_RETRY,
  SILENT_ERROR,
  SKIP_AUTH_REFRESH
} from "./chunk-WUU5544Q.js";
import {
  LayoutService
} from "./chunk-VMZPD5CU.js";
import {
...
import {
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-U5MHJFFK.js";
import "./chunk-AFE2YUEN.js";
import {
  Menu,
  MenuModule
} from "./chunk-PZY6SF26.js";
import {
  Tag,
  TagModule
...
import {
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-QFVJPFVR.js";
import "./chunk-WW5JATKP.js";
import {
  Popover,
  PopoverModule,
  UtilityService
} from "./chunk-A4NH4TA4.js";
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-UVVHZQKP.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-J6I6Q2ZW.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-ZFFKEB5D.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        data: { featureFlag: "page.moreapps.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-64ZJJO5Q.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        canActivate: [nonProductionGuard],
        loadChildren: () => import("./chunk-P2P53IFK.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-L6NTFXEM.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-ONBZYJSK.js").then((m5) => m5.UnauthorizedComponent)
  }
];
