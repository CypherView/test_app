import {
  ...
  userProfileResolver
} from "./chunk-24JBIQZF.js";
import {
  SplitterModule
} from "./chunk-GLZ3N7N2.js";
import {
  Menu,
  MenuModule,
  Toast,
  ToastModule
} from "./chunk-K32L7TYM.js";
import {
  FaIconComponent,
  FontAwesomeModule
} from "./chunk-OB7POHBA.js";
import {
  ToastService
} from "./chunk-SOFGEAAV.js";
import {
  GridComponent,
  TableModule
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-2WJF4CX3.js").then((m5) => m5);
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-KBGNYK2W.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-KBGNYK2W.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-BUYBZ3A6.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-MWRK54ZU.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-YLPXOYCK.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-MXIDML3U.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-JR625WPW.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-5L7OSFTP.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-3YI6AQKS.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-BNADWY5Z.js").then((m5) => m5.AUTH_ROUTES)
  }
];
