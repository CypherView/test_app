...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-7PSX2NLO.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-7PSX2NLO.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.history.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-ROWSRTOK.js").then((m5) => m5.HistoryModule)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-6MBUNUID.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-GI2X73C7.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-LJDFUUO4.js").then((m5) => m5.AuthModule)
  }
];
