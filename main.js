import {
  ...
  userProfileResolver
} from "./chunk-4HLBFE4J.js";
import {
  SplitterModule
} from "./chunk-WUG6WBHP.js";
import {
  ENTITY_ADAPTER_REGISTRY
} from "./chunk-5R5FSHTC.js";
import {
  AlertsDataAdapter,
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-ACFVKNSU.js";
import {
  FaIconComponent,
  FontAwesomeModule
} from "./chunk-4ICMQIRP.js";
import "./chunk-UUDHIPGY.js";
import {
  ToastService
} from "./chunk-5UPPGJ2R.js";
import {
  GridComponent,
  TableModule
} from "./chunk-RKYMAEZO.js";
import "./chunk-Y7L4QABX.js";
import {
  ApiSchemaService,
  Dialog,
  DialogModule,
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-JF6JC2DB.js";
import {
  UtilityService
} from "./chunk-2J3GIFAI.js";
import {
  BadgeModule,
  BaseComponent,
  BaseStyle,
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-LYDQ36YB.js").then((m5) => m5);
...
var ClientSwitcherComponent = class _ClientSwitcherComponent {
  ...
  ngOnInit() {
    ...
    this.searchSubject.pipe(debounceTime(this.DEBOUNCE_TIME), takeUntilDestroyed(this.destroyRef)).subscribe(() => {
...
` }]
  }], null, { onClosed: [{ type: Output, args: ["onClosed"] }], logoTemplate: [{
    type: ViewChild,
    args: ["logoTemplate", { static: true }]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientSwitcherComponent, { className: "ClientSwitcherComponent", filePath: "src/app/features/clients/components/client-switcher/client-switcher.component.ts", lineNumber: 55 });
})();
...
var SidebarComponent = class _SidebarComponent {
  ...
  dynamicBottomMenuItems = computed(() => {
    return this.createBottomMenuItems();
...
var ThemeComponent = class _ThemeComponent {
  ...
  constructor() {
    effect(() => {
      ...
      if (selectedClient && selectedClient.id !== this.previousClientId) {
        this.updateTheme(this.getThemeId());
        this.previousClientId = selectedClient.id;
      }
    });
  }
  ngOnInit() {
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-ND67VEXV.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-ND67VEXV.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-SCZFDFXU.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-NKDV76SU.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-AIPA5INJ.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-EQOXUMLW.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-W3CJB55G.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-P5OYSF5H.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-TFDD6VZ2.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-F4Q2NUNN.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-Y3ZRC64E.js").then((m5) => m5.AUTH_ROUTES)
  }
];
...
function startupInitializer() {
  return async () => {
    ...
    try {
      localStorage.migrateSelectedClientIdToSessionId();
