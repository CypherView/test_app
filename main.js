...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-ZE7MPNGM.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-ZE7MPNGM.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-TG265VW4.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-CPWS4UML.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-NDBHK7XT.js").then((m5) => m5.DevelopmentModule)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-QOMXKCAK.js").then((m5) => m5.AuthModule)
  }
];
