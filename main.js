import {
  ...
  userProfileResolver
} from "./chunk-WZVCNKOZ.js";
import {
  ThemeComponent
} from "./chunk-7RRKM5S4.js";
import {
  NO_RETRY,
  SILENT_ERROR,
  SKIP_AUTH_REFRESH
} from "./chunk-6YA2H5H4.js";
import {
  LayoutService
} from "./chunk-QPXNU2SC.js";
import {
...
import {
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-OTLWSTVF.js";
import "./chunk-AFE2YUEN.js";
import {
  Menu,
  MenuModule
} from "./chunk-VZKH22ZX.js";
import {
  Tag,
  TagModule
...
import {
  ...
  Toast,
  ToastModule
} from "./chunk-7UI32YRN.js";
import "./chunk-VQZODH6K.js";
import {
  LanguageService
} from "./chunk-7T2RTLQG.js";
...
import {
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-KYO6ZEUQ.js";
import "./chunk-WW5JATKP.js";
import {
  Popover,
  PopoverModule,
  UtilityService
} from "./chunk-J3DZJXYK.js";
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-NGETEKRW.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-I7KFF7U7.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-YL7OVSUN.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        data: { featureFlag: "page.moreapps.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-CAEYDEYM.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        canActivate: [nonProductionGuard],
        loadChildren: () => import("./chunk-JP2ENUCZ.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-NXSMB2JC.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-PBDB5S3Y.js").then((m5) => m5.UnauthorizedComponent)
  }
];
