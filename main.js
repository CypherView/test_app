import {
  ...
  userProfileResolver
} from "./chunk-4PF62MDH.js";
import {
  ThemeComponent
} from "./chunk-IUDUWJN7.js";
import {
  Tag,
  TagModule
} from "./chunk-YRD2G732.js";
import {
...
import {
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-IPDDT53K.js";
import {
  FaIconComponent,
  FontAwesomeModule,
  Toast,
  ToastModule
} from "./chunk-3SP5DPPG.js";
import "./chunk-3HMCVQYQ.js";
import "./chunk-ZLLI6SMD.js";
import {
  ToastService
} from "./chunk-4U5JIUJL.js";
import "./chunk-DXDVPHIO.js";
import {
  Card,
  CardModule
} from "./chunk-NTRZRX32.js";
import {
  SplitterModule
} from "./chunk-4ELBCO6M.js";
import "./chunk-AAPZGS4D.js";
import "./chunk-I3GLYQ4V.js";
import {
  Table,
  TableModule
} from "./chunk-J225XH3P.js";
import "./chunk-R3N3P5LZ.js";
import {
  ApiSchemaService,
  DialogService,
  DynamicDialogConfig,
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-KPRG7L7L.js";
import {
  Dialog,
  DialogModule
} from "./chunk-GPJSQTNR.js";
import {
  UtilityService
} from "./chunk-NS6YWNCI.js";
import "./chunk-DTC2ZSBN.js";
import "./chunk-MN6NIPQY.js";
import {
  Tab,
  TabList,
  TabPanel,
  ...
  Tabs,
  TabsModule
} from "./chunk-IP6GKUYI.js";
import "./chunk-2JKK5HB2.js";
import "./chunk-246LWNGC.js";
import "./chunk-ORWXPZA3.js";
import "./chunk-6ELJIV2M.js";
import {
  ...
  Select,
  SelectModule
} from "./chunk-2SGGVSCE.js";
import {
  ProgressSpinner,
  ProgressSpinnerModule
} from "./chunk-UY7RJXPW.js";
import {
  Tooltip,
  TooltipModule
} from "./chunk-QQQ6ISQ3.js";
import {
  BadgeModule,
  Button,
  ButtonModule
} from "./chunk-UTRNHLRQ.js";
import {
  BaseComponent,
  BaseStyle,
  Bind,
...
var SmartPayloadBuilder = class {
  ...
  static getValueForField(name) {
    ...
    if (lowered.includes("amount") || lowered.includes("count") || lowered.includes("price") || lowered.includes("total")) {
      return 100;
    }
    if (lowered.startsWith("is") || lowered.startsWith("has") || lowered.startsWith("should") || lowered.includes("active") || lowered.includes("enabled")) {
      return true;
    }
...
var API_SIMULATION_REGISTRY = [
  ...
  // --- External Entities ---
  {
    ...
    requiresOwnerId: true,
    createFields: ["name", "email", "phoneNumber", "address", "ownerId"],
    updateFields: ["name", "email", "phoneNumber", "address"]
  },
  {
    id: "vendors",
    domain: "Accounts",
  ...
  },
  {
    ...
    requiresOwnerId: false,
    createFields: ["name", "manufacturer", "model", "capabilities"],
    updateFields: ["name", "manufacturer", "model", "capabilities"]
  },
  {
    id: "deviceProviders",
    domain: "Hardware",
  ...
  // --- Reports & Dashboards ---
  {
    ...
    requiresOwnerId: true,
    createFields: ["name", "description", "widgets", "ownerId"],
    updateFields: ["name", "description", "widgets"]
  },
  {
    ...
    requiresOwnerId: false,
    createFields: ["name", "description", "layout", "widgets"],
    updateFields: ["name", "description", "layout", "widgets"]
  },
  {
    id: "reportTemplates",
    domain: "Reports",
    ...
    requiresOwnerId: false,
    createFields: ["name", "description", "format", "parameters"],
    updateFields: ["name", "description", "format", "parameters"]
  },
  {
    id: "scheduledReports",
    domain: "Reports",
    ...
    requiresOwnerId: true,
    createFields: ["name", "templateId", "schedule", "recipients", "ownerId"],
    updateFields: ["name", "templateId", "schedule", "recipients"]
  },
  ...
  // --- Integrations ---
  {
    ...
    requiresOwnerId: true,
    createFields: ["name", "providerType", "settings", "ownerId"],
    updateFields: ["name", "providerType", "settings"]
  },
  {
...
function QaApiSimulationPanelComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275property("value", ctx_r1.stats().total.toString());
    \u0275\u0275advance(4);
    \u0275\u0275property("value", ctx_r1.stats().allowed.toString());
    \u0275\u0275advance(4);
    \u0275\u0275property("value", ctx_r1.stats().forbidden.toString());
    \u0275\u0275advance(4);
    \u0275\u0275property("value", ctx_r1.stats().errors.toString());
    \u0275\u0275advance(4);
    \u0275\u0275property("value", ctx_r1.stats().mismatches.toString())("severity", ctx_r1.stats().mismatches > 0 ? "danger" : "success");
  }
}
function QaApiSimulationPanelComponent_ng_template_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(entry_r3.domain);
  }
}
...
function QaApiSimulationPanelComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("onClick", function QaApiSimulationPanelComponent_ng_template_17_Template_p_button_onClick_15_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.runSingleVerification(entry_r5));
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    const opCell_r6 = \u0275\u0275reference(20);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", entry_r5.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", entry_r5.basePath, " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngTemplateOutlet", opCell_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction1(13, _c13, ctx_r1.getResultFor(entry_r5.id, "list")));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngTemplateOutlet", opCell_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction1(15, _c2, ctx_r1.getResultFor(entry_r5.id, "create")));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngTemplateOutlet", opCell_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction1(17, _c3, ctx_r1.getResultFor(entry_r5.id, "update")));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngTemplateOutlet", opCell_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction1(19, _c4, ctx_r1.getResultFor(entry_r5.id, "delete")));
    \u0275\u0275advance(2);
    \u0275\u0275property("rounded", true)("text", true)("loading", ctx_r1.isVerifying());
  }
}
...
function QaApiSimulationPanelComponent_ng_template_19_Conditional_0_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("Expected: ", result_r8.frontendExpected);
  }
}
function QaApiSimulationPanelComponent_ng_template_19_Conditional_0_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const result_r8 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275property("title", result_r8.errorDetails ?? "");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(result_r8.errorDetails);
  }
}
function QaApiSimulationPanelComponent_ng_template_19_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function QaApiSimulationPanelComponent_ng_template_19_Conditional_0_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.showDetails(result_r8));
    });
  ...
  if (rf & 2) {
    ...
    const result_r8 = ctx_r8.$implicit;
    const op_r10 = ctx_r8.op;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("severity", ctx_r1.getAccessSeverity(result_r8.backendAccess))("value", result_r8.backendAccess);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isMismatch(result_r8) ? 3 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", result_r8.durationMs, "ms \xB7 ", op_r10);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isMismatch(result_r8) ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(result_r8.backendAccess === "Error" ? 7 : -1);
  }
}
...
function QaApiSimulationPanelComponent_Conditional_23_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(1, _c6, r_r11.backendAccess === "Allowed", r_r11.backendAccess === "Forbidden", r_r11.backendAccess === "Error"));
  }
}
function QaApiSimulationPanelComponent_Conditional_23_Conditional_32_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const r_r11 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 1, r_r11.requestBody));
  }
}
...
function QaApiSimulationPanelComponent_Conditional_23_Conditional_39_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const r_r11 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 1, r_r11.responseBody));
  }
}
function QaApiSimulationPanelComponent_Conditional_23_Conditional_40_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const r_r11 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(r_r11.errorDetails);
  }
}
...
function QaApiSimulationPanelComponent_Conditional_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(15, _c5, r_r11.backendAccess === "Allowed" && !ctx_r1.isMismatch(r_r11), r_r11.backendAccess === "Forbidden" || ctx_r1.isMismatch(r_r11), r_r11.backendAccess === "Error"));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.isMismatch(r_r11) ? 4 : 5);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(r_r11.frontendExpected);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(r_r11.backendAccess);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", r_r11.durationMs, "ms");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(r_r11.httpMethod);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", r_r11.url, " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(28, 13, r_r11.headersSent));
    \u0275\u0275advance(5);
    \u0275\u0275conditional(r_r11.requestBody ? 32 : 33);
    \u0275\u0275advance(6);
    \u0275\u0275property("severity", ctx_r1.getAccessSeverity(r_r11.backendAccess))("value", r_r11.backendAccess)("rounded", true);
    \u0275\u0275advance();
    \u0275\u0275conditional(r_r11.responseBody ? 39 : r_r11.errorDetails ? 40 : 41);
  }
}
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QaApiSimulationPanelComponent, selectors: [["app-qa-api-simulation-panel"]], decls: 24, vars: 14, consts: [["opCell", ""], [1, "flex", "flex-col", "gap-6", "mt-6"], [1, "flex", "items-center", "justify-between", "border-b", "pb-4", "border-gray-100", "dark:border-gray-700"], [1, "text-lg", "font-bold", "flex", "items-center", "gap-2"], [1, "pi", "pi-bolt", "text-yellow-500"], [1, "text-sm", "text-gray-500"], [1, "text-[11px]", "bg-gray-100", "dark:bg-gray-700", "px-1", "rounded"], ["type", "button", "label", "Verify All", "icon", "pi pi-play", "severity", "warn", 3, "onClick", "loading", "disabled"], [1, "flex", "flex-wrap", "gap-4", "p-4", "bg-gray-50", "dark:bg-gray-800", "rounded-xl"], [1, "border", "rounded-xl", "border-gray-100", "dark:border-gray-700", "overflow-hidden"], ["groupRowsBy", "domain", "rowGroupMode", "subheader", 3, "value", "tableStyle"], ["pTemplate", "groupheader"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], ["styleClass", "w-full md:w-[50vw]", 3, "visibleChange", "header", "visible", "modal", "dismissableMask", "draggable"], [1, "flex", "flex-col", "gap-4"], [1, "flex", "items-center", "gap-2"], [1, "text-xs", "font-bold", "text-gray-500", "uppercase"], ["severity", "info", 3, "value"], ["severity", "success", 3, "value"], ["severity", "danger", 3, "value"], ["severity", "warn", 3, "value"], [1, "ml-auto", "flex", "items-center", "gap-2"], [3, "value", "severity"], [1, "p-rowgroup-header", "bg-gray-50", "dark:bg-gray-800/50", "uppercase"], ["colspan", "6"], [1, "font-bold", "text-gray-500", "text-xs", "tracking-wider"], ["scope", "col"], ["scope", "col", 1, "w-24"], [1, "font-medium"], [1, "text-xs", "text-gray-500", "font-mono"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], ["type", "button", "icon", "pi pi-play", "size", "small", "pTooltip", "Verify this entity", 3, "onClick", "rounded", "text", "loading"], ["colspan", "5", 1, "p-8", "text-center", "bg-gray-50", "dark:bg-gray-800"], [1, "pi", "pi-info-circle", "text-4xl", "text-gray-300", "mb-4"], [1, "text-gray-500"], ["type", "button", 1, "flex", "flex-col", "gap-1", "items-start", "cursor-pointer", "bg-transparent", "border-none", "p-0", "text-left"], [1, "text-gray-300", "dark:text-gray-600"], ["type", "button", 1, "flex", "flex-col", "gap-1", "items-start", "cursor-pointer", "bg-transparent", "border-none", "p-0", "text-left", 3, "click"], [1, "flex", "items-center", "gap-1"], [3, "severity", "value"], ["pTooltip", "Frontend/Backend mismatch!", 1, "pi", "pi-exclamation-triangle", "text-yellow-500", "text-xs"], [1, "text-[10px]", "text-gray-400", "font-mono"], [1, "text-[10px]", "text-yellow-600", "dark:text-yellow-400", "font-bold"], [1, "text-[10px]", "text-red-500", "truncate", "w-32", 3, "title"], [1, "flex", "items-center", "gap-3", "p-3", "rounded-lg", 3, "ngClass"], [1, "flex-1"], [1, "flex", "items-center", "gap-2", "text-sm", "font-bold"], [1, "text-xs", "text-gray-500", "mt-1"], [1, "font-bold"], [1, "text-xs", "text-gray-400", "font-mono"], [1, "p-3", "bg-gray-50", "border", "border-gray-200", "dark:bg-gray-800", "dark:border-gray-700", "rounded-lg"], [1, "text-xs", "font-bold", "text-gray-500", "uppercase", "mb-2"], [1, "text-sm", "font-mono", "break-all", "text-gray-700", "dark:text-gray-300"], [1, "font-bold", "text-primary"], [1, "mt-2"], [1, "bg-white", "dark:bg-gray-900", "border", "dark:border-gray-600", "p-2", "text-xs", "rounded", "mt-1"], [1, "max-h-48", "overflow-y-auto", "w-full"], [1, "text-sm", "text-gray-400", "italic"], [1, "text-xs", "font-bold", "text-gray-500", "uppercase", "mb-2", "flex", "items-center", "justify-between"], [3, "severity", "value", "rounded"], [1, "text-sm", "text-red-500"], [1, "pi", "pi-exclamation-triangle", "text-yellow-500"], [1, "text-yellow-700", "dark:text-yellow-400"], [1, "pi", "pi-check-circle", 3, "ngClass"], [1, "text-xs", "font-mono", "bg-white", "dark:bg-gray-900", "border", "dark:border-gray-600", "p-2", "rounded", "m-0", "break-words", "whitespace-pre-wrap"]], template: function QaApiSimulationPanelComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("onClick", function QaApiSimulationPanelComponent_Template_p_button_onClick_11_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.runAllVerifications());
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("visibleChange", function QaApiSimulationPanelComponent_Template_p_dialog_visibleChange_21_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.selectedResult.set(null));
      });
...
var SidebarComponent = class _SidebarComponent {
  ...
  }, features: [\u0275\u0275ProvidersFeature([DialogService])], decls: 12, vars: 23, consts: [[1, "md:hidden", "p-4"], [1, "flex", "flex-col", "min-h-full", "sidebar-container", "left-0", "bottom-0", "top-0", 3, "ngClass"], [3, "click", "keydown.enter", "isCollapsed", "userProfile", "clientLogo", "clientName", "ngClass", "pTooltip", "showDelay"], [1, "w-full", "top-menu", "overflow-y-auto", "overflow-x-hidden", 3, "model"], ["pTemplate", "submenuheader"], ["pTemplate", "item"], [1, "mt-auto", "w-full", 3, "model"], [3, "toggleChange", "isCollapsed"], [1, "pi", "pi-bars", "text-2xl", "cursor-pointer", 3, "click", "keydown.enter"], [1, "flex", "items-center", "justify-center", "text-xs", "text-nav-client-font-color", "opacity-50"], [3, "item", "isCollapsed"], [3, "onClosed"], [3, "closeModal"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "src/app/layouts/components/sidebar/sidebar.component.ts", lineNumber: 73 });
})();

// src/app/layouts/components/main-layout/main-layout.component.ts
var MainLayoutComponent_Defer_10_DepsFn = () => [import("./chunk-NCBR4BO2.js").then((m5) => m5.FlutterLayoutComponent)];
...
function MainLayoutComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 9)(8, "button", 13);
    \u0275\u0275listener("click", function MainLayoutComponent_Conditional_4_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function MainLayoutComponent_Conditional_4_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function MainLayoutComponent_Defer_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-flutter-layout");
  }
}
function MainLayoutComponent_DeferLoading_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-progressSpinner", 17);
  }
}
function MainLayoutComponent_DeferPlaceholder_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-progressSpinner", 17);
  }
}
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], hostBindings: function MainLayoutComponent_HostBindings(rf, ctx) {
  ...
  }, features: [\u0275\u0275ProvidersFeature([DialogService])], decls: 16, vars: 15, consts: [[1e3, 100], [500], [1, "flex", "h-full"], [1, "w-full"], [1, "qa-test-banner", "flex", "items-center", "justify-between", "px-4", "py-2", "bg-orange-500", "text-white", "border-b-2", "border-orange-600"], [3, "ngClass"], [1, "h-full", "flutter-layout", 3, "ngClass"], [1, "h-full", 3, "ngClass"], ["title", "External Application", "sandbox", "allow-same-origin allow-scripts allow-forms allow-popups", 1, "w-full", "h-full", "border-0", 3, "src"], [1, "flex", "items-center", "gap-2"], [1, "pi", "pi-exclamation-triangle"], [1, "font-semibold"], [1, "text-sm", "opacity-90"], [1, "px-3", "py-1", "text-sm", "bg-white", "text-orange-600", "rounded", "hover:bg-orange-50", "transition-colors", 3, "click"], [1, "pi", "pi-cog", "mr-1"], [1, "px-3", "py-1", "text-sm", "bg-orange-700", "text-white", "rounded", "hover:bg-orange-800", "transition-colors", 3, "click"], [1, "pi", "pi-refresh", "mr-1"], ["styleClass", "w-[50px] h-[50px]", "strokeWidth", "4"]], template: function MainLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "app-theme")(1, "div", 2);
      \u0275\u0275element(2, "app-sidebar");
      \u0275\u0275elementStart(3, "div", 3);
      \u0275\u0275conditionalCreate(4, MainLayoutComponent_Conditional_4_Template, 14, 1, "div", 4);
      \u0275\u0275elementStart(5, "p-scrollpanel", 5)(6, "div", 6);
      \u0275\u0275domTemplate(7, MainLayoutComponent_Defer_7_Template, 1, 0)(8, MainLayoutComponent_DeferLoading_8_Template, 1, 0)(9, MainLayoutComponent_DeferPlaceholder_9_Template, 1, 0);
      \u0275\u0275defer(10, 7, MainLayoutComponent_Defer_10_DepsFn, 8, 9, null, 0, 1, \u0275\u0275deferEnableTimerScheduling);
      \u0275\u0275deferOnIdle();
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "div", 7);
      \u0275\u0275conditionalCreate(13, MainLayoutComponent_Conditional_13_Template, 1, 1, "iframe", 8);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.qaTools.testMode() ? 4 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", ctx.scrollPanelClass());
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(6, _c07, !ctx.isFlutterRoute(), ctx.isFlutterRoute()));
      \u0275\u0275advance(6);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(9, _c07, !ctx.isIframeRoute(), ctx.isIframeRoute()));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.iframeUrl() ? 13 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(12, _c07, ctx.isFlutterRoute() || ctx.isIframeRoute(), !ctx.isFlutterRoute() && !ctx.isIframeRoute()));
    }
  }, dependencies: [
    RouterModule,
    RouterOutlet,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-NCBR4BO2.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayoutComponent, { className: "MainLayoutComponent", filePath: "src/app/layouts/components/main-layout/main-layout.component.ts", lineNumber: 53 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExternalTabComponent, { className: "ExternalTabComponent", filePath: "src/app/features/external-tab/external-tab.component.ts", lineNumber: 21 });
})();
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-LQHMFSZF.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-5KYGD4SL.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-6AWG3Q2E.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-BBY4UWBM.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-CBQLZDHV.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-QPQNLJH4.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-XMN7OEPP.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        data: { featureFlag: "page.moreapps.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-AXPC3ATZ.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-YKVV2ITU.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-4UZQXGC3.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-EXPID6TT.js").then((m5) => m5.UnauthorizedComponent)
  }
];
