...
var require_webfontloader = __commonJS({
  "node_modules/webfontloader/webfontloader.js"(exports, module2) {
    "use strict";
    (function() {
      function aa(a, b, c) {
      ...
      "function" === typeof define && define.amd ? define(function() {
        return Z;
      }) : "undefined" !== typeof module2 && module2.exports ? module2.exports = Z : (window.WebFont = Z, window.WebFontConfig && Y.load(window.WebFontConfig));
    })();
  }
});
...
var require_eventemitter3 = __commonJS({
  "node_modules/subscriptions-transport-ws/node_modules/eventemitter3/index.js"(exports, module2) {
    "use strict";
    ...
    var SubscriptionClient2 = function() {
      ...
      SubscriptionClient3.prototype.request = function(request) {
        ...
        return _a = {}, _a[symbol_observable_1.default] = function() {
          return this;
        }, _a.subscribe = function(observerOrNext, onError2, onComplete2) {
          var observer = getObserver(observerOrNext, onError2, onComplete2);
      ...
      SubscriptionClient3.prototype.buildMessage = function(id, type, payload) {
        var payloadToReturn = payload && payload.query ? __assign2(__assign2({}, payload), {
      ...
      SubscriptionClient3.prototype.processReceivedData = function(receivedData) {
        ...
        switch (parsedMessage.type) {
          ...
          case message_types_1.default.GQL_DATA:
            var parsedPayload = !parsedMessage.payload.errors ? parsedMessage.payload : __assign2(__assign2({}, parsedMessage.payload), {
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-PWLSLCOC.js").then((m) => m);
...
var _c03 = ["logoTemplate"];
function ClientSwitcherComponent_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 6);
  }
  if (rf & 2) {
    ...
    \u0275\u0275propertyInterpolate1("alt", "Logo of ", client_r2.name, "");
    \u0275\u0275property("src", ctx_r2.getImageUrl(client_r2.id), \u0275\u0275sanitizeUrl);
  }
}
var ClientSwitcherComponent = class _ClientSwitcherComponent {
  ...
  loadClients(event) {
    ...
    this.clientsService.listClients(ownerId, event.first, pageSize, "name", rqlFilter).subscribe({
      next: (data) => {
  ...
  static \u0275fac = function ClientSwitcherComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ClientSwitcherComponent)(\u0275\u0275directiveInject(BroadcastMessageService));
  };
  ...
  }, outputs: { onClosed: "onClosed" }, decls: 9, vars: 11, consts: [["logoTemplate", ""], ["header", "Select Client", "styleClass", "w-[90vw] md:w-[50vw] sm:w-[75vw]", 3, "visibleChange", "onHide", "visible", "modal"], [1, "p-2"], ["pInputText", "", "placeholder", "Search", 1, "w-full", 3, "ngModelChange", "input", "ngModel"], [1, "pi", "pi-search"], [3, "onLazyLoad", "rowSelect", "columns", "data", "pagination", "totalRecords", "lazy", "selectionMode", "hideHeader", "loading"], ["width", "50", 3, "src", "alt"]], template: function ClientSwitcherComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275element(5, "br");
      \u0275\u0275elementStart(6, "app-grid", 5);
      \u0275\u0275listener("onLazyLoad", function ClientSwitcherComponent_Template_app_grid_onLazyLoad_6_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.loadClients($event));
      })("rowSelect", function ClientSwitcherComponent_Template_app_grid_rowSelect_6_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.selectClient($event.data));
      });
      \u0275\u0275template(7, ClientSwitcherComponent_ng_template_7_Template, 1, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275property("columns", ctx.columns)("data", ctx.clients())("pagination", true)("totalRecords", ctx.totalRecords())("lazy", true)("selectionMode", "single")("hideHeader", true)("loading", ctx.loading());
    }
  }, dependencies: [
    DialogModule,
    Dialog,
...
var _c04 = (a0, a1) => ({ "justify-center": a0, "justify-between": a1 });
var _c12 = (a0) => [a0, "!text-2xl flex items-center justify-center"];
...
function MenuItemComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    let tmp_2_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(2, _c12, (tmp_1_0 = ctx_r0.item()) == null ? null : tmp_1_0["icon"]))("pTooltip", (tmp_2_0 = ctx_r0.item()) == null ? null : tmp_2_0["label"]);
  }
}
...
var MenuItemComponent = class _MenuItemComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MenuItemComponent, selectors: [["app-menu-item"]], inputs: { item: [1, "item"], isCollapsed: [1, "isCollapsed"] }, decls: 5, vars: 7, consts: [["routerLinkActive", "p-menuitem-link-active", "pRipple", "", 1, "flex", "items-center", "p-menu-item-link", 3, "routerLink", "ngClass"], [1, "custom-icon-svg", 3, "pTooltip"], [1, "!text-2xl", "flex", "items-center", "justify-center", 3, "icon", "pTooltip"], [3, "ngClass", "pTooltip"], [1, "ml-2"]], template: function MenuItemComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(1, MenuItemComponent_Conditional_1_Template, 2, 2, ":svg:svg", 1)(2, MenuItemComponent_Conditional_2_Template, 1, 2, "fa-icon", 2)(3, MenuItemComponent_Conditional_3_Template, 1, 4, "span", 3)(4, MenuItemComponent_Conditional_4_Template, 2, 1, "span", 4);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_0_0;
      let tmp_2_0;
      \u0275\u0275property("routerLink", (tmp_0_0 = ctx.item()) == null ? null : tmp_0_0["routerLink"])("ngClass", \u0275\u0275pureFunction2(4, _c04, ctx.isCollapsed(), !ctx.isCollapsed()));
      \u0275\u0275advance();
...
function MenuItemContent_ng_container_1_a_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("target", ctx_r1.item.target)("ngClass", \u0275\u0275pureFunction1(9, _c13, ctx_r1.item.disabled));
...
function Menu_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(18, _c11, ctx_r1.popup))("ngStyle", ctx_r1.style)("@overlayAnimation", \u0275\u0275pureFunction1(23, _c132, \u0275\u0275pureFunction2(20, _c122, ctx_r1.showTransitionOptions, ctx_r1.hideTransitionOptions)))("@.disabled", ctx_r1.popup !== true);
...
var _c06 = (a0, a1) => ({ "text-right": a0, "text-center": a1 });
var _c16 = (a0, a1) => ({ "pi-chevron-left": a0, "pi-chevron-right": a1 });
var ToggleButtonComponent = class _ToggleButtonComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToggleButtonComponent, selectors: [["app-toggle-button"]], inputs: { isCollapsed: [1, "isCollapsed"] }, outputs: { toggleChange: "toggleChange" }, decls: 2, vars: 8, consts: [[1, "block", "p-2", "w-full", "text-nav-client-font-color", 3, "click", "ngClass"], [1, "pi", 3, "ngClass"]], template: function ToggleButtonComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(2, _c06, !ctx.isCollapsed(), ctx.isCollapsed()));
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(5, _c16, !ctx.isCollapsed(), ctx.isCollapsed()));
    }
...
function UserProfileComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserProfileComponent_Conditional_0_Conditional_1_Template, 2, 1, "div", 1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var UserProfileComponent = class _UserProfileComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserProfileComponent, selectors: [["app-user-profile"]], inputs: { isCollapsed: [1, "isCollapsed"], userProfile: [1, "userProfile"], clientLogo: [1, "clientLogo"], clientName: [1, "clientName"] }, decls: 2, vars: 1, consts: [[1, "flex", "items-center", "justify-center", "gap-1", "px-2", "py-2", "user-profile"], [1, "w-10", "h-10", "rounded-full", "bg-gray-500", "text-white", "flex", "items-center", "justify-center"], [1, "flex", "items-center", "justify-center", "gap-1", "sidebar-brand"], ["alt", "", 3, "src"], [1, "user-profile", "text-center", "text-ellipsis", "overflow-hidden", "p-2"]], template: function UserProfileComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, UserProfileComponent_Conditional_0_Template, 2, 1, "div", 0)(1, UserProfileComponent_Conditional_1_Template, 4, 2);
    }
    if (rf & 2) {
...
var PAGE_ICONS = {
  ...
  mapsearch: "pi pi-map-marked-alt",
...
var NavigationService = class _NavigationService {
  ...
  setPath(url) {
    ...
    const root2 = Object.keys(pages).find((x) => url.indexOf(x) === 1);
    if (root2 != null) {
      const page = pages[root2];
      this.pageHistory.update((history) => __spreadProps(__spreadValues({}, history), { [root2]: url }));
      ...
      this.activeRoot.next(child != null ? `${root2}/${child}` : root2);
    }
  }
  getFeatures() {
  ...
  computeNavigationGroups() {
    ...
    const allGroups = groupIds.map((groupId) => ({
      ...
      items: items.filter((item) => item.group === groupId).sort((a, b) => a.order - b.order)
    }));
    const regularGroups = [];
  ...
  async navigateToPage(page, child) {
    ...
    const validPages = [
      ...Object.keys(pages),
      ...Object.values(pages).filter((p) => Boolean(p.route)).map((p) => p.route)
    ];
...
var _c07 = (a0, a1, a2, a3) => ({ "w-16": a0, "w-aside": a1, "w-1/2": a2, open: a3 });
...
function SidebarComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SidebarComponent_ng_template_4_Conditional_0_Template, 3, 3, "span", 9);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function SidebarComponent_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SidebarComponent_ng_template_9_Conditional_0_Template, 3, 3, "span", 9);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(!ctx_r2.isCollapsed() ? 0 : -1);
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275fac = function SidebarComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SidebarComponent)(\u0275\u0275directiveInject(BroadcastMessageService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], hostBindings: function SidebarComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275template(0, SidebarComponent_Conditional_0_Template, 2, 0, "div", 2);
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(14, SidebarComponent_Conditional_14_Template, 1, 0, "app-client-switcher");
    }
    if (rf & 2) {
      let tmp_9_0;
      \u0275\u0275conditional(!ctx.isSidebarOpen() ? 0 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(11, _c07, ctx.isCollapsed(), !ctx.isCollapsed() && !ctx.isMobile(), ctx.isMobile(), ctx.isSidebarOpen()));
      \u0275\u0275advance();
...
function parseCss(css) {
  ...
  var settings = _extends({}, defaults3, options);
  var errors = [];
  function error(msg) {
...
var ThemeComponent = class _ThemeComponent {
  ...
  ngOnInit() {
    this.themeService.theme$.pipe(takeUntil(this.destroy$)).subscribe({
      next: (theme4) => {
        if (!theme4)
          return;
        this.loadTheme(theme4).catch((error) => console.error("Error loading theme:", error));
      }
    });
  }
  ngOnDestroy() {
  ...
  async loadTheme(theme4) {
    try {
      this.loading.set(true);
      await this.processTheme(theme4);
      this.loading.set(false);
    } catch (error) {
      this.loading.set(false);
  ...
  processCustomTags(theme4) {
    theme4.customTags?.forEach((customTag, index) => {
      this.appendHTML(`custom-tag-${index}`, customTag.location, customTag.tag, customTag.attributes, customTag.contents);
    });
  }
  async processThemeVariables(theme4) {
    if (!theme4.variables)
      return;
    await this.injectSettingsVariables(theme4.variables);
    this.updateClasses(theme4.variables);
  }
  async processTheme(theme4) {
    await Promise.all([
      this.processThemeVariables(theme4),
      this.loadExternalStyles(theme4),
      this.injectCustomStyles(theme4),
      this.processCustomTags(theme4)
    ]);
  }
  async loadExternalStyles(theme4) {
    if (!theme4.settings?.["cssSrc"])
      return;
    try {
      const response = await firstValueFrom(this.http.get(theme4.settings["cssSrc"], {
        responseType: "text"
      }));
  ...
  async injectCustomStyles(theme4) {
    if (isNullOrUndefined(theme4.customStyles))
      return;
    try {
      await this.injectStyle("custom-css", theme4.customStyles);
    } catch (error) {
  ...
  updateClasses(variables) {
    ...
    if (variables["--main-gutter-width"] && !["0", "0px", "0rem"].includes(variables["--main-gutter-width"])) {
      classes4.push("app-has-gutter");
    }
    this.classes = classes4.join(" ");
  }
  updateTheme(themeId) {
    (themeId === "default" ? this.themeService.getDomainTheme(themeId) : this.themeService.fetchTheme(themeId)).subscribe({
      next: (theme4) => {
        this.loadTheme(theme4).catch(() => {
        });
        this.themeService.setTheme(theme4);
      }
    });
  }
  getThemeId() {
  ...
  }, ngContentSelectors: _c08, decls: 2, vars: 1, consts: [[1, "fixed", "inset-0", "flex", "items-center", "justify-center"], ["styleClass", "w-12 h-12 text-primary-500"]], template: function ThemeComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      \u0275\u0275template(0, ThemeComponent_Conditional_0_Template, 2, 0, "div", 0)(1, ThemeComponent_Conditional_1_Template, 1, 0);
    }
    if (rf & 2) {
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-NRBPK3NK.js").then((m) => m.FlutterLayoutComponent)];
var _c09 = (a0, a1) => ({ hidden: a0, block: a1 });
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], decls: 15, vars: 13, consts: [[1e3, 100], [500], [1, "flex", "h-full"], [1, "w-full"], ["styleClass", "w-full h-full"], [1, "h-full", 3, "ngClass"], ["title", "External Application", "sandbox", "allow-same-origin allow-scripts allow-forms allow-popups", 1, "w-full", "h-full", "border-0", 3, "src"], ["styleClass", "w-[50px] h-[50px]", "strokeWidth", "4"]], template: function MainLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(12, MainLayoutComponent_Conditional_12_Template, 1, 1, "iframe", 6);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275advance(5);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(4, _c09, !ctx.isFlutterRoute(), ctx.isFlutterRoute()));
      \u0275\u0275advance(6);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(7, _c09, !ctx.isIframeRoute(), ctx.isIframeRoute()));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.iframeUrl() ? 12 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(10, _c09, ctx.isFlutterRoute() || ctx.isIframeRoute(), !ctx.isFlutterRoute() && !ctx.isIframeRoute()));
    }
  }, dependencies: [
    RouterModule,
    RouterOutlet,
...
function ExternalTabComponent_iframe_0_Template(rf, ctx) {
  if (rf & 1) {
...
var ExternalTabComponent = class _ExternalTabComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExternalTabComponent, selectors: [["app-external-tab"]], decls: 1, vars: 1, consts: [["class", "external-iframe", "title", "External Content", 3, "src", 4, "ngIf"], ["title", "External Content", 1, "external-iframe", 3, "src"]], template: function ExternalTabComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, ExternalTabComponent_iframe_0_Template, 1, 1, "iframe", 0);
    }
    if (rf & 2) {
      \u0275\u0275property("ngIf", ctx.iframeUrl());
    }
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-LEPXOJWW.js").then((m) => m.PositionModule)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true },
        loadChildren: () => import("./chunk-NWJINWTM.js").then((m) => m.AlertsModule)
      },
      {
        path: "media",
        data: { isFlutterRoute: true },
        loadChildren: () => import("./chunk-DXWBEKWV.js").then((m) => m.MediaModule)
      },
      {
        path: "history",
        data: { isFlutterRoute: true },
        loadChildren: () => import("./chunk-DTZXMVFY.js").then((m) => m.HistoryModule)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-OHZPL26V.js").then((m) => m.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-K4NEIFEW.js").then((m) => m.AdministrationModule)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-LFXGXD36.js").then((m) => m.AuthModule)
  }
];
...
var ToastService = class _ToastService {
  ...
  static \u0275fac = function ToastService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ToastService)(\u0275\u0275inject(MessageService));
  };
...
var AuthInterceptorService = class _AuthInterceptorService {
  ...
  authDataService = inject(AuthDataService);
  intercept(req, next) {
    const accessToken = this.authTokenManagerService.getAccessToken();
  ...
  handle401Error(req, next, refreshToken) {
    if (!this.refreshTokenInProgress) {
      ...
      return this.authService.refreshToken(refreshToken).pipe(switchMap((authResponse) => {
        ...
        this.authTokenManagerService.storeTokens(authResponse);
        return next.handle(this.addToken(req, authResponse.accessToken));
      }), catchError((error) => {
        this.refreshTokenInProgress = false;
        this.authDataService.forceLogout();
  ...
  handleError(req, next, error) {
    ...
    if (error.status === 401) {
      if (req.url.includes("/auth/signin")) {
        this.showToastForError(errorObject);
        return throwError(() => errorObject);
      }
      const refreshToken = this.authTokenManagerService.getRefreshToken();
      return isDefined(refreshToken) ? this.handle401Error(req, next, refreshToken).pipe(catchError((refreshError) => {
        this.authDataService.forceLogout();
        this.showToastForError(errorObject);
  ...
  showToastForError(errorObject) {
    switch (errorObject.errorReason) {
      case ErrorReasons.Unauthorized:
        this.toastService.showError("Unauthorized", errorObject.errorMessage);
        break;
      case ErrorReasons.NetworkError:
        this.toastService.showError("Network Error", errorObject.errorMessage);
        break;
      case ErrorReasons.ServerError:
        this.toastService.showError("Server Error", errorObject.errorMessage);
        break;
      case ErrorReasons.InvalidEndpoint:
        this.toastService.showError("Service Unavailable", errorObject.errorMessage);
        break;
      case ErrorReasons.RequestTimeout:
        this.toastService.showError("Request Timeout", errorObject.errorMessage);
        break;
      case ErrorReasons.TooManyLogins:
        this.toastService.showError("Too Many Logins", errorObject.errorMessage);
        break;
      case ErrorReasons.BadRequest:
        this.toastService.showError("Validation Error", errorObject.errorMessage);
        break;
      case ErrorReasons.Unknown:
        this.toastService.showError("Error", errorObject.errorMessage);
        break;
    }
  }
  /**
   * Determines if an HTTP error should be retried based on the error type.
   * Only retries network errors, timeouts, and server errors.
   * Avoids retrying client errors like 401, 403, 400, etc.
   */
  ...
  static \u0275fac = function AuthInterceptorService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AuthInterceptorService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AuthInterceptorService, factory: _AuthInterceptorService.\u0275fac, providedIn: "root" });
};
...
function pick(context, options, key) {
  return prioritize(context[key], options[key], defaults2[key]);
}
var HttpBatchLinkHandler = class extends ApolloLink {
  ...
  constructor(httpClient, options) {
    ...
    this.batchInterval = options.batchInterval || defaults2.batchInterval;
    this.batchMax = options.batchMax || defaults2.batchMax;
...
var appConfig = {
  providers: [
    ...
    provideApollo(() => {
      ...
      const baseUrl = apiUrlService.getCurrentApiUrl();
      const http = httpLink.create({
        uri: `${baseUrl}/gql`,
        // Add auth headers if needed
        headers: new HttpHeaders(isDefined(localStorage.getItem("accessToken")) ? { "x-access-token": `${localStorage.getItem("accessToken")}` } : {})
      });
      const wsUrl = baseUrl.replace(/^http:\/\//, "ws://").replace(/^https:\/\//, "wss://") + "/gql";
      ...
      return {
        ...
        defaultOptions: {
          ...
          mutation: { fetchPolicy: "network-only", errorPolicy: "all" }
        }
      };
    }),
...
var _c010 = () => ({ width: "100%", right: "0", left: "0" });
var _c17 = (a0) => ({ "768px": a0 });
var ToastComponent = class _ToastComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], decls: 1, vars: 4, consts: [[3, "breakpoints"]], template: function ToastComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("breakpoints", \u0275\u0275pureFunction1(2, _c17, \u0275\u0275pureFunction0(1, _c010)));
    }
