import {
  ...
  userProfileResolver
} from "./chunk-VSKWG34P.js";
import {
  SplitterModule
} from "./chunk-GMDB6F45.js";
import {
  Menu,
  MenuModule,
  Toast,
  ToastModule
} from "./chunk-PJUUHOEO.js";
import {
  FaIconComponent,
  FontAwesomeModule
} from "./chunk-VWECFJOD.js";
import {
  ToastService
} from "./chunk-IDRGKWDS.js";
import {
  GridComponent,
  TableModule
} from "./chunk-WA5XVVI2.js";
import {
  ApiSchemaService,
  ClientDataService,
  Dialog,
...
} from "./chunk-AYZUHLN5.js";
import "./chunk-2WJ75EMG.js";
import {
  ApiModule,
  ApiUrlService,
  AuthDataService,
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-VNQ5WWUD.js").then((m5) => m5);
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-M426PMYE.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-M426PMYE.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-CPDLVAFC.js").then((m5) => m5.PositionModule)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-IBZOM6N5.js").then((m5) => m5.AlertsModule)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-VZSRONVH.js").then((m5) => m5.MediaModule)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-EEGJIDH6.js").then((m5) => m5.HistoryModule)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-EMBVTY7M.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-KXFGRVZG.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-F3YOA2WD.js").then((m5) => m5.DevelopmentModule)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-TSWEUIE3.js").then((m5) => m5.AuthModule)
  }
];
