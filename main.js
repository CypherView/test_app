...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-6JDHIX33.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-6JDHIX33.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-C2XO36G7.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-NELARMC3.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "external/:id",
