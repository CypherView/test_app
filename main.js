...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-IU3RZZHE.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-IU3RZZHE.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-BFB6XLDB.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-UPFSTOIK.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "external/:id",
