import {
  ...
  userProfileResolver
} from "./chunk-ANAP2KQM.js";
import {
  ThemeComponent
} from "./chunk-MCWRQM4A.js";
import {
  Tag,
  TagModule
...
import {
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-32QKI2TA.js";
import {
  FaIconComponent,
  FontAwesomeModule,
  Toast,
  ToastModule
} from "./chunk-ATG6P4B6.js";
import "./chunk-XWPY7GRV.js";
import {
  ToastService
} from "./chunk-XRVWHBPM.js";
...
import {
  SplitterModule
} from "./chunk-QAEJUBXZ.js";
import "./chunk-KSRI3TZO.js";
import "./chunk-3N3LORMC.js";
import {
  Table,
  TableModule
...
import {
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-VOFM54C4.js";
import {
  Dialog,
  DialogModule
} from "./chunk-UNBXKGC2.js";
import {
  UtilityService
} from "./chunk-EPGWPKSI.js";
import "./chunk-PVAVA4C5.js";
import "./chunk-6IZKR6AN.js";
import {
  TabPanel,
  Tabs,
  TabsModule
} from "./chunk-ICUVBTLS.js";
import "./chunk-3ULDGPQL.js";
...
var NavigationService = class _NavigationService {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (clientId === this.lastInheritanceClientId) {
        if (isNullOrUndefined(clientId)) {
          this.inheritanceLoaded.set(true);
        }
        return;
      }
      this.lastInheritanceClientId = clientId;
  ...
  setPath(url) {
    ...
    if (root != null) {
      ...
      this.activeRoot.set(isDefined(child) ? `${root}/${child}` : root);
    }
  }
  getFeatures() {
    ...
    const result = (0, import_lodash2.cloneDeep)(clientDataFeatures);
  ...
  async mergeParentGroupFlags(clientId, clientObject) {
    try {
      ...
      console.debug("Inheritance flags not available:", error);
      return {};
    }
  }
  /**
  ...
  async getCompanyGroupMergedFlags(groupId) {
    ...
    while (isDefined(currentGroupId) && currentGroupId.length > 0 && currentGroupId !== DEFAULT_SYSTEM_ID) {
      try {
...
var _c04 = (a0, a1, a210, a310) => ({ "w-16": a0, "w-aside": a1, "w-1/2": a210, open: a310 });
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], hostBindings: function SidebarComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(16, _c04, ctx.isCollapsed(), !ctx.isCollapsed() && !ctx.isMobile(), ctx.isMobile(), ctx.isSidebarOpen()));
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "src/app/layouts/components/sidebar/sidebar.component.ts", lineNumber: 68 });
})();
...
function QaPermissionTesterComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "i", 25);
    \u0275\u0275elementStart(3, "div", 11)(4, "p", 26);
    ...
    \u0275\u0275listener("click", function QaPermissionTesterComponent_Conditional_10_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.resetPermissions());
    });
    \u0275\u0275elementStart(11, "span", 5);
    \u0275\u0275text(12, "Reset to Real Permissions");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function QaPermissionTesterComponent_For_36_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 20)(1, "input", 31);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r1.qaTools.isPermissionEnabled(permission_r5));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(permission_r5);
  }
}
function QaPermissionTesterComponent_Conditional_38_ng_template_19_Template(rf, ctx) {
  if (rf & 1) {
...
function QaPermissionTesterComponent_Conditional_38_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "code", 49);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td");
    \u0275\u0275text(5);
...
function QaPermissionTesterComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-tabpanel", 21)(1, "div", 33)(2, "div", 1)(3, "div")(4, "p", 34);
    \u0275\u0275text(5, " Client Administration Features ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 35);
    \u0275\u0275text(7, " Features available when managing a client ");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(18, "p-table", 43);
    \u0275\u0275template(19, QaPermissionTesterComponent_Conditional_38_ng_template_19_Template, 9, 0, "ng-template", 44)(20, QaPermissionTesterComponent_Conditional_38_ng_template_20_Template, 11, 6, "ng-template", 45);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1(" Accessible: ", ctx_r1.clientStats().accessible, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Restricted: ", ctx_r1.clientStats().restricted, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Total: ", ctx_r1.clientStats().total, " ");
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.clientFeatureAccess())("tableStyle", \u0275\u0275pureFunction0(5, _c05));
  }
}
function QaPermissionTesterComponent_Conditional_39_ng_template_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 46);
    \u0275\u0275text(2, "Feature ID");
    \u0275\u0275elementEnd();
...
function QaPermissionTesterComponent_Conditional_39_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "code", 49);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function QaPermissionTesterComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-tabpanel", 22)(1, "div", 52)(2, "div", 1)(3, "div")(4, "p", 53);
    \u0275\u0275text(5, " Vendor Administration Features ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 54);
    \u0275\u0275text(7, " Features available when managing a vendor ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 36)(9, "span", 37);
    \u0275\u0275element(10, "i", 38);
    \u0275\u0275text(11);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(18, "p-table", 43);
    \u0275\u0275template(19, QaPermissionTesterComponent_Conditional_39_ng_template_19_Template, 9, 0, "ng-template", 44)(20, QaPermissionTesterComponent_Conditional_39_ng_template_20_Template, 11, 6, "ng-template", 45);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1(" Accessible: ", ctx_r1.vendorStats().accessible, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Restricted: ", ctx_r1.vendorStats().restricted, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Total: ", ctx_r1.vendorStats().total, " ");
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.vendorFeatureAccess())("tableStyle", \u0275\u0275pureFunction0(5, _c05));
  }
}
function QaPermissionTesterComponent_Conditional_40_ng_template_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 46);
    \u0275\u0275text(2, "Feature ID");
    \u0275\u0275elementEnd();
...
function QaPermissionTesterComponent_Conditional_40_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "code", 49);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function QaPermissionTesterComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-tabpanel", 23)(1, "div", 55)(2, "div", 1)(3, "div")(4, "p", 56);
    \u0275\u0275text(5, " Distributor Administration Features ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 57);
    \u0275\u0275text(7, " Features available when managing a distributor ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 36)(9, "span", 37);
    \u0275\u0275element(10, "i", 38);
    \u0275\u0275text(11);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(18, "p-table", 43);
    \u0275\u0275template(19, QaPermissionTesterComponent_Conditional_40_ng_template_19_Template, 9, 0, "ng-template", 44)(20, QaPermissionTesterComponent_Conditional_40_ng_template_20_Template, 11, 6, "ng-template", 45);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1(" Accessible: ", ctx_r1.distributorStats().accessible, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Restricted: ", ctx_r1.distributorStats().restricted, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Total: ", ctx_r1.distributorStats().total, " ");
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.distributorFeatureAccess())("tableStyle", \u0275\u0275pureFunction0(5, _c05));
  }
}
var QaPermissionTesterComponent = class _QaPermissionTesterComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QaPermissionTesterComponent, selectors: [["app-qa-permission-tester"]], decls: 41, vars: 7, consts: [[1, "qa-permission-tester", "flex", "flex-col", "gap-4", "p-4"], [1, "flex", "items-center", "justify-between"], [1, "text-2xl", "font-bold", "text-primary"], [1, "text-sm", "text-gray-600", "mt-1"], ["pButton", "", "icon", "pi pi-times", "label", "Close", "aria-label", "Close dialog", 1, "p-button-text", "p-button-rounded", 3, "click"], [1, "sr-only"], [1, "p-4", "rounded-lg", "border-l-4", "border-orange-500", "bg-orange-100", "dark:bg-orange-900/30"], [1, "flex", "flex-col", "gap-4"], [1, "font-semibold", "mb-2"], [1, "text-sm", "text-gray-600", "mb-3"], [1, "flex", "gap-3", "items-end"], [1, "flex-1"], ["for", "profile-selector", 1, "block", "text-sm", "font-medium", "mb-2"], ["id", "profile-selector", "optionLabel", "name", "optionValue", "id", "placeholder", "Select a role...", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "options", "ngModel"], ["pTemplate", "item"], ["label", "Apply Profile", "icon", "pi pi-check", "severity", "success", 3, "onClick", "disabled"], [1, "flex", "flex-col", "gap-3"], [1, "font-semibold", "mb-1"], [1, "text-sm", "text-gray-600"], [1, "qa-permission-toggle-list"], [1, "flex", "items-center", "gap-2", "py-1"], ["header", "Client Features"], ["header", "Vendor Features"], ["header", "Distributor Features"], [1, "flex", "items-center", "gap-2"], [1, "pi", "pi-exclamation-triangle", "text-orange-600", "dark:text-orange-400"], [1, "font-semibold", "text-orange-900", "dark:text-orange-200"], [1, "text-sm", "text-orange-850", "dark:text-orange-300"], ["pButton", "", "label", "Reset to Real Permissions", "icon", "pi pi-refresh", 1, "p-button-warning", 3, "click"], [1, "font-medium"], [1, "text-xs", "text-gray-500"], ["type", "checkbox", 3, "change", "checked"], [1, "text-sm"], [1, "mb-4", "p-3", "bg-blue-100", "dark:bg-blue-900/30", "rounded-lg"], [1, "font-semibold", "text-blue-900", "dark:text-blue-200"], [1, "text-sm", "text-blue-800", "dark:text-blue-300"], [1, "flex", "gap-4", "text-sm"], [1, "text-green-600"], [1, "pi", "pi-check-circle", "mr-1"], [1, "text-red-600"], [1, "pi", "pi-times-circle", "mr-1"], [1, "text-gray-600"], [1, "pi", "pi-info-circle", "mr-1"], ["styleClass", "p-datatable-sm", 3, "value", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["scope", "col", 1, "col-25"], ["scope", "col", 1, "col-15"], ["scope", "col", 1, "col-35"], [1, "text-xs"], [3, "value", "severity", "icon"], [1, "text-xs", "text-gray-600"], [1, "mb-4", "p-3", "bg-purple-100", "dark:bg-purple-900/30", "rounded-lg"], [1, "font-semibold", "text-purple-900", "dark:text-purple-200"], [1, "text-sm", "text-purple-800", "dark:text-purple-300"], [1, "mb-4", "p-3", "bg-indigo-100", "dark:bg-indigo-900/30", "rounded-lg"], [1, "font-semibold", "text-indigo-900", "dark:text-indigo-200"], [1, "text-sm", "text-indigo-800", "dark:text-indigo-300"]], template: function QaPermissionTesterComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(9, "Close");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(10, QaPermissionTesterComponent_Conditional_10_Template, 13, 1, "div", 6);
      ...
      \u0275\u0275conditionalCreate(38, QaPermissionTesterComponent_Conditional_38_Template, 21, 6, "p-tabpanel", 21);
      \u0275\u0275conditionalCreate(39, QaPermissionTesterComponent_Conditional_39_Template, 21, 6, "p-tabpanel", 22);
      \u0275\u0275conditionalCreate(40, QaPermissionTesterComponent_Conditional_40_Template, 21, 6, "p-tabpanel", 23);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(10);
...
(() => {
  ...
  @if (qaTools.testMode()) {
    <div
      class="p-4 rounded-lg border-l-4 border-orange-500 bg-orange-100 dark:bg-orange-900/30"
    >
      <div class="flex items-center gap-2">
        <i
          class="pi pi-exclamation-triangle text-orange-600 dark:text-orange-400"
        ></i>
        <div class="flex-1">
          <p class="font-semibold text-orange-900 dark:text-orange-200">
            Test Mode Active
          </p>
          <p class="text-sm text-orange-850 dark:text-orange-300">
        ...
        <button
          pButton
          label="Reset to Real Permissions"
          icon="pi pi-refresh"
      ...
      <div class="qa-permission-toggle-list">
        @for (permission of togglePermissions(); track permission) {
          <label class="flex items-center gap-2 py-1">
            <input
              type="checkbox"
              [checked]="qaTools.isPermissionEnabled(permission)"
              (change)="
  ...
  <p-tabs>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-blue-800 dark:text-blue-300">
                Features available when managing a client
              </p>
            </div>
            <div class="flex gap-4 text-sm">
              <span class="text-green-600">
                <i class="pi pi-check-circle mr-1"></i>
                Accessible: {{ clientStats().accessible }}
              </span>
              <span class="text-red-600">
                <i class="pi pi-times-circle mr-1"></i>
                Restricted: {{ clientStats().restricted }}
              </span>
          ...
          <div class="flex items-center justify-between">
            <div>
              <p class="font-semibold text-purple-900 dark:text-purple-200">
                Vendor Administration Features
              </p>
              <p class="text-sm text-purple-800 dark:text-purple-300">
                Features available when managing a vendor
              </p>
            </div>
            <div class="flex gap-4 text-sm">
              <span class="text-green-600">
                <i class="pi pi-check-circle mr-1"></i>
                Accessible: {{ vendorStats().accessible }}
              </span>
              <span class="text-red-600">
                <i class="pi pi-times-circle mr-1"></i>
                Restricted: {{ vendorStats().restricted }}
              </span>
              <span class="text-gray-600">
                <i class="pi pi-info-circle mr-1"></i>
    ...
    @if (canViewContext('distributor')) {
      <p-tabpanel header="Distributor Features">
        <div class="mb-4 p-3 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg">
          <div class="flex items-center justify-between">
            <div>
              <p class="font-semibold text-indigo-900 dark:text-indigo-200">
                Distributor Administration Features
              </p>
              <p class="text-sm text-indigo-800 dark:text-indigo-300">
                Features available when managing a distributor
              </p>
            </div>
            <div class="flex gap-4 text-sm">
              <span class="text-green-600">
                <i class="pi pi-check-circle mr-1"></i>
                Accessible: {{ distributorStats().accessible }}
              </span>
              <span class="text-red-600">
                <i class="pi pi-times-circle mr-1"></i>
                Restricted: {{ distributorStats().restricted }}
              </span>
              <span class="text-gray-600">
                <i class="pi pi-info-circle mr-1"></i>
                Total: {{ distributorStats().total }}
              </span>
            </div>
          </div>
        </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QaPermissionTesterComponent, { className: "QaPermissionTesterComponent", filePath: "src/app/shared/components/qa-permission-tester/qa-permission-tester.component.ts", lineNumber: 48 });
})();

// src/app/layouts/components/main-layout/main-layout.component.ts
var MainLayoutComponent_Defer_10_DepsFn = () => [import("./chunk-IWN63QGO.js").then((m5) => m5.FlutterLayoutComponent)];
...
function MainLayoutComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MainLayoutComponent_Conditional_4_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.qaTools.resetPermissions());
    });
    \u0275\u0275element(12, "i", 16);
    \u0275\u0275text(13, " Reset ");
    \u0275\u0275elementEnd()()();
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  scrollPanelClass = computed(() => {
    return this.qaTools.testMode() ? "w-full h-[calc(100%-48px)]" : "w-full h-full";
  ...
  handleQAPanelShortcut(event) {
    if (this.qaTools.isQAToolsAvailable()) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-IWN63QGO.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-F4VRJUZ6.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-YHDJWJNR.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-LG2INGID.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        loadChildren: () => import("./chunk-BQK73QOY.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-XHPAR4OY.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-WQKOAF4J.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-NE4CIVN2.js").then((m5) => m5.UnauthorizedComponent)
  }
];
...
var AuthInterceptor = (req, next) => {
  ...
  function showToastForError(errorObject, versionUpdateService2) {
  ...
  function handleError(req2, next2, error) {
    ...
    if (error.status === 401) {
      if (req2.url.includes("/auth/signin") || req2.url.includes("/auth/refresh")) {
        showToastForError(errorObject, versionUpdateService);
