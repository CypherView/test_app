...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-AKH2DHNG.js").then((m) => m);
...
var MenuItemComponent = class _MenuItemComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MenuItemComponent, selectors: [["app-menu-item"]], inputs: { item: [1, "item"], isCollapsed: [1, "isCollapsed"] }, decls: 5, vars: 7, consts: [["routerLinkActive", "p-menuitem-link-active", "pRipple", "", 1, "flex", "items-center", "p-menu-item-link", 3, "routerLink", "ngClass"], [1, "custom-icon-svg", 3, "pTooltip"], [1, "!text-2xl", "flex", "items-center", "justify-center", 3, "icon", "pTooltip"], [3, "ngClass", "pTooltip"], [1, "ml-2"]], template: function MenuItemComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      let tmp_0_0;
      let tmp_2_0;
      \u0275\u0275property("routerLink", (tmp_0_0 = (tmp_0_0 = ctx.item()) == null ? null : tmp_0_0["routerLink"]) !== null && tmp_0_0 !== void 0 ? tmp_0_0 : (tmp_0_0 = ctx.item()) == null ? null : tmp_0_0["route"])("ngClass", \u0275\u0275pureFunction2(4, _c03, ctx.isCollapsed(), !ctx.isCollapsed()));
      \u0275\u0275advance();
...
var _c06 = (a0, a1, a2, a3) => ({ "w-16": a0, "w-aside": a1, "w-1/2": a2, open: a3 });
...
var ThemeComponent = class _ThemeComponent {
  ...
  ngOnInit() {
    this.themeService.theme$.pipe(takeUntil(this.destroy$)).subscribe({
      next: (theme3) => {
        if (!theme3)
          return;
        this.loadTheme(theme3).catch((error) => console.error("Error loading theme:", error));
      }
    });
  }
  ngOnDestroy() {
  ...
  async loadTheme(theme3) {
    try {
      this.loading.set(true);
      await this.processTheme(theme3);
      this.loading.set(false);
    } catch (error) {
      this.loading.set(false);
  ...
  processCustomTags(theme3) {
    theme3.customTags?.forEach((customTag, index) => {
      this.appendHTML(`custom-tag-${index}`, customTag.location, customTag.tag, customTag.attributes, customTag.contents);
    });
  }
  async processThemeVariables(theme3) {
    if (!theme3.variables)
      return;
    await this.injectSettingsVariables(theme3.variables);
    this.updateClasses(theme3.variables);
  }
  async processTheme(theme3) {
    await Promise.all([
      this.processThemeVariables(theme3),
      this.loadExternalStyles(theme3),
      this.injectCustomStyles(theme3),
      this.processCustomTags(theme3)
    ]);
  }
  async loadExternalStyles(theme3) {
    if (!theme3.settings?.["cssSrc"])
      return;
    try {
      const response = await firstValueFrom(this.http.get(theme3.settings["cssSrc"], {
        responseType: "text"
      }));
  ...
  async injectCustomStyles(theme3) {
    if (isNullOrUndefined(theme3.customStyles))
      return;
    try {
      await this.injectStyle("custom-css", theme3.customStyles);
    } catch (error) {
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-GFL7HPEQ.js").then((m) => m.FlutterLayoutComponent)];
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-V4LORBNJ.js").then((m) => m.PositionModule)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true },
        loadChildren: () => import("./chunk-VIOHZ3LC.js").then((m) => m.AlertsModule)
      },
      {
        path: "media",
        data: { isFlutterRoute: true },
        loadChildren: () => import("./chunk-X7OUIGDC.js").then((m) => m.MediaModule)
      },
      {
        path: "history",
        data: { isFlutterRoute: true },
        loadChildren: () => import("./chunk-76JAMPOV.js").then((m) => m.HistoryModule)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-OPOSC3QZ.js").then((m) => m.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-AUYWWFUT.js").then((m) => m.AdministrationModule)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-T2WDB3QL.js").then((m) => m.AuthModule)
  }
];
...
var ToastComponent = class _ToastComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], decls: 1, vars: 4, consts: [[3, "breakpoints"]], template: function ToastComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("breakpoints", \u0275\u0275pureFunction1(2, _c17, \u0275\u0275pureFunction0(1, _c09)));
    }
