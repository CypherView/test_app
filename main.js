import {
  ...
  ThemeComponent,
  userProfileResolver
} from "./chunk-FLDPDFAL.js";
import {
  SplitterModule
} from "./chunk-SNWPBCZR.js";
import {
  ENTITY_ADAPTER_REGISTRY
} from "./chunk-5UVE3X7F.js";
import {
  AlertsDataAdapter,
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-USOMWZIF.js";
import {
  FaIconComponent,
  FontAwesomeModule,
  Toast,
  ToastModule
} from "./chunk-2VZPIZR3.js";
import "./chunk-TE7KYM2F.js";
import {
  ToastService
} from "./chunk-7VF4PY6J.js";
import "./chunk-DXDVPHIO.js";
import "./chunk-XG3QZFP7.js";
import "./chunk-CIMIJWPK.js";
import "./chunk-UWSUC7LR.js";
import "./chunk-74PDGLLQ.js";
import {
  ApiSchemaService,
  DialogService,
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-ISK7BB7Y.js";
import {
  UtilityService
} from "./chunk-6PERSVVA.js";
import "./chunk-E42ISNWF.js";
import "./chunk-K2ZPTIYP.js";
import {
  Dialog,
  DialogModule
} from "./chunk-GMXIORZL.js";
import "./chunk-KXEMECWW.js";
import "./chunk-QUPAAPV7.js";
import {
  ProgressSpinner,
  ProgressSpinnerModule
} from "./chunk-QDDPOQB6.js";
import "./chunk-C52NSY5C.js";
import "./chunk-GDV2LZDZ.js";
import {
  BadgeModule,
  BaseComponent,
  BaseStyle,
...
var ClientSwitcherComponent = class _ClientSwitcherComponent {
  ...
  loadClients(searchTerm = "") {
    ...
    this.clientsService.listClients(ownerId, 0, DEFAULT_PAGE_SIZE, "name:asc", rqlFilter).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (data) => {
        if (isDefined(data) && hasProperty(data, "items") && hasProperty(data, "count")) {
          ...
          if (searchTerm.trim() === "") {
            this.unfilteredTotalCount.set(data.count ?? data.items.length);
          }
        } else {
  ...
  onClientSearch(searchTerm) {
    ...
    if (this.useServerSearch()) {
      this.onLazyLoadClients({ first: 0, rows: DEFAULT_PAGE_SIZE });
    }
  }
  onLazyLoadClients(event) {
    ...
    if (isString(this.currentSearchTerm) && this.currentSearchTerm.trim().length > 0) {
      filters["name"] = {
    ...
    this.loading.set(true);
    const rqlFilter = this.utilityService.constructRqlFilter(filters);
    this.clientsService.listClients(ownerId, offset, pageSize, "name:asc", rqlFilter).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (data) => {
        if (isDefined(data) && hasProperty(data, "items") && hasProperty(data, "count")) {
          this.clients.set(data.items);
          this.totalRecords.set(data.count);
...
` }]
  }], null, { onClosed: [{ type: Output, args: ["onClosed"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientSwitcherComponent, { className: "ClientSwitcherComponent", filePath: "src/app/features/clients/components/client-switcher/client-switcher.component.ts", lineNumber: 38 });
})();
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], hostBindings: function SidebarComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(12, _c04, ctx.isCollapsed(), !ctx.isCollapsed() && !ctx.isMobile(), ctx.isMobile(), ctx.isSidebarOpen()));
      \u0275\u0275advance();
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-4A3N5J4U.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-4A3N5J4U.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-KMQMIVPC.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-SOOFKL4Z.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-XCENIDE5.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-COZZJGB3.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-NAD2XAE5.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-LJ6KUUNQ.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-L4Z6O6LR.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        loadChildren: () => import("./chunk-T6KYZOBL.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-PJ3DTKQ2.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-H2SD4544.js").then((m5) => m5.AUTH_ROUTES)
  }
];
...
var AuthInterceptor = (req, next) => {
  ...
  const isExternalApi = req.url.includes("kt1.io") || req.url.includes("api.us1.kt1.io") || req.url.includes("workers.dev");
  let request = req;
  if (!isExternalApi) {
...
var ToastComponent = class _ToastComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], decls: 1, vars: 4, consts: [[3, "breakpoints"]], template: function ToastComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("breakpoints", \u0275\u0275pureFunction1(2, _c12, \u0275\u0275pureFunction0(1, _c06)));
    }
