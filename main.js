...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-EHMIEGRZ.js").then((m5) => m5);
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-ZRUXS7N3.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-ZRUXS7N3.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-G5LPAXJE.js").then((m5) => m5.PositionModule)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-ZGVHZ4R5.js").then((m5) => m5.AlertsModule)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-LB7W64GH.js").then((m5) => m5.MediaModule)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-VF6ECXTM.js").then((m5) => m5.HistoryModule)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-IV2O6BFT.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-KNWLBZ2H.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-OAV3LS5K.js").then((m5) => m5.DevelopmentModule)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-YBQAYMUY.js").then((m5) => m5.AuthModule)
  }
];
