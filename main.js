...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-LJ3YKOKW.js").then((m5) => m5);
...
var ToggleButtonComponent = class _ToggleButtonComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToggleButtonComponent, selectors: [["app-toggle-button"]], inputs: { isCollapsed: [1, "isCollapsed"] }, outputs: { toggleChange: "toggleChange" }, decls: 2, vars: 8, consts: [[1, "block", "p-2", "w-full", "text-nav-client-font-color", 3, "click", "ngClass"], [1, "pi", 3, "ngClass"]], template: function ToggleButtonComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(2, _c04, !ctx.isCollapsed(), ctx.isCollapsed()));
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(5, _c12, !ctx.isCollapsed(), ctx.isCollapsed()));
    }
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], hostBindings: function SidebarComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(11, _c05, ctx.isCollapsed(), !ctx.isCollapsed() && !ctx.isMobile(), ctx.isMobile(), ctx.isSidebarOpen()));
      \u0275\u0275advance();
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-QH4WFBCE.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-QH4WFBCE.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var userProfileResolver = () => {
  ...
  return apiAuth.getUserProfile().pipe(tap((profile) => {
    if (profile != null) {
      authData.setUserProfile(profile);
    }
  }));
};
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-YYSHOSOA.js").then((m5) => m5.PositionModule)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-DSER7BVZ.js").then((m5) => m5.AlertsModule)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-XII5SV7H.js").then((m5) => m5.MediaModule)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-NYMWFEMY.js").then((m5) => m5.HistoryModule)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-IRR3ESY2.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-CNAWVGPD.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-RVPM6XS6.js").then((m5) => m5.AuthModule)
  }
];
  ...
  return async () => {
    ...
    try {
      ...
      if (isNullOrUndefined(profile))
        return;
      const storedClientState = localStorage.getItem(LOCAL_STORAGE_KEY_SELECTED_CLIENT);
      const storedClientId = hasProperty(storedClientState, "id") && isString(storedClientState.id) ? storedClientState.id : void 0;
      const defaultClient = profile.defaultClient;
      const defaultClientId = isDefined(defaultClient) && hasProperty(defaultClient, "id") ? defaultClient.id : void 0;
      const candidateIds = [storedClientId, defaultClientId].filter((v3, idx, arr) => isDefined(v3) && arr.indexOf(v3) === idx);
      for (const id of candidateIds) {
        try {
          const client = await firstValueFrom(accountsService.getClient(id));
          if (isDefined(client)) {
