import {
  ...
  userProfileResolver
} from "./chunk-3EBOVSYM.js";
import {
  ThemeComponent
} from "./chunk-THDSZMTT.js";
import {
  SILENT_ERROR,
  SKIP_AUTH_REFRESH
} from "./chunk-FHG3PMY2.js";
import {
  LayoutService
...
import {
  SplitterModule
} from "./chunk-W3FU4YKA.js";
import {
  ENTITY_ADAPTER_REGISTRY
} from "./chunk-J3RAL2WO.js";
import {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientSwitcherComponent, { className: "ClientSwitcherComponent", filePath: "src/app/features/clients/components/client-switcher/client-switcher.component.ts", lineNumber: 44 });
})();
...
var SidebarComponent = class _SidebarComponent {
   ...
   * Matches {@link ClientSwitcherComponent.selectClient}: notifies Flutter via
   * {@link ActionType.profile_changed} before updating Angular state.
   */
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FlutterLayoutComponent, { className: "FlutterLayoutComponent", filePath: "src/app/layouts/components/flutter-layout/flutter-layout.component.ts", lineNumber: 18 });
})();
...
var ExternalTabComponent = class _ExternalTabComponent {
    ...
    if (isDefined(externalUrl) && externalUrl.trim() !== "") {
      try {
        ...
        if (parsed.protocol === "https:") {
          return this.sanitizer.sanitize(SecurityContext.RESOURCE_URL, parsed.toString());
        }
        if (isDevMode() && parsed.protocol === "http:") {
  ...
  }, decls: 1, vars: 1, consts: [["iframeEl", ""], [1, "external-iframe", 3, "src", "title"]], template: function ExternalTabComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, ExternalTabComponent_Conditional_0_Template, 3, 4, "iframe", 1);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExternalTabComponent, { className: "ExternalTabComponent", filePath: "src/app/features/external-tab/external-tab.component.ts", lineNumber: 33 });
})();
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-TSVJYZHP.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-NHN7OLK7.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-KRBZAZ6I.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-Z3J2IIUC.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-X6YZKQJS.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-34CK45ZE.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-BK6NP66W.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        data: { featureFlag: "page.moreapps.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-UKGQVXNB.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        canActivate: [nonProductionGuard],
        loadChildren: () => import("./chunk-VTGBXZ2I.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-UDY56VL4.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-GFYIZZCF.js").then((m5) => m5.UnauthorizedComponent)
  }
];
...
var SwPush = class _SwPush {
  ...
  requestSubscription(options) {
    ...
    for (let i29 = 0; i29 < key.length; i29++) {
      applicationServerKey[i29] = key.charCodeAt(i29);
    }
