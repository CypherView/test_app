...
import {
  SplitterModule
} from "./chunk-EL7SWK3H.js";
import {
  ENTITY_ADAPTER_REGISTRY
} from "./chunk-OIUQOR6R.js";
import {
  VersionUpdateService
} from "./chunk-VREFFKOZ.js";
import {
  AlertsDataAdapter,
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-X73C7WIK.js";
import {
  Menu,
  MenuModule,
  Tag,
  TagModule
} from "./chunk-ZEYGFEDC.js";
...
var MainLayoutComponent_Defer_11_DepsFn = () => [import("./chunk-PLWR3GLL.js").then((m5) => m5.FlutterLayoutComponent)];
...
function MainLayoutComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 11)(10, "button", 15);
...
function MainLayoutComponent_Defer_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-flutter-layout");
  }
}
function MainLayoutComponent_DeferLoading_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-progressSpinner", 19);
  }
}
function MainLayoutComponent_DeferPlaceholder_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-progressSpinner", 19);
  }
}
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], hostBindings: function MainLayoutComponent_HostBindings(rf, ctx) {
  ...
  }, features: [\u0275\u0275ProvidersFeature([DialogService])], decls: 17, vars: 16, consts: [[1e3, 100], [500], [1, "flex", "h-full"], [1, "fixed", "inset-0", "z-10", "bg-black/50"], [1, "w-full"], [1, "flex", "justify-between", "items-center", "px-4", "py-2", "text-white", "bg-orange-500", "border-b-2", "border-orange-600", "qa-test-banner"], [3, "ngClass"], [1, "h-full", "flutter-layout", 3, "ngClass"], [1, "h-full", 3, "ngClass"], ["sandbox", "allow-same-origin allow-scripts allow-forms allow-popups", 1, "w-full", "h-full", "border-0", 3, "src", "title"], [1, "fixed", "inset-0", "z-10", "bg-black/50", 3, "click"], [1, "flex", "gap-2", "items-center"], [1, "pi", "pi-exclamation-triangle"], [1, "font-semibold"], [1, "text-sm", "opacity-90"], [1, "px-3", "py-1", "text-sm", "text-orange-600", "bg-white", "rounded", "transition-colors", "hover:bg-orange-50", 3, "click"], [1, "mr-1", "pi", "pi-cog"], [1, "px-3", "py-1", "text-sm", "text-white", "bg-orange-700", "rounded", "transition-colors", "hover:bg-orange-800", 3, "click"], [1, "mr-1", "pi", "pi-refresh"], ["styleClass", "w-[50px] h-[50px]", "strokeWidth", "4"]], template: function MainLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "app-theme")(1, "div", 2);
      \u0275\u0275element(2, "app-sidebar");
      \u0275\u0275conditionalCreate(3, MainLayoutComponent_Conditional_3_Template, 1, 0, "div", 3);
      \u0275\u0275elementStart(4, "div", 4);
      \u0275\u0275conditionalCreate(5, MainLayoutComponent_Conditional_5_Template, 18, 15, "div", 5);
      \u0275\u0275elementStart(6, "p-scrollpanel", 6)(7, "div", 7);
      \u0275\u0275domTemplate(8, MainLayoutComponent_Defer_8_Template, 1, 0)(9, MainLayoutComponent_DeferLoading_9_Template, 1, 0)(10, MainLayoutComponent_DeferPlaceholder_10_Template, 1, 0);
      \u0275\u0275defer(11, 8, MainLayoutComponent_Defer_11_DepsFn, 9, 10, null, 0, 1, \u0275\u0275deferEnableTimerScheduling);
      \u0275\u0275deferOnIdle();
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "div", 8);
      \u0275\u0275conditionalCreate(14, MainLayoutComponent_Conditional_14_Template, 2, 4, "iframe", 9);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.iframeUrl() ? 14 : -1);
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-PLWR3GLL.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayoutComponent, { className: "MainLayoutComponent", filePath: "src/app/layouts/components/main-layout/main-layout.component.ts", lineNumber: 57 });
})();
...
function ExternalTabComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275domProperty("src", ctx_r0.iframeUrl(), \u0275\u0275sanitizeResourceUrl)("title", \u0275\u0275pipeBind1(1, 2, "FEATURES.EXTERNAL_TAB.TITLE"));
  }
}
var ExternalTabComponent = class _ExternalTabComponent {
  ...
  iframeUrl = computed(() => {
    ...
    if (isDefined(navItem?.externalUrl) && navItem.externalUrl.trim() !== "") {
      try {
        const parsed = new URL(navItem.externalUrl);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExternalTabComponent, selectors: [["app-external-tab"]], decls: 1, vars: 1, consts: [[1, "external-iframe", 3, "src", "title"]], template: function ExternalTabComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, ExternalTabComponent_Conditional_0_Template, 2, 4, "iframe", 0);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExternalTabComponent, { className: "ExternalTabComponent", filePath: "src/app/features/external-tab/external-tab.component.ts", lineNumber: 24 });
})();
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-C6J2GDH2.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-P2AHQQPI.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-OYG56UXK.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-GHWGDLZF.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-ZQIF7S2T.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-BOBRTQJC.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-YEZWXHHR.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        data: { featureFlag: "page.moreapps.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-U3IXIR7C.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        canActivate: [nonProductionGuard],
        loadChildren: () => import("./chunk-3X4ZMQF6.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-SYUHCYSU.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-GIIS5TQX.js").then((m5) => m5.UnauthorizedComponent)
  }
];
...
var ToastComponent = class _ToastComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], decls: 1, vars: 4, consts: [[3, "breakpoints"]], template: function ToastComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("breakpoints", \u0275\u0275pureFunction1(2, _c16, \u0275\u0275pureFunction0(1, _c08)));
    }
