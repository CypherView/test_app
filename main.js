import {
  ...
  userProfileResolver
} from "./chunk-6II3TRU2.js";
import {
  ThemeComponent
} from "./chunk-YXQFJ5DV.js";
import {
  NO_RETRY,
  SILENT_ERROR,
  SKIP_AUTH_REFRESH
} from "./chunk-RHK6SPOB.js";
import {
  LayoutService
} from "./chunk-WXSMXDFG.js";
import {
...
import {
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-WEWJTVOV.js";
import "./chunk-AFE2YUEN.js";
import {
  Menu,
  MenuModule
} from "./chunk-2A4PUZ3Q.js";
import {
  Tag,
  TagModule
...
import {
  ...
  Toast,
  ToastModule
} from "./chunk-4ZUWW3FH.js";
import "./chunk-VQZODH6K.js";
import {
  LanguageService
} from "./chunk-6NV364E5.js";
...
import {
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-AKOZMPT2.js";
import "./chunk-WW5JATKP.js";
import {
  Popover,
  PopoverModule,
  UtilityService
} from "./chunk-5VT2T6VX.js";
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-6SXLORNK.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-NRL6CRKL.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-ORDR3JAF.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        data: { featureFlag: "page.moreapps.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-NNVU3FCA.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        canActivate: [nonProductionGuard],
        loadChildren: () => import("./chunk-TUD6SXQA.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-VDR6RYFE.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-TZDP4RTQ.js").then((m5) => m5.UnauthorizedComponent)
  }
];
