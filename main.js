...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-LAXZ3QL5.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-LAXZ3QL5.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var userProfileResolver = () => {
  ...
  return apiAuth.getUserProfile().pipe(tap(async (profile) => {
    if (profile != null) {
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-MMNFLWTL.js").then((m5) => m5.PositionModule)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-MTF3EEKJ.js").then((m5) => m5.AlertsModule)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-XHA4UBV7.js").then((m5) => m5.MediaModule)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-4KZLMUOR.js").then((m5) => m5.HistoryModule)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-A7AVJUHW.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-XIFCBLMD.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-U2WCXFZU.js").then((m5) => m5.AuthModule)
  }
];
