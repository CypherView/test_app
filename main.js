import {
  ...
  userProfileResolver
} from "./chunk-RYZKWM3S.js";
import {
  ThemeComponent
} from "./chunk-LES3G5CM.js";
import {
  ENTITY_ADAPTER_REGISTRY
} from "./chunk-N76FRIAW.js";
import {
  VersionUpdateService
} from "./chunk-7LR6KRAV.js";
import {
  AlertsDataAdapter,
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-IU5PHRJC.js";
import {
  FaIconComponent,
  FontAwesomeModule,
  Toast,
  ToastModule
} from "./chunk-76O3QV6L.js";
import {
  ToastService
} from "./chunk-WYMXTO7G.js";
import "./chunk-DXDVPHIO.js";
import "./chunk-EY566YJ3.js";
import "./chunk-JHYQFUMG.js";
import {
  SplitterModule
} from "./chunk-HG7OUYOE.js";
...
import {
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-2DEWPY35.js";
import {
  UtilityService
} from "./chunk-24M4RCVM.js";
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-EZCXESS4.js").then((m5) => m5.FlutterLayoutComponent)];
var _c05 = (a0, a1) => ({ hidden: a0, block: a1 });
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], decls: 15, vars: 13, consts: [[1e3, 100], [500], [1, "flex", "h-full"], [1, "w-full"], ["styleClass", "w-full h-full"], [1, "h-full", "flutter-layout", 3, "ngClass"], [1, "h-full", 3, "ngClass"], ["title", "External Application", "sandbox", "allow-same-origin allow-scripts allow-forms allow-popups", 1, "w-full", "h-full", "border-0", 3, "src"], ["styleClass", "w-[50px] h-[50px]", "strokeWidth", "4"]], template: function MainLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275domTemplate(6, MainLayoutComponent_Defer_6_Template, 1, 0)(7, MainLayoutComponent_DeferLoading_7_Template, 1, 0)(8, MainLayoutComponent_DeferPlaceholder_8_Template, 1, 0);
    ...
    if (rf & 2) {
      \u0275\u0275advance(5);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(4, _c05, !ctx.isFlutterRoute(), ctx.isFlutterRoute()));
      \u0275\u0275advance(6);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(7, _c05, !ctx.isIframeRoute(), ctx.isIframeRoute()));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.iframeUrl() ? 12 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(10, _c05, ctx.isFlutterRoute() || ctx.isIframeRoute(), !ctx.isFlutterRoute() && !ctx.isIframeRoute()));
    }
  }, dependencies: [
    RouterModule,
    RouterOutlet,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-EZCXESS4.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayoutComponent, { className: "MainLayoutComponent", filePath: "src/app/layouts/components/main-layout/main-layout.component.ts", lineNumber: 47 });
})();
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-2OLNLWRZ.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-4LIXGANJ.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-727X7UNG.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-YNW56PCN.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-V3Q5EVT2.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-5GXPUZ3V.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-L7A6GGQ2.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        loadChildren: () => import("./chunk-CPSAGHPP.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-EUFBRDEI.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-HCI3L36D.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-23NO3DSV.js").then((m5) => m5.UnauthorizedComponent)
  }
];
...
var ToastComponent = class _ToastComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], decls: 1, vars: 4, consts: [[3, "breakpoints"]], template: function ToastComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("breakpoints", \u0275\u0275pureFunction1(2, _c13, \u0275\u0275pureFunction0(1, _c06)));
    }
