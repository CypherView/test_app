import {
  ...
  userProfileResolver
} from "./chunk-JQJSOFQ3.js";
import {
  ThemeComponent
} from "./chunk-CRVCXZJD.js";
import {
  NO_RETRY,
  SILENT_ERROR,
  SKIP_AUTH_REFRESH
} from "./chunk-AJEKZ335.js";
import {
  LayoutService
} from "./chunk-PG4KQ4PS.js";
import {
...
import {
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-TDTE57HU.js";
import "./chunk-AFE2YUEN.js";
import {
  Menu,
  MenuModule
} from "./chunk-WNDEW5A6.js";
import {
  Tag,
  TagModule
...
import {
  ...
  Toast,
  ToastModule
} from "./chunk-EWYB4GAD.js";
import "./chunk-VQZODH6K.js";
import {
  LanguageService
} from "./chunk-USDFPOHK.js";
...
import {
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-T32ZY5JY.js";
import "./chunk-WW5JATKP.js";
import {
  Popover,
  PopoverModule,
  UtilityService
} from "./chunk-TE47BFGN.js";
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  }, features: [\u0275\u0275ProvidersFeature([DialogService])], decls: 13, vars: 16, consts: [[1, "flex", "h-full"], [1, "fixed", "inset-0", "z-10", "bg-black/50"], [1, "w-full"], [1, "flex", "justify-between", "items-center", "px-4", "py-2", "text-white", "bg-orange-500", "border-b-2", "border-orange-600", "qa-test-banner"], [3, "ngClass"], [1, "h-full", "flutter-layout", 3, "ngClass"], [1, "h-full", 3, "ngClass"], ["sandbox", "allow-same-origin allow-scripts allow-forms allow-popups", 1, "w-full", "h-full", "border-0", 3, "src", "title"], [1, "fixed", "inset-0", "z-10", "bg-black/50", 3, "click"], [1, "flex", "gap-2", "items-center"], [1, "pi", "pi-exclamation-triangle"], [1, "font-semibold"], [1, "text-sm", "opacity-90"], [1, "px-3", "py-1", "text-sm", "text-orange-600", "bg-white", "rounded", "transition-colors", "hover:bg-orange-50", 3, "click"], [1, "mr-1", "pi", "pi-cog"], [1, "px-3", "py-1", "text-sm", "text-white", "bg-orange-700", "rounded", "transition-colors", "hover:bg-orange-800", 3, "click"], [1, "mr-1", "pi", "pi-refresh"]], template: function MainLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-X3ZJNSXA.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-XH27BM7W.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-YQRUQGRO.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        data: { featureFlag: "page.moreapps.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-IIFTSMUI.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        canActivate: [nonProductionGuard],
        loadChildren: () => import("./chunk-2CVRBUOD.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-ZA3LUVBI.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-3XXSK2DV.js").then((m5) => m5.UnauthorizedComponent)
  }
];
...
var ADAPTERS = [
  ...
  {
    types: ["vendor-map-sets", "distributor-map-sets", "map-set"],
