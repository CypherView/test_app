...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-IUZSGQAG.js").then((m5) => m5.FlutterLayoutComponent)];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-IUZSGQAG.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-PKGYCGMT.js").then((m5) => m5.UsersModule)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-HO3RXS2H.js").then((m5) => m5.AdministrationModule)
      },
      {
        path: "external/:id",
