import {
  ...
  userProfileResolver
} from "./chunk-3GYNFVAD.js";
import {
  ThemeComponent
} from "./chunk-LEPKIKND.js";
import {
  Tag,
  TagModule
...
} from "./chunk-P5IQDLWM.js";
import {
  VersionUpdateService
} from "./chunk-NHOHPWN7.js";
import {
  AlertsDataAdapter,
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-2JWGF4YF.js";
import {
  FaIconComponent,
  FontAwesomeModule,
  Toast,
  ToastModule
} from "./chunk-5WHM6MNX.js";
import "./chunk-6BAES45M.js";
import {
  ToastService
} from "./chunk-LXPAFWVT.js";
...
import {
  SplitterModule
} from "./chunk-F2I6YUV5.js";
import "./chunk-3JCNAAN3.js";
import "./chunk-5IDWGUXD.js";
import {
  Table,
  TableModule
...
import {
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-NH5QRQ52.js";
import {
  Dialog,
  DialogModule
} from "./chunk-PLJSV3JW.js";
import {
  UtilityService
} from "./chunk-GASQKAOI.js";
import "./chunk-CUIMFRB7.js";
import "./chunk-JGBYC6UQ.js";
import {
  TabPanel,
  Tabs,
  TabsModule
} from "./chunk-UMSZA5B6.js";
import "./chunk-AGRHEECN.js";
...
var ApiVerificationService = class _ApiVerificationService {
  ...
  simCardsService = inject(SimCardsService);
    ...
    const testCases = [
      {
        ...
        action: (id) => firstValueFrom(this.entitiesService.listAssets(id, void 0, 1, void 0, void 0, "response", false, { context: new HttpContext().set(SILENT_ERROR, true) }))
      },
      {
        ...
        action: (id) => firstValueFrom(this.entitiesService.listDevices(id, void 0, 1, void 0, void 0, "response", false, { context: new HttpContext().set(SILENT_ERROR, true) }))
      },
      {
        ...
        action: (id) => firstValueFrom(this.entitiesService.listZones(id, void 0, 1, void 0, void 0, void 0, "response", false, { context: new HttpContext().set(SILENT_ERROR, true) }))
      },
      {
        ...
        action: (id) => firstValueFrom(this.entitiesService.listAlerts(id, void 0, 1, void 0, void 0, "response", false, { context: new HttpContext().set(SILENT_ERROR, true) }))
      },
      {
        ...
        action: (id) => firstValueFrom(this.simCardsService.listSimCards(id, 0, 1, void 0, void 0, "response", false, { context: new HttpContext().set(SILENT_ERROR, true) }))
      },
      {
        ...
        action: (id) => firstValueFrom(this.accountsService.listUsers(id, void 0, 1, void 0, void 0, "response", false, { context: new HttpContext().set(SILENT_ERROR, true) }))
      },
      {
        ...
        action: (id) => firstValueFrom(this.accountsService.listUserRoles(id, void 0, 1, void 0, void 0, "response", false, { context: new HttpContext().set(SILENT_ERROR, true) }))
      }
    ];
    const results = [];
    const relevantTests = testCases.filter((t43) => t43.validLevels.includes(ownerType));
...
function QaPermissionTesterComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6)(1, "div", 38);
    \u0275\u0275element(2, "i", 39);
    \u0275\u0275elementStart(3, "div", 11)(4, "p", 40);
    \u0275\u0275text(5, " Test Mode Active ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 41);
    \u0275\u0275text(7, " Currently simulating: ");
    \u0275\u0275elementStart(8, "span", 42);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "div", 43)(11, "p-button", 44);
    \u0275\u0275listener("onClick", function QaPermissionTesterComponent_Conditional_10_Template_p_button_onClick_11_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.saveToRole());
    });
    \u0275\u0275elementStart(12, "span", 5);
    \u0275\u0275text(13, "Save Current Overrides to Role");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "p-button", 45);
    \u0275\u0275listener("onClick", function QaPermissionTesterComponent_Conditional_10_Template_p_button_onClick_14_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.resetPermissions());
    });
    \u0275\u0275elementStart(15, "span", 5);
    \u0275\u0275text(16, "Reset to Real Permissions");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r1.isSaving())("loading", ctx_r1.isSaving());
  }
}
function QaPermissionTesterComponent_ng_template_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46);
    \u0275\u0275element(1, "span");
    \u0275\u0275elementStart(2, "div")(3, "div", 47);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classMap(\u0275\u0275interpolate1("w-3 h-3 rounded-full ", ctx_r1.getProfileColorClass(profile_r3.color)));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(profile_r3.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", profile_r3.description, " ");
  }
}
function QaPermissionTesterComponent_For_36_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 20)(1, "input", 49);
    \u0275\u0275listener("change", function QaPermissionTesterComponent_For_36_Template_input_change_1_listener($event) {
      const permission_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.togglePermission(permission_r5, $event.target.checked));
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r1.permissionService.canAccess(permission_r5));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(permission_r5);
  }
}
function QaPermissionTesterComponent_Conditional_38_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
...
function QaPermissionTesterComponent_Conditional_38_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "code", 64);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td");
    \u0275\u0275text(5);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r6.featureId);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(feature_r6.label);
    \u0275\u0275advance(2);
    \u0275\u0275property("value", feature_r6.hasAccess ? "Accessible" : "Restricted")("severity", ctx_r1.getAccessSeverity(feature_r6.hasAccess))("icon", feature_r6.hasAccess ? "pi pi-check" : "pi pi-times");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r6.permissions);
  }
}
function QaPermissionTesterComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-tabpanel", 21)(1, "div", 51)(2, "div", 1)(3, "div")(4, "p", 52);
    \u0275\u0275text(5, "Client Administration Features");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 50);
    \u0275\u0275text(7, " Features available when managing a client context ");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(15, "p-table", 58);
    \u0275\u0275template(16, QaPermissionTesterComponent_Conditional_38_ng_template_16_Template, 9, 0, "ng-template", 59)(17, QaPermissionTesterComponent_Conditional_38_ng_template_17_Template, 11, 6, "ng-template", 60);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1(" ", ctx_r1.clientStats().accessible, " Accessible ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.clientStats().restricted, " Restricted ");
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.clientFeatureAccess())("tableStyle", \u0275\u0275pureFunction0(4, _c04));
  }
}
function QaPermissionTesterComponent_Conditional_39_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 61);
    \u0275\u0275text(2, "Feature ID");
    \u0275\u0275elementEnd();
...
function QaPermissionTesterComponent_Conditional_39_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "code", 64);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r7.featureId);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(feature_r7.label);
    \u0275\u0275advance(2);
    \u0275\u0275property("value", feature_r7.hasAccess ? "Accessible" : "Restricted")("severity", ctx_r1.getAccessSeverity(feature_r7.hasAccess))("icon", feature_r7.hasAccess ? "pi pi-check" : "pi pi-times");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r7.permissions);
  }
}
function QaPermissionTesterComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-tabpanel", 22)(1, "div", 67)(2, "div", 1)(3, "div")(4, "p", 52);
    \u0275\u0275text(5, "Vendor Administration Features");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 50);
    \u0275\u0275text(7, " Features available when managing a vendor context ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 53)(9, "span", 54);
    \u0275\u0275element(10, "i", 55);
    \u0275\u0275text(11);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(15, "p-table", 58);
    \u0275\u0275template(16, QaPermissionTesterComponent_Conditional_39_ng_template_16_Template, 9, 0, "ng-template", 59)(17, QaPermissionTesterComponent_Conditional_39_ng_template_17_Template, 11, 6, "ng-template", 60);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1(" ", ctx_r1.vendorStats().accessible, " Accessible ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.vendorStats().restricted, " Restricted ");
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.vendorFeatureAccess())("tableStyle", \u0275\u0275pureFunction0(4, _c04));
  }
}
function QaPermissionTesterComponent_Conditional_40_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 61);
    \u0275\u0275text(2, "Feature ID");
    \u0275\u0275elementEnd();
...
function QaPermissionTesterComponent_Conditional_40_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "code", 64);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r8.featureId);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(feature_r8.label);
    \u0275\u0275advance(2);
    \u0275\u0275property("value", feature_r8.hasAccess ? "Accessible" : "Restricted")("severity", ctx_r1.getAccessSeverity(feature_r8.hasAccess))("icon", feature_r8.hasAccess ? "pi pi-check" : "pi pi-times");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r8.permissions);
  }
}
function QaPermissionTesterComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-tabpanel", 23)(1, "div", 68)(2, "div", 1)(3, "div")(4, "p", 52);
    \u0275\u0275text(5, "Distributor Administration Features");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 50);
    \u0275\u0275text(7, " Features available when managing a distributor context ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 53)(9, "span", 54);
    \u0275\u0275element(10, "i", 55);
    \u0275\u0275text(11);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(15, "p-table", 58);
    \u0275\u0275template(16, QaPermissionTesterComponent_Conditional_40_ng_template_16_Template, 9, 0, "ng-template", 59)(17, QaPermissionTesterComponent_Conditional_40_ng_template_17_Template, 11, 6, "ng-template", 60);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1(" ", ctx_r1.distributorStats().accessible, " Accessible ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.distributorStats().restricted, " Restricted ");
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.distributorFeatureAccess())("tableStyle", \u0275\u0275pureFunction0(4, _c04));
  }
}
function QaPermissionTesterComponent_Conditional_55_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 30)(1, "label", 69);
    \u0275\u0275text(2, "Test as Distributor");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p-select", 70);
    \u0275\u0275listener("ngModelChange", function QaPermissionTesterComponent_Conditional_55_Template_p_select_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.qaTools.selectDistributor($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p-button", 71);
    \u0275\u0275listener("onClick", function QaPermissionTesterComponent_Conditional_55_Template_p_button_onClick_4_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.runApiVerification("distributor"));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("options", ctx_r1.availableDistributors())("ngModel", ctx_r1.selectedDistributorId())("showClear", true);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", !ctx_r1.selectedDistributorId() || ctx_r1.isVerifying());
  }
}
function QaPermissionTesterComponent_Conditional_56_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 30)(1, "label", 72);
    \u0275\u0275text(2, "Test as Vendor");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p-select", 73);
    \u0275\u0275listener("ngModelChange", function QaPermissionTesterComponent_Conditional_56_Template_p_select_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.qaTools.selectVendor($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p-button", 74);
    \u0275\u0275listener("onClick", function QaPermissionTesterComponent_Conditional_56_Template_p_button_onClick_4_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.runApiVerification("vendor"));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("options", ctx_r1.availableVendors())("ngModel", ctx_r1.selectedVendorId())("showClear", true)("disabled", ctx_r1.realOwnerType() === "system" && !ctx_r1.selectedDistributorId());
    \u0275\u0275advance();
    \u0275\u0275property("disabled", !ctx_r1.selectedVendorId() || ctx_r1.isVerifying());
  }
}
function QaPermissionTesterComponent_Conditional_67_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 83);
    \u0275\u0275text(2, "Endpoint");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "th", 83);
    \u0275\u0275text(4, "Permission");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th", 83);
    \u0275\u0275text(6, "Frontend (Expected)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th", 83);
    \u0275\u0275text(8, "Backend (Actual)");
    \u0275\u0275elementEnd()();
  }
}
function QaPermissionTesterComponent_Conditional_67_ng_template_7_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(result_r11.errorDetails);
  }
}
function QaPermissionTesterComponent_Conditional_67_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "code", 64);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td")(5, "code", 64);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "td");
    \u0275\u0275element(8, "p-tag", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td")(10, "div", 30);
    \u0275\u0275element(11, "p-tag", 65);
    \u0275\u0275conditionalCreate(12, QaPermissionTesterComponent_Conditional_67_ng_template_7_Conditional_12_Template, 2, 1, "span", 84);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const result_r11 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(result_r11.endpoint);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(result_r11.permission);
    \u0275\u0275advance(2);
    \u0275\u0275property("value", result_r11.frontendExpected ? "Allowed" : "Forbidden")("severity", result_r11.frontendExpected ? "success" : "danger")("icon", result_r11.frontendExpected ? "pi pi-check" : "pi pi-times");
    \u0275\u0275advance(3);
    \u0275\u0275property("value", result_r11.backendAccess)("severity", result_r11.backendAccess === "Allowed" ? "success" : result_r11.backendAccess === "Forbidden" ? "danger" : "warn")("icon", result_r11.backendAccess === "Allowed" ? "pi pi-check" : result_r11.backendAccess === "Forbidden" ? "pi pi-lock" : "pi pi-exclamation-triangle");
    \u0275\u0275advance();
    \u0275\u0275conditional(result_r11.errorDetails && result_r11.backendAccess === "Error" ? 12 : -1);
  }
}
function QaPermissionTesterComponent_Conditional_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 75);
    \u0275\u0275element(1, "i", 76);
    \u0275\u0275elementStart(2, "h4", 77);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "titlecase");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "p-table", 78);
    \u0275\u0275template(6, QaPermissionTesterComponent_Conditional_67_ng_template_6_Template, 9, 0, "ng-template", 59)(7, QaPermissionTesterComponent_Conditional_67_ng_template_7_Template, 13, 9, "ng-template", 60);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 79)(9, "div", 43);
    \u0275\u0275element(10, "i", 80);
    \u0275\u0275elementStart(11, "div")(12, "p", 81);
    \u0275\u0275text(13, "How to interpret results:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "ul", 82)(15, "li")(16, "strong");
    \u0275\u0275text(17, "Frontend (Expected)");
    \u0275\u0275elementEnd();
    \u0275\u0275text(18, ": What your actual user role permissions allow (ignores QA simulation). ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "li")(20, "strong");
    \u0275\u0275text(21, "Backend (Actual)");
    \u0275\u0275elementEnd();
    \u0275\u0275text(22, ": What the backend API actually enforces. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "li")(24, "strong");
    \u0275\u0275text(25, "Mismatch");
    \u0275\u0275elementEnd();
    \u0275\u0275text(26, ": If these differ, there's a bug in either frontend permission checks or backend enforcement. ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Results for ", \u0275\u0275pipeBind1(4, 2, ctx_r1.lastVerifiedLevel()), " Level ");
    \u0275\u0275advance(2);
    \u0275\u0275property("value", ctx_r1.verificationResults());
  }
}
function QaPermissionTesterComponent_Conditional_68_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 37);
    \u0275\u0275element(1, "i", 85);
    \u0275\u0275elementStart(2, "p", 86);
    \u0275\u0275text(3, "No verification results yet");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 50);
    \u0275\u0275text(5, ' Click "Run Verification" to start testing backend enforcement. ');
    \u0275\u0275elementEnd()();
  }
}
var QaPermissionTesterComponent = class _QaPermissionTesterComponent {
  ...
  async runApiVerification(level) {
    ...
    try {
      ...
      const results = await this.apiVerificationService.verifyBackEndEnforcement(targetOwnerId, level);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QaPermissionTesterComponent, selectors: [["app-qa-permission-tester"]], decls: 69, vars: 20, consts: [[1, "qa-permission-tester", "flex", "flex-col", "gap-4", "p-4"], [1, "flex", "items-center", "justify-between"], [1, "text-2xl", "font-bold", "text-primary"], [1, "text-sm", "text-gray-600", "mt-1"], ["pButton", "", "icon", "pi pi-times", "label", "Close", "aria-label", "Close dialog", 1, "p-button-text", "p-button-rounded", 3, "click"], [1, "sr-only"], [1, "p-4", "rounded-lg", "border-l-4", "border-orange-500", "bg-orange-100", "dark:bg-orange-900/40", "border", "border-orange-200", "dark:border-orange-800"], [1, "flex", "flex-col", "gap-4"], [1, "font-semibold", "mb-2"], [1, "text-sm", "text-gray-600", "mb-3"], [1, "flex", "gap-3", "items-end"], [1, "flex-1"], ["for", "profile-selector", 1, "block", "text-sm", "font-medium", "mb-2"], ["id", "profile-selector", "optionLabel", "name", "optionValue", "id", "placeholder", "Select a role...", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "options", "ngModel"], ["pTemplate", "item"], ["label", "Apply Profile", "icon", "pi pi-check", "severity", "success", 3, "onClick", "disabled"], [1, "flex", "flex-col", "gap-3"], [1, "font-semibold", "mb-1"], [1, "text-sm", "text-gray-600"], [1, "qa-permission-toggle-list"], [1, "flex", "items-center", "gap-2", "py-1"], ["header", "Client Features"], ["header", "Vendor Features"], ["header", "Distributor Features"], ["header", "API Verification"], [1, "flex", "flex-col", "gap-2"], [1, "font-semibold", "text-lg"], [1, "p-4", "rounded-lg", "bg-gray-50", "dark:bg-gray-800/40", "border", "border-gray-200", "dark:border-gray-700", "flex", "flex-col", "gap-4"], [1, "text-xs", "font-bold", "uppercase", "tracking-wider", "text-gray-500"], [1, "grid", "grid-cols-1", "md:grid-cols-3", "gap-4"], [1, "flex", "flex-col", "gap-1"], ["for", "client-selector", 1, "text-xs", "font-medium"], ["inputId", "client-selector", "optionLabel", "name", "optionValue", "id", "placeholder", "Select client...", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "options", "ngModel", "showClear", "disabled"], ["label", "Verify Client", "size", "small", 1, "mt-1", 3, "onClick", "disabled"], [1, "border-t", "border-gray-200", "dark:border-gray-700", "pt-3", "flex", "justify-between", "items-center"], [1, "text-xs", "text-gray-500", "italic", "font-medium"], ["label", "Verify Default Owner", "icon", "pi pi-play", "severity", "secondary", "size", "small", 3, "onClick", "loading", "disabled"], [1, "flex", "flex-col", "items-center", "justify-center", "py-12", "text-gray-400", "border-2", "border-dashed", "border-gray-200", "dark:border-gray-800", "rounded-xl"], [1, "flex", "items-center", "gap-3"], [1, "pi", "pi-exclamation-triangle", "text-orange-700", "dark:text-orange-400", "text-xl"], [1, "font-bold", "text-orange-950", "dark:text-orange-100", "uppercase", "text-xs", "tracking-wider", "mb-0.5"], [1, "text-sm", "text-orange-900", "dark:text-orange-300"], [1, "font-bold", "underline", "decoration-orange-400"], [1, "flex", "gap-2"], ["label", "Save to Role", "icon", "pi pi-save", "severity", "success", "size", "small", 3, "onClick", "disabled", "loading"], ["label", "Reset", "icon", "pi pi-refresh", "severity", "primary", "size", "small", 3, "onClick"], [1, "flex", "items-center", "gap-2"], [1, "font-medium"], [1, "text-xs", "text-gray-500"], ["type", "checkbox", 3, "change", "checked"], [1, "text-sm"], [1, "mb-2", "p-4", "rounded-lg", "border", "border-blue-200", "dark:border-blue-800"], [1, "font-bold"], [1, "flex", "gap-4", "text-xs", "font-semibold"], [1, "px-2", "py-1", "bg-green-200", "dark:bg-green-900/40", "text-green-900", "dark:text-green-200", "rounded"], [1, "pi", "pi-check-circle", "mr-1"], [1, "px-2", "py-1", "bg-red-200", "dark:bg-red-900/40", "text-red-900", "dark:text-red-200", "rounded"], [1, "pi", "pi-times-circle", "mr-1"], [1, "p-datatable-sm", "mb-4", 3, "value", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["scope", "col", 1, "col-25"], ["scope", "col", 1, "col-15"], ["scope", "col", 1, "col-35"], [1, "text-xs"], [3, "value", "severity", "icon"], [1, "text-xs", "text-gray-600"], [1, "mb-2", "p-4", "rounded-lg", "border", "border-purple-200", "dark:border-purple-800"], [1, "mb-2", "p-4", "rounded-lg", "border", "border-indigo-200", "dark:border-indigo-800"], ["for", "distributor-selector", 1, "text-xs", "font-medium"], ["inputId", "distributor-selector", "optionLabel", "name", "optionValue", "id", "placeholder", "Select distributor...", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "options", "ngModel", "showClear"], ["label", "Verify Distributor", "size", "small", 1, "mt-1", 3, "onClick", "disabled"], ["for", "vendor-selector", 1, "text-xs", "font-medium"], ["inputId", "vendor-selector", "optionLabel", "name", "optionValue", "id", "placeholder", "Select vendor...", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "options", "ngModel", "showClear", "disabled"], ["label", "Verify Vendor", "size", "small", 1, "mt-1", 3, "onClick", "disabled"], [1, "flex", "items-center", "gap-2", "px-1"], [1, "pi", "pi-verified", "text-blue-500"], [1, "font-semibold"], [1, "p-datatable-sm", 3, "value"], [1, "p-3", "bg-blue-50", "dark:bg-blue-900/30", "border", "border-blue-200", "dark:border-blue-800", "rounded-lg", "text-sm", "text-blue-800", "dark:text-blue-200"], [1, "pi", "pi-info-circle", "mt-0.5"], [1, "font-bold", "mb-1"], [1, "list-disc", "ml-4", "space-y-1"], ["scope", "col"], [1, "text-[10px]", "text-red-500", "break-all"], [1, "pi", "pi-shield", "text-4xl", "mb-3"], [1, "italic", "font-medium"]], template: function QaPermissionTesterComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h2", 2);
      \u0275\u0275text(4, "QA Permission Tester");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p", 3);
      \u0275\u0275text(6, " Simulate different permission profiles to test route and tab accessibility ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "button", 4);
      \u0275\u0275listener("click", function QaPermissionTesterComponent_Template_button_click_7_listener() {
        return ctx.closeDialog();
      });
      \u0275\u0275elementStart(8, "span", 5);
      \u0275\u0275text(9, "Close");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(10, QaPermissionTesterComponent_Conditional_10_Template, 17, 3, "div", 6);
      \u0275\u0275elementStart(11, "p-card")(12, "div", 7)(13, "div")(14, "h3", 8);
      \u0275\u0275text(15, "Select Test Profile");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "p", 9);
      \u0275\u0275text(17, " Choose a persona to simulate different permission levels ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(18, "div", 10)(19, "div", 11)(20, "label", 12);
      \u0275\u0275text(21, " Permission Profile ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "p-select", 13);
      \u0275\u0275listener("ngModelChange", function QaPermissionTesterComponent_Template_p_select_ngModelChange_22_listener($event) {
        return ctx.selectedProfileId.set($event);
      });
      \u0275\u0275template(23, QaPermissionTesterComponent_ng_template_23_Template, 7, 5, "ng-template", 14);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "p-button", 15);
      \u0275\u0275listener("onClick", function QaPermissionTesterComponent_Template_p_button_onClick_24_listener() {
        return ctx.applyProfile();
      });
      \u0275\u0275elementStart(25, "span", 5);
      \u0275\u0275text(26, "Apply Profile");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(27, "p-card")(28, "div", 16)(29, "div")(30, "h3", 17);
      \u0275\u0275text(31, "Permission Toggles (Scoped)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "p", 18);
      \u0275\u0275text(33, " Toggle permissions within your allowed owner context. Higher-tier permissions are hidden. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(34, "div", 19);
      \u0275\u0275repeaterCreate(35, QaPermissionTesterComponent_For_36_Template, 4, 2, "label", 20, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(37, "p-tabs");
      \u0275\u0275conditionalCreate(38, QaPermissionTesterComponent_Conditional_38_Template, 18, 5, "p-tabpanel", 21);
      \u0275\u0275conditionalCreate(39, QaPermissionTesterComponent_Conditional_39_Template, 18, 5, "p-tabpanel", 22);
      \u0275\u0275conditionalCreate(40, QaPermissionTesterComponent_Conditional_40_Template, 18, 5, "p-tabpanel", 23);
      \u0275\u0275elementStart(41, "p-tabpanel", 24)(42, "div", 7)(43, "div", 25)(44, "h3", 26);
      \u0275\u0275text(45, "Backend Enforcement Check");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(46, "p", 18);
      \u0275\u0275text(47, " Validates that frontend permission checks match backend API enforcement using your ");
      \u0275\u0275elementStart(48, "strong");
      \u0275\u0275text(49, "actual user role");
      \u0275\u0275elementEnd();
      \u0275\u0275text(50, " (ignores QA simulation). ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(51, "div", 27)(52, "p", 28);
      \u0275\u0275text(53, " Hierarchical Target Selection ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(54, "div", 29);
      \u0275\u0275conditionalCreate(55, QaPermissionTesterComponent_Conditional_55_Template, 5, 4, "div", 30);
      \u0275\u0275conditionalCreate(56, QaPermissionTesterComponent_Conditional_56_Template, 5, 5, "div", 30);
      \u0275\u0275elementStart(57, "div", 30)(58, "label", 31);
      \u0275\u0275text(59, "Test as Client");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(60, "p-select", 32);
      \u0275\u0275listener("ngModelChange", function QaPermissionTesterComponent_Template_p_select_ngModelChange_60_listener($event) {
        return ctx.qaTools.selectClient($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(61, "p-button", 33);
      \u0275\u0275listener("onClick", function QaPermissionTesterComponent_Template_p_button_onClick_61_listener() {
        return ctx.runApiVerification("client");
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(62, "div", 34)(63, "span", 35);
      \u0275\u0275text(64);
      \u0275\u0275pipe(65, "titlecase");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(66, "p-button", 36);
      \u0275\u0275listener("onClick", function QaPermissionTesterComponent_Template_p_button_onClick_66_listener() {
        return ctx.runApiVerification();
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(67, QaPermissionTesterComponent_Conditional_67_Template, 27, 4)(68, QaPermissionTesterComponent_Conditional_68_Template, 6, 0, "div", 37);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(10);
      \u0275\u0275conditional(ctx.qaTools.testMode() ? 10 : -1);
      \u0275\u0275advance(12);
      \u0275\u0275property("options", ctx.roles())("ngModel", ctx.selectedProfileId());
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", !ctx.selectedProfileId());
      \u0275\u0275advance(11);
      \u0275\u0275repeater(ctx.togglePermissions());
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.canViewContext("client") ? 38 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.canViewContext("vendor") ? 39 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.canViewContext("distributor") ? 40 : -1);
      \u0275\u0275advance(15);
      \u0275\u0275conditional(ctx.realOwnerType() === "system" ? 55 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.realOwnerType() === "system" || ctx.realOwnerType() === "distributor" ? 56 : -1);
      \u0275\u0275advance(4);
      \u0275\u0275property("options", ctx.availableClients())("ngModel", ctx.selectedClientId())("showClear", true)("disabled", (ctx.realOwnerType() === "system" || ctx.realOwnerType() === "distributor") && !ctx.selectedVendorId());
      \u0275\u0275advance();
      \u0275\u0275property("disabled", !ctx.selectedClientId() || ctx.isVerifying());
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" Default: Tests against your current level (", \u0275\u0275pipeBind1(65, 18, ctx.realOwnerType()), ") ");
      \u0275\u0275advance(2);
      \u0275\u0275property("loading", ctx.isVerifying())("disabled", ctx.isVerifying());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.verificationResults().length > 0 ? 67 : 68);
    }
  }, dependencies: [
    CommonModule,
    SelectModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(QaPermissionTesterComponent, [{
    ...
    args: [{ selector: "app-qa-permission-tester", imports: [
      ...
      CardModule,
      FormsModule
    ], template: `<div class="qa-permission-tester flex flex-col gap-4 p-4">
  <!-- Header -->
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QaPermissionTesterComponent, { className: "QaPermissionTesterComponent", filePath: "src/app/shared/components/qa-permission-tester/qa-permission-tester.component.ts", lineNumber: 55 });
})();

// src/app/layouts/components/sidebar/sidebar.component.ts
var _c05 = (a0, a1, a210, a310) => ({ "w-16": a0, "w-aside": a1, "w-1/2": a210, open: a310 });
var _c12 = (a0) => ({ "cursor-not-allowed opacity-50": a0 });
...
var SidebarComponent = class _SidebarComponent {
  ...
  qaTools = inject(QAToolsService);
  topMenuItems = signal([], ...ngDevMode ? [{ debugName: "topMenuItems" }] : []);
  bottomMenuItems = [];
  ...
  }, ...ngDevMode ? [{ debugName: "dynamicMenuItems" }] : []);
  dynamicBottomMenuItems = computed(() => {
  ...
  }, ...ngDevMode ? [{ debugName: "dynamicBottomMenuItems" }] : []);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], hostBindings: function SidebarComponent_HostBindings(rf, ctx) {
  ...
  }, features: [\u0275\u0275ProvidersFeature([DialogService])], decls: 16, vars: 23, consts: [["submenuheader", ""], ["item", ""], [1, "md:hidden", "p-4"], [1, "flex", "flex-col", "min-h-full", "sidebar-container", "left-0", "bottom-0", "top-0", 3, "ngClass"], [3, "click", "keydown.enter", "isCollapsed", "userProfile", "clientLogo", "clientName", "ngClass", "pTooltip", "showDelay"], [1, "w-full", "top-menu", "overflow-y-auto", "overflow-x-hidden", 3, "model"], [1, "mt-auto", "w-full", 3, "model"], [3, "toggleChange", "isCollapsed"], [1, "pi", "pi-bars", "text-2xl", "cursor-pointer", 3, "click", "keydown.enter"], [1, "flex", "items-center", "justify-center", "text-xs", "text-nav-client-font-color", "opacity-50"], [3, "item", "isCollapsed"], [3, "onClosed"], [3, "closeModal"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275listener("click", function SidebarComponent_Template_app_user_profile_click_2_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.canListClients() && ctx.toggleSwitchClient());
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(16, _c05, ctx.isCollapsed(), !ctx.isCollapsed() && !ctx.isMobile(), ctx.isMobile(), ctx.isSidebarOpen()));
      \u0275\u0275advance();
      \u0275\u0275classProp("hover:cursor-pointer", ctx.canListClients());
      \u0275\u0275property("isCollapsed", ctx.isCollapsed())("userProfile", ctx.userProfileSignal())("clientLogo", ctx.clientLogo())("clientName", (tmp_10_0 = ctx.selectedClientSignal()) == null ? null : tmp_10_0.name)("ngClass", \u0275\u0275pureFunction1(21, _c12, !ctx.canListClients()))("pTooltip", ctx.canListClients() ? "Switch Client" : "No permission to switch clients")("showDelay", 1250);
      \u0275\u0275advance();
...
var MainLayoutComponent_Defer_10_DepsFn = () => [import("./chunk-VI42VHHP.js").then((m5) => m5.FlutterLayoutComponent)];
var _c06 = (a0, a1) => ({ hidden: a0, block: a1 });
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], hostBindings: function MainLayoutComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(6, _c06, !ctx.isFlutterRoute(), ctx.isFlutterRoute()));
      \u0275\u0275advance(6);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(9, _c06, !ctx.isIframeRoute(), ctx.isIframeRoute()));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.iframeUrl() ? 13 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(12, _c06, ctx.isFlutterRoute() || ctx.isIframeRoute(), !ctx.isFlutterRoute() && !ctx.isIframeRoute()));
    }
  }, dependencies: [
    RouterModule,
    RouterOutlet,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-VI42VHHP.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-GSY5MVCP.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-W6UO4GHU.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-FA5VYFZP.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-CZOLIUYX.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-MVR4KPSC.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        canActivate: [adminPermissionsGuard],
        loadChildren: () => import("./chunk-M5DEMRZR.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-GD2RKKEH.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "app-store",
        loadChildren: () => import("./chunk-TRQXYXN5.js").then((m5) => m5.APP_STORE_ROUTES)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-I45TPCEA.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-QOXGCAEY.js").then((m5) => m5.AUTH_ROUTES)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-C7CTWQHU.js").then((m5) => m5.UnauthorizedComponent)
  }
];
...
var _c07 = () => ({ width: "100%", right: "0", left: "0" });
...
var ToastComponent = class _ToastComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], decls: 1, vars: 4, consts: [[3, "breakpoints"]], template: function ToastComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("breakpoints", \u0275\u0275pureFunction1(2, _c13, \u0275\u0275pureFunction0(1, _c07)));
    }
