import {
  ...
  ThemeComponent,
  userProfileResolver
} from "./chunk-5KD6V7UQ.js";
import {
  SplitterModule
} from "./chunk-ZGMI5B3N.js";
import {
  ENTITY_ADAPTER_REGISTRY
} from "./chunk-SSYASRIT.js";
import {
  AlertsDataAdapter,
  ...
  UsersDataAdapter,
  VendorsDataAdapter
} from "./chunk-5Q4BX7L6.js";
import {
  FaIconComponent,
  FontAwesomeModule,
  Toast,
  ToastModule
} from "./chunk-5R2PPOXT.js";
import "./chunk-JRKTVKI5.js";
import {
  ToastService
} from "./chunk-27KEXIZN.js";
...
import {
  ...
  ScrollPanel,
  ScrollPanelModule
} from "./chunk-RE6N4RRK.js";
import {
  UtilityService
} from "./chunk-RVEVJ4H4.js";
import {
  BadgeModule,
  BaseComponent,
  BaseStyle,
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-N5UOR5TK.js").then((m5) => m5);
...
var _c02 = () => ({ width: "90vw", "max-width": "800px" });
var _c1 = () => ({ "max-height": "70vh", "overflow": "visible", "padding": "1.5rem" });
var ClientSwitcherComponent = class _ClientSwitcherComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClientSwitcherComponent, selectors: [["app-client-switcher"]], outputs: { onClosed: "onClosed" }, decls: 2, vars: 15, consts: [["header", "Select Client", 3, "visibleChange", "onHide", "visible", "modal", "maximizable", "contentStyle"], [3, "clientSelected", "searchQuery", "lazyLoad", "clients", "loading", "useServerSearch", "totalRecords", "enablePagination", "enableLazyLoad", "recentClients"]], template: function ClientSwitcherComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275styleMap(\u0275\u0275pureFunction0(13, _c02));
      \u0275\u0275property("visible", ctx.display())("modal", true)("maximizable", false)("contentStyle", \u0275\u0275pureFunction0(14, _c1));
      \u0275\u0275advance();
...
(() => {
  ...
  [contentStyle]="{ 'max-height': '70vh', 'overflow': 'visible', 'padding': '1.5rem' }"
>
...
var SmallCapsPipe = class _SmallCapsPipe {
  transform(value) {
    ...
    while (i29 < text.length) {
      if (text[i29] === " ") {
        segments.push({ letter: " ", isCapital: false, isSpace: true });
        i29++;
        continue;
      }
      segments.push({ letter: text[i29], isCapital: true, isSpace: false });
      i29++;
      let wordRest = "";
      while (i29 < text.length && text[i29] !== " ") {
        wordRest += text[i29];
        i29++;
      }
      if (wordRest.length > 0) {
        segments.push({ letter: wordRest, isCapital: false, isSpace: false });
      }
    }
    return segments;
  }
...
var _c03 = (a0) => [a0, "!text-2xl flex items-center justify-center"];
...
function MenuItemComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    let tmp_2_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(2, _c03, (tmp_1_0 = ctx_r0.item()) == null ? null : tmp_1_0["icon"]))("pTooltip", (tmp_2_0 = ctx_r0.item()) == null ? null : tmp_2_0["label"]);
  }
}
...
function MenuItemComponent_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(3, 0, (tmp_1_0 = ctx_r0.item()) == null ? null : tmp_1_0["label"]));
  }
}
var MenuItemComponent = class _MenuItemComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MenuItemComponent, selectors: [["app-menu-item"]], inputs: { item: [1, "item"], isCollapsed: [1, "isCollapsed"] }, decls: 5, vars: 5, consts: [["routerLinkActive", "p-menuitem-link-active", "pRipple", "", 1, "menu-item-link", "flex", "items-center", "p-menu-item-link", 3, "routerLink"], [1, "custom-icon-svg", 3, "pTooltip"], [1, "!text-2xl", "flex", "items-center", "justify-center", 3, "icon", "pTooltip"], [3, "ngClass", "pTooltip"], [1, "small-caps-text", "ml-2"], [1, "ml-0.5"], [1, "text-xl", "leading-none"], [1, "text-sm", "leading-none"]], template: function MenuItemComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(4, MenuItemComponent_Conditional_4_Template, 4, 2, "span", 4);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_1_0;
...
>
  ...
  @if (!isCollapsed()) {
    <span class="small-caps-text ml-2">
...
var MainLayoutComponent_Defer_9_DepsFn = () => [import("./chunk-RXJ2DYAD.js").then((m5) => m5.FlutterLayoutComponent)];
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], decls: 15, vars: 13, consts: [[1e3, 100], [500], [1, "flex", "h-full"], [1, "w-full"], ["styleClass", "w-full h-full"], [1, "h-full", "flutter-layout", 3, "ngClass"], [1, "h-full", 3, "ngClass"], ["title", "External Application", "sandbox", "allow-same-origin allow-scripts allow-forms allow-popups", 1, "w-full", "h-full", "border-0", 3, "src"], ["styleClass", "w-[50px] h-[50px]", "strokeWidth", "4"]], template: function MainLayoutComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(5);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(4, _c06, !ctx.isFlutterRoute(), ctx.isFlutterRoute()));
      \u0275\u0275advance(6);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(7, _c06, !ctx.isIframeRoute(), ctx.isIframeRoute()));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.iframeUrl() ? 12 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(10, _c06, ctx.isFlutterRoute() || ctx.isIframeRoute(), !ctx.isFlutterRoute() && !ctx.isIframeRoute()));
    }
  }, dependencies: [
    RouterModule,
    RouterOutlet,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(MainLayoutComponent, () => [import("./chunk-RXJ2DYAD.js").then((m5) => m5.FlutterLayoutComponent)], (FlutterLayoutComponent) => {
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-LG65YTLZ.js").then((m5) => m5.POSITION_ROUTES)
      },
      {
        path: "alerts",
        data: { isFlutterRoute: true, featureFlag: "page.alerts.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-GKQ6J2VR.js").then((m5) => m5.ALERTS_ROUTES)
      },
      {
        path: "media",
        data: { isFlutterRoute: true, featureFlag: "page.videos.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-7APHPRIZ.js").then((m5) => m5.MEDIA_ROUTES)
      },
      {
        path: "history",
        data: { isFlutterRoute: true, featureFlag: "page.replay.enabled" },
        canActivate: [featureGuard],
        loadChildren: () => import("./chunk-DYPLIHZ5.js").then((m5) => m5.HISTORY_ROUTES)
      },
      {
        path: "user",
        loadChildren: () => import("./chunk-DGOROTYY.js").then((m5) => m5.USERS_ROUTES)
      },
      {
        path: "admin",
        loadChildren: () => import("./chunk-L3O43BLJ.js").then((m5) => m5.ADMINISTRATION_ROUTES)
      },
      {
        path: "analytical-report",
        loadComponent: () => import("./chunk-6653W34E.js").then((m5) => m5.AnalyticalReportComponent)
      },
      {
        path: "development",
        loadChildren: () => import("./chunk-CC7QQNXH.js").then((m5) => m5.DEVELOPMENT_ROUTES)
      },
      {
        path: "external/:id",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-ZBCAH73C.js").then((m5) => m5.AUTH_ROUTES)
  }
];
